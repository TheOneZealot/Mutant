...
{
HX_STACK_FRAME("mint.core.unifill.CodePointIter","new",0xddb4b6af,"mint.core.unifill.CodePointIter.new","mint/core/unifill/CodePointIter.hx",3,0x50de4202)
HX_STACK_THIS(this)
HX_STACK_ARG(s,"s")
{
	HX_STACK_LINE(19)
...
bool CodePointIter_obj::hasNext( ){
	HX_STACK_FRAME("mint.core.unifill.CodePointIter","hasNext",0xcbba5f3c,"mint.core.unifill.CodePointIter.hasNext","mint/core/unifill/CodePointIter.hx",15,0x50de4202)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16)
...
int CodePointIter_obj::next( ){
	HX_STACK_FRAME("mint.core.unifill.CodePointIter","next",0x206b23c4,"mint.core.unifill.CodePointIter.next","mint/core/unifill/CodePointIter.hx",20,0x50de4202)
	HX_STACK_THIS(this)
	HX_STACK_LINE(21)
	int tmp = this->index;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(21)
	...
	HX_STACK_LINE(23)
	int tmp5 = ::mint::core::unifill::_Utf8::Utf8_Impl__obj::codePointAt(tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(23)
...
void CodePointIter_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("mint.core.unifill.CodePointIter","\x3d","\x33","\xf2","\xce");
