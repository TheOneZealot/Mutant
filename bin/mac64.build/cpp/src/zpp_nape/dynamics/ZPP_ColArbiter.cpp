...
bool ZPP_ColArbiter_obj::preStep( Float dt){
	...
	HX_STACK_LINE(1892)
	bool statType = tmp16;		HX_STACK_VAR(statType,"statType");
	HX_STACK_LINE(1893)
	bool tmp17 = statType;		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(1893)
	Float tmp18;		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(1893)
	if ((tmp17)){
		HX_STACK_LINE(1893)
		bool tmp19 = this->continuous;		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(1893)
		if ((tmp19)){
			HX_STACK_LINE(1893)
			tmp18 = ::nape::Config_obj::contactContinuousStaticBiasCoef;
		}
		else{
			HX_STACK_LINE(1893)
			tmp18 = ::nape::Config_obj::contactStaticBiasCoef;
		}
	}
	else{
		HX_STACK_LINE(1893)
		...
		if ((tmp19)){
			HX_STACK_LINE(1893)
			tmp18 = ::nape::Config_obj::contactContinuousBiasCoef;
		}
		else{
			HX_STACK_LINE(1893)
			tmp18 = ::nape::Config_obj::contactBiasCoef;
		}
	}
	HX_STACK_LINE(1893)
	Float bias = tmp18;		HX_STACK_VAR(bias,"bias");
	HX_STACK_LINE(1894)
	this->biasCoef = bias;
	HX_STACK_LINE(1895)
	...
	::zpp_nape::dynamics::ZPP_IContact prei = null();		HX_STACK_VAR(prei,"prei");
	HX_STACK_LINE(1898)
	::zpp_nape::dynamics::ZPP_IContact tmp19 = this->innards;		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(1898)
	::zpp_nape::dynamics::ZPP_IContact cx_itei = tmp19->next;		HX_STACK_VAR(cx_itei,"cx_itei");
	HX_STACK_LINE(1899)
	{
		HX_STACK_LINE(1900)
		::zpp_nape::dynamics::ZPP_Contact tmp20 = this->contacts;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(1900)
		::zpp_nape::dynamics::ZPP_Contact cx_ite = tmp20->next;		HX_STACK_VAR(cx_ite,"cx_ite");
		HX_STACK_LINE(1901)
		while((true)){
			HX_STACK_LINE(1901)
			...
			{
				HX_STACK_LINE(1904)
				int tmp23 = c->stamp;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(1904)
				int tmp24 = ::nape::Config_obj::arbiterExpirationDelay;		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(1904)
				int tmp25 = (tmp23 + tmp24);		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(1904)
				int tmp26 = this->stamp;		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(1904)
				bool tmp27 = (tmp25 < tmp26);		HX_STACK_VAR(tmp27,"tmp27");
				HX_STACK_LINE(1904)
				if ((tmp27)){
					HX_STACK_LINE(1905)
					::zpp_nape::dynamics::ZPP_Contact tmp28;		HX_STACK_VAR(tmp28,"tmp28");
					HX_STACK_LINE(1905)
					{
						HX_STACK_LINE(1905)
						::zpp_nape::dynamics::ZPP_Contact tmp29 = this->contacts;		HX_STACK_VAR(tmp29,"tmp29");
						HX_STACK_LINE(1905)
						::zpp_nape::dynamics::ZPP_Contact _this = tmp29;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(1905)
						::zpp_nape::dynamics::ZPP_Contact old;		HX_STACK_VAR(old,"old");
						HX_STACK_LINE(1905)
						::zpp_nape::dynamics::ZPP_Contact ret;		HX_STACK_VAR(ret,"ret");
						HX_STACK_LINE(1905)
						bool tmp30 = (pre == null());		HX_STACK_VAR(tmp30,"tmp30");
						HX_STACK_LINE(1905)
						if ((tmp30)){
							HX_STACK_LINE(1905)
							old = _this->next;
							...
							_this->next = ret;
							HX_STACK_LINE(1905)
							bool tmp31 = (_this->next == null());		HX_STACK_VAR(tmp31,"tmp31");
							HX_STACK_LINE(1905)
							if ((tmp31)){
								HX_STACK_LINE(1905)
								_this->pushmod = true;
					...
					cx_ite = tmp28;
					HX_STACK_LINE(1906)
					::zpp_nape::dynamics::ZPP_IContact tmp29;		HX_STACK_VAR(tmp29,"tmp29");
					HX_STACK_LINE(1906)
					{
						HX_STACK_LINE(1906)
						::zpp_nape::dynamics::ZPP_IContact tmp30 = this->innards;		HX_STACK_VAR(tmp30,"tmp30");
						HX_STACK_LINE(1906)
						::zpp_nape::dynamics::ZPP_IContact _this = tmp30;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(1906)
						::zpp_nape::dynamics::ZPP_IContact old;		HX_STACK_VAR(old,"old");
						HX_STACK_LINE(1906)
						::zpp_nape::dynamics::ZPP_IContact ret;		HX_STACK_VAR(ret,"ret");
						HX_STACK_LINE(1906)
						bool tmp31 = (prei == null());		HX_STACK_VAR(tmp31,"tmp31");
						HX_STACK_LINE(1906)
						if ((tmp31)){
							HX_STACK_LINE(1906)
							old = _this->next;
				...
				bool pact = c->active;		HX_STACK_VAR(pact,"pact");
				HX_STACK_LINE(1930)
				int tmp28 = c->stamp;		HX_STACK_VAR(tmp28,"tmp28");
				HX_STACK_LINE(1930)
				...
				c->active = tmp30;
				HX_STACK_LINE(1931)
				bool tmp31 = c->active;		HX_STACK_VAR(tmp31,"tmp31");
				HX_STACK_LINE(1931)
				if ((tmp31)){
					HX_STACK_LINE(1934)
					...
					{
						HX_STACK_LINE(1945)
						Float tmp33 = c->px;		HX_STACK_VAR(tmp33,"tmp33");
						HX_STACK_LINE(1945)
						::zpp_nape::phys::ZPP_Body tmp34 = this->b2;		HX_STACK_VAR(tmp34,"tmp34");
						HX_STACK_LINE(1945)
						Float tmp35 = tmp34->posx;		HX_STACK_VAR(tmp35,"tmp35");
						HX_STACK_LINE(1945)
						Float tmp36 = (tmp33 - tmp35);		HX_STACK_VAR(tmp36,"tmp36");
						HX_STACK_LINE(1945)
						ci->r2x = tmp36;
						HX_STACK_LINE(1946)
						Float tmp37 = c->py;		HX_STACK_VAR(tmp37,"tmp37");
						HX_STACK_LINE(1946)
					...
					HX_STACK_LINE(1952)
					Float tmp33 = mass_sum;		HX_STACK_VAR(tmp33,"tmp33");
					HX_STACK_LINE(1952)
					::zpp_nape::phys::ZPP_Body tmp34 = this->b2;		HX_STACK_VAR(tmp34,"tmp34");
					HX_STACK_LINE(1952)
					...
					{
						HX_STACK_LINE(1952)
						Float tmp37 = ci->r2x;		HX_STACK_VAR(tmp37,"tmp37");
						HX_STACK_LINE(1952)
						Float tmp38 = this->nx;		HX_STACK_VAR(tmp38,"tmp38");
						HX_STACK_LINE(1952)
						Float tmp39 = (tmp37 * tmp38);		HX_STACK_VAR(tmp39,"tmp39");
						HX_STACK_LINE(1952)
						Float tmp40 = ci->r2y;		HX_STACK_VAR(tmp40,"tmp40");
						HX_STACK_LINE(1952)
						Float tmp41 = this->ny;		HX_STACK_VAR(tmp41,"tmp41");
						HX_STACK_LINE(1952)
					...
					HX_STACK_LINE(1952)
					Float kt = tmp38;		HX_STACK_VAR(kt,"kt");
					HX_STACK_LINE(1953)
					::zpp_nape::phys::ZPP_Body tmp39 = this->b1;		HX_STACK_VAR(tmp39,"tmp39");
					HX_STACK_LINE(1953)
					Float tmp40 = tmp39->sinertia;		HX_STACK_VAR(tmp40,"tmp40");
					HX_STACK_LINE(1953)
					Float tmp41;		HX_STACK_VAR(tmp41,"tmp41");
					HX_STACK_LINE(1953)
					{
						HX_STACK_LINE(1953)
						Float tmp42 = ci->r1x;		HX_STACK_VAR(tmp42,"tmp42");
						HX_STACK_LINE(1953)
						Float tmp43 = this->nx;		HX_STACK_VAR(tmp43,"tmp43");
						HX_STACK_LINE(1953)
						Float tmp44 = (tmp42 * tmp43);		HX_STACK_VAR(tmp44,"tmp44");
						HX_STACK_LINE(1953)
						Float tmp45 = ci->r1y;		HX_STACK_VAR(tmp45,"tmp45");
						HX_STACK_LINE(1953)
						Float tmp46 = this->ny;		HX_STACK_VAR(tmp46,"tmp46");
						HX_STACK_LINE(1953)
						Float tmp47 = (tmp45 * tmp46);		HX_STACK_VAR(tmp47,"tmp47");
						HX_STACK_LINE(1953)
						Float tmp48 = (tmp44 + tmp47);		HX_STACK_VAR(tmp48,"tmp48");
						HX_STACK_LINE(1953)
						Float x = tmp48;		HX_STACK_VAR(x,"x");
						HX_STACK_LINE(1953)
						tmp41 = (x * x);
					}
					HX_STACK_LINE(1953)
					...
					hx::AddEq(kt,tmp42);
					HX_STACK_LINE(1954)
					Float tmp43 = kt;		HX_STACK_VAR(tmp43,"tmp43");
					HX_STACK_LINE(1954)
					...
					if ((tmp47)){
						...
						HX_STACK_LINE(1954)
						tmp48 = (Float(((Float)1.0)) / Float(kt));
					}
					HX_STACK_LINE(1954)
					ci->tMass = tmp48;
					HX_STACK_LINE(1955)
					Float tmp49 = mass_sum;		HX_STACK_VAR(tmp49,"tmp49");
					HX_STACK_LINE(1955)
					::zpp_nape::phys::ZPP_Body tmp50 = this->b2;		HX_STACK_VAR(tmp50,"tmp50");
					HX_STACK_LINE(1955)
					Float tmp51 = tmp50->sinertia;		HX_STACK_VAR(tmp51,"tmp51");
					HX_STACK_LINE(1955)
					Float tmp52;		HX_STACK_VAR(tmp52,"tmp52");
					HX_STACK_LINE(1955)
					{
						HX_STACK_LINE(1955)
						Float tmp53 = this->ny;		HX_STACK_VAR(tmp53,"tmp53");
						HX_STACK_LINE(1955)
						Float tmp54 = ci->r2x;		HX_STACK_VAR(tmp54,"tmp54");
						HX_STACK_LINE(1955)
						Float tmp55 = (tmp53 * tmp54);		HX_STACK_VAR(tmp55,"tmp55");
						HX_STACK_LINE(1955)
						Float tmp56 = this->nx;		HX_STACK_VAR(tmp56,"tmp56");
						HX_STACK_LINE(1955)
						Float tmp57 = ci->r2y;		HX_STACK_VAR(tmp57,"tmp57");
						HX_STACK_LINE(1955)
						Float tmp58 = (tmp56 * tmp57);		HX_STACK_VAR(tmp58,"tmp58");
						HX_STACK_LINE(1955)
						Float tmp59 = (tmp55 - tmp58);		HX_STACK_VAR(tmp59,"tmp59");
						HX_STACK_LINE(1955)
						Float x = tmp59;		HX_STACK_VAR(x,"x");
						HX_STACK_LINE(1955)
						tmp52 = (x * x);
					}
					HX_STACK_LINE(1955)
					...
					HX_STACK_LINE(1955)
					Float nt = tmp54;		HX_STACK_VAR(nt,"nt");
					HX_STACK_LINE(1956)
					...
					HX_STACK_LINE(1956)
					{
						...
						HX_STACK_LINE(1956)
						Float tmp59 = ci->r1x;		HX_STACK_VAR(tmp59,"tmp59");
						HX_STACK_LINE(1956)
						Float tmp60 = (tmp58 * tmp59);		HX_STACK_VAR(tmp60,"tmp60");
						HX_STACK_LINE(1956)
						Float tmp61 = this->nx;		HX_STACK_VAR(tmp61,"tmp61");
						HX_STACK_LINE(1956)
						Float tmp62 = ci->r1y;		HX_STACK_VAR(tmp62,"tmp62");
						HX_STACK_LINE(1956)
						Float tmp63 = (tmp61 * tmp62);		HX_STACK_VAR(tmp63,"tmp63");
						HX_STACK_LINE(1956)
						Float tmp64 = (tmp60 - tmp63);		HX_STACK_VAR(tmp64,"tmp64");
						HX_STACK_LINE(1956)
						Float x = tmp64;		HX_STACK_VAR(x,"x");
						HX_STACK_LINE(1956)
						tmp57 = (x * x);
					}
					HX_STACK_LINE(1956)
					...
					hx::AddEq(nt,tmp58);
					HX_STACK_LINE(1957)
					Float tmp59 = nt;		HX_STACK_VAR(tmp59,"tmp59");
					HX_STACK_LINE(1957)
					Float tmp60 = ::nape::Config_obj::epsilon;		HX_STACK_VAR(tmp60,"tmp60");
					HX_STACK_LINE(1957)
					Float tmp61 = ::nape::Config_obj::epsilon;		HX_STACK_VAR(tmp61,"tmp61");
					HX_STACK_LINE(1957)
					Float tmp62 = (tmp60 * tmp61);		HX_STACK_VAR(tmp62,"tmp62");
					HX_STACK_LINE(1957)
					bool tmp63 = (tmp59 < tmp62);		HX_STACK_VAR(tmp63,"tmp63");
					HX_STACK_LINE(1957)
					...
					if ((tmp63)){
						...
						HX_STACK_LINE(1957)
						tmp64 = (Float(((Float)1.0)) / Float(nt));
					}
					HX_STACK_LINE(1957)
					ci->nMass = tmp64;
					HX_STACK_LINE(1958)
					...
					HX_STACK_LINE(1960)
					{
						...
						HX_STACK_LINE(1961)
						::zpp_nape::phys::ZPP_Body tmp67 = this->b2;		HX_STACK_VAR(tmp67,"tmp67");
						HX_STACK_LINE(1961)
						Float tmp68 = tmp67->kinangvel;		HX_STACK_VAR(tmp68,"tmp68");
						HX_STACK_LINE(1961)
						Float tmp69 = (tmp66 + tmp68);		HX_STACK_VAR(tmp69,"tmp69");
						HX_STACK_LINE(1961)
						Float ang = tmp69;		HX_STACK_VAR(ang,"ang");
						HX_STACK_LINE(1962)
						::zpp_nape::phys::ZPP_Body tmp70 = this->b2;		HX_STACK_VAR(tmp70,"tmp70");
						HX_STACK_LINE(1962)
						Float tmp71 = tmp70->velx;		HX_STACK_VAR(tmp71,"tmp71");
						HX_STACK_LINE(1962)
						::zpp_nape::phys::ZPP_Body tmp72 = this->b2;		HX_STACK_VAR(tmp72,"tmp72");
						HX_STACK_LINE(1962)
						Float tmp73 = tmp72->kinvelx;		HX_STACK_VAR(tmp73,"tmp73");
						HX_STACK_LINE(1962)
						Float tmp74 = (tmp71 + tmp73);		HX_STACK_VAR(tmp74,"tmp74");
						HX_STACK_LINE(1962)
						Float tmp75 = (ci->r2y * ang);		HX_STACK_VAR(tmp75,"tmp75");
						HX_STACK_LINE(1962)
						...
						HX_STACK_LINE(1963)
						Float tmp78 = tmp77->vely;		HX_STACK_VAR(tmp78,"tmp78");
						HX_STACK_LINE(1963)
						::zpp_nape::phys::ZPP_Body tmp79 = this->b2;		HX_STACK_VAR(tmp79,"tmp79");
						HX_STACK_LINE(1963)
						Float tmp80 = tmp79->kinvely;		HX_STACK_VAR(tmp80,"tmp80");
						HX_STACK_LINE(1963)
						Float tmp81 = (tmp78 + tmp80);		HX_STACK_VAR(tmp81,"tmp81");
						HX_STACK_LINE(1963)
						Float tmp82 = (ci->r2x * ang);		HX_STACK_VAR(tmp82,"tmp82");
						HX_STACK_LINE(1963)
						...
						HX_STACK_LINE(1964)
						Float tmp85 = tmp84->angvel;		HX_STACK_VAR(tmp85,"tmp85");
						HX_STACK_LINE(1964)
						::zpp_nape::phys::ZPP_Body tmp86 = this->b1;		HX_STACK_VAR(tmp86,"tmp86");
						HX_STACK_LINE(1964)
						Float tmp87 = tmp86->kinangvel;		HX_STACK_VAR(tmp87,"tmp87");
						HX_STACK_LINE(1964)
						...
						HX_STACK_LINE(1965)
						Float tmp90 = tmp89->velx;		HX_STACK_VAR(tmp90,"tmp90");
						HX_STACK_LINE(1965)
						::zpp_nape::phys::ZPP_Body tmp91 = this->b1;		HX_STACK_VAR(tmp91,"tmp91");
						HX_STACK_LINE(1965)
						Float tmp92 = tmp91->kinvelx;		HX_STACK_VAR(tmp92,"tmp92");
						HX_STACK_LINE(1965)
						Float tmp93 = (tmp90 + tmp92);		HX_STACK_VAR(tmp93,"tmp93");
						HX_STACK_LINE(1965)
						Float tmp94 = (ci->r1y * ang);		HX_STACK_VAR(tmp94,"tmp94");
						HX_STACK_LINE(1965)
						...
						HX_STACK_LINE(1966)
						Float tmp97 = tmp96->vely;		HX_STACK_VAR(tmp97,"tmp97");
						HX_STACK_LINE(1966)
						::zpp_nape::phys::ZPP_Body tmp98 = this->b1;		HX_STACK_VAR(tmp98,"tmp98");
						HX_STACK_LINE(1966)
						Float tmp99 = tmp98->kinvely;		HX_STACK_VAR(tmp99,"tmp99");
						HX_STACK_LINE(1966)
						Float tmp100 = (tmp97 + tmp99);		HX_STACK_VAR(tmp100,"tmp100");
						HX_STACK_LINE(1966)
						Float tmp101 = (ci->r1x * ang);		HX_STACK_VAR(tmp101,"tmp101");
						HX_STACK_LINE(1966)
					...
					HX_STACK_LINE(1968)
					Float tmp65 = this->nx;		HX_STACK_VAR(tmp65,"tmp65");
					HX_STACK_LINE(1968)
					Float tmp66 = vrx;		HX_STACK_VAR(tmp66,"tmp66");
					HX_STACK_LINE(1968)
					Float tmp67 = (tmp65 * tmp66);		HX_STACK_VAR(tmp67,"tmp67");
					HX_STACK_LINE(1968)
					Float tmp68 = this->ny;		HX_STACK_VAR(tmp68,"tmp68");
					HX_STACK_LINE(1968)
					Float tmp69 = vry;		HX_STACK_VAR(tmp69,"tmp69");
					HX_STACK_LINE(1968)
					Float tmp70 = (tmp68 * tmp69);		HX_STACK_VAR(tmp70,"tmp70");
					HX_STACK_LINE(1968)
					Float tmp71 = (tmp67 + tmp70);		HX_STACK_VAR(tmp71,"tmp71");
					HX_STACK_LINE(1968)
					Float vdot = tmp71;		HX_STACK_VAR(vdot,"vdot");
					HX_STACK_LINE(1969)
					Float tmp72 = this->restitution;		HX_STACK_VAR(tmp72,"tmp72");
					HX_STACK_LINE(1969)
					c->elasticity = tmp72;
					HX_STACK_LINE(1970)
					Float tmp73 = (vdot * c->elasticity);		HX_STACK_VAR(tmp73,"tmp73");
					HX_STACK_LINE(1970)
					ci->bounce = tmp73;
					HX_STACK_LINE(1971)
					Float tmp74 = ci->bounce;		HX_STACK_VAR(tmp74,"tmp74");
					HX_STACK_LINE(1971)
					Float tmp75 = ::nape::Config_obj::elasticThreshold;		HX_STACK_VAR(tmp75,"tmp75");
					HX_STACK_LINE(1971)
					Float tmp76 = -(tmp75);		HX_STACK_VAR(tmp76,"tmp76");
					HX_STACK_LINE(1971)
					bool tmp77 = (tmp74 > tmp76);		HX_STACK_VAR(tmp77,"tmp77");
					HX_STACK_LINE(1971)
					if ((tmp77)){
						HX_STACK_LINE(1972)
						ci->bounce = (int)0;
					...
					HX_STACK_LINE(1974)
					Float tmp78 = vry;		HX_STACK_VAR(tmp78,"tmp78");
					HX_STACK_LINE(1974)
					Float tmp79 = this->nx;		HX_STACK_VAR(tmp79,"tmp79");
					HX_STACK_LINE(1974)
					Float tmp80 = (tmp78 * tmp79);		HX_STACK_VAR(tmp80,"tmp80");
					HX_STACK_LINE(1974)
					Float tmp81 = vrx;		HX_STACK_VAR(tmp81,"tmp81");
					HX_STACK_LINE(1974)
					Float tmp82 = this->ny;		HX_STACK_VAR(tmp82,"tmp82");
					HX_STACK_LINE(1974)
					Float tmp83 = (tmp81 * tmp82);		HX_STACK_VAR(tmp83,"tmp83");
					HX_STACK_LINE(1974)
					...
					vdot = tmp84;
					HX_STACK_LINE(1975)
					Float tmp85 = ::nape::Config_obj::staticFrictionThreshold;		HX_STACK_VAR(tmp85,"tmp85");
					HX_STACK_LINE(1975)
					Float thr = tmp85;		HX_STACK_VAR(thr,"thr");
					HX_STACK_LINE(1976)
					Float tmp86 = (vdot * vdot);		HX_STACK_VAR(tmp86,"tmp86");
					HX_STACK_LINE(1976)
					Float tmp87 = (thr * thr);		HX_STACK_VAR(tmp87,"tmp87");
					HX_STACK_LINE(1976)
					bool tmp88 = (tmp86 > tmp87);		HX_STACK_VAR(tmp88,"tmp88");
					HX_STACK_LINE(1976)
					if ((tmp88)){
						HX_STACK_LINE(1977)
						Float tmp89 = this->dyn_fric;		HX_STACK_VAR(tmp89,"tmp89");
						HX_STACK_LINE(1977)
						ci->friction = tmp89;
					}
					else{
						HX_STACK_LINE(1980)
						Float tmp89 = this->stat_fric;		HX_STACK_VAR(tmp89,"tmp89");
						HX_STACK_LINE(1980)
						ci->friction = tmp89;
					}
					HX_STACK_LINE(1982)
				...
				HX_STACK_LINE(1985)
				bool tmp32 = (pact != c->active);		HX_STACK_VAR(tmp32,"tmp32");
				HX_STACK_LINE(1985)
				if ((tmp32)){
					HX_STACK_LINE(1985)
					::zpp_nape::dynamics::ZPP_Contact tmp33 = this->contacts;		HX_STACK_VAR(tmp33,"tmp33");
					HX_STACK_LINE(1985)
					tmp33->modified = true;
				}
				HX_STACK_LINE(1986)
	...
	HX_STACK_LINE(1993)
	bool tmp20 = this->hc2;		HX_STACK_VAR(tmp20,"tmp20");
	HX_STACK_LINE(1993)
	if ((tmp20)){
		HX_STACK_LINE(1994)
		this->hpc2 = true;
		HX_STACK_LINE(1995)
		::zpp_nape::dynamics::ZPP_Contact tmp21 = this->oc1;		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(1995)
		bool tmp22 = tmp21->posOnly;		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(1995)
		if ((tmp22)){
			HX_STACK_LINE(1996)
			::zpp_nape::dynamics::ZPP_IContact tmp23 = this->c1;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(1996)
			::zpp_nape::dynamics::ZPP_IContact tmp24 = tmp23;		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(1997)
			::zpp_nape::dynamics::ZPP_IContact tmp25 = this->c2;		HX_STACK_VAR(tmp25,"tmp25");
			HX_STACK_LINE(1997)
			this->c1 = tmp25;
			HX_STACK_LINE(1998)
			this->c2 = tmp24;
			HX_STACK_LINE(1999)
			::zpp_nape::dynamics::ZPP_Contact tmp26 = this->oc1;		HX_STACK_VAR(tmp26,"tmp26");
			HX_STACK_LINE(1999)
			::zpp_nape::dynamics::ZPP_Contact tmp27 = tmp26;		HX_STACK_VAR(tmp27,"tmp27");
			HX_STACK_LINE(2000)
			::zpp_nape::dynamics::ZPP_Contact tmp28 = this->oc2;		HX_STACK_VAR(tmp28,"tmp28");
			HX_STACK_LINE(2000)
			this->oc1 = tmp28;
			HX_STACK_LINE(2001)
			this->oc2 = tmp27;
			...
			HX_STACK_LINE(2004)
			::zpp_nape::dynamics::ZPP_Contact tmp23 = this->oc2;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(2004)
			bool tmp24 = tmp23->posOnly;		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(2004)
			if ((tmp24)){
				HX_STACK_LINE(2005)
				this->hc2 = false;
		...
		HX_STACK_LINE(2007)
		::zpp_nape::dynamics::ZPP_Contact tmp23 = this->oc1;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(2007)
		bool tmp24 = tmp23->posOnly;		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(2007)
		if ((tmp24)){
	...
	HX_STACK_LINE(2015)
	bool tmp21 = fst;		HX_STACK_VAR(tmp21,"tmp21");
	HX_STACK_LINE(2015)
	bool tmp22 = !(tmp21);		HX_STACK_VAR(tmp22,"tmp22");
	HX_STACK_LINE(2015)
	if ((tmp22)){
		HX_STACK_LINE(2016)
		Float tmp23 = this->ny;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(2016)
		::zpp_nape::dynamics::ZPP_IContact tmp24 = this->c1;		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(2016)
		Float tmp25 = tmp24->r1x;		HX_STACK_VAR(tmp25,"tmp25");
		HX_STACK_LINE(2016)
		Float tmp26 = (tmp23 * tmp25);		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(2016)
		Float tmp27 = this->nx;		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(2016)
		::zpp_nape::dynamics::ZPP_IContact tmp28 = this->c1;		HX_STACK_VAR(tmp28,"tmp28");
		HX_STACK_LINE(2016)
		Float tmp29 = tmp28->r1y;		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(2016)
		...
		this->rn1a = tmp31;
		HX_STACK_LINE(2017)
		::zpp_nape::dynamics::ZPP_IContact tmp32 = this->c1;		HX_STACK_VAR(tmp32,"tmp32");
		HX_STACK_LINE(2017)
		Float tmp33 = tmp32->r1x;		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(2017)
		Float tmp34 = this->nx;		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(2017)
		Float tmp35 = (tmp33 * tmp34);		HX_STACK_VAR(tmp35,"tmp35");
		HX_STACK_LINE(2017)
		::zpp_nape::dynamics::ZPP_IContact tmp36 = this->c1;		HX_STACK_VAR(tmp36,"tmp36");
		HX_STACK_LINE(2017)
		Float tmp37 = tmp36->r1y;		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(2017)
		Float tmp38 = this->ny;		HX_STACK_VAR(tmp38,"tmp38");
		HX_STACK_LINE(2017)
		Float tmp39 = (tmp37 * tmp38);		HX_STACK_VAR(tmp39,"tmp39");
		HX_STACK_LINE(2017)
		...
		Float tmp41 = this->ny;		HX_STACK_VAR(tmp41,"tmp41");
		HX_STACK_LINE(2018)
		::zpp_nape::dynamics::ZPP_IContact tmp42 = this->c1;		HX_STACK_VAR(tmp42,"tmp42");
		HX_STACK_LINE(2018)
		Float tmp43 = tmp42->r2x;		HX_STACK_VAR(tmp43,"tmp43");
		HX_STACK_LINE(2018)
		Float tmp44 = (tmp41 * tmp43);		HX_STACK_VAR(tmp44,"tmp44");
		HX_STACK_LINE(2018)
		Float tmp45 = this->nx;		HX_STACK_VAR(tmp45,"tmp45");
		HX_STACK_LINE(2018)
		::zpp_nape::dynamics::ZPP_IContact tmp46 = this->c1;		HX_STACK_VAR(tmp46,"tmp46");
		HX_STACK_LINE(2018)
		Float tmp47 = tmp46->r2y;		HX_STACK_VAR(tmp47,"tmp47");
		HX_STACK_LINE(2018)
		...
		HX_STACK_LINE(2019)
		Float tmp51 = tmp50->r2x;		HX_STACK_VAR(tmp51,"tmp51");
		HX_STACK_LINE(2019)
		Float tmp52 = this->nx;		HX_STACK_VAR(tmp52,"tmp52");
		HX_STACK_LINE(2019)
		Float tmp53 = (tmp51 * tmp52);		HX_STACK_VAR(tmp53,"tmp53");
		HX_STACK_LINE(2019)
		::zpp_nape::dynamics::ZPP_IContact tmp54 = this->c1;		HX_STACK_VAR(tmp54,"tmp54");
		HX_STACK_LINE(2019)
		Float tmp55 = tmp54->r2y;		HX_STACK_VAR(tmp55,"tmp55");
		HX_STACK_LINE(2019)
		Float tmp56 = this->ny;		HX_STACK_VAR(tmp56,"tmp56");
		HX_STACK_LINE(2019)
		Float tmp57 = (tmp55 * tmp56);		HX_STACK_VAR(tmp57,"tmp57");
		HX_STACK_LINE(2019)
		Float tmp58 = (tmp53 + tmp57);		HX_STACK_VAR(tmp58,"tmp58");
		HX_STACK_LINE(2019)
		this->rt1b = tmp58;
		HX_STACK_LINE(2020)
		::zpp_nape::phys::ZPP_Body tmp59 = this->b2;		HX_STACK_VAR(tmp59,"tmp59");
		HX_STACK_LINE(2020)
		Float tmp60 = tmp59->kinvelx;		HX_STACK_VAR(tmp60,"tmp60");
		HX_STACK_LINE(2020)
		::zpp_nape::dynamics::ZPP_IContact tmp61 = this->c1;		HX_STACK_VAR(tmp61,"tmp61");
		HX_STACK_LINE(2020)
		Float tmp62 = tmp61->r2y;		HX_STACK_VAR(tmp62,"tmp62");
		HX_STACK_LINE(2020)
		::zpp_nape::phys::ZPP_Body tmp63 = this->b2;		HX_STACK_VAR(tmp63,"tmp63");
		HX_STACK_LINE(2020)
		Float tmp64 = tmp63->kinangvel;		HX_STACK_VAR(tmp64,"tmp64");
		HX_STACK_LINE(2020)
		...
		HX_STACK_LINE(2020)
		Float tmp68 = tmp67->kinvelx;		HX_STACK_VAR(tmp68,"tmp68");
		HX_STACK_LINE(2020)
		::zpp_nape::dynamics::ZPP_IContact tmp69 = this->c1;		HX_STACK_VAR(tmp69,"tmp69");
		HX_STACK_LINE(2020)
		Float tmp70 = tmp69->r1y;		HX_STACK_VAR(tmp70,"tmp70");
		HX_STACK_LINE(2020)
		::zpp_nape::phys::ZPP_Body tmp71 = this->b1;		HX_STACK_VAR(tmp71,"tmp71");
		HX_STACK_LINE(2020)
		Float tmp72 = tmp71->kinangvel;		HX_STACK_VAR(tmp72,"tmp72");
		HX_STACK_LINE(2020)
		Float tmp73 = (tmp70 * tmp72);		HX_STACK_VAR(tmp73,"tmp73");
		HX_STACK_LINE(2020)
		Float tmp74 = (tmp68 - tmp73);		HX_STACK_VAR(tmp74,"tmp74");
		HX_STACK_LINE(2020)
		Float tmp75 = (tmp66 - tmp74);		HX_STACK_VAR(tmp75,"tmp75");
		HX_STACK_LINE(2020)
		this->k1x = tmp75;
		HX_STACK_LINE(2021)
		::zpp_nape::phys::ZPP_Body tmp76 = this->b2;		HX_STACK_VAR(tmp76,"tmp76");
		HX_STACK_LINE(2021)
		Float tmp77 = tmp76->kinvely;		HX_STACK_VAR(tmp77,"tmp77");
		HX_STACK_LINE(2021)
		::zpp_nape::dynamics::ZPP_IContact tmp78 = this->c1;		HX_STACK_VAR(tmp78,"tmp78");
		HX_STACK_LINE(2021)
		Float tmp79 = tmp78->r2x;		HX_STACK_VAR(tmp79,"tmp79");
		HX_STACK_LINE(2021)
		::zpp_nape::phys::ZPP_Body tmp80 = this->b2;		HX_STACK_VAR(tmp80,"tmp80");
		HX_STACK_LINE(2021)
		Float tmp81 = tmp80->kinangvel;		HX_STACK_VAR(tmp81,"tmp81");
		HX_STACK_LINE(2021)
		...
		::zpp_nape::phys::ZPP_Body tmp84 = this->b1;		HX_STACK_VAR(tmp84,"tmp84");
		HX_STACK_LINE(2021)
		Float tmp85 = tmp84->kinvely;		HX_STACK_VAR(tmp85,"tmp85");
		HX_STACK_LINE(2021)
		::zpp_nape::dynamics::ZPP_IContact tmp86 = this->c1;		HX_STACK_VAR(tmp86,"tmp86");
		HX_STACK_LINE(2021)
		Float tmp87 = tmp86->r1x;		HX_STACK_VAR(tmp87,"tmp87");
		HX_STACK_LINE(2021)
		::zpp_nape::phys::ZPP_Body tmp88 = this->b1;		HX_STACK_VAR(tmp88,"tmp88");
		HX_STACK_LINE(2021)
		Float tmp89 = tmp88->kinangvel;		HX_STACK_VAR(tmp89,"tmp89");
		HX_STACK_LINE(2021)
		Float tmp90 = (tmp87 * tmp89);		HX_STACK_VAR(tmp90,"tmp90");
		HX_STACK_LINE(2021)
		Float tmp91 = (tmp85 + tmp90);		HX_STACK_VAR(tmp91,"tmp91");
		HX_STACK_LINE(2021)
		Float tmp92 = (tmp83 - tmp91);		HX_STACK_VAR(tmp92,"tmp92");
		HX_STACK_LINE(2021)
		this->k1y = tmp92;
	}
	HX_STACK_LINE(2023)
	bool tmp23 = this->hc2;		HX_STACK_VAR(tmp23,"tmp23");
	HX_STACK_LINE(2023)
	if ((tmp23)){
		HX_STACK_LINE(2024)
		...
		HX_STACK_LINE(2024)
		::zpp_nape::dynamics::ZPP_IContact tmp29 = this->c2;		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(2024)
		...
		this->rn2a = tmp32;
		HX_STACK_LINE(2025)
		::zpp_nape::dynamics::ZPP_IContact tmp33 = this->c2;		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(2025)
		...
		HX_STACK_LINE(2025)
		::zpp_nape::dynamics::ZPP_IContact tmp37 = this->c2;		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(2025)
		...
		HX_STACK_LINE(2026)
		::zpp_nape::dynamics::ZPP_IContact tmp43 = this->c2;		HX_STACK_VAR(tmp43,"tmp43");
		HX_STACK_LINE(2026)
		...
		HX_STACK_LINE(2026)
		::zpp_nape::dynamics::ZPP_IContact tmp47 = this->c2;		HX_STACK_VAR(tmp47,"tmp47");
		HX_STACK_LINE(2026)
		...
		this->rn2b = tmp50;
		HX_STACK_LINE(2027)
		::zpp_nape::dynamics::ZPP_IContact tmp51 = this->c2;		HX_STACK_VAR(tmp51,"tmp51");
		HX_STACK_LINE(2027)
		...
		HX_STACK_LINE(2027)
		::zpp_nape::dynamics::ZPP_IContact tmp55 = this->c2;		HX_STACK_VAR(tmp55,"tmp55");
		HX_STACK_LINE(2027)
		...
		HX_STACK_LINE(2028)
		::zpp_nape::dynamics::ZPP_IContact tmp62 = this->c2;		HX_STACK_VAR(tmp62,"tmp62");
		HX_STACK_LINE(2028)
		...
		HX_STACK_LINE(2028)
		::zpp_nape::dynamics::ZPP_IContact tmp70 = this->c2;		HX_STACK_VAR(tmp70,"tmp70");
		HX_STACK_LINE(2028)
		...
		HX_STACK_LINE(2029)
		::zpp_nape::dynamics::ZPP_IContact tmp79 = this->c2;		HX_STACK_VAR(tmp79,"tmp79");
		HX_STACK_LINE(2029)
		...
		HX_STACK_LINE(2029)
		::zpp_nape::dynamics::ZPP_IContact tmp87 = this->c2;		HX_STACK_VAR(tmp87,"tmp87");
		HX_STACK_LINE(2029)
		...
		{
			HX_STACK_LINE(2031)
			Float tmp94 = mass_sum;		HX_STACK_VAR(tmp94,"tmp94");
			HX_STACK_LINE(2031)
			::zpp_nape::phys::ZPP_Body tmp95 = this->b1;		HX_STACK_VAR(tmp95,"tmp95");
			HX_STACK_LINE(2031)
			Float tmp96 = tmp95->sinertia;		HX_STACK_VAR(tmp96,"tmp96");
			HX_STACK_LINE(2031)
			Float tmp97 = this->rn1a;		HX_STACK_VAR(tmp97,"tmp97");
			HX_STACK_LINE(2031)
			Float tmp98 = (tmp96 * tmp97);		HX_STACK_VAR(tmp98,"tmp98");
			HX_STACK_LINE(2031)
			Float tmp99 = this->rn1a;		HX_STACK_VAR(tmp99,"tmp99");
			HX_STACK_LINE(2031)
			Float tmp100 = (tmp98 * tmp99);		HX_STACK_VAR(tmp100,"tmp100");
			HX_STACK_LINE(2031)
			Float tmp101 = (tmp94 + tmp100);		HX_STACK_VAR(tmp101,"tmp101");
			HX_STACK_LINE(2031)
			::zpp_nape::phys::ZPP_Body tmp102 = this->b2;		HX_STACK_VAR(tmp102,"tmp102");
			HX_STACK_LINE(2031)
			Float tmp103 = tmp102->sinertia;		HX_STACK_VAR(tmp103,"tmp103");
			HX_STACK_LINE(2031)
			Float tmp104 = this->rn1b;		HX_STACK_VAR(tmp104,"tmp104");
			HX_STACK_LINE(2031)
			Float tmp105 = (tmp103 * tmp104);		HX_STACK_VAR(tmp105,"tmp105");
			HX_STACK_LINE(2031)
			Float tmp106 = this->rn1b;		HX_STACK_VAR(tmp106,"tmp106");
			HX_STACK_LINE(2031)
			Float tmp107 = (tmp105 * tmp106);		HX_STACK_VAR(tmp107,"tmp107");
			HX_STACK_LINE(2031)
			Float tmp108 = (tmp101 + tmp107);		HX_STACK_VAR(tmp108,"tmp108");
			HX_STACK_LINE(2031)
			this->kMassa = tmp108;
			HX_STACK_LINE(2032)
			...
			HX_STACK_LINE(2032)
			Float tmp112 = this->rn1a;		HX_STACK_VAR(tmp112,"tmp112");
			HX_STACK_LINE(2032)
			Float tmp113 = (tmp111 * tmp112);		HX_STACK_VAR(tmp113,"tmp113");
			HX_STACK_LINE(2032)
			Float tmp114 = this->rn2a;		HX_STACK_VAR(tmp114,"tmp114");
			HX_STACK_LINE(2032)
			Float tmp115 = (tmp113 * tmp114);		HX_STACK_VAR(tmp115,"tmp115");
			HX_STACK_LINE(2032)
			Float tmp116 = (tmp109 + tmp115);		HX_STACK_VAR(tmp116,"tmp116");
			HX_STACK_LINE(2032)
			::zpp_nape::phys::ZPP_Body tmp117 = this->b2;		HX_STACK_VAR(tmp117,"tmp117");
			HX_STACK_LINE(2032)
			Float tmp118 = tmp117->sinertia;		HX_STACK_VAR(tmp118,"tmp118");
			HX_STACK_LINE(2032)
			Float tmp119 = this->rn1b;		HX_STACK_VAR(tmp119,"tmp119");
			HX_STACK_LINE(2032)
			Float tmp120 = (tmp118 * tmp119);		HX_STACK_VAR(tmp120,"tmp120");
			HX_STACK_LINE(2032)
			Float tmp121 = this->rn2b;		HX_STACK_VAR(tmp121,"tmp121");
			HX_STACK_LINE(2032)
			Float tmp122 = (tmp120 * tmp121);		HX_STACK_VAR(tmp122,"tmp122");
			HX_STACK_LINE(2032)
			Float tmp123 = (tmp116 + tmp122);		HX_STACK_VAR(tmp123,"tmp123");
			HX_STACK_LINE(2032)
			this->kMassb = tmp123;
			HX_STACK_LINE(2033)
			Float tmp124 = mass_sum;		HX_STACK_VAR(tmp124,"tmp124");
			HX_STACK_LINE(2033)
			::zpp_nape::phys::ZPP_Body tmp125 = this->b1;		HX_STACK_VAR(tmp125,"tmp125");
			HX_STACK_LINE(2033)
			Float tmp126 = tmp125->sinertia;		HX_STACK_VAR(tmp126,"tmp126");
			HX_STACK_LINE(2033)
			Float tmp127 = this->rn2a;		HX_STACK_VAR(tmp127,"tmp127");
			HX_STACK_LINE(2033)
			Float tmp128 = (tmp126 * tmp127);		HX_STACK_VAR(tmp128,"tmp128");
			HX_STACK_LINE(2033)
			Float tmp129 = this->rn2a;		HX_STACK_VAR(tmp129,"tmp129");
			HX_STACK_LINE(2033)
			Float tmp130 = (tmp128 * tmp129);		HX_STACK_VAR(tmp130,"tmp130");
			HX_STACK_LINE(2033)
			Float tmp131 = (tmp124 + tmp130);		HX_STACK_VAR(tmp131,"tmp131");
			HX_STACK_LINE(2033)
			::zpp_nape::phys::ZPP_Body tmp132 = this->b2;		HX_STACK_VAR(tmp132,"tmp132");
			HX_STACK_LINE(2033)
			Float tmp133 = tmp132->sinertia;		HX_STACK_VAR(tmp133,"tmp133");
			HX_STACK_LINE(2033)
			Float tmp134 = this->rn2b;		HX_STACK_VAR(tmp134,"tmp134");
			HX_STACK_LINE(2033)
			Float tmp135 = (tmp133 * tmp134);		HX_STACK_VAR(tmp135,"tmp135");
			HX_STACK_LINE(2033)
			Float tmp136 = this->rn2b;		HX_STACK_VAR(tmp136,"tmp136");
			HX_STACK_LINE(2033)
			Float tmp137 = (tmp135 * tmp136);		HX_STACK_VAR(tmp137,"tmp137");
			HX_STACK_LINE(2033)
			Float tmp138 = (tmp131 + tmp137);		HX_STACK_VAR(tmp138,"tmp138");
			HX_STACK_LINE(2033)
			this->kMassc = tmp138;
		}
		HX_STACK_LINE(2035)
		Float tmp94 = this->kMassa;		HX_STACK_VAR(tmp94,"tmp94");
		HX_STACK_LINE(2035)
		Float tmp95 = this->kMassa;		HX_STACK_VAR(tmp95,"tmp95");
		HX_STACK_LINE(2035)
		Float tmp96 = (tmp94 * tmp95);		HX_STACK_VAR(tmp96,"tmp96");
		HX_STACK_LINE(2035)
		Float tmp97 = this->kMassb;		HX_STACK_VAR(tmp97,"tmp97");
		HX_STACK_LINE(2035)
		Float tmp98 = ((int)2 * tmp97);		HX_STACK_VAR(tmp98,"tmp98");
		HX_STACK_LINE(2035)
		Float tmp99 = this->kMassb;		HX_STACK_VAR(tmp99,"tmp99");
		HX_STACK_LINE(2035)
		Float tmp100 = (tmp98 * tmp99);		HX_STACK_VAR(tmp100,"tmp100");
		HX_STACK_LINE(2035)
		Float tmp101 = (tmp96 + tmp100);		HX_STACK_VAR(tmp101,"tmp101");
		HX_STACK_LINE(2035)
		Float tmp102 = this->kMassc;		HX_STACK_VAR(tmp102,"tmp102");
		HX_STACK_LINE(2035)
		...
		HX_STACK_LINE(2035)
		Float norm = tmp105;		HX_STACK_VAR(norm,"norm");
		HX_STACK_LINE(2036)
		Float tmp106 = norm;		HX_STACK_VAR(tmp106,"tmp106");
		HX_STACK_LINE(2036)
		Float tmp107 = ::nape::Config_obj::illConditionedThreshold;		HX_STACK_VAR(tmp107,"tmp107");
		HX_STACK_LINE(2036)
		Float tmp108 = this->kMassa;		HX_STACK_VAR(tmp108,"tmp108");
		HX_STACK_LINE(2036)
		Float tmp109 = this->kMassc;		HX_STACK_VAR(tmp109,"tmp109");
		HX_STACK_LINE(2036)
		Float tmp110 = (tmp108 * tmp109);		HX_STACK_VAR(tmp110,"tmp110");
		HX_STACK_LINE(2036)
		Float tmp111 = this->kMassb;		HX_STACK_VAR(tmp111,"tmp111");
		HX_STACK_LINE(2036)
		...
		HX_STACK_LINE(2036)
		Float tmp115 = (tmp107 * tmp114);		HX_STACK_VAR(tmp115,"tmp115");
		HX_STACK_LINE(2036)
		bool tmp116 = (tmp106 < tmp115);		HX_STACK_VAR(tmp116,"tmp116");
		HX_STACK_LINE(2036)
		if ((tmp116)){
			HX_STACK_LINE(2037)
			{
				HX_STACK_LINE(2038)
				Float tmp117 = this->kMassa;		HX_STACK_VAR(tmp117,"tmp117");
				HX_STACK_LINE(2038)
				this->Ka = tmp117;
				HX_STACK_LINE(2039)
				Float tmp118 = this->kMassb;		HX_STACK_VAR(tmp118,"tmp118");
				HX_STACK_LINE(2039)
				this->Kb = tmp118;
				HX_STACK_LINE(2040)
			...
			HX_STACK_LINE(2042)
			{
				...
				Float tmp117 = this->kMassa;		HX_STACK_VAR(tmp117,"tmp117");
				HX_STACK_LINE(2043)
				Float tmp118 = this->kMassc;		HX_STACK_VAR(tmp118,"tmp118");
				HX_STACK_LINE(2043)
				Float tmp119 = (tmp117 * tmp118);		HX_STACK_VAR(tmp119,"tmp119");
				HX_STACK_LINE(2043)
				Float tmp120 = this->kMassb;		HX_STACK_VAR(tmp120,"tmp120");
				HX_STACK_LINE(2043)
				...
				HX_STACK_LINE(2043)
				Float det = tmp123;		HX_STACK_VAR(det,"det");
				HX_STACK_LINE(2044)
				bool tmp124 = (det != det);		HX_STACK_VAR(tmp124,"tmp124");
				HX_STACK_LINE(2044)
				if ((tmp124)){
					HX_STACK_LINE(2045)
					Float tmp125 = this->kMassc = (int)0;		HX_STACK_VAR(tmp125,"tmp125");
					HX_STACK_LINE(2045)
					Float tmp126 = this->kMassb = tmp125;		HX_STACK_VAR(tmp126,"tmp126");
					HX_STACK_LINE(2045)
					this->kMassa = tmp126;
					HX_STACK_LINE(2046)
					(int)3;
					...
					HX_STACK_LINE(2048)
					bool tmp125 = (det == (int)0);		HX_STACK_VAR(tmp125,"tmp125");
					HX_STACK_LINE(2048)
					if ((tmp125)){
						HX_STACK_LINE(2049)
						int flag = (int)0;		HX_STACK_VAR(flag,"flag");
						HX_STACK_LINE(2050)
						Float tmp126 = this->kMassa;		HX_STACK_VAR(tmp126,"tmp126");
						HX_STACK_LINE(2050)
						bool tmp127 = (tmp126 != (int)0);		HX_STACK_VAR(tmp127,"tmp127");
						HX_STACK_LINE(2050)
						if ((tmp127)){
							HX_STACK_LINE(2050)
							Float tmp128 = this->kMassa;		HX_STACK_VAR(tmp128,"tmp128");
							HX_STACK_LINE(2050)
							Float tmp129 = (Float((int)1) / Float(tmp128));		HX_STACK_VAR(tmp129,"tmp129");
							HX_STACK_LINE(2050)
							this->kMassa = tmp129;
						}
						else{
						...
						HX_STACK_LINE(2055)
						bool tmp129 = (tmp128 != (int)0);		HX_STACK_VAR(tmp129,"tmp129");
						HX_STACK_LINE(2055)
						if ((tmp129)){
							HX_STACK_LINE(2055)
							Float tmp130 = this->kMassc;		HX_STACK_VAR(tmp130,"tmp130");
							HX_STACK_LINE(2055)
							Float tmp131 = (Float((int)1) / Float(tmp130));		HX_STACK_VAR(tmp131,"tmp131");
							HX_STACK_LINE(2055)
							this->kMassc = tmp131;
						}
						else{
						...
						HX_STACK_LINE(2064)
						Float tmp126 = (Float((int)1) / Float(det));		HX_STACK_VAR(tmp126,"tmp126");
						HX_STACK_LINE(2064)
						det = tmp126;
						HX_STACK_LINE(2065)
						Float tmp127 = this->kMassc;		HX_STACK_VAR(tmp127,"tmp127");
						HX_STACK_LINE(2065)
						Float tmp128 = det;		HX_STACK_VAR(tmp128,"tmp128");
						HX_STACK_LINE(2065)
						Float tmp129 = (tmp127 * tmp128);		HX_STACK_VAR(tmp129,"tmp129");
						HX_STACK_LINE(2065)
						Float t = tmp129;		HX_STACK_VAR(t,"t");
						HX_STACK_LINE(2066)
						Float tmp130 = this->kMassa;		HX_STACK_VAR(tmp130,"tmp130");
						HX_STACK_LINE(2066)
						Float tmp131 = det;		HX_STACK_VAR(tmp131,"tmp131");
						HX_STACK_LINE(2066)
						...
						this->kMassa = t;
						HX_STACK_LINE(2068)
						Float tmp133 = det;		HX_STACK_VAR(tmp133,"tmp133");
						HX_STACK_LINE(2068)
						Float tmp134 = -(tmp133);		HX_STACK_VAR(tmp134,"tmp134");
						HX_STACK_LINE(2068)
						hx::MultEq(this->kMassb,tmp134);
						HX_STACK_LINE(2069)
						(int)0;
					}
				}
			...
			this->hc2 = false;
			HX_STACK_LINE(2075)
			::zpp_nape::dynamics::ZPP_Contact tmp117 = this->oc2;		HX_STACK_VAR(tmp117,"tmp117");
			HX_STACK_LINE(2075)
			Float tmp118 = tmp117->dist;		HX_STACK_VAR(tmp118,"tmp118");
			HX_STACK_LINE(2075)
			::zpp_nape::dynamics::ZPP_Contact tmp119 = this->oc1;		HX_STACK_VAR(tmp119,"tmp119");
			HX_STACK_LINE(2075)
			Float tmp120 = tmp119->dist;		HX_STACK_VAR(tmp120,"tmp120");
			HX_STACK_LINE(2075)
			bool tmp121 = (tmp118 < tmp120);		HX_STACK_VAR(tmp121,"tmp121");
			HX_STACK_LINE(2075)
			if ((tmp121)){
				HX_STACK_LINE(2076)
				::zpp_nape::dynamics::ZPP_IContact tmp122 = this->c1;		HX_STACK_VAR(tmp122,"tmp122");
				HX_STACK_LINE(2076)
				::zpp_nape::dynamics::ZPP_IContact t = tmp122;		HX_STACK_VAR(t,"t");
				HX_STACK_LINE(2077)
				::zpp_nape::dynamics::ZPP_IContact tmp123 = this->c2;		HX_STACK_VAR(tmp123,"tmp123");
				HX_STACK_LINE(2077)
				this->c1 = tmp123;
				HX_STACK_LINE(2078)
				this->c2 = t;
			...
			HX_STACK_LINE(2080)
			::zpp_nape::dynamics::ZPP_Contact tmp122 = this->oc2;		HX_STACK_VAR(tmp122,"tmp122");
			HX_STACK_LINE(2080)
			tmp122->active = false;
			HX_STACK_LINE(2081)
			::zpp_nape::dynamics::ZPP_Contact tmp123 = this->contacts;		HX_STACK_VAR(tmp123,"tmp123");
			HX_STACK_LINE(2081)
			tmp123->modified = true;
		}
	}
	HX_STACK_LINE(2084)
	{
	...
	HX_STACK_LINE(2104)
	{
		...
		HX_STACK_LINE(2114)
		Float tmp25 = tmp24->svelx;		HX_STACK_VAR(tmp25,"tmp25");
		HX_STACK_LINE(2114)
		Float tmp26 = t;		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(2114)
		Float tmp27 = (tmp25 * tmp26);		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(2114)
		hx::AddEq(this->surfacex,tmp27);
		HX_STACK_LINE(2115)
		::zpp_nape::phys::ZPP_Body tmp28 = this->b1;		HX_STACK_VAR(tmp28,"tmp28");
		HX_STACK_LINE(2115)
		Float tmp29 = tmp28->svely;		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(2115)
		Float tmp30 = t;		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(2115)
		Float tmp31 = (tmp29 * tmp30);		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(2115)
		hx::AddEq(this->surfacey,tmp31);
	}
	HX_STACK_LINE(2117)
	{
		HX_STACK_LINE(2118)
		Float tmp24 = this->surfacex;		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(2118)
		Float tmp25 = -(tmp24);		HX_STACK_VAR(tmp25,"tmp25");
		HX_STACK_LINE(2118)
		this->surfacex = tmp25;
		HX_STACK_LINE(2119)
		Float tmp26 = this->surfacey;		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(2119)
	...
	this->rMass = tmp28;
	HX_STACK_LINE(2122)
	Float tmp29 = this->rMass;		HX_STACK_VAR(tmp29,"tmp29");
	HX_STACK_LINE(2122)
	bool tmp30 = (tmp29 != (int)0);		HX_STACK_VAR(tmp30,"tmp30");
	HX_STACK_LINE(2122)
	if ((tmp30)){
		HX_STACK_LINE(2122)
		Float tmp31 = this->rMass;		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(2122)
	...
	HX_STACK_LINE(2123)
	bool tmp31 = fst;		HX_STACK_VAR(tmp31,"tmp31");
	HX_STACK_LINE(2123)
	return tmp31;
}
