...
{
		HX_STACK_LINE(663)
		::nape::geom::ConvexResultList tmp = ::nape::geom::ConvexResultList_obj::__new();		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(663)
		::nape::geom::ConvexResultList ret = tmp;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(664)
		{
			HX_STACK_LINE(664)
			...
			while((true)){
				...
				HX_STACK_LINE(664)
				::nape::geom::ConvexResult i = tmp4;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(664)
				bool tmp5 = deep;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(664)
				::nape::geom::ConvexResult tmp6;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(664)
				if ((tmp5)){
					HX_STACK_LINE(666)
					::String tmp7 = HX_HCSTRING("Error: ConvexResult","\x12","\x8d","\xbd","\xa3");		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(666)
...
::nape::geom::ConvexResultList ConvexResultList_obj::fromArray( Array< ::Dynamic > array){
	...
	HX_STACK_LINE(310)
	::nape::geom::ConvexResultList tmp1 = ::nape::geom::ConvexResultList_obj::__new();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(310)
	::nape::geom::ConvexResultList ret = tmp1;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(311)
	{
		HX_STACK_LINE(311)
		...
		while((true)){
			...
			HX_STACK_LINE(311)
			::nape::geom::ConvexResult tmp4 = array->__get(_g).StaticCast< ::nape::geom::ConvexResult >();		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(311)
			::nape::geom::ConvexResult i = tmp4;		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			::nape::geom::ConvexResult tmp5 = i;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(316)
			ret->push(tmp5);
		}
	}
	HX_STACK_LINE(318)
	::nape::geom::ConvexResultList tmp2 = ret;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(318)
	return tmp2;
}
