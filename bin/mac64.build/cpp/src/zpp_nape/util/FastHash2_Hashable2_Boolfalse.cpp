...
Void FastHash2_Hashable2_Boolfalse_obj::clear( ){
{
		...
		while((true)){
			...
			HX_STACK_LINE(274)
			::zpp_nape::util::Hashable2_Boolfalse tmp4 = this->table->__get(i).StaticCast< ::zpp_nape::util::Hashable2_Boolfalse >();		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(274)
			::zpp_nape::util::Hashable2_Boolfalse n = tmp4;		HX_STACK_VAR(n,"n");
			HX_STACK_LINE(275)
...
::zpp_nape::util::Hashable2_Boolfalse FastHash2_Hashable2_Boolfalse_obj::get( int id,int di){
	...
	HX_STACK_LINE(289)
	::zpp_nape::util::Hashable2_Boolfalse tmp4 = this->table->__get(tmp3).StaticCast< ::zpp_nape::util::Hashable2_Boolfalse >();		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(289)
	::zpp_nape::util::Hashable2_Boolfalse n = tmp4;		HX_STACK_VAR(n,"n");
	HX_STACK_LINE(290)
	bool tmp5 = (n == null());		HX_STACK_VAR(tmp5,"tmp5");
	...
	if ((tmp5)){
		...
		HX_STACK_LINE(291)
		bool tmp6 = (n->id == id);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(291)
		...
		if ((tmp7)){
			HX_STACK_LINE(291)
			::zpp_nape::util::Hashable2_Boolfalse tmp8 = n;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(291)
			return tmp8;
		}
		else{
			...
			while((true)){
				...
				if ((tmp8)){
					HX_STACK_LINE(293)
					bool tmp10 = (n->id != id);		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(293)
...
::zpp_nape::util::Hashable2_Boolfalse FastHash2_Hashable2_Boolfalse_obj::ordered_get( int id,int di){
	...
	{
		HX_STACK_LINE(305)
		int tmp2 = (id * (int)106039);		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(305)
		int tmp3 = di;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(305)
		int tmp4 = (tmp2 + tmp3);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(305)
		int tmp5 = (int(tmp4) & int((int)1048575));		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(305)
		::zpp_nape::util::Hashable2_Boolfalse tmp6 = this->table->__get(tmp5).StaticCast< ::zpp_nape::util::Hashable2_Boolfalse >();		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(305)
		...
		if ((tmp7)){
			...
			HX_STACK_LINE(305)
			bool tmp8 = (n->id == id);		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(305)
			bool tmp9;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(305)
			if ((tmp8)){
			...
			if ((tmp9)){
				...
				while((true)){
					...
					n = n->hnext;
					HX_STACK_LINE(305)
					bool tmp10 = (n != null());		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(305)
					bool tmp11;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(305)
					if ((tmp10)){
						HX_STACK_LINE(305)
						bool tmp12 = (n->id != id);		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(305)
						bool tmp13 = tmp12;		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(305)
						bool tmp14 = tmp13;		HX_STACK_VAR(tmp14,"tmp14");
...
Void FastHash2_Hashable2_Boolfalse_obj::maybeAdd( ::zpp_nape::util::Hashable2_Boolfalse arb){
{
		...
		HX_STACK_LINE(326)
		::zpp_nape::util::Hashable2_Boolfalse tmp4 = this->table->__get(h).StaticCast< ::zpp_nape::util::Hashable2_Boolfalse >();		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(326)
		::zpp_nape::util::Hashable2_Boolfalse n = tmp4;		HX_STACK_VAR(n,"n");
		HX_STACK_LINE(327)
		...
		if ((tmp5)){
			HX_STACK_LINE(329)
			::zpp_nape::util::Hashable2_Boolfalse tmp6 = arb;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(329)
			this->table[h] = tmp6;
			HX_STACK_LINE(330)
			arb->hnext = null();
...
Void FastHash2_Hashable2_Boolfalse_obj::remove( ::zpp_nape::util::Hashable2_Boolfalse arb){
{
		...
		::zpp_nape::util::Hashable2_Boolfalse n = tmp4;		HX_STACK_VAR(n,"n");
		HX_STACK_LINE(393)
		bool tmp5 = (n == arb);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(393)
		if ((tmp5)){
			HX_STACK_LINE(393)
			::zpp_nape::util::Hashable2_Boolfalse tmp6 = n->hnext;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(393)
			this->table[h] = tmp6;
		}
		else{
