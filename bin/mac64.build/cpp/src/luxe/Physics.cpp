...
{
		HX_STACK_FRAME("luxe.Physics","init",0x484f83ef,"luxe.Physics.init","luxe/Physics.hx",48,0xe794c970)
		HX_STACK_THIS(this)
		HX_STACK_LINE(50)
		this->engines = Array_obj< ::Dynamic >::__new();
		HX_STACK_LINE(57)
		::luxe::physics::nape::PhysicsNape tmp = this->add_engine(hx::ClassOf< ::luxe::physics::nape::PhysicsNape >(),null());		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(57)
		this->nape = tmp;
	}
return null();
...
{
	HX_VISIT_MEMBER_NAME(nape,"nape");
...
Dynamic Physics_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 3:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"nape") ) { return nape; }
...
Dynamic Physics_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"nape") ) { nape=inValue.Cast< ::luxe::physics::nape::PhysicsNape >(); return inValue; }
...
{
	outFields->push(HX_HCSTRING("nape","\xe8","\x74","\xff","\x48"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::luxe::physics::nape::PhysicsNape*/ ,(int)offsetof(Physics_obj,nape),HX_HCSTRING("nape","\xe8","\x74","\xff","\x48")},
...
static ::String sMemberFields[] = {
	HX_HCSTRING("nape","\xe8","\x74","\xff","\x48"),
