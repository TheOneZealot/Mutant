...
::nape::geom::Ray Ray_obj::copy( ){
	...
	HX_STACK_LINE(352)
	{
		...
		HX_STACK_LINE(352)
		Float maxDistance = tmp5->maxdist;		HX_STACK_VAR(maxDistance,"maxDistance");
		HX_STACK_LINE(352)
		{
			HX_STACK_LINE(352)
...
::nape::geom::Ray Ray_obj::fromSegment( ::nape::geom::Vec2 start,::nape::geom::Vec2 end){
	...
	HX_STACK_LINE(390)
	::nape::geom::Ray tmp4 = ::nape::geom::Ray_obj::__new(start,dir);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(390)
	::nape::geom::Ray ret = tmp4;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(391)
	{
		...
		HX_STACK_LINE(391)
		{
			...
			{
				HX_STACK_LINE(391)
				bool tmp8 = (start != null());		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(391)
				bool tmp9;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(391)
				if ((tmp8)){
			...
			HX_STACK_LINE(391)
			{
				...
				HX_STACK_LINE(391)
				tmp8 = end->zpp_inner->x;
			}
			HX_STACK_LINE(391)
			Float bx = tmp8;		HX_STACK_VAR(bx,"bx");
			HX_STACK_LINE(391)
			Float tmp9;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(391)
			{
				HX_STACK_LINE(391)
				bool tmp10 = (end != null());		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(391)
				bool tmp11;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(391)
				if ((tmp10)){
				...
				HX_STACK_LINE(391)
				tmp9 = end->zpp_inner->y;
			}
			HX_STACK_LINE(391)
			Float by = tmp9;		HX_STACK_VAR(by,"by");
			HX_STACK_LINE(391)
			...
			{
				HX_STACK_LINE(391)
				Float tmp10 = (ax - bx);		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(391)
				dx = tmp10;
				HX_STACK_LINE(391)
				Float tmp11 = (ay - by);		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(391)
				dy = tmp11;
			}
			HX_STACK_LINE(391)
		...
		HX_STACK_LINE(391)
		Float maxDistance = tmp6;		HX_STACK_VAR(maxDistance,"maxDistance");
		HX_STACK_LINE(391)
		{
			HX_STACK_LINE(391)
			bool tmp7 = (maxDistance != maxDistance);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(391)
			if ((tmp7)){
				HX_STACK_LINE(391)
				HX_STACK_DO_THROW(HX_HCSTRING("Error: maxDistance cannot be NaN","\xc6","\x98","\x5d","\x73"));
	...
	HX_STACK_LINE(392)
	{
		...
		if ((tmp5)){
			HX_STACK_LINE(396)
			{
				...
				HX_STACK_LINE(396)
				bool tmp6 = start->zpp_inner->_inuse;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(396)
				if ((tmp6)){
					HX_STACK_LINE(396)
					HX_STACK_DO_THROW(HX_HCSTRING("Error: This Vec2 is not disposable","\xb5","\xd1","\xd1","\xd8"));
	...
	HX_STACK_LINE(403)
	{
		...
		if ((tmp5)){
			HX_STACK_LINE(407)
			{
				...
				{
					HX_STACK_LINE(407)
					bool tmp6 = (end != null());		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(407)
					bool tmp7;		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(407)
					if ((tmp6)){
				...
				HX_STACK_LINE(407)
				bool tmp6 = end->zpp_inner->_inuse;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(407)
				if ((tmp6)){
					HX_STACK_LINE(407)
					HX_STACK_DO_THROW(HX_HCSTRING("Error: This Vec2 is not disposable","\xb5","\xd1","\xd1","\xd8"));
