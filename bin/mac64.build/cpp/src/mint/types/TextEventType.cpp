...
::mint::types::TextEventType TextEventType_obj::edit;

::mint::types::TextEventType TextEventType_obj::input;

::mint::types::TextEventType TextEventType_obj::unknown;
...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("mint.types.TextEventType","\xe6","\x8e","\xbf","\xeb"), hx::TCanCast< TextEventType_obj >,sStaticFields,sMemberFields,
