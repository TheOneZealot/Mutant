...
class HXCPP_CLASS_ATTRIBUTES  ZNPList_ZPP_AABBPair_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPList_ZPP_AABBPair")
		...
		::String __ToString() const { return HX_HCSTRING("ZNPList_ZPP_AABBPair","\x24","\xc3","\x53","\x51"); }
