...
Void ZPP_PulleyJoint_obj::validate( ){
{
		...
		if ((tmp34)){
			...
			HX_STACK_LINE(955)
			::zpp_nape::phys::ZPP_Body tmp37 = tmp36;		HX_STACK_VAR(tmp37,"tmp37");
			HX_STACK_LINE(955)
			int tmp38 = tmp37->type;		HX_STACK_VAR(tmp38,"tmp38");
			HX_STACK_LINE(955)
			bool tmp39 = (tmp38 == (int)2);		HX_STACK_VAR(tmp39,"tmp39");
			HX_STACK_LINE(955)
		...
		HX_STACK_LINE(956)
		::zpp_nape::phys::ZPP_Body tmp36 = this->b3;		HX_STACK_VAR(tmp36,"tmp36");
		HX_STACK_LINE(956)
		int tmp37 = tmp36->type;		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(956)
		bool tmp38 = (tmp37 == (int)2);		HX_STACK_VAR(tmp38,"tmp38");
		HX_STACK_LINE(956)
		...
		if ((tmp40)){
			HX_STACK_LINE(956)
			::zpp_nape::phys::ZPP_Body tmp42 = this->b4;		HX_STACK_VAR(tmp42,"tmp42");
			HX_STACK_LINE(956)
			::zpp_nape::phys::ZPP_Body tmp43 = tmp42;		HX_STACK_VAR(tmp43,"tmp43");
			HX_STACK_LINE(956)
			int tmp44 = tmp43->type;		HX_STACK_VAR(tmp44,"tmp44");
			HX_STACK_LINE(956)
			bool tmp45 = (tmp44 == (int)2);		HX_STACK_VAR(tmp45,"tmp45");
			HX_STACK_LINE(956)
...
Void ZPP_PulleyJoint_obj::forest( ){
{
		...
		if ((tmp2)){
			...
			HX_STACK_LINE(966)
			{
				...
				HX_STACK_LINE(967)
				::zpp_nape::space::ZPP_Component tmp7 = tmp6->component->parent;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(967)
				...
				if ((tmp8)){
					...
					::zpp_nape::phys::ZPP_Body tmp9 = this->b1;		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(969)
					::zpp_nape::space::ZPP_Component obj = tmp9->component;		HX_STACK_VAR(obj,"obj");
					HX_STACK_LINE(970)
					::zpp_nape::space::ZPP_Component stack = null();		HX_STACK_VAR(stack,"stack");
					HX_STACK_LINE(971)
					while((true)){
						HX_STACK_LINE(971)
						bool tmp10 = (obj != obj->parent);		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(971)
			...
			HX_STACK_LINE(966)
			::zpp_nape::space::ZPP_Component xr = tmp3;		HX_STACK_VAR(xr,"xr");
			HX_STACK_LINE(985)
			::zpp_nape::space::ZPP_Component tmp4;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(985)
			{
				HX_STACK_LINE(986)
				::zpp_nape::space::ZPP_Component tmp5 = this->component;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(986)
				::zpp_nape::space::ZPP_Component tmp6 = this->component;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(986)
				::zpp_nape::space::ZPP_Component tmp7 = tmp6->parent;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(986)
				bool tmp8 = (tmp5 == tmp7);		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(986)
				if ((tmp8)){
					...
					HX_STACK_LINE(988)
					::zpp_nape::space::ZPP_Component obj = tmp9;		HX_STACK_VAR(obj,"obj");
					HX_STACK_LINE(989)
					::zpp_nape::space::ZPP_Component stack = null();		HX_STACK_VAR(stack,"stack");
					HX_STACK_LINE(990)
					while((true)){
			...
			HX_STACK_LINE(985)
			::zpp_nape::space::ZPP_Component yr = tmp4;		HX_STACK_VAR(yr,"yr");
			HX_STACK_LINE(1004)
			bool tmp5 = (xr != yr);		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(1004)
			if ((tmp5)){
				HX_STACK_LINE(1005)
				bool tmp6 = (xr->rank < yr->rank);		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(1005)
				if ((tmp6)){
					HX_STACK_LINE(1005)
					xr->parent = yr;
		...
		if ((tmp5)){
			...
			HX_STACK_LINE(1014)
			{
				...
				HX_STACK_LINE(1015)
				::zpp_nape::space::ZPP_Component tmp8 = tmp7->component;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(1015)
				::zpp_nape::phys::ZPP_Body tmp9 = this->b2;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(1015)
				::zpp_nape::space::ZPP_Component tmp10 = tmp9->component->parent;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(1015)
				...
				if ((tmp11)){
					...
					::zpp_nape::phys::ZPP_Body tmp12 = this->b2;		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(1015)
					tmp6 = tmp12->component;
				}
				else{
					HX_STACK_LINE(1017)
					::zpp_nape::phys::ZPP_Body tmp12 = this->b2;		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(1017)
					::zpp_nape::space::ZPP_Component obj = tmp12->component;		HX_STACK_VAR(obj,"obj");
					HX_STACK_LINE(1018)
					::zpp_nape::space::ZPP_Component stack = null();		HX_STACK_VAR(stack,"stack");
					HX_STACK_LINE(1019)
					while((true)){
			...
			HX_STACK_LINE(1014)
			::zpp_nape::space::ZPP_Component xr = tmp6;		HX_STACK_VAR(xr,"xr");
			HX_STACK_LINE(1033)
			...
			HX_STACK_LINE(1033)
			{
				...
				if ((tmp11)){
					...
					HX_STACK_LINE(1036)
					::zpp_nape::space::ZPP_Component tmp12 = this->component;		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(1036)
			...
			HX_STACK_LINE(1033)
			::zpp_nape::space::ZPP_Component yr = tmp7;		HX_STACK_VAR(yr,"yr");
			HX_STACK_LINE(1052)
			bool tmp8 = (xr != yr);		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(1052)
			if ((tmp8)){
				HX_STACK_LINE(1053)
		...
		if ((tmp8)){
			...
			HX_STACK_LINE(1062)
			{
				...
				::zpp_nape::phys::ZPP_Body tmp10 = this->b3;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(1063)
				::zpp_nape::space::ZPP_Component tmp11 = tmp10->component;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(1063)
				::zpp_nape::phys::ZPP_Body tmp12 = this->b3;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(1063)
				::zpp_nape::space::ZPP_Component tmp13 = tmp12->component->parent;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(1063)
				...
				if ((tmp14)){
					...
					::zpp_nape::phys::ZPP_Body tmp15 = this->b3;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(1063)
					tmp9 = tmp15->component;
				}
				else{
					HX_STACK_LINE(1065)
					::zpp_nape::phys::ZPP_Body tmp15 = this->b3;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(1065)
					::zpp_nape::space::ZPP_Component obj = tmp15->component;		HX_STACK_VAR(obj,"obj");
					HX_STACK_LINE(1066)
					::zpp_nape::space::ZPP_Component stack = null();		HX_STACK_VAR(stack,"stack");
					HX_STACK_LINE(1067)
					while((true)){
						HX_STACK_LINE(1067)
						bool tmp16 = (obj != obj->parent);		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(1067)
						bool tmp17 = !(tmp16);		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(1067)
						if ((tmp17)){
			...
			HX_STACK_LINE(1062)
			::zpp_nape::space::ZPP_Component xr = tmp9;		HX_STACK_VAR(xr,"xr");
			HX_STACK_LINE(1081)
			::zpp_nape::space::ZPP_Component tmp10;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(1081)
			{
				HX_STACK_LINE(1082)
				...
				::zpp_nape::space::ZPP_Component tmp12 = this->component;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(1082)
				::zpp_nape::space::ZPP_Component tmp13 = tmp12->parent;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(1082)
				bool tmp14 = (tmp11 == tmp13);		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(1082)
				if ((tmp14)){
					HX_STACK_LINE(1082)
					tmp10 = this->component;
				}
				else{
					HX_STACK_LINE(1084)
					::zpp_nape::space::ZPP_Component tmp15 = this->component;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(1084)
					::zpp_nape::space::ZPP_Component obj = tmp15;		HX_STACK_VAR(obj,"obj");
					HX_STACK_LINE(1085)
					::zpp_nape::space::ZPP_Component stack = null();		HX_STACK_VAR(stack,"stack");
					HX_STACK_LINE(1086)
					while((true)){
			...
			HX_STACK_LINE(1081)
			::zpp_nape::space::ZPP_Component yr = tmp10;		HX_STACK_VAR(yr,"yr");
			HX_STACK_LINE(1100)
			bool tmp11 = (xr != yr);		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(1100)
			if ((tmp11)){
				HX_STACK_LINE(1101)
				...
				if ((tmp12)){
					...
					HX_STACK_LINE(1102)
					bool tmp13 = (xr->rank > yr->rank);		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(1102)
					if ((tmp13)){
						HX_STACK_LINE(1102)
						yr->parent = xr;
