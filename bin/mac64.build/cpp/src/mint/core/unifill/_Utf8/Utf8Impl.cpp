...
int Utf8Impl_obj::code_point_width( int c){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8Impl","code_point_width",0x35028906,"mint.core.unifill._Utf8.Utf8Impl.code_point_width","mint/core/unifill/Utf8.hx",166,0xef70830e)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(167)
...
int Utf8Impl_obj::find_prev_code_point( Dynamic accessor,int index){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8Impl","find_prev_code_point",0x2314bf85,"mint.core.unifill._Utf8.Utf8Impl.find_prev_code_point","mint/core/unifill/Utf8.hx",170,0xef70830e)
...
{
		HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8Impl","encode_code_point",0x1b5f2f66,"mint.core.unifill._Utf8.Utf8Impl.encode_code_point","mint/core/unifill/Utf8.hx",179,0xef70830e)
			...
			if ((tmp1)){
				...
				if ((tmp2)){
					...
					if ((tmp3)){
						...
						HX_STACK_LINE(195)
						::mint::core::unifill::Exception tmp5 = ::mint::core::unifill::Exception_obj::InvalidCodePoint(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
						HX_STACK_LINE(195)
...
int Utf8Impl_obj::decode_code_point( int len,Dynamic accessor,int index){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8Impl","decode_code_point",0x97b9eb4e,"mint.core.unifill._Utf8.Utf8Impl.decode_code_point","mint/core/unifill/Utf8.hx",199,0xef70830e)
	...
	if ((tmp2)){
		...
		HX_STACK_LINE(202)
		::mint::core::unifill::Exception tmp4 = ::mint::core::unifill::Exception_obj::InvalidCodeUnitSequence(tmp3);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(202)
	...
	if ((tmp6)){
		...
		HX_STACK_LINE(208)
		::mint::core::unifill::Exception tmp8 = ::mint::core::unifill::Exception_obj::InvalidCodeUnitSequence(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(208)
	...
	if ((tmp9)){
		...
		HX_STACK_LINE(212)
		::mint::core::unifill::Exception tmp11 = ::mint::core::unifill::Exception_obj::InvalidCodeUnitSequence(tmp10);		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(212)
	...
	if ((tmp12)){
		...
		if ((tmp15)){
			...
			HX_STACK_LINE(218)
			::mint::core::unifill::Exception tmp17 = ::mint::core::unifill::Exception_obj::InvalidCodeUnitSequence(tmp16);		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(218)
	...
	if ((tmp18)){
		...
		if ((tmp28)){
			...
			HX_STACK_LINE(229)
			::mint::core::unifill::Exception tmp30 = ::mint::core::unifill::Exception_obj::InvalidCodeUnitSequence(tmp29);		HX_STACK_VAR(tmp30,"tmp30");
			HX_STACK_LINE(229)
	...
	if ((tmp21)){
		...
		HX_STACK_LINE(233)
		::mint::core::unifill::Exception tmp23 = ::mint::core::unifill::Exception_obj::InvalidCodeUnitSequence(tmp22);		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(233)
	...
	if ((tmp24)){
		...
		if ((tmp36)){
			...
			HX_STACK_LINE(240)
			::mint::core::unifill::Exception tmp38 = ::mint::core::unifill::Exception_obj::InvalidCodeUnitSequence(tmp37);		HX_STACK_VAR(tmp38,"tmp38");
			HX_STACK_LINE(240)
	...
	HX_STACK_LINE(242)
	::mint::core::unifill::Exception tmp26 = ::mint::core::unifill::Exception_obj::InvalidCodeUnitSequence(tmp25);		HX_STACK_VAR(tmp26,"tmp26");
	HX_STACK_LINE(242)
...
void Utf8Impl_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("mint.core.unifill._Utf8.Utf8Impl","\xcd","\x38","\x4c","\x83");
