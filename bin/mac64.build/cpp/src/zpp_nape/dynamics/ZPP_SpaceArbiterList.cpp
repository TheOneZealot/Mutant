...
::nape::dynamics::Arbiter ZPP_SpaceArbiterList_obj::at( int index){
	...
	if ((tmp3)){
		...
		HX_STACK_LINE(334)
		int tmp6 = this->lengths->__get((int)0);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(334)
		...
		if ((tmp8)){
			HX_STACK_LINE(335)
			int tmp9 = (index - accum_length);		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(335)
			int offset = tmp9;		HX_STACK_VAR(offset,"offset");
			HX_STACK_LINE(336)
			int tmp10 = offset;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(336)
			int tmp11 = this->at_index_0;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(336)
			...
			if ((tmp13)){
				HX_STACK_LINE(336)
				::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp15 = this->ite_0;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(336)
				::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp16 = tmp15;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(336)
				tmp14 = (tmp16 == null());
			}
			else{
			...
			if ((tmp14)){
				...
				this->at_index_0 = (int)0;
				HX_STACK_LINE(338)
				::zpp_nape::space::ZPP_Space tmp15 = this->space;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(338)
				::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp16 = tmp15->c_arbiters_true->head;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(338)
				this->ite_0 = tmp16;
				HX_STACK_LINE(339)
				while((true)){
					HX_STACK_LINE(340)
					::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp17 = this->ite_0;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(340)
					::zpp_nape::dynamics::ZPP_ColArbiter x = tmp17->elt;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(341)
					...
					HX_STACK_LINE(342)
					::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp19 = this->ite_0;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(342)
					this->ite_0 = tmp19->next;
				}
			}
			HX_STACK_LINE(345)
			while((true)){
				HX_STACK_LINE(345)
				int tmp15 = this->at_index_0;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(345)
				...
				while((true)){
					...
					HX_STACK_LINE(349)
					::zpp_nape::dynamics::ZPP_ColArbiter x = tmp20->elt;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(350)
					...
					HX_STACK_LINE(351)
					::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp22 = this->ite_0;		HX_STACK_VAR(tmp22,"tmp22");
					HX_STACK_LINE(351)
					this->ite_0 = tmp22->next;
				}
			}
			HX_STACK_LINE(354)
			::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp15 = this->ite_0;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(354)
			::nape::dynamics::Arbiter tmp16 = tmp15->elt->wrapper();		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(354)
			ret = tmp16;
		}
		else{
			HX_STACK_LINE(356)
			int tmp9 = this->lengths->__get((int)0);		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(356)
			hx::AddEq(accum_length,tmp9);
		}
	}
	HX_STACK_LINE(358)
	...
	if ((tmp4)){
		...
		HX_STACK_LINE(359)
		int tmp7 = this->lengths->__get((int)1);		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(359)
		...
		if ((tmp9)){
			...
			HX_STACK_LINE(361)
			int tmp12 = this->at_index_1;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(361)
			...
			if ((tmp14)){
				HX_STACK_LINE(361)
				::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp16 = this->ite_1;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(361)
			...
			if ((tmp15)){
				...
				HX_STACK_LINE(363)
				::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp17 = tmp16->c_arbiters_false->head;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(363)
				this->ite_1 = tmp17;
				HX_STACK_LINE(364)
				while((true)){
					HX_STACK_LINE(365)
					::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp18 = this->ite_1;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(365)
					...
					HX_STACK_LINE(367)
					::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp20 = this->ite_1;		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(367)
					this->ite_1 = tmp20->next;
				}
			}
			HX_STACK_LINE(370)
			while((true)){
				HX_STACK_LINE(370)
				int tmp16 = this->at_index_1;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(370)
				...
				while((true)){
					...
					HX_STACK_LINE(376)
					::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp23 = this->ite_1;		HX_STACK_VAR(tmp23,"tmp23");
					HX_STACK_LINE(376)
					this->ite_1 = tmp23->next;
				}
			}
			HX_STACK_LINE(379)
			::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp16 = this->ite_1;		HX_STACK_VAR(tmp16,"tmp16");
			...
			HX_STACK_LINE(381)
			int tmp10 = this->lengths->__get((int)1);		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(381)
			hx::AddEq(accum_length,tmp10);
		}
	}
	HX_STACK_LINE(383)
	...
	if ((tmp5)){
		...
		HX_STACK_LINE(384)
		int tmp8 = this->lengths->__get((int)2);		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(384)
		...
		if ((tmp10)){
			...
			HX_STACK_LINE(386)
			int tmp13 = this->at_index_2;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(386)
			...
			if ((tmp15)){
				HX_STACK_LINE(386)
				::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp17 = this->ite_2;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(386)
				::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp18 = tmp17;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(386)
				tmp16 = (tmp18 == null());
			}
			else{
			...
			if ((tmp16)){
				...
				HX_STACK_LINE(388)
				::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp18 = tmp17->f_arbiters->head;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(388)
				this->ite_2 = tmp18;
				HX_STACK_LINE(389)
				while((true)){
					HX_STACK_LINE(390)
					::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp19 = this->ite_2;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(390)
					::zpp_nape::dynamics::ZPP_FluidArbiter x = tmp19->elt;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(391)
					...
					HX_STACK_LINE(392)
					::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp21 = this->ite_2;		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(392)
					this->ite_2 = tmp21->next;
				}
			}
			HX_STACK_LINE(395)
			while((true)){
				HX_STACK_LINE(395)
				int tmp17 = this->at_index_2;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(395)
				...
				while((true)){
					...
					HX_STACK_LINE(399)
					::zpp_nape::dynamics::ZPP_FluidArbiter x = tmp22->elt;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(400)
					...
					HX_STACK_LINE(401)
					::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp24 = this->ite_2;		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(401)
					this->ite_2 = tmp24->next;
				}
			}
			HX_STACK_LINE(404)
			::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp17 = this->ite_2;		HX_STACK_VAR(tmp17,"tmp17");
			...
			HX_STACK_LINE(406)
			int tmp11 = this->lengths->__get((int)2);		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(406)
	...
	if ((tmp6)){
		...
		HX_STACK_LINE(409)
		int tmp9 = this->lengths->__get((int)3);		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(409)
		...
		if ((tmp11)){
			...
			HX_STACK_LINE(411)
			int tmp14 = this->at_index_3;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(411)
			...
			if ((tmp16)){
				HX_STACK_LINE(411)
				::zpp_nape::util::ZNPNode_ZPP_SensorArbiter tmp18 = this->ite_3;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(411)
				::zpp_nape::util::ZNPNode_ZPP_SensorArbiter tmp19 = tmp18;		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(411)
				tmp17 = (tmp19 == null());
			}
			else{
			...
			if ((tmp17)){
				...
				HX_STACK_LINE(413)
				::zpp_nape::util::ZNPNode_ZPP_SensorArbiter tmp19 = tmp18->s_arbiters->head;		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(413)
				this->ite_3 = tmp19;
				HX_STACK_LINE(414)
				while((true)){
					HX_STACK_LINE(415)
					::zpp_nape::util::ZNPNode_ZPP_SensorArbiter tmp20 = this->ite_3;		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(415)
					::zpp_nape::dynamics::ZPP_SensorArbiter x = tmp20->elt;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(416)
					bool tmp21 = x->active;		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(416)
					if ((tmp21)){
					...
					HX_STACK_LINE(417)
					::zpp_nape::util::ZNPNode_ZPP_SensorArbiter tmp22 = this->ite_3;		HX_STACK_VAR(tmp22,"tmp22");
					HX_STACK_LINE(417)
					this->ite_3 = tmp22->next;
				}
			}
			HX_STACK_LINE(420)
			while((true)){
				HX_STACK_LINE(420)
				int tmp18 = this->at_index_3;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(420)
				...
				while((true)){
					...
					HX_STACK_LINE(424)
					::zpp_nape::dynamics::ZPP_SensorArbiter x = tmp23->elt;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(425)
					...
					HX_STACK_LINE(426)
					::zpp_nape::util::ZNPNode_ZPP_SensorArbiter tmp25 = this->ite_3;		HX_STACK_VAR(tmp25,"tmp25");
					HX_STACK_LINE(426)
					this->ite_3 = tmp25->next;
				}
			}
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_SensorArbiter tmp18 = this->ite_3;		HX_STACK_VAR(tmp18,"tmp18");
			...
			HX_STACK_LINE(431)
			int tmp12 = this->lengths->__get((int)3);		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(431)
