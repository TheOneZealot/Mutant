			...
			if ((tmp1)){
				...
				HX_STACK_LINE(492)
				{
					...
					if ((tmp2)){
						...
						HX_STACK_LINE(492)
						bool tmp3 = (c->type == (int)1);		HX_STACK_VAR(tmp3,"tmp3");
						HX_STACK_LINE(492)
						if ((tmp3)){
							HX_STACK_LINE(492)
						...
						HX_STACK_LINE(492)
						bool tmp4 = (c->wrap_localCOM != null());		HX_STACK_VAR(tmp4,"tmp4");
						HX_STACK_LINE(492)
						if ((tmp4)){
							HX_STACK_LINE(492)
							::zpp_nape::geom::ZPP_Vec2 tmp5 = c->wrap_localCOM->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(492)
							tmp5->x = c->localCOMx;
							HX_STACK_LINE(492)
							::zpp_nape::geom::ZPP_Vec2 tmp6 = c->wrap_localCOM->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
							HX_STACK_LINE(492)
							tmp6->y = c->localCOMy;
							HX_STACK_LINE(492)
							{
