...
class HXCPP_CLASS_ATTRIBUTES  ZNPList_ZPP_SimpleEvent_obj : public hx::Object{
	public:
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPList_ZPP_SimpleEvent")
		...
		::String __ToString() const { return HX_HCSTRING("ZNPList_ZPP_SimpleEvent","\x5e","\xa0","\x22","\x40"); }

		::zpp_nape::util::ZNPNode_ZPP_SimpleEvent head;
