...
{  hx::ObjectPtr< ZPP_ShapeList_obj > _result_ = new ZPP_ShapeList_obj();
...
Void ZPP_ShapeList_obj::valmod( ){
{
		...
		this->validate();
		HX_STACK_LINE(17200)
		::zpp_nape::util::ZNPList_ZPP_Shape tmp = this->inner;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(17200)
		bool tmp1 = tmp->modified;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(17200)
		if ((tmp1)){
			HX_STACK_LINE(17201)
			::zpp_nape::util::ZNPList_ZPP_Shape tmp2 = this->inner;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(17201)
			...
			this->at_ite = null();
			HX_STACK_LINE(17203)
			::zpp_nape::util::ZNPList_ZPP_Shape tmp4 = this->inner;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(17203)
			tmp4->modified = false;
			HX_STACK_LINE(17204)
			::zpp_nape::util::ZNPList_ZPP_Shape tmp5 = this->inner;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(17204)
			tmp5->pushmod = false;
			HX_STACK_LINE(17205)
...
{
		HX_STACK_FRAME("zpp_nape.util.ZPP_ShapeList","validate",0x401936f5,"zpp_nape.util.ZPP_ShapeList.validate","zpp_nape/util/Lists.hx",17218,0x9f4e6754)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17219)
...
Dynamic ZPP_ShapeList_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic ZPP_ShapeList_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nape::shape::ShapeList*/ ,(int)offsetof(ZPP_ShapeList_obj,outer),HX_HCSTRING("outer","\x7b","\xb8","\x28","\x37")},
	{hx::fsObject /*::zpp_nape::util::ZNPList_ZPP_Shape*/ ,(int)offsetof(ZPP_ShapeList_obj,inner),HX_HCSTRING("inner","\x96","\x31","\x1c","\xbe")},
	{hx::fsBool,(int)offsetof(ZPP_ShapeList_obj,immutable),HX_HCSTRING("immutable","\x42","\x28","\xc7","\x66")},
	{hx::fsBool,(int)offsetof(ZPP_ShapeList_obj,_invalidated),HX_HCSTRING("_invalidated","\x8a","\xe0","\xb5","\x23")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_ShapeList_obj,_invalidate),HX_HCSTRING("_invalidate","\x9a","\xe6","\xb3","\x59")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_ShapeList_obj,_validate),HX_HCSTRING("_validate","\xf5","\xc7","\x79","\x4c")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_ShapeList_obj,_modifiable),HX_HCSTRING("_modifiable","\x23","\xcc","\xcf","\x0c")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_ShapeList_obj,adder),HX_HCSTRING("adder","\xce","\xd4","\x43","\x1c")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_ShapeList_obj,post_adder),HX_HCSTRING("post_adder","\x6f","\x28","\xcf","\x38")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ZPP_ShapeList_obj,subber),HX_HCSTRING("subber","\xcf","\xfb","\xfd","\x99")},
	{hx::fsBool,(int)offsetof(ZPP_ShapeList_obj,dontremove),HX_HCSTRING("dontremove","\x95","\xcf","\xb2","\x03")},
	{hx::fsBool,(int)offsetof(ZPP_ShapeList_obj,reverse_flag),HX_HCSTRING("reverse_flag","\x29","\x93","\x06","\x7a")},
	{hx::fsInt,(int)offsetof(ZPP_ShapeList_obj,at_index),HX_HCSTRING("at_index","\x86","\xef","\xd2","\x3d")},
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_Shape*/ ,(int)offsetof(ZPP_ShapeList_obj,at_ite),HX_HCSTRING("at_ite","\x8e","\xa1","\x34","\xd2")},
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_Shape*/ ,(int)offsetof(ZPP_ShapeList_obj,push_ite),HX_HCSTRING("push_ite","\xf5","\x5d","\x33","\x23")},
	{hx::fsBool,(int)offsetof(ZPP_ShapeList_obj,zip_length),HX_HCSTRING("zip_length","\xc4","\xc5","\x11","\x3c")},
	{hx::fsInt,(int)offsetof(ZPP_ShapeList_obj,user_length),HX_HCSTRING("user_length","\x9a","\xc3","\x4e","\x06")},
	{ hx::fsUnknown, 0, null()}
};
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsBool,(void *) &ZPP_ShapeList_obj::internal,HX_HCSTRING("internal","\x3d","\x67","\x76","\x28")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
void ZPP_ShapeList_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("zpp_nape.util.ZPP_ShapeList","\xef","\x41","\x01","\x52");
