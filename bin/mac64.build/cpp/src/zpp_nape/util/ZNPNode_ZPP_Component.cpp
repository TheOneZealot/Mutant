...
{  hx::ObjectPtr< ZNPNode_ZPP_Component_obj > _result_ = new ZNPNode_ZPP_Component_obj();
...
::zpp_nape::space::ZPP_Component ZNPNode_ZPP_Component_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_Component","elem",0xfcd408b1,"zpp_nape.util.ZNPNode_ZPP_Component.elem","zpp_nape/util/Lists.hx",15884,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15885)
	::zpp_nape::space::ZPP_Component tmp = this->elt;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(15885)
	return tmp;
}
...
Dynamic ZNPNode_ZPP_Component_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic ZNPNode_ZPP_Component_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_Component*/ ,(int)offsetof(ZNPNode_ZPP_Component_obj,next),HX_HCSTRING("next","\xf3","\x84","\x02","\x49")},
	{hx::fsObject /*::zpp_nape::space::ZPP_Component*/ ,(int)offsetof(ZNPNode_ZPP_Component_obj,elt),HX_HCSTRING("elt","\x2d","\x02","\x4d","\x00")},
	{ hx::fsUnknown, 0, null()}
};
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_Component*/ ,(void *) &ZNPNode_ZPP_Component_obj::zpp_pool,HX_HCSTRING("zpp_pool","\x81","\x5d","\xd4","\x38")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
void ZNPNode_ZPP_Component_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("zpp_nape.util.ZNPNode_ZPP_Component","\x8c","\x23","\xe7","\x14");
