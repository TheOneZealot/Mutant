...
::nape::callbacks::ListenerIterator ListenerIterator_obj::get( ::nape::callbacks::ListenerList list){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(220)
		::nape::callbacks::ListenerIterator tmp3 = ::nape::callbacks::ListenerIterator_obj::__new();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(220)
		::nape::callbacks::ListenerIterator ret = tmp3;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(221)
