...
{
HX_STACK_FRAME("nape.geom.RayResultIterator","new",0x81e8d15b,"nape.geom.RayResultIterator.new","nape/geom/RayResultIterator.hx",178,0x926b9ed5)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	...
	this->zpp_inner = null();
	HX_STACK_LINE(204)
	bool tmp = ::zpp_nape::util::ZPP_RayResultList_obj::internal;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(204)
	bool tmp1 = !(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(204)
	if ((tmp1)){
		HX_STACK_LINE(204)
		::String tmp2 = HX_HCSTRING("Error: Cannot instantiate RayResult","\xe2","\xf7","\x46","\x3f");		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(204)
...
{  hx::ObjectPtr< RayResultIterator_obj > _result_ = new RayResultIterator_obj();
...
bool RayResultIterator_obj::hasNext( ){
	HX_STACK_FRAME("nape.geom.RayResultIterator","hasNext",0x0def3fe8,"nape.geom.RayResultIterator.hasNext","nape/geom/RayResultIterator.hx",240,0x926b9ed5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
	::nape::geom::RayResultList tmp = this->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(241)
	...
	{
		HX_STACK_LINE(244)
		::nape::geom::RayResultList tmp2 = this->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(244)
		::nape::geom::RayResultList _this = tmp2;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(244)
		...
		if ((tmp3)){
			...
			{
				HX_STACK_LINE(244)
				::zpp_nape::util::ZNPList_RayResult tmp4 = _this->zpp_inner->inner;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(244)
...
::nape::geom::RayResult RayResultIterator_obj::next( ){
	HX_STACK_FRAME("nape.geom.RayResultIterator","next",0x29ce5f98,"nape.geom.RayResultIterator.next","nape/geom/RayResultIterator.hx",264,0x926b9ed5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
	...
	HX_STACK_LINE(266)
	::nape::geom::RayResult tmp2 = tmp->at(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(266)
	return tmp2;
}
...
::nape::geom::RayResultIterator RayResultIterator_obj::get( ::nape::geom::RayResultList list){
	HX_STACK_FRAME("nape.geom.RayResultIterator","get",0x81e38191,"nape.geom.RayResultIterator.get","nape/geom/RayResultIterator.hx",217,0x926b9ed5)
	...
	HX_STACK_LINE(218)
	::nape::geom::RayResultIterator tmp2;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(218)
	if ((tmp1)){
		HX_STACK_LINE(219)
		::zpp_nape::util::ZPP_RayResultList_obj::internal = true;
		HX_STACK_LINE(220)
		::nape::geom::RayResultIterator tmp3 = ::nape::geom::RayResultIterator_obj::__new();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(220)
		::nape::geom::RayResultIterator ret = tmp3;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(221)
		...
		HX_STACK_LINE(225)
		::nape::geom::RayResultIterator r = tmp3;		HX_STACK_VAR(r,"r");
		HX_STACK_LINE(226)
	...
	HX_STACK_LINE(218)
	::nape::geom::RayResultIterator ret = tmp2;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(229)
	ret->zpp_i = (int)0;
	HX_STACK_LINE(230)
	ret->zpp_inner = list;
	...
	HX_STACK_LINE(232)
	::nape::geom::RayResultIterator tmp3 = ret;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(232)
	return tmp3;
}
...
Dynamic RayResultIterator_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic RayResultIterator_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
