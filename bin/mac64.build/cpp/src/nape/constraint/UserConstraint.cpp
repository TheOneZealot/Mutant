...
::nape::geom::Vec2 UserConstraint_obj::__bindVec2( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(224)
	::nape::geom::Vec2 tmp = ::nape::geom::Vec2_obj::__new(null(),null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(224)
	...
	HX_STACK_LINE(226)
	ret->zpp_inner->_invalidate = tmp1->bindVec2_invalidate_dyn();
	HX_STACK_LINE(227)
...
::nape::geom::MatMN UserConstraint_obj::impulse( ){
	...
	HX_STACK_LINE(401)
	::nape::geom::MatMN tmp2 = ::nape::geom::MatMN_obj::__new(tmp1,(int)1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(401)
	::nape::geom::MatMN ret = tmp2;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(402)
	{
		HX_STACK_LINE(402)
		...
		HX_STACK_LINE(402)
		int _g = tmp3->dim;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(402)
		while((true)){
			HX_STACK_LINE(402)
			...
			HX_STACK_LINE(403)
			{
				...
				if ((tmp12)){
					...
					HX_STACK_LINE(403)
					int tmp15 = ret->zpp_inner->m;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(403)
				...
				if ((tmp14)){
					HX_STACK_LINE(403)
					int tmp16 = ret->zpp_inner->n;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(403)
					int tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(403)
					tmp15 = ((int)0 >= tmp17);
				...
				HX_STACK_LINE(403)
				Float tmp21 = tmp20->jAcc->__get(i);		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(403)
				ret->zpp_inner->x[tmp19] = tmp21;
			}
		}
	}
	HX_STACK_LINE(405)
	::nape::geom::MatMN tmp3 = ret;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(405)
	return tmp3;
}
...
Void UserConstraint_obj::visitBodies( Dynamic lambda){
{
		...
		while((true)){
			...
			::zpp_nape::constraint::ZPP_UserConstraint tmp4 = this->zpp_inner_zn;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(440)
			::zpp_nape::constraint::ZPP_UserBody tmp5 = tmp4->bodies->__get(i).StaticCast< ::zpp_nape::constraint::ZPP_UserBody >();		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(440)
			::zpp_nape::constraint::ZPP_UserBody b = tmp5;		HX_STACK_VAR(b,"b");
			HX_STACK_LINE(441)
			bool tmp6 = (b->body != null());		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(441)
			if ((tmp6)){
				HX_STACK_LINE(442)
				bool found = false;		HX_STACK_VAR(found,"found");
				HX_STACK_LINE(443)
				{
					...
					while((true)){
						HX_STACK_LINE(443)
						bool tmp8 = (_g < nbodies);		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(443)
						bool tmp9 = !(tmp8);		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(443)
						if ((tmp9)){
						...
						HX_STACK_LINE(444)
						::zpp_nape::constraint::ZPP_UserConstraint tmp11 = this->zpp_inner_zn;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(444)
						::zpp_nape::constraint::ZPP_UserBody tmp12 = tmp11->bodies->__get(j).StaticCast< ::zpp_nape::constraint::ZPP_UserBody >();		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(444)
						::zpp_nape::constraint::ZPP_UserBody c = tmp12;		HX_STACK_VAR(c,"c");
						HX_STACK_LINE(445)
						bool tmp13 = (c->body == b->body);		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(445)
						if ((tmp13)){
							HX_STACK_LINE(446)
							found = true;
				...
				HX_STACK_LINE(450)
				bool tmp7 = found;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(450)
				bool tmp8 = !(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(450)
				if ((tmp8)){
					HX_STACK_LINE(451)
					::nape::phys::Body tmp9 = b->body->outer;		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(451)
