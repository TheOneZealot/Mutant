...
::nape::dynamics::ArbiterIterator ArbiterIterator_obj::get( ::nape::dynamics::ArbiterList list){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(220)
		::nape::dynamics::ArbiterIterator tmp3 = ::nape::dynamics::ArbiterIterator_obj::__new();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(220)
		::nape::dynamics::ArbiterIterator ret = tmp3;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(221)
