...
::nape::geom::ConvexResultIterator ConvexResultIterator_obj::get( ::nape::geom::ConvexResultList list){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(220)
		::nape::geom::ConvexResultIterator tmp3 = ::nape::geom::ConvexResultIterator_obj::__new();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(220)
		::nape::geom::ConvexResultIterator ret = tmp3;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(221)
