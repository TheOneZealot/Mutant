...
::nape::dynamics::ContactIterator ContactIterator_obj::get( ::nape::dynamics::ContactList list){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(220)
		::nape::dynamics::ContactIterator tmp3 = ::nape::dynamics::ContactIterator_obj::__new();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(220)
		::nape::dynamics::ContactIterator ret = tmp3;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(221)
