...
{
HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_BodyListener","new",0x04967239,"zpp_nape.util.ZNPNode_ZPP_BodyListener.new","zpp_nape/util/Lists.hx",15201,0x9f4e6754)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(15235)
	this->elt = null();
...
{  hx::ObjectPtr< ZNPNode_ZPP_BodyListener_obj > _result_ = new ZNPNode_ZPP_BodyListener_obj();
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_BodyListener","alloc",0xb5252e8e,"zpp_nape.util.ZNPNode_ZPP_BodyListener.alloc","zpp_nape/util/Lists.hx",15229,0x9f4e6754)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_BodyListener","free",0xf9cd98b3,"zpp_nape.util.ZNPNode_ZPP_BodyListener.free","zpp_nape/util/Lists.hx",15233,0x9f4e6754)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15233)
		this->elt = null();
	}
...
::zpp_nape::callbacks::ZPP_BodyListener ZNPNode_ZPP_BodyListener_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_BodyListener","elem",0xf91fd496,"zpp_nape.util.ZNPNode_ZPP_BodyListener.elem","zpp_nape/util/Lists.hx",15239,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15240)
	::zpp_nape::callbacks::ZPP_BodyListener tmp = this->elt;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(15240)
	return tmp;
}
...
Dynamic ZNPNode_ZPP_BodyListener_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic ZNPNode_ZPP_BodyListener_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_BodyListener*/ ,(int)offsetof(ZNPNode_ZPP_BodyListener_obj,next),HX_HCSTRING("next","\xf3","\x84","\x02","\x49")},
	{hx::fsObject /*::zpp_nape::callbacks::ZPP_BodyListener*/ ,(int)offsetof(ZNPNode_ZPP_BodyListener_obj,elt),HX_HCSTRING("elt","\x2d","\x02","\x4d","\x00")},
	{ hx::fsUnknown, 0, null()}
};
static hx::StaticInfo sStaticStorageInfo[] = {
	{hx::fsObject /*::zpp_nape::util::ZNPNode_ZPP_BodyListener*/ ,(void *) &ZNPNode_ZPP_BodyListener_obj::zpp_pool,HX_HCSTRING("zpp_pool","\x81","\x5d","\xd4","\x38")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
void ZNPNode_ZPP_BodyListener_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("zpp_nape.util.ZNPNode_ZPP_BodyListener","\xc7","\xe1","\x98","\xfc");
