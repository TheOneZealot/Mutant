...
::nape::callbacks::InteractionType Space_obj::interactionType( ::nape::shape::Shape shape1,::nape::shape::Shape shape2){
	...
	if ((tmp13)){
		...
		if ((tmp20)){
			HX_STACK_LINE(585)
			::zpp_nape::phys::ZPP_Body tmp21 = shape2->zpp_inner->body;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(585)
		...
		HX_STACK_LINE(585)
		int tmp21 = tmp19->zpp_inner->type;		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(585)
	...
	HX_STACK_LINE(586)
	::zpp_nape::phys::ZPP_Body tmp15 = shape1->zpp_inner->body;		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(586)
	...
	if ((tmp16)){
		HX_STACK_LINE(586)
		::zpp_nape::phys::ZPP_Body tmp18 = shape1->zpp_inner->body;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(586)
		tmp17 = tmp18->outer;
	}
	else{
	...
	HX_STACK_LINE(586)
	::zpp_nape::phys::ZPP_Body tmp18 = shape2->zpp_inner->body;		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(586)
	...
	HX_STACK_LINE(589)
	{
		...
		HX_STACK_LINE(589)
		{
			...
			HX_STACK_LINE(589)
			{
				...
				{
					HX_STACK_LINE(589)
					::zpp_nape::util::ZNPNode_ZPP_Constraint tmp24 = b1->constraints->head;		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(589)
					::zpp_nape::util::ZNPNode_ZPP_Constraint cx_ite = tmp24;		HX_STACK_VAR(cx_ite,"cx_ite");
					HX_STACK_LINE(589)
					while((true)){
						HX_STACK_LINE(589)
						...
						{
							HX_STACK_LINE(589)
							bool tmp27 = con->ignore;		HX_STACK_VAR(tmp27,"tmp27");
							HX_STACK_LINE(589)
							bool tmp28;		HX_STACK_VAR(tmp28,"tmp28");
							HX_STACK_LINE(589)
							if ((tmp27)){
								HX_STACK_LINE(589)
								int tmp29 = b1->id;		HX_STACK_VAR(tmp29,"tmp29");
								HX_STACK_LINE(589)
								int tmp30 = b2->id;		HX_STACK_VAR(tmp30,"tmp30");
								HX_STACK_LINE(589)
								int tmp31 = tmp29;		HX_STACK_VAR(tmp31,"tmp31");
								HX_STACK_LINE(589)
								int tmp32 = tmp30;		HX_STACK_VAR(tmp32,"tmp32");
								HX_STACK_LINE(589)
								tmp28 = con->pair_exists(tmp31,tmp32);
							}
							else{
								HX_STACK_LINE(589)
								tmp28 = false;
			...
			HX_STACK_LINE(589)
			bool tmp24 = con_ignore;		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(589)
			...
			if ((tmp26)){
				...
				{
					HX_STACK_LINE(589)
					::zpp_nape::dynamics::ZPP_InteractionGroup tmp29;		HX_STACK_VAR(tmp29,"tmp29");
					HX_STACK_LINE(589)
					{
						HX_STACK_LINE(589)
						...
						while((true)){
							HX_STACK_LINE(589)
							bool tmp30 = (cur != null());		HX_STACK_VAR(tmp30,"tmp30");
							HX_STACK_LINE(589)
							...
							if ((tmp33)){
								HX_STACK_LINE(589)
								bool tmp34 = (cur->group == null());		HX_STACK_VAR(tmp34,"tmp34");
								HX_STACK_LINE(589)
								tmp32 = tmp34;
							}
							else{
							...
							HX_STACK_LINE(589)
							bool tmp38 = (cur->ishape != null());		HX_STACK_VAR(tmp38,"tmp38");
							HX_STACK_LINE(589)
							...
							if ((tmp40)){
								HX_STACK_LINE(589)
								::zpp_nape::phys::ZPP_Body tmp41 = cur->ishape->body;		HX_STACK_VAR(tmp41,"tmp41");
								HX_STACK_LINE(589)
								...
								HX_STACK_LINE(589)
								bool tmp41 = (cur->icompound != null());		HX_STACK_VAR(tmp41,"tmp41");
								HX_STACK_LINE(589)
								...
								if ((tmp43)){
									HX_STACK_LINE(589)
									::zpp_nape::phys::ZPP_Compound tmp44 = cur->icompound->compound;		HX_STACK_VAR(tmp44,"tmp44");
									HX_STACK_LINE(589)
									...
									HX_STACK_LINE(589)
									::zpp_nape::phys::ZPP_Compound tmp44 = cur->ibody->compound;		HX_STACK_VAR(tmp44,"tmp44");
									HX_STACK_LINE(589)
									::zpp_nape::phys::ZPP_Compound tmp45 = tmp44;		HX_STACK_VAR(tmp45,"tmp45");
									HX_STACK_LINE(589)
									cur = tmp45;
					...
					HX_STACK_LINE(589)
					::zpp_nape::dynamics::ZPP_InteractionGroup g1 = tmp29;		HX_STACK_VAR(g1,"g1");
					HX_STACK_LINE(589)
					bool tmp30 = (g1 == null());		HX_STACK_VAR(tmp30,"tmp30");
					HX_STACK_LINE(589)
					bool tmp31 = tmp30;		HX_STACK_VAR(tmp31,"tmp31");
					HX_STACK_LINE(589)
					bool tmp32 = tmp31;		HX_STACK_VAR(tmp32,"tmp32");
					...
					if ((tmp32)){
						...
						HX_STACK_LINE(589)
						::zpp_nape::dynamics::ZPP_InteractionGroup tmp33;		HX_STACK_VAR(tmp33,"tmp33");
						HX_STACK_LINE(589)
						{
							HX_STACK_LINE(589)
							...
							while((true)){
								...
								if ((tmp37)){
									HX_STACK_LINE(589)
									bool tmp38 = (cur->group == null());		HX_STACK_VAR(tmp38,"tmp38");
									HX_STACK_LINE(589)
									tmp36 = tmp38;
								}
								else{
								...
								HX_STACK_LINE(589)
								bool tmp42 = (cur->ishape != null());		HX_STACK_VAR(tmp42,"tmp42");
								HX_STACK_LINE(589)
								bool tmp43 = tmp42;		HX_STACK_VAR(tmp43,"tmp43");
								HX_STACK_LINE(589)
								...
								if ((tmp44)){
									HX_STACK_LINE(589)
									::zpp_nape::phys::ZPP_Body tmp45 = cur->ishape->body;		HX_STACK_VAR(tmp45,"tmp45");
									HX_STACK_LINE(589)
									...
									HX_STACK_LINE(589)
									bool tmp45 = (cur->icompound != null());		HX_STACK_VAR(tmp45,"tmp45");
									HX_STACK_LINE(589)
									...
									if ((tmp47)){
										HX_STACK_LINE(589)
										::zpp_nape::phys::ZPP_Compound tmp48 = cur->icompound->compound;		HX_STACK_VAR(tmp48,"tmp48");
										HX_STACK_LINE(589)
										::zpp_nape::phys::ZPP_Compound tmp49 = tmp48;		HX_STACK_VAR(tmp49,"tmp49");
										HX_STACK_LINE(589)
										cur = tmp49;
									}
									else{
										HX_STACK_LINE(589)
										::zpp_nape::phys::ZPP_Compound tmp48 = cur->ibody->compound;		HX_STACK_VAR(tmp48,"tmp48");
										HX_STACK_LINE(589)
										::zpp_nape::phys::ZPP_Compound tmp49 = tmp48;		HX_STACK_VAR(tmp49,"tmp49");
										HX_STACK_LINE(589)
										cur = tmp49;
						...
						HX_STACK_LINE(589)
						::zpp_nape::dynamics::ZPP_InteractionGroup g2 = tmp33;		HX_STACK_VAR(g2,"g2");
						HX_STACK_LINE(589)
						bool tmp34 = (g2 == null());		HX_STACK_VAR(tmp34,"tmp34");
						HX_STACK_LINE(589)
						bool tmp35 = tmp34;		HX_STACK_VAR(tmp35,"tmp35");
						HX_STACK_LINE(589)
						bool tmp36 = tmp35;		HX_STACK_VAR(tmp36,"tmp36");
						...
						if ((tmp36)){
							...
							while((true)){
								HX_STACK_LINE(589)
								bool tmp37 = (g1 != null());		HX_STACK_VAR(tmp37,"tmp37");
								HX_STACK_LINE(589)
								...
								if ((tmp40)){
									HX_STACK_LINE(589)
									bool tmp41 = (g2 != null());		HX_STACK_VAR(tmp41,"tmp41");
									HX_STACK_LINE(589)
									tmp39 = tmp41;
								}
								else{
								...
								HX_STACK_LINE(589)
								bool tmp45 = (g1 == g2);		HX_STACK_VAR(tmp45,"tmp45");
								HX_STACK_LINE(589)
								bool tmp46 = tmp45;		HX_STACK_VAR(tmp46,"tmp46");
								HX_STACK_LINE(589)
								bool tmp47 = tmp46;		HX_STACK_VAR(tmp47,"tmp47");
								...
								HX_STACK_LINE(589)
								bool tmp48 = (g1->depth < g2->depth);		HX_STACK_VAR(tmp48,"tmp48");
								HX_STACK_LINE(589)
			...
			if ((tmp27)){
				HX_STACK_LINE(589)
				bool tmp28 = s1->sensorEnabled;		HX_STACK_VAR(tmp28,"tmp28");
				HX_STACK_LINE(589)
				bool tmp29 = !(tmp28);		HX_STACK_VAR(tmp29,"tmp29");
				HX_STACK_LINE(589)
				...
				if ((tmp31)){
					...
					HX_STACK_LINE(589)
					int tmp33 = (int(_this->sensorMask) & int(x->sensorGroup));		HX_STACK_VAR(tmp33,"tmp33");
					HX_STACK_LINE(589)
					...
					if ((tmp37)){
						HX_STACK_LINE(589)
						int tmp38 = (int(x->sensorMask) & int(_this->sensorGroup));		HX_STACK_VAR(tmp38,"tmp38");
						HX_STACK_LINE(589)
				...
				if ((tmp32)){
					...
					HX_STACK_LINE(589)
					bool tmp33 = s1->fluidEnabled;		HX_STACK_VAR(tmp33,"tmp33");
					HX_STACK_LINE(589)
					...
					if ((tmp37)){
						...
						if ((tmp46)){
							HX_STACK_LINE(589)
							int tmp47 = (int(x->fluidMask) & int(_this->fluidGroup));		HX_STACK_VAR(tmp47,"tmp47");
							HX_STACK_LINE(589)
					...
					if ((tmp38)){
						HX_STACK_LINE(589)
						bool tmp40 = (b1->imass == (int)0);		HX_STACK_VAR(tmp40,"tmp40");
						HX_STACK_LINE(589)
						bool tmp41 = tmp40;		HX_STACK_VAR(tmp41,"tmp41");
						HX_STACK_LINE(589)
						bool tmp42 = tmp41;		HX_STACK_VAR(tmp42,"tmp42");
						...
						if ((tmp44)){
							HX_STACK_LINE(589)
							bool tmp45 = (b2->imass == (int)0);		HX_STACK_VAR(tmp45,"tmp45");
							HX_STACK_LINE(589)
							tmp43 = tmp45;
						}
						else{
						...
						if ((tmp47)){
							HX_STACK_LINE(589)
							bool tmp48 = (b1->iinertia == (int)0);		HX_STACK_VAR(tmp48,"tmp48");
							HX_STACK_LINE(589)
							tmp46 = tmp48;
						}
						else{
						...
						HX_STACK_LINE(589)
						bool tmp49 = tmp46;		HX_STACK_VAR(tmp49,"tmp49");
						HX_STACK_LINE(589)
						if ((tmp49)){
							HX_STACK_LINE(589)
							bool tmp50 = (b2->iinertia == (int)0);		HX_STACK_VAR(tmp50,"tmp50");
							HX_STACK_LINE(589)
							tmp48 = tmp50;
						}
						else{
					...
					if ((tmp39)){
						...
						HX_STACK_LINE(589)
						{
							...
							::zpp_nape::dynamics::ZPP_InteractionFilter x = s2->filter;		HX_STACK_VAR(x,"x");
							HX_STACK_LINE(589)
							int tmp41 = (int(_this->collisionMask) & int(x->collisionGroup));		HX_STACK_VAR(tmp41,"tmp41");
							HX_STACK_LINE(589)
							...
							if ((tmp45)){
								HX_STACK_LINE(589)
								int tmp46 = (int(x->collisionMask) & int(_this->collisionGroup));		HX_STACK_VAR(tmp46,"tmp46");
								HX_STACK_LINE(589)
						...
						if ((tmp40)){
							HX_STACK_LINE(589)
							bool tmp42 = (b1->imass == (int)0);		HX_STACK_VAR(tmp42,"tmp42");
							HX_STACK_LINE(589)
							bool tmp43 = tmp42;		HX_STACK_VAR(tmp43,"tmp43");
							HX_STACK_LINE(589)
							bool tmp44 = tmp43;		HX_STACK_VAR(tmp44,"tmp44");
							...
							if ((tmp46)){
								HX_STACK_LINE(589)
								bool tmp47 = (b2->imass == (int)0);		HX_STACK_VAR(tmp47,"tmp47");
								HX_STACK_LINE(589)
								tmp45 = tmp47;
							}
							else{
							...
							if ((tmp49)){
								HX_STACK_LINE(589)
								bool tmp50 = (b1->iinertia == (int)0);		HX_STACK_VAR(tmp50,"tmp50");
								HX_STACK_LINE(589)
								tmp48 = tmp50;
							}
							else{
							...
							HX_STACK_LINE(589)
							bool tmp51 = tmp48;		HX_STACK_VAR(tmp51,"tmp51");
							HX_STACK_LINE(589)
							if ((tmp51)){
								HX_STACK_LINE(589)
								bool tmp52 = (b2->iinertia == (int)0);		HX_STACK_VAR(tmp52,"tmp52");
								HX_STACK_LINE(589)
								tmp50 = tmp52;
							}
							else{
		...
		switch( (int)(tmp24)){
			case (int)0: {
				...
				HX_STACK_LINE(590)
				tmp22 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;
			}
			;break;
			case (int)1: {
				HX_STACK_LINE(591)
				::nape::callbacks::InteractionType tmp25 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION;		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(591)
				bool tmp26 = (tmp25 == null());		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(591)
				if ((tmp26)){
					...
					::nape::callbacks::InteractionType tmp27 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(tmp27,"tmp27");
					HX_STACK_LINE(591)
					::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION = tmp27;
					HX_STACK_LINE(591)
					::zpp_nape::util::ZPP_Flags_obj::internal = false;
				}
				HX_STACK_LINE(591)
			...
			case (int)2: {
				HX_STACK_LINE(592)
				::nape::callbacks::InteractionType tmp25 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(592)
				bool tmp26 = (tmp25 == null());		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(592)
				if ((tmp26)){
					...
					::nape::callbacks::InteractionType tmp27 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(tmp27,"tmp27");
					HX_STACK_LINE(592)
					::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR = tmp27;
					HX_STACK_LINE(592)
					::zpp_nape::util::ZPP_Flags_obj::internal = false;
				}
				HX_STACK_LINE(592)
				tmp22 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;
			}
			;break;
			default: {
				HX_STACK_LINE(593)
	...
	HX_STACK_ARG(output,"output")
{
		...
		if ((tmp6)){
			HX_STACK_LINE(843)
			::zpp_nape::shape::ZPP_Polygon tmp7 = shape->zpp_inner->polygon;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(843)
			::nape::shape::ValidationResult tmp8 = tmp7->valid();		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(843)
			::nape::shape::ValidationResult res = tmp8;		HX_STACK_VAR(res,"res");
			HX_STACK_LINE(844)
			::nape::shape::ValidationResult tmp9 = res;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(844)
			::nape::shape::ValidationResult tmp10;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(844)
			{
				HX_STACK_LINE(844)
				::nape::shape::ValidationResult tmp11 = ::zpp_nape::util::ZPP_Flags_obj::ValidationResult_VALID;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(844)
				...
				if ((tmp12)){
					...
					::zpp_nape::util::ZPP_Flags_obj::internal = true;
					HX_STACK_LINE(844)
					::nape::shape::ValidationResult tmp13 = ::nape::shape::ValidationResult_obj::__new();		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(844)
					::zpp_nape::util::ZPP_Flags_obj::ValidationResult_VALID = tmp13;
					HX_STACK_LINE(844)
					::zpp_nape::util::ZPP_Flags_obj::internal = false;
				}
				HX_STACK_LINE(844)
				tmp10 = ::zpp_nape::util::ZPP_Flags_obj::ValidationResult_VALID;
			}
			HX_STACK_LINE(844)
			bool tmp11 = (tmp9 != tmp10);		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(844)
			if ((tmp11)){
				HX_STACK_LINE(844)
				::String tmp12 = res->toString();		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(844)
				::String tmp13 = (HX_HCSTRING("Error: Polygon query shape is invalid : ","\xfa","\x40","\xf2","\x2b") + tmp12);		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(844)
				HX_STACK_DO_THROW(tmp13);
			}
		}
		HX_STACK_LINE(847)
		::zpp_nape::space::ZPP_Space tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(847)
		::zpp_nape::shape::ZPP_Shape tmp8 = shape->zpp_inner;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(847)
		bool tmp9 = containment;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(847)
		bool tmp10 = (filter == null());		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(847)
		::zpp_nape::dynamics::ZPP_InteractionFilter tmp11;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(847)
		if ((tmp10)){
			HX_STACK_LINE(847)
			tmp11 = null();
			...
			HX_STACK_LINE(847)
			tmp11 = filter->zpp_inner;
		}
		HX_STACK_LINE(847)
		::nape::shape::ShapeList tmp12 = output;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(847)
		::nape::shape::ShapeList tmp13 = tmp7->shapesInShape(tmp8,tmp9,tmp11,tmp12);		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(847)
		return tmp13;
	}
}
	...
	HX_STACK_ARG(output,"output")
{
		...
		HX_STACK_LINE(879)
		::nape::phys::BodyList tmp12 = output;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(879)
		::nape::phys::BodyList tmp13 = tmp7->bodiesInShape(tmp8,tmp9,tmp11,tmp12);		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(879)
		return tmp13;
	}
}
