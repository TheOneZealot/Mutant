...
bool pure = __o_pure.Default(false);
{
	...
	HX_STACK_LINE(349)
	::zpp_nape::callbacks::ZPP_InteractionListener tmp5 = ::zpp_nape::callbacks::ZPP_InteractionListener_obj::__new(tmp2,tmp4,(int)5,(int)3);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(349)
	this->zpp_inner_zn = tmp5;
	HX_STACK_LINE(350)
	::zpp_nape::callbacks::ZPP_InteractionListener tmp6 = this->zpp_inner_zn;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(350)
	this->zpp_inner = tmp6;
	HX_STACK_LINE(351)
	::zpp_nape::callbacks::ZPP_Listener tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(351)
	...
	HX_STACK_LINE(352)
	tmp8->outer_znp = hx::ObjectPtr<OBJ_>(this);
	HX_STACK_LINE(353)
	::zpp_nape::callbacks::ZPP_Listener tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(353)
	tmp9->precedence = precedence;
	HX_STACK_LINE(354)
	::zpp_nape::callbacks::ZPP_InteractionListener tmp10 = this->zpp_inner_zn;		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(354)
	tmp10->pure = pure;
	HX_STACK_LINE(355)
	::zpp_nape::callbacks::ZPP_InteractionListener tmp11 = this->zpp_inner_zn;		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(355)
	tmp11->handlerp = handler;
	HX_STACK_LINE(356)
	{
		HX_STACK_LINE(356)
		{
			HX_STACK_LINE(356)
			bool tmp12 = (interactionType == null());		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(356)
			if ((tmp12)){
				HX_STACK_LINE(356)
			...
			HX_STACK_LINE(356)
			::nape::callbacks::InteractionType tmp13;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(356)
			{
				HX_STACK_LINE(356)
				...
				HX_STACK_LINE(356)
				bool tmp15 = (ret == (int)1);		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(356)
				if ((tmp15)){
					HX_STACK_LINE(356)
					::nape::callbacks::InteractionType tmp16 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(356)
					...
					if ((tmp17)){
						...
						HX_STACK_LINE(356)
						::nape::callbacks::InteractionType tmp18 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(356)
						::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION = tmp18;
						HX_STACK_LINE(356)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(356)
					tmp13 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION;
				}
				else{
					HX_STACK_LINE(356)
					bool tmp16 = (ret == (int)2);		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(356)
					if ((tmp16)){
						HX_STACK_LINE(356)
						...
						HX_STACK_LINE(356)
						tmp13 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;
					}
					else{
						HX_STACK_LINE(356)
						bool tmp17 = (ret == (int)4);		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(356)
						if ((tmp17)){
							HX_STACK_LINE(356)
							::nape::callbacks::InteractionType tmp18 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(356)
							...
							if ((tmp19)){
								...
								HX_STACK_LINE(356)
								::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID = tmp20;
								HX_STACK_LINE(356)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(356)
							tmp13 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;
						}
						else{
							HX_STACK_LINE(356)
							bool tmp18 = (ret == (int)7);		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(356)
							if ((tmp18)){
								HX_STACK_LINE(356)
								::nape::callbacks::InteractionType tmp19 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY;		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(356)
								...
								if ((tmp20)){
									...
									HX_STACK_LINE(356)
									::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY = tmp21;
									HX_STACK_LINE(356)
									::zpp_nape::util::ZPP_Flags_obj::internal = false;
								}
								HX_STACK_LINE(356)
								tmp13 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY;
							}
							else{
								HX_STACK_LINE(356)
								tmp13 = null();
			...
			HX_STACK_LINE(356)
			::nape::callbacks::InteractionType tmp14 = interactionType;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(356)
			...
			if ((tmp15)){
				...
				HX_STACK_LINE(356)
				::nape::callbacks::InteractionType tmp17;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(356)
				{
					HX_STACK_LINE(356)
					...
					HX_STACK_LINE(356)
					tmp17 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION;
				}
				HX_STACK_LINE(356)
				...
				if ((tmp18)){
					...
					HX_STACK_LINE(356)
					::nape::callbacks::InteractionType tmp20 = interactionType;		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(356)
					::nape::callbacks::InteractionType tmp21;		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(356)
					{
						HX_STACK_LINE(356)
						...
						HX_STACK_LINE(356)
						tmp21 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;
					}
					HX_STACK_LINE(356)
					...
					if ((tmp22)){
						...
						HX_STACK_LINE(356)
						::nape::callbacks::InteractionType tmp23 = interactionType;		HX_STACK_VAR(tmp23,"tmp23");
						HX_STACK_LINE(356)
						::nape::callbacks::InteractionType tmp24;		HX_STACK_VAR(tmp24,"tmp24");
						HX_STACK_LINE(356)
						{
							HX_STACK_LINE(356)
							...
							HX_STACK_LINE(356)
							tmp24 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;
						}
						HX_STACK_LINE(356)
				...
				HX_STACK_LINE(356)
				int xtype = tmp19;		HX_STACK_VAR(xtype,"xtype");
				HX_STACK_LINE(356)
				{
					HX_STACK_LINE(356)
					::zpp_nape::callbacks::ZPP_InteractionListener tmp20 = this->zpp_inner_zn;		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(356)
					tmp20->itype = xtype;
				}
			}
		...
		HX_STACK_LINE(356)
		{
			...
			HX_STACK_LINE(356)
			int ret = tmp12->itype;		HX_STACK_VAR(ret,"ret");
			HX_STACK_LINE(356)
			bool tmp13 = (ret == (int)1);		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(356)
			if ((tmp13)){
				HX_STACK_LINE(356)
				::nape::callbacks::InteractionType tmp14 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(356)
				...
				if ((tmp15)){
					...
					HX_STACK_LINE(356)
					::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION = tmp16;
					HX_STACK_LINE(356)
					::zpp_nape::util::ZPP_Flags_obj::internal = false;
				}
				HX_STACK_LINE(356)
				...
				HX_STACK_LINE(356)
				bool tmp14 = (ret == (int)2);		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(356)
				if ((tmp14)){
					HX_STACK_LINE(356)
					::nape::callbacks::InteractionType tmp15 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(356)
					...
					if ((tmp16)){
						...
						HX_STACK_LINE(356)
						::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR = tmp17;
						HX_STACK_LINE(356)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(356)
					...
					HX_STACK_LINE(356)
					bool tmp15 = (ret == (int)4);		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(356)
					if ((tmp15)){
						HX_STACK_LINE(356)
						::nape::callbacks::InteractionType tmp16 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(356)
						bool tmp17 = (tmp16 == null());		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(356)
						if ((tmp17)){
							...
							::nape::callbacks::InteractionType tmp18 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(356)
							::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID = tmp18;
							HX_STACK_LINE(356)
							::zpp_nape::util::ZPP_Flags_obj::internal = false;
						}
						HX_STACK_LINE(356)
						...
						HX_STACK_LINE(356)
						bool tmp16 = (ret == (int)7);		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(356)
						if ((tmp16)){
							HX_STACK_LINE(356)
							::nape::callbacks::InteractionType tmp17 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY;		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(356)
							bool tmp18 = (tmp17 == null());		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(356)
							if ((tmp18)){
								...
								::nape::callbacks::InteractionType tmp19 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(356)
								::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY = tmp19;
								HX_STACK_LINE(356)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(356)
...
::nape::callbacks::InteractionType PreListener_obj::get_interactionType( ){
	...
	HX_STACK_LINE(289)
	bool tmp1 = (ret == (int)1);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(289)
	::nape::callbacks::InteractionType tmp2;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(289)
	if ((tmp1)){
		HX_STACK_LINE(289)
		::nape::callbacks::InteractionType tmp3 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(289)
		...
		if ((tmp4)){
			...
			HX_STACK_LINE(289)
			::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION = tmp5;
			HX_STACK_LINE(289)
			::zpp_nape::util::ZPP_Flags_obj::internal = false;
		}
		HX_STACK_LINE(289)
		tmp2 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION;
	}
	else{
		HX_STACK_LINE(290)
		bool tmp3 = (ret == (int)2);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(290)
		if ((tmp3)){
			HX_STACK_LINE(290)
			::nape::callbacks::InteractionType tmp4 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(290)
			...
			if ((tmp5)){
				...
				HX_STACK_LINE(290)
				::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR = tmp6;
				HX_STACK_LINE(290)
				::zpp_nape::util::ZPP_Flags_obj::internal = false;
			}
			HX_STACK_LINE(290)
			...
			HX_STACK_LINE(291)
			bool tmp4 = (ret == (int)4);		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(291)
			if ((tmp4)){
				HX_STACK_LINE(291)
				...
				HX_STACK_LINE(291)
				tmp2 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;
			}
			else{
				HX_STACK_LINE(292)
				bool tmp5 = (ret == (int)7);		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(292)
				if ((tmp5)){
					HX_STACK_LINE(292)
					::nape::callbacks::InteractionType tmp6 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY;		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(292)
					...
					if ((tmp7)){
						...
						HX_STACK_LINE(292)
						::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY = tmp8;
						HX_STACK_LINE(292)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(292)
					tmp2 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY;
				}
				else{
					HX_STACK_LINE(293)
					tmp2 = null();
...
::nape::callbacks::InteractionType PreListener_obj::set_interactionType( ::nape::callbacks::InteractionType interactionType){
	...
	HX_STACK_LINE(296)
	{
		...
		HX_STACK_LINE(302)
		{
			...
			HX_STACK_LINE(302)
			bool tmp3 = (ret == (int)1);		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(302)
			if ((tmp3)){
				HX_STACK_LINE(302)
				...
				HX_STACK_LINE(302)
				bool tmp4 = (ret == (int)2);		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(302)
				if ((tmp4)){
					HX_STACK_LINE(302)
					::nape::callbacks::InteractionType tmp5 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(302)
					bool tmp6 = (tmp5 == null());		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(302)
					if ((tmp6)){
						...
						::nape::callbacks::InteractionType tmp7 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(302)
						::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR = tmp7;
						HX_STACK_LINE(302)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(302)
					...
					HX_STACK_LINE(302)
					bool tmp5 = (ret == (int)4);		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(302)
					if ((tmp5)){
						HX_STACK_LINE(302)
						::nape::callbacks::InteractionType tmp6 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(302)
						bool tmp7 = (tmp6 == null());		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(302)
						if ((tmp7)){
							...
							::nape::callbacks::InteractionType tmp8 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(302)
							::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID = tmp8;
							HX_STACK_LINE(302)
							::zpp_nape::util::ZPP_Flags_obj::internal = false;
						}
						HX_STACK_LINE(302)
						...
						HX_STACK_LINE(302)
						bool tmp6 = (ret == (int)7);		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(302)
						if ((tmp6)){
							HX_STACK_LINE(302)
	...
	HX_STACK_LINE(307)
	{
		...
		HX_STACK_LINE(307)
		bool tmp2 = (ret == (int)1);		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(307)
		if ((tmp2)){
			HX_STACK_LINE(307)
			::nape::callbacks::InteractionType tmp3 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION;		HX_STACK_VAR(tmp3,"tmp3");
