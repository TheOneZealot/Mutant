...
int Unicode_obj::decodeSurrogate( int hi,int lo){
	HX_STACK_FRAME("mint.core.unifill.Unicode","decodeSurrogate",0x26a2c49b,"mint.core.unifill.Unicode.decodeSurrogate","mint/core/unifill/Unicode.hx",13,0x4ffa8380)
	HX_STACK_ARG(hi,"hi")
	HX_STACK_ARG(lo,"lo")
	HX_STACK_LINE(13)
...
int Unicode_obj::encodeHighSurrogate( int c){
	HX_STACK_FRAME("mint.core.unifill.Unicode","encodeHighSurrogate",0x7d3d0871,"mint.core.unifill.Unicode.encodeHighSurrogate","mint/core/unifill/Unicode.hx",16,0x4ffa8380)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(16)
...
int Unicode_obj::encodeLowSurrogate( int c){
	HX_STACK_FRAME("mint.core.unifill.Unicode","encodeLowSurrogate",0x3de7aca9,"mint.core.unifill.Unicode.encodeLowSurrogate","mint/core/unifill/Unicode.hx",19,0x4ffa8380)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(19)
...
bool Unicode_obj::isScalar( int code){
	HX_STACK_FRAME("mint.core.unifill.Unicode","isScalar",0xc9c250c5,"mint.core.unifill.Unicode.isScalar","mint/core/unifill/Unicode.hx",21,0x4ffa8380)
...
bool Unicode_obj::isHighSurrogate( int code){
	HX_STACK_FRAME("mint.core.unifill.Unicode","isHighSurrogate",0x92b84d9d,"mint.core.unifill.Unicode.isHighSurrogate","mint/core/unifill/Unicode.hx",25,0x4ffa8380)
	HX_STACK_ARG(code,"code")
	HX_STACK_LINE(26)
...
bool Unicode_obj::isLowSurrogate( int code){
	HX_STACK_FRAME("mint.core.unifill.Unicode","isLowSurrogate",0xa1e030fd,"mint.core.unifill.Unicode.isLowSurrogate","mint/core/unifill/Unicode.hx",29,0x4ffa8380)
	HX_STACK_ARG(code,"code")
	HX_STACK_LINE(30)
...
void Unicode_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("mint.core.unifill.Unicode","\x3f","\x90","\x0f","\x2e");
