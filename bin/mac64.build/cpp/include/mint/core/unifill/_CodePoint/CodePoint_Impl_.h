...
#define INCLUDED_mint_core_unifill__CodePoint_CodePoint_Impl_

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS4(mint,core,unifill,_CodePoint,CodePoint_Impl_)
namespace mint{
namespace core{
namespace unifill{
...
class HXCPP_CLASS_ATTRIBUTES  CodePoint_Impl__obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="mint.core.unifill._CodePoint.CodePoint_Impl_")
...
#endif /* INCLUDED_mint_core_unifill__CodePoint_CodePoint_Impl_ */ 
