...
{
HX_STACK_FRAME("mint.core.unifill.InternalEncodingIter","new",0xf927cdf8,"mint.core.unifill.InternalEncodingIter.new","mint/core/unifill/InternalEncodingIter.hx",3,0xb87bc837)
HX_STACK_THIS(this)
HX_STACK_ARG(s,"s")
...
bool InternalEncodingIter_obj::hasNext( ){
	HX_STACK_FRAME("mint.core.unifill.InternalEncodingIter","hasNext",0x5c454f05,"mint.core.unifill.InternalEncodingIter.hasNext","mint/core/unifill/InternalEncodingIter.hx",15,0xb87bc837)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16)
...
int InternalEncodingIter_obj::next( ){
	HX_STACK_FRAME("mint.core.unifill.InternalEncodingIter","next",0x09ac6c5b,"mint.core.unifill.InternalEncodingIter.next","mint/core/unifill/InternalEncodingIter.hx",20,0xb87bc837)
	HX_STACK_THIS(this)
	HX_STACK_LINE(21)
	int tmp = this->index;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(21)
...
void InternalEncodingIter_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("mint.core.unifill.InternalEncodingIter","\x06","\xb2","\x43","\xb5");
