...
::nape::shape::ShapeType Shape_obj::get_type( ){
	...
	HX_STACK_LINE(188)
	::nape::shape::ShapeType tmp2 = ::zpp_nape::shape::ZPP_Shape_obj::types->__get(tmp1).StaticCast< ::nape::shape::ShapeType >();		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(188)
	return tmp2;
}
...
::nape::shape::Circle Shape_obj::get_castCircle( ){
	...
	bool tmp2 = (tmp1 == (int)0);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(258)
	::nape::shape::Circle tmp3;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(258)
	if ((tmp2)){
		HX_STACK_LINE(258)
		::zpp_nape::shape::ZPP_Shape tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(258)
		tmp3 = tmp4->circle->outer_zn;
	}
	else{
		HX_STACK_LINE(258)
		tmp3 = null();
...
::nape::shape::Polygon Shape_obj::get_castPolygon( ){
	...
	bool tmp2 = (tmp1 == (int)1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(266)
	::nape::shape::Polygon tmp3;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(266)
	if ((tmp2)){
		HX_STACK_LINE(266)
		::zpp_nape::shape::ZPP_Shape tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(266)
		tmp3 = tmp4->polygon->outer_zn;
	}
	else{
		HX_STACK_LINE(266)
		tmp3 = null();
...
::nape::geom::Vec2 Shape_obj::get_localCOM( ){
	...
	if ((tmp2)){
		...
		if ((tmp5)){
			...
			HX_STACK_LINE(302)
			tmp6->circle->setupLocalCOM();
		}
		else{
			HX_STACK_LINE(303)
			::zpp_nape::shape::ZPP_Shape tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(303)
			tmp6->polygon->setupLocalCOM();
		}
	}
	HX_STACK_LINE(305)
	::zpp_nape::shape::ZPP_Shape tmp3 = this->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
			...
			HX_STACK_LINE(319)
			{
				...
				if ((tmp11)){
					...
					if ((tmp14)){
						...
						HX_STACK_LINE(319)
						tmp15->circle->setupLocalCOM();
					}
					else{
						HX_STACK_LINE(319)
						::zpp_nape::shape::ZPP_Shape tmp15 = this->zpp_inner;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(319)
						tmp15->polygon->setupLocalCOM();
					}
				}
				HX_STACK_LINE(319)
				::zpp_nape::shape::ZPP_Shape tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
...
bool Shape_obj::set_fluidEnabled( bool fluidEnabled){
	...
	HX_STACK_LINE(432)
	{
		...
		if ((tmp3)){
			HX_STACK_LINE(435)
			::nape::phys::FluidProperties tmp4 = ::nape::phys::FluidProperties_obj::__new(null(),null());		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(435)
			::nape::phys::FluidProperties fluidProperties = tmp4;		HX_STACK_VAR(fluidProperties,"fluidProperties");
			HX_STACK_LINE(435)
			{
				HX_STACK_LINE(435)
				bool tmp5 = (fluidProperties == null());		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(435)
				if ((tmp5)){
					HX_STACK_LINE(435)
					HX_STACK_DO_THROW(HX_HCSTRING("Error: Cannot assign null as Shape fluidProperties, disable fluids by setting fluidEnabled to false","\xb2","\xc7","\x28","\xb5"));
				...
				::zpp_nape::shape::ZPP_Shape tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(435)
				::zpp_nape::phys::ZPP_FluidProperties tmp7 = fluidProperties->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(435)
				tmp6->setFluid(tmp7);
			}
			HX_STACK_LINE(435)
			{
				...
				::zpp_nape::shape::ZPP_Shape tmp5 = this->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(435)
				tmp5->immutable_midstep(HX_HCSTRING("Shape::fluidProperties","\xbc","\x2b","\xf3","\x66"));
				HX_STACK_LINE(435)
				::zpp_nape::shape::ZPP_Shape tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(435)
				::zpp_nape::phys::ZPP_FluidProperties tmp7 = tmp6->fluidProperties;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(435)
				...
				if ((tmp8)){
					...
					::zpp_nape::shape::ZPP_Shape tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(435)
					::nape::phys::FluidProperties tmp10 = ::nape::phys::FluidProperties_obj::__new(null(),null());		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(435)
					::zpp_nape::phys::ZPP_FluidProperties tmp11 = tmp10->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(435)
					tmp9->setFluid(tmp11);
				}
				HX_STACK_LINE(435)
	...
	if ((tmp9)){
		...
		if ((tmp12)){
			...
			HX_STACK_LINE(501)
			{
				...
				{
					HX_STACK_LINE(501)
					bool tmp15 = (translation != null());		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(501)
					bool tmp16;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(501)
					if ((tmp15)){
						HX_STACK_LINE(501)
						tmp16 = translation->zpp_disp;
					}
					else{
						HX_STACK_LINE(501)
						tmp16 = false;
			...
			HX_STACK_LINE(501)
			{
				...
				HX_STACK_LINE(501)
				tmp15 = translation->zpp_inner->y;
			}
			HX_STACK_LINE(501)
			tmp13->circle->__translate(tmp14,tmp15);
		}
		else{
			HX_STACK_LINE(502)
			::zpp_nape::shape::ZPP_Shape tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			...
			HX_STACK_LINE(502)
			tmp13->polygon->__translate(tmp14,tmp15);
		}
	}
	HX_STACK_LINE(504)
	{
...
::nape::shape::Shape Shape_obj::scale( Float scalex,Float scaley){
	...
	if ((tmp15)){
		HX_STACK_LINE(537)
		Float tmp16 = (scalex * scalex);		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(537)
		Float tmp17 = (scaley * scaley);		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(537)
		Float tmp18 = (tmp16 - tmp17);		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(537)
		Float d = tmp18;		HX_STACK_VAR(d,"d");
		HX_STACK_LINE(538)
		Float tmp19 = (d * d);		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(538)
		...
		if ((tmp23)){
			HX_STACK_LINE(539)
			::zpp_nape::shape::ZPP_Shape tmp24 = this->zpp_inner;		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(539)
			Float tmp25 = scalex;		HX_STACK_VAR(tmp25,"tmp25");
			HX_STACK_LINE(539)
			Float tmp26 = scaley;		HX_STACK_VAR(tmp26,"tmp26");
			HX_STACK_LINE(539)
			tmp24->circle->__scale(tmp25,tmp26);
		}
		else{
			HX_STACK_LINE(543)
		...
		HX_STACK_LINE(547)
		tmp16->polygon->__scale(tmp17,tmp18);
	}
	HX_STACK_LINE(548)
	return hx::ObjectPtr<OBJ_>(this);
}
...
::nape::shape::Shape Shape_obj::rotate( Float angle){
	...
	if ((tmp12)){
		...
		if ((tmp19)){
			HX_STACK_LINE(569)
			::zpp_nape::shape::ZPP_Shape tmp20 = this->zpp_inner;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(569)
			Float tmp21 = sin;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(569)
			Float tmp22 = cos;		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(569)
			tmp20->circle->__rotate(tmp21,tmp22);
		}
		else{
			HX_STACK_LINE(570)
			::zpp_nape::shape::ZPP_Shape tmp20 = this->zpp_inner;		HX_STACK_VAR(tmp20,"tmp20");
			...
			Float tmp22 = cos;		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(570)
			tmp20->polygon->__rotate(tmp21,tmp22);
		}
	}
	HX_STACK_LINE(572)
	return hx::ObjectPtr<OBJ_>(this);
...
::nape::shape::Shape Shape_obj::transform( ::nape::geom::Mat23 matrix){
	...
	if ((tmp11)){
		HX_STACK_LINE(594)
		bool tmp12 = matrix->equiorthogonal();		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(594)
		if ((tmp12)){
			HX_STACK_LINE(595)
			::zpp_nape::shape::ZPP_Shape tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			...
			HX_STACK_LINE(595)
			tmp13->circle->__transform(tmp14);
		}
		else{
			HX_STACK_LINE(599)
		...
		::zpp_nape::shape::ZPP_Shape tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(603)
		::nape::geom::Mat23 tmp13 = matrix;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(603)
		tmp12->polygon->__transform(tmp13);
	}
	HX_STACK_LINE(604)
	return hx::ObjectPtr<OBJ_>(this);
}
...
::String Shape_obj::toString( ){
	...
	if ((tmp2)){
		HX_STACK_LINE(663)
		tmp3 = HX_HCSTRING("Circle","\x30","\xe6","\xa1","\x8a");
	}
	else{
		HX_STACK_LINE(663)
		tmp3 = HX_HCSTRING("Polygon","\x5a","\x2a","\xe2","\xdf");
	}
	HX_STACK_LINE(663)
	::String ret = tmp3;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(664)
	::String tmp4 = (ret + HX_HCSTRING("#","\x23","\x00","\x00","\x00"));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(664)
