...
HX_STACK_ARG(position,"position")
{
	...
	HX_STACK_LINE(517)
	{
		...
		HX_STACK_LINE(517)
		{
			...
			HX_STACK_LINE(517)
			::nape::phys::BodyType tmp12 = ::zpp_nape::phys::ZPP_Body_obj::types->__get(tmp11).StaticCast< ::nape::phys::BodyType >();		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(517)
			...
			if ((tmp14)){
				HX_STACK_LINE(517)
				bool tmp15 = (type1 == null());		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(517)
				if ((tmp15)){
					HX_STACK_LINE(517)
				...
				HX_STACK_LINE(517)
				::nape::phys::BodyType tmp16 = type1;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(517)
				::nape::phys::BodyType tmp17;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(517)
				{
					HX_STACK_LINE(517)
					::nape::phys::BodyType tmp18 = ::zpp_nape::util::ZPP_Flags_obj::BodyType_DYNAMIC;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(517)
					...
					if ((tmp19)){
						...
						::zpp_nape::util::ZPP_Flags_obj::internal = true;
						HX_STACK_LINE(517)
						::nape::phys::BodyType tmp20 = ::nape::phys::BodyType_obj::__new();		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(517)
						::zpp_nape::util::ZPP_Flags_obj::BodyType_DYNAMIC = tmp20;
						HX_STACK_LINE(517)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(517)
					tmp17 = ::zpp_nape::util::ZPP_Flags_obj::BodyType_DYNAMIC;
				}
				HX_STACK_LINE(517)
				...
				if ((tmp18)){
					...
					HX_STACK_LINE(517)
					::nape::phys::BodyType tmp20 = type1;		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(517)
					::nape::phys::BodyType tmp21;		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(517)
					{
						HX_STACK_LINE(517)
						::nape::phys::BodyType tmp22 = ::zpp_nape::util::ZPP_Flags_obj::BodyType_KINEMATIC;		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(517)
						...
						if ((tmp23)){
							...
							::zpp_nape::util::ZPP_Flags_obj::internal = true;
							HX_STACK_LINE(517)
							::nape::phys::BodyType tmp24 = ::nape::phys::BodyType_obj::__new();		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(517)
							::zpp_nape::util::ZPP_Flags_obj::BodyType_KINEMATIC = tmp24;
							HX_STACK_LINE(517)
							::zpp_nape::util::ZPP_Flags_obj::internal = false;
						}
						HX_STACK_LINE(517)
						tmp21 = ::zpp_nape::util::ZPP_Flags_obj::BodyType_KINEMATIC;
					}
					HX_STACK_LINE(517)
				...
				HX_STACK_LINE(517)
				int ntype = tmp19;		HX_STACK_VAR(ntype,"ntype");
				HX_STACK_LINE(517)
				bool tmp20 = (ntype == (int)1);		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(517)
				...
				if ((tmp20)){
					...
					HX_STACK_LINE(517)
					::zpp_nape::space::ZPP_Space tmp24 = tmp23->space;		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(517)
					tmp21 = (tmp24 != null());
				}
				else{
				...
				if ((tmp25)){
					...
					HX_STACK_LINE(517)
					::zpp_nape::phys::ZPP_Body tmp27 = this->zpp_inner;		HX_STACK_VAR(tmp27,"tmp27");
					HX_STACK_LINE(517)
					int tmp28 = ntype;		HX_STACK_VAR(tmp28,"tmp28");
					HX_STACK_LINE(517)
					tmp26->space->transmitType(tmp27,tmp28);
				}
				else{
					HX_STACK_LINE(517)
					::zpp_nape::phys::ZPP_Body tmp26 = this->zpp_inner;		HX_STACK_VAR(tmp26,"tmp26");
...
::nape::phys::BodyType Body_obj::set_type( ::nape::phys::BodyType type){
	...
	HX_STACK_LINE(201)
	{
		...
		HX_STACK_LINE(206)
		::nape::phys::BodyType tmp5 = ::zpp_nape::phys::ZPP_Body_obj::types->__get(tmp4).StaticCast< ::nape::phys::BodyType >();		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(206)
		...
		if ((tmp7)){
			HX_STACK_LINE(208)
			bool tmp8 = (type == null());		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(208)
			if ((tmp8)){
				HX_STACK_LINE(208)
				HX_STACK_DO_THROW(HX_HCSTRING("Error: Cannot use null BodyType","\xcd","\xf3","\x4c","\x7b"));
			...
			HX_STACK_LINE(210)
			::nape::phys::BodyType tmp9 = type;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(210)
			::nape::phys::BodyType tmp10;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(210)
			{
				HX_STACK_LINE(210)
				::nape::phys::BodyType tmp11 = ::zpp_nape::util::ZPP_Flags_obj::BodyType_DYNAMIC;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(210)
				...
				if ((tmp12)){
					...
					HX_STACK_LINE(210)
					::zpp_nape::util::ZPP_Flags_obj::BodyType_DYNAMIC = tmp13;
					HX_STACK_LINE(210)
					::zpp_nape::util::ZPP_Flags_obj::internal = false;
				}
				HX_STACK_LINE(210)
				tmp10 = ::zpp_nape::util::ZPP_Flags_obj::BodyType_DYNAMIC;
			}
			HX_STACK_LINE(210)
			...
			if ((tmp11)){
				...
				HX_STACK_LINE(210)
				::nape::phys::BodyType tmp13 = type;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(210)
				::nape::phys::BodyType tmp14;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(210)
				{
					HX_STACK_LINE(210)
					::nape::phys::BodyType tmp15 = ::zpp_nape::util::ZPP_Flags_obj::BodyType_KINEMATIC;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(210)
					...
					if ((tmp16)){
						...
						HX_STACK_LINE(210)
						::zpp_nape::util::ZPP_Flags_obj::BodyType_KINEMATIC = tmp17;
						HX_STACK_LINE(210)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(210)
					tmp14 = ::zpp_nape::util::ZPP_Flags_obj::BodyType_KINEMATIC;
				}
				HX_STACK_LINE(210)
			...
			HX_STACK_LINE(210)
			int ntype = tmp12;		HX_STACK_VAR(ntype,"ntype");
			HX_STACK_LINE(211)
			bool tmp13 = (ntype == (int)1);		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(211)
			...
			if ((tmp18)){
				...
				HX_STACK_LINE(235)
				tmp19->space->transmitType(tmp20,tmp21);
			}
			else{
				HX_STACK_LINE(236)
				::zpp_nape::phys::ZPP_Body tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
	...
	HX_STACK_LINE(308)
	{
		HX_STACK_LINE(308)
		{
			...
			while((true)){
				...
				{
					HX_STACK_LINE(308)
					bool tmp9 = (s->type == (int)1);		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(308)
					if ((tmp9)){
						HX_STACK_LINE(308)
...
Float Body_obj::set_rotation( Float rotation){
	...
	HX_STACK_LINE(777)
	{
		...
		if ((tmp5)){
			...
			HX_STACK_LINE(783)
			::zpp_nape::space::ZPP_Space tmp9 = tmp8->space;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(783)
			tmp6 = (tmp9 != null());
		}
		else{
		...
		::zpp_nape::phys::ZPP_Body tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(785)
		Float tmp8 = tmp7->rot;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(785)
		...
		if ((tmp10)){
			HX_STACK_LINE(787)
			bool tmp11 = (rotation != rotation);		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(787)
			if ((tmp11)){
				HX_STACK_LINE(787)
			...
			HX_STACK_LINE(790)
			{
				...
				{
					HX_STACK_LINE(790)
					::zpp_nape::util::ZNPNode_ZPP_Shape tmp14 = _this->shapes->head;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(790)
...
Float Body_obj::set_torque( Float torque){
	...
	HX_STACK_LINE(873)
	{
		...
		HX_STACK_LINE(881)
		bool tmp6 = (torque != torque);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(881)
		if ((tmp6)){
			HX_STACK_LINE(881)
		...
		::zpp_nape::phys::ZPP_Body tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(883)
		Float tmp8 = tmp7->torque;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(883)
		Float tmp9 = torque;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(883)
		bool tmp10 = (tmp8 != tmp9);		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(883)
		if ((tmp10)){
...
Float Body_obj::get_mass( ){
	...
	if ((tmp5)){
		...
		::zpp_nape::phys::ZPP_Body tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(1016)
		::zpp_nape::util::ZNPNode_ZPP_Shape tmp9 = tmp8->shapes->head;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(1016)
		::zpp_nape::util::ZNPNode_ZPP_Shape tmp10 = tmp9;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(1016)
		tmp6 = (tmp10 == null());
	}
	else{
	...
	::zpp_nape::phys::ZPP_Body tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(1018)
	Float tmp8 = tmp7->cmass;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(1018)
	return tmp8;
}
...
Float Body_obj::set_gravMass( Float gravMass){
	...
	HX_STACK_LINE(1085)
	{
		...
		::zpp_nape::phys::ZPP_Body tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(1093)
		tmp4->gravMassMode = (int)1;
		HX_STACK_LINE(1094)
		::zpp_nape::phys::ZPP_Body tmp5 = this->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(1094)
		tmp5->gravMass = gravMass;
		HX_STACK_LINE(1095)
		::zpp_nape::phys::ZPP_Body tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(1095)
...
Float Body_obj::get_gravMassScale( ){
	...
	if ((tmp3)){
		...
		if ((tmp6)){
			...
			::zpp_nape::phys::ZPP_Body tmp9 = tmp8;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(1113)
			int tmp10 = tmp9->gravMassMode;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(1113)
			tmp7 = (tmp10 != (int)2);
		}
		else{
...
Float Body_obj::set_gravMassScale( Float gravMassScale){
	...
	HX_STACK_LINE(1119)
	{
		...
		::zpp_nape::phys::ZPP_Body tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(1127)
		tmp4->gravMassMode = (int)2;
		HX_STACK_LINE(1128)
		::zpp_nape::phys::ZPP_Body tmp5 = this->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(1128)
		tmp5->gravMassScale = gravMassScale;
		HX_STACK_LINE(1129)
		::zpp_nape::phys::ZPP_Body tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(1129)
		tmp6->invalidate_gravMassScale();
	}
	HX_STACK_LINE(1131)
	Float tmp;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(1131)
...
Float Body_obj::get_inertia( ){
	...
	if ((tmp5)){
		...
		::zpp_nape::phys::ZPP_Body tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(1185)
		::nape::shape::ShapeList _this = tmp8->wrap_shapes;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(1185)
		{
			HX_STACK_LINE(1185)
			::zpp_nape::util::ZNPList_ZPP_Shape tmp9 = _this->zpp_inner->inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(1185)
			::zpp_nape::util::ZNPList_ZPP_Shape tmp10 = tmp9;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(1185)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp11 = tmp10->head;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(1185)
			tmp6 = (tmp11 == null());
		}
	}
	...
	::zpp_nape::phys::ZPP_Body tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(1187)
	Float tmp8 = tmp7->cinertia;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(1187)
	return tmp8;
}
...
Float Body_obj::set_inertia( Float inertia){
	...
	HX_STACK_LINE(1190)
	{
		...
		::zpp_nape::phys::ZPP_Body tmp8 = this->zpp_inner;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(1200)
		tmp8->inertiaMode = (int)1;
		HX_STACK_LINE(1201)
		::zpp_nape::phys::ZPP_Body tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(1201)
		tmp9->cinertia = inertia;
		HX_STACK_LINE(1202)
		::zpp_nape::phys::ZPP_Body tmp10 = this->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(1202)
		tmp10->invalidate_inertia();
	}
	HX_STACK_LINE(1204)
	Float tmp;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(1204)
...
Float Body_obj::crushFactor( ){
	...
	HX_STACK_LINE(1285)
	{
		...
		if ((tmp15)){
			...
			HX_STACK_LINE(1285)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp19 = tmp18->shapes->head;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(1285)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp20 = tmp19;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(1285)
			tmp16 = (tmp20 == null());
		}
		else{
	...
	HX_STACK_LINE(1810)
	{
		...
		HX_STACK_LINE(1810)
		{
			...
			HX_STACK_LINE(1810)
			{
				...
				if ((tmp12)){
					HX_STACK_LINE(1810)
					::zpp_nape::space::ZPP_Space tmp14 = _g->zpp_inner->space;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(1810)
				...
				HX_STACK_LINE(1810)
				Float tmp14 = _g->zpp_inner->rot;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(1810)
				...
				if ((tmp16)){
					HX_STACK_LINE(1810)
					bool tmp17 = (rotation != rotation);		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(1810)
					if ((tmp17)){
						HX_STACK_LINE(1810)
						HX_STACK_DO_THROW(HX_HCSTRING("Error: Body::rotation cannot be NaN","\xa9","\xa5","\x47","\x9c"));
					...
					HX_STACK_LINE(1810)
					{
						...
						{
							HX_STACK_LINE(1810)
							::zpp_nape::util::ZNPNode_ZPP_Shape tmp18 = _this->shapes->head;		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(1810)
							::zpp_nape::util::ZNPNode_ZPP_Shape cx_ite = tmp18;		HX_STACK_VAR(cx_ite,"cx_ite");
							HX_STACK_LINE(1810)
							while((true)){
								HX_STACK_LINE(1810)
								...
								{
									HX_STACK_LINE(1810)
									bool tmp21 = (s->type == (int)1);		HX_STACK_VAR(tmp21,"tmp21");
									HX_STACK_LINE(1810)
									if ((tmp21)){
										HX_STACK_LINE(1810)
										s->polygon->invalidate_gverts();
...
::String Body_obj::toString( ){
	...
	if ((tmp1)){
		...
		if ((tmp5)){
			HX_STACK_LINE(2550)
			tmp6 = HX_HCSTRING("dynamic","\x7f","\x9f","\x15","\x36");
		}
		else{
			HX_STACK_LINE(2550)
			::zpp_nape::phys::ZPP_Body tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
			...
			if ((tmp9)){
				HX_STACK_LINE(2550)
				tmp6 = HX_HCSTRING("static","\xae","\xdc","\xfb","\x05");
			}
			else{
				HX_STACK_LINE(2550)
				tmp6 = HX_HCSTRING("kinematic","\x05","\x79","\xff","\xe3");
			}
		}
		HX_STACK_LINE(2550)
		tmp2 = (HX_HCSTRING("(","\x28","\x00","\x00","\x00") + tmp6);
	}
	HX_STACK_LINE(2550)
