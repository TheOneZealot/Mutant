...
::nape::phys::Compound ZPP_Compound_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	...
	HX_STACK_LINE(340)
	::nape::phys::Compound tmp3 = ::nape::phys::Compound_obj::__new();		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(340)
	::nape::phys::Compound ret = tmp3;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(341)
	{
		HX_STACK_LINE(342)
		::zpp_nape::util::ZNPList_ZPP_Compound tmp4 = this->compounds;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(342)
		::zpp_nape::util::ZNPNode_ZPP_Compound cx_ite = tmp4->head;		HX_STACK_VAR(cx_ite,"cx_ite");
		HX_STACK_LINE(343)
		while((true)){
			HX_STACK_LINE(343)
			...
			{
				HX_STACK_LINE(346)
				::nape::phys::Compound tmp7 = c->copy(dict,todo);		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(346)
				::nape::phys::Compound cc = tmp7;		HX_STACK_VAR(cc,"cc");
				HX_STACK_LINE(347)
				{
					HX_STACK_LINE(347)
					{
						...
						HX_STACK_LINE(347)
						::zpp_nape::phys::ZPP_Compound tmp8 = cc->zpp_inner->compound;		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(347)
						...
						HX_STACK_LINE(347)
						::nape::phys::Compound tmp11 = ret;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(347)
						bool tmp12 = (tmp10 != tmp11);		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(347)
						if ((tmp12)){
							HX_STACK_LINE(347)
							::zpp_nape::phys::ZPP_Compound tmp13 = cc->zpp_inner->compound;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(347)
							...
							if ((tmp14)){
								...
								HX_STACK_LINE(347)
								::zpp_nape::phys::ZPP_Compound tmp16 = cc->zpp_inner->compound;		HX_STACK_VAR(tmp16,"tmp16");
								HX_STACK_LINE(347)
								tmp15 = tmp16->outer;
							}
							HX_STACK_LINE(347)
							...
							if ((tmp16)){
								...
								HX_STACK_LINE(347)
								::nape::phys::Compound tmp19;		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(347)
								if ((tmp18)){
									HX_STACK_LINE(347)
									tmp19 = null();
									...
									HX_STACK_LINE(347)
									::zpp_nape::phys::ZPP_Compound tmp20 = cc->zpp_inner->compound;		HX_STACK_VAR(tmp20,"tmp20");
									HX_STACK_LINE(347)
									tmp19 = tmp20->outer;
								}
								HX_STACK_LINE(347)
								::nape::phys::CompoundList tmp20 = tmp19->zpp_inner->wrap_compounds;		HX_STACK_VAR(tmp20,"tmp20");
								HX_STACK_LINE(347)
							...
							if ((tmp17)){
								HX_STACK_LINE(347)
								::nape::phys::CompoundList tmp18 = ret->zpp_inner->wrap_compounds;		HX_STACK_VAR(tmp18,"tmp18");
								HX_STACK_LINE(347)
								::nape::phys::CompoundList _this = tmp18;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(347)
								bool tmp19 = _this->zpp_inner->reverse_flag;		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(347)
								if ((tmp19)){
									HX_STACK_LINE(347)
									::nape::phys::Compound tmp20 = cc;		HX_STACK_VAR(tmp20,"tmp20");
									HX_STACK_LINE(347)
									_this->push(tmp20);
								}
								else{
					...
					if ((tmp9)){
						...
						HX_STACK_LINE(347)
						::zpp_nape::phys::ZPP_Compound tmp10 = cc->zpp_inner->compound;		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(347)
						tmp10->outer;
					}
				}
	...
	HX_STACK_LINE(352)
	{
		...
		while((true)){
			...
			{
				HX_STACK_LINE(357)
				::nape::phys::Body tmp7 = b->outer->copy();		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(357)
				::nape::phys::Body bc = tmp7;		HX_STACK_VAR(bc,"bc");
				HX_STACK_LINE(358)
				int tmp8 = b->id;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(358)
				::nape::phys::Body tmp9 = bc;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(358)
				::zpp_nape::constraint::ZPP_CopyHelper tmp10 = ::zpp_nape::constraint::ZPP_CopyHelper_obj::dict(tmp8,tmp9);		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(358)
				dict->push(tmp10);
				HX_STACK_LINE(359)
				{
					...
					{
						HX_STACK_LINE(359)
						::zpp_nape::phys::ZPP_Compound tmp11 = bc->zpp_inner->compound;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(359)
						bool tmp12 = (tmp11 == null());		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(359)
						::nape::phys::Compound tmp13;		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(359)
						if ((tmp12)){
							HX_STACK_LINE(359)
							tmp13 = null();
							...
							HX_STACK_LINE(359)
							::zpp_nape::phys::ZPP_Compound tmp14 = bc->zpp_inner->compound;		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(359)
							tmp13 = tmp14->outer;
						}
						HX_STACK_LINE(359)
						::nape::phys::Compound tmp14 = ret;		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(359)
						bool tmp15 = (tmp13 != tmp14);		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(359)
						if ((tmp15)){
							HX_STACK_LINE(359)
							::zpp_nape::phys::ZPP_Compound tmp16 = bc->zpp_inner->compound;		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(359)
							bool tmp17 = (tmp16 == null());		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(359)
							::nape::phys::Compound tmp18;		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(359)
							if ((tmp17)){
								HX_STACK_LINE(359)
								tmp18 = null();
							...
							if ((tmp19)){
								HX_STACK_LINE(359)
								::zpp_nape::phys::ZPP_Compound tmp20 = bc->zpp_inner->compound;		HX_STACK_VAR(tmp20,"tmp20");
								HX_STACK_LINE(359)
								bool tmp21 = (tmp20 == null());		HX_STACK_VAR(tmp21,"tmp21");
								HX_STACK_LINE(359)
								::nape::phys::Compound tmp22;		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(359)
								if ((tmp21)){
									HX_STACK_LINE(359)
									tmp22 = null();
									...
									HX_STACK_LINE(359)
									::zpp_nape::phys::ZPP_Compound tmp23 = bc->zpp_inner->compound;		HX_STACK_VAR(tmp23,"tmp23");
									HX_STACK_LINE(359)
									tmp22 = tmp23->outer;
								}
								HX_STACK_LINE(359)
								::nape::phys::BodyList tmp23 = tmp22->zpp_inner->wrap_bodies;		HX_STACK_VAR(tmp23,"tmp23");
								HX_STACK_LINE(359)
								::nape::phys::Body tmp24 = bc;		HX_STACK_VAR(tmp24,"tmp24");
								HX_STACK_LINE(359)
								tmp23->remove(tmp24);
							}
							HX_STACK_LINE(359)
							...
							if ((tmp20)){
								HX_STACK_LINE(359)
								::nape::phys::BodyList tmp21 = ret->zpp_inner->wrap_bodies;		HX_STACK_VAR(tmp21,"tmp21");
								HX_STACK_LINE(359)
								::nape::phys::BodyList _this = tmp21;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(359)
								bool tmp22 = _this->zpp_inner->reverse_flag;		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(359)
								if ((tmp22)){
									HX_STACK_LINE(359)
	...
	HX_STACK_LINE(364)
	{
		...
		::zpp_nape::util::ZNPList_ZPP_Constraint tmp4 = this->constraints;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(365)
		::zpp_nape::util::ZNPNode_ZPP_Constraint cx_ite = tmp4->head;		HX_STACK_VAR(cx_ite,"cx_ite");
		HX_STACK_LINE(366)
		while((true)){
			HX_STACK_LINE(366)
			bool tmp5 = (cx_ite != null());		HX_STACK_VAR(tmp5,"tmp5");
			...
			{
				HX_STACK_LINE(369)
				::nape::constraint::Constraint tmp7 = c->copy(dict,todo);		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(369)
				::nape::constraint::Constraint cc = tmp7;		HX_STACK_VAR(cc,"cc");
				HX_STACK_LINE(370)
				{
					HX_STACK_LINE(370)
					{
						...
						if ((tmp12)){
							...
							if ((tmp16)){
								...
								HX_STACK_LINE(370)
								::nape::constraint::ConstraintList tmp20 = tmp19->zpp_inner->wrap_constraints;		HX_STACK_VAR(tmp20,"tmp20");
								HX_STACK_LINE(370)
							...
							if ((tmp17)){
								HX_STACK_LINE(370)
								::nape::constraint::ConstraintList tmp18 = ret->zpp_inner->wrap_constraints;		HX_STACK_VAR(tmp18,"tmp18");
								HX_STACK_LINE(370)
								::nape::constraint::ConstraintList _this = tmp18;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(370)
								bool tmp19 = _this->zpp_inner->reverse_flag;		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(370)
								if ((tmp19)){
									HX_STACK_LINE(370)
									::nape::constraint::Constraint tmp20 = cc;		HX_STACK_VAR(tmp20,"tmp20");
									HX_STACK_LINE(370)
									_this->push(tmp20);
								}
								else{
	...
	HX_STACK_LINE(375)
	bool tmp4 = root;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(375)
	if ((tmp4)){
		HX_STACK_LINE(376)
		while((true)){
			HX_STACK_LINE(376)
			bool tmp5 = (todo->length > (int)0);		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(376)
			bool tmp6 = !(tmp5);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(376)
			if ((tmp6)){
			...
			HX_STACK_LINE(377)
			::zpp_nape::constraint::ZPP_CopyHelper tmp7 = todo->pop().StaticCast< ::zpp_nape::constraint::ZPP_CopyHelper >();		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(377)
			::zpp_nape::constraint::ZPP_CopyHelper xcb = tmp7;		HX_STACK_VAR(xcb,"xcb");
			HX_STACK_LINE(378)
			{
				HX_STACK_LINE(378)
				...
				while((true)){
					...
					++(_g);
					HX_STACK_LINE(379)
					bool tmp11 = (idc->id == xcb->id);		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(379)
					if ((tmp11)){
						HX_STACK_LINE(380)
						::nape::phys::Body tmp12 = idc->bc;		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(380)
						xcb->cb(tmp12);
						HX_STACK_LINE(381)
						break;
	...
	this->copyto(tmp5);
	HX_STACK_LINE(387)
	::nape::phys::Compound tmp6 = ret;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(387)
	return tmp6;
}
