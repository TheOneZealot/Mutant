...
class HXCPP_CLASS_ATTRIBUTES  ZNPList_ZPP_CbSetPair_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPList_ZPP_CbSetPair")
		...
		::String __ToString() const { return HX_HCSTRING("ZNPList_ZPP_CbSetPair","\x53","\x30","\xef","\x4d"); }
