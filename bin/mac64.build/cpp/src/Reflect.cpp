...
Dynamic Reflect_obj::copy( Dynamic o){
	HX_STACK_FRAME("Reflect","copy",0x47e2b5a6,"Reflect.copy","/usr/local/lib/haxe/std/cpp/_std/Reflect.hx",92,0x1c2422c3)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(93)
	bool tmp = (o == null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(93)
	...
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/local/lib/haxe/std/cpp/_std/Reflect.hx",97,0x1c2422c3)
			{
