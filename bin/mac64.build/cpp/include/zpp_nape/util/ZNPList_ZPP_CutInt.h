...
class HXCPP_CLASS_ATTRIBUTES  ZNPList_ZPP_CutInt_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPList_ZPP_CutInt")
		...
		::String __ToString() const { return HX_HCSTRING("ZNPList_ZPP_CutInt","\x77","\x8a","\x8c","\xeb"); }
