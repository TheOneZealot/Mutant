...
{
HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_Vec2","new",0xd76f2b61,"zpp_nape.util.ZNPNode_ZPP_Vec2.new","zpp_nape/util/Lists.hx",15674,0x9f4e6754)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(15708)
	this->elt = null();
...
{  hx::ObjectPtr< ZNPNode_ZPP_Vec2_obj > _result_ = new ZNPNode_ZPP_Vec2_obj();
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_Vec2","alloc",0x7a7c81b6,"zpp_nape.util.ZNPNode_ZPP_Vec2.alloc","zpp_nape/util/Lists.hx",15702,0x9f4e6754)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_Vec2","free",0xa496e28b,"zpp_nape.util.ZNPNode_ZPP_Vec2.free","zpp_nape/util/Lists.hx",15706,0x9f4e6754)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15706)
		this->elt = null();
	}
...
::zpp_nape::geom::ZPP_Vec2 ZNPNode_ZPP_Vec2_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_Vec2","elem",0xa3e91e6e,"zpp_nape.util.ZNPNode_ZPP_Vec2.elem","zpp_nape/util/Lists.hx",15712,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15713)
	::zpp_nape::geom::ZPP_Vec2 tmp = this->elt;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(15713)
	return tmp;
}
...
Dynamic ZNPNode_ZPP_Vec2_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic ZNPNode_ZPP_Vec2_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
