...
{
HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_AABBNode","new",0x5c4e8725,"zpp_nape.util.ZNPNode_ZPP_AABBNode.new","zpp_nape/util/Lists.hx",15803,0x9f4e6754)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(15837)
	this->elt = null();
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_AABBNode","alloc",0x7abd567a,"zpp_nape.util.ZNPNode_ZPP_AABBNode.alloc","zpp_nape/util/Lists.hx",15831,0x9f4e6754)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_AABBNode","free",0x6327d247,"zpp_nape.util.ZNPNode_ZPP_AABBNode.free","zpp_nape/util/Lists.hx",15835,0x9f4e6754)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15835)
		this->elt = null();
	}
...
::zpp_nape::space::ZPP_AABBNode ZNPNode_ZPP_AABBNode_obj::elem( ){
	HX_STACK_FRAME("zpp_nape.util.ZNPNode_ZPP_AABBNode","elem",0x627a0e2a,"zpp_nape.util.ZNPNode_ZPP_AABBNode.elem","zpp_nape/util/Lists.hx",15841,0x9f4e6754)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15842)
