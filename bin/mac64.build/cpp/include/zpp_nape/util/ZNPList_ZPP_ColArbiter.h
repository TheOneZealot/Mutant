...
class HXCPP_CLASS_ATTRIBUTES  ZNPList_ZPP_ColArbiter_obj : public hx::Object{
	public:
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPList_ZPP_ColArbiter")
		...
		::String __ToString() const { return HX_HCSTRING("ZNPList_ZPP_ColArbiter","\x73","\x9a","\x57","\xec"); }

		::zpp_nape::util::ZNPNode_ZPP_ColArbiter head;
