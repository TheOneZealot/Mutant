...
bool ZPP_DynAABBPhase_obj::dyn( ::zpp_nape::shape::ZPP_Shape shape){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(715)
		::zpp_nape::space::ZPP_Component tmp2 = shape->body->component;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(715)
		bool tmp3 = tmp2->sleeping;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(715)
...
Void ZPP_DynAABBPhase_obj::__sync( ::zpp_nape::shape::ZPP_Shape shape){
{
		...
		if ((tmp1)){
			...
			if ((tmp4)){
				...
				if ((tmp5)){
					...
					if ((tmp6)){
						...
						HX_STACK_LINE(963)
						bool tmp7 = (shape->type == (int)0);		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(963)
						if ((tmp7)){
							HX_STACK_LINE(963)
									...
									if ((tmp9)){
										...
										HX_STACK_LINE(963)
										{
											...
											if ((tmp10)){
												...
												HX_STACK_LINE(963)
												bool tmp11 = (_this->type == (int)1);		HX_STACK_VAR(tmp11,"tmp11");
												HX_STACK_LINE(963)
												if ((tmp11)){
													HX_STACK_LINE(963)
													...
													HX_STACK_LINE(963)
													::zpp_nape::geom::ZPP_Vec2 tmp15 = tmp14->next;		HX_STACK_VAR(tmp15,"tmp15");
													HX_STACK_LINE(963)
													...
													if ((tmp16)){
														...
														::zpp_nape::geom::ZPP_Vec2 tmp17 = _this1->lverts->next;		HX_STACK_VAR(tmp17,"tmp17");
														HX_STACK_LINE(963)
														::zpp_nape::geom::ZPP_Vec2 tmp18 = tmp17->next->next;		HX_STACK_VAR(tmp18,"tmp18");
														HX_STACK_LINE(963)
														...
														if ((tmp19)){
															...
															HX_STACK_LINE(963)
															{
																...
																HX_STACK_LINE(963)
																{
																	...
																	Float tmp22 = v->x;		HX_STACK_VAR(tmp22,"tmp22");
																	HX_STACK_LINE(963)
																	Float tmp23 = (w1->y - u->y);		HX_STACK_VAR(tmp23,"tmp23");
																	HX_STACK_LINE(963)
																	Float tmp24 = (tmp22 * tmp23);		HX_STACK_VAR(tmp24,"tmp24");
																	HX_STACK_LINE(963)
																	hx::AddEq(area,tmp24);
																	HX_STACK_LINE(963)
																	Float tmp25 = (w1->y * v->x);		HX_STACK_VAR(tmp25,"tmp25");
																	HX_STACK_LINE(963)
																	Float tmp26 = (w1->x * v->y);		HX_STACK_VAR(tmp26,"tmp26");
																	HX_STACK_LINE(963)
																	Float tmp27 = (tmp25 - tmp26);		HX_STACK_VAR(tmp27,"tmp27");
																	HX_STACK_LINE(963)
																	Float cf = tmp27;		HX_STACK_VAR(cf,"cf");
																	HX_STACK_LINE(963)
																	Float tmp28 = (v->x + w1->x);		HX_STACK_VAR(tmp28,"tmp28");
																	HX_STACK_LINE(963)
																	Float tmp29 = cf;		HX_STACK_VAR(tmp29,"tmp29");
																	HX_STACK_LINE(963)
																	Float tmp30 = (tmp28 * tmp29);		HX_STACK_VAR(tmp30,"tmp30");
																	...
																	hx::AddEq(_this1->localCOMx,tmp30);
																	HX_STACK_LINE(963)
																	Float tmp31 = (v->y + w1->y);		HX_STACK_VAR(tmp31,"tmp31");
																	HX_STACK_LINE(963)
																	Float tmp32 = cf;		HX_STACK_VAR(tmp32,"tmp32");
																	HX_STACK_LINE(963)
																	Float tmp33 = (tmp31 * tmp32);		HX_STACK_VAR(tmp33,"tmp33");
															...
															HX_STACK_LINE(963)
															Float tmp20 = ((int)3 * area);		HX_STACK_VAR(tmp20,"tmp20");
															HX_STACK_LINE(963)
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(964)
				::zpp_nape::space::ZPP_Component tmp9 = shape->body->component;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(964)
				bool tmp10 = tmp9->sleeping;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(964)
				tmp8 = !(tmp10);
			}
			HX_STACK_LINE(964)
			...
			if ((tmp10)){
				...
				HX_STACK_LINE(964)
				{
					...
					HX_STACK_LINE(964)
					bool tmp13 = (x->minx >= _this->minx);		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(964)
					...
					if ((tmp17)){
						HX_STACK_LINE(964)
						bool tmp18 = (x->miny >= _this->miny);		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(964)
						tmp16 = tmp18;
					}
					else{
					...
					if ((tmp20)){
						HX_STACK_LINE(964)
						bool tmp21 = (x->maxx <= _this->maxx);		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(964)
						tmp19 = tmp21;
					}
					else{
					...
					if ((tmp21)){
						HX_STACK_LINE(964)
						bool tmp22 = (x->maxy <= _this->maxy);		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(964)
						tmp12 = tmp22;
					}
					else{
			...
			HX_STACK_LINE(964)
			bool sync = tmp11;		HX_STACK_VAR(sync,"sync");
			HX_STACK_LINE(965)
			bool tmp12 = sync;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(965)
			if ((tmp12)){
				HX_STACK_LINE(968)
				node->synced = true;
				...
				{
					HX_STACK_LINE(978)
					::zpp_nape::space::ZPP_AABBNode tmp13 = this->syncs;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(978)
					node->snext = tmp13;
					HX_STACK_LINE(979)
					this->syncs = node;
				...
				while((true)){
					...
					HX_STACK_LINE(992)
					{
						...
						if ((tmp12)){
							...
							if ((tmp13)){
								...
								if ((tmp14)){
									...
									shape->zip_aabb = false;
									HX_STACK_LINE(1016)
									bool tmp15 = (shape->type == (int)0);		HX_STACK_VAR(tmp15,"tmp15");
									HX_STACK_LINE(1016)
									if ((tmp15)){
										HX_STACK_LINE(1016)
										::zpp_nape::shape::ZPP_Circle _this = shape->circle;		HX_STACK_VAR(_this,"_this");
										...
										{
											HX_STACK_LINE(1016)
											bool tmp16 = _this->zip_worldCOM;		HX_STACK_VAR(tmp16,"tmp16");
											HX_STACK_LINE(1016)
											if ((tmp16)){
												HX_STACK_LINE(1016)
												bool tmp17 = (_this->body != null());		HX_STACK_VAR(tmp17,"tmp17");
												HX_STACK_LINE(1016)
												if ((tmp17)){
													HX_STACK_LINE(1016)
													_this->zip_worldCOM = false;
													...
													{
														HX_STACK_LINE(1016)
														bool tmp18 = _this->zip_localCOM;		HX_STACK_VAR(tmp18,"tmp18");
														HX_STACK_LINE(1016)
														if ((tmp18)){
															HX_STACK_LINE(1016)
															_this->zip_localCOM = false;
															HX_STACK_LINE(1016)
															bool tmp19 = (_this->type == (int)1);		HX_STACK_VAR(tmp19,"tmp19");
															HX_STACK_LINE(1016)
															if ((tmp19)){
																HX_STACK_LINE(1016)
																::zpp_nape::shape::ZPP_Polygon _this1 = _this->polygon;		HX_STACK_VAR(_this1,"_this1");
																...
																if ((tmp24)){
																	...
																	if ((tmp27)){
																		...
																		HX_STACK_LINE(1016)
																		{
																			...
																			::zpp_nape::geom::ZPP_Vec2 tmp28 = _this1->lverts->next;		HX_STACK_VAR(tmp28,"tmp28");
																			HX_STACK_LINE(1016)
																			::zpp_nape::geom::ZPP_Vec2 cx_ite = tmp28;		HX_STACK_VAR(cx_ite,"cx_ite");
																			HX_STACK_LINE(1016)
																			::zpp_nape::geom::ZPP_Vec2 u = cx_ite;		HX_STACK_VAR(u,"u");
																			HX_STACK_LINE(1016)
																			cx_ite = cx_ite->next;
													...
													HX_STACK_LINE(1016)
													{
														...
														::zpp_nape::phys::ZPP_Body _this1 = _this->body;		HX_STACK_VAR(_this1,"_this1");
														HX_STACK_LINE(1016)
														bool tmp18 = _this1->zip_axis;		HX_STACK_VAR(tmp18,"tmp18");
														HX_STACK_LINE(1016)
														if ((tmp18)){
															HX_STACK_LINE(1016)
															_this1->zip_axis = false;
													...
													HX_STACK_LINE(1016)
													{
														...
														HX_STACK_LINE(1016)
														_this->worldCOMx = tmp26;
														HX_STACK_LINE(1016)
														Float tmp27 = _this->body->posy;		HX_STACK_VAR(tmp27,"tmp27");
														HX_STACK_LINE(1016)
														Float tmp28 = _this->localCOMx;		HX_STACK_VAR(tmp28,"tmp28");
														HX_STACK_LINE(1016)
														Float tmp29 = _this->body->axisx;		HX_STACK_VAR(tmp29,"tmp29");
														HX_STACK_LINE(1016)
														Float tmp30 = (tmp28 * tmp29);		HX_STACK_VAR(tmp30,"tmp30");
														HX_STACK_LINE(1016)
														Float tmp31 = _this->localCOMy;		HX_STACK_VAR(tmp31,"tmp31");
														HX_STACK_LINE(1016)
										...
										{
											HX_STACK_LINE(1016)
											Float tmp16 = (_this->worldCOMx - rx);		HX_STACK_VAR(tmp16,"tmp16");
											HX_STACK_LINE(1016)
											_this->aabb->minx = tmp16;
											HX_STACK_LINE(1016)
											Float tmp17 = (_this->worldCOMy - ry);		HX_STACK_VAR(tmp17,"tmp17");
											HX_STACK_LINE(1016)
											_this->aabb->miny = tmp17;
										}
										HX_STACK_LINE(1016)
										{
											HX_STACK_LINE(1016)
											Float tmp16 = (_this->worldCOMx + rx);		HX_STACK_VAR(tmp16,"tmp16");
											HX_STACK_LINE(1016)
											_this->aabb->maxx = tmp16;
											HX_STACK_LINE(1016)
											Float tmp17 = (_this->worldCOMy + ry);		HX_STACK_VAR(tmp17,"tmp17");
											HX_STACK_LINE(1016)
											_this->aabb->maxy = tmp17;
										}
									}
									else{
										HX_STACK_LINE(1016)
										...
										{
											HX_STACK_LINE(1016)
											bool tmp16 = _this->zip_gverts;		HX_STACK_VAR(tmp16,"tmp16");
											HX_STACK_LINE(1016)
											if ((tmp16)){
												HX_STACK_LINE(1016)
												bool tmp17 = (_this->body != null());		HX_STACK_VAR(tmp17,"tmp17");
													...
													HX_STACK_LINE(1016)
													{
														...
														while((true)){
															...
															HX_STACK_LINE(1016)
															{
																...
																{
																	HX_STACK_LINE(1016)
																	Float tmp22 = _this->body->posx;		HX_STACK_VAR(tmp22,"tmp22");
																	HX_STACK_LINE(1016)
																	...
																	g->x = tmp30;
																	HX_STACK_LINE(1016)
																	Float tmp31 = _this->body->posy;		HX_STACK_VAR(tmp31,"tmp31");
																	HX_STACK_LINE(1016)
																	Float tmp32 = l->x;		HX_STACK_VAR(tmp32,"tmp32");
																	HX_STACK_LINE(1016)
																	Float tmp33 = _this->body->axisx;		HX_STACK_VAR(tmp33,"tmp33");
																	HX_STACK_LINE(1016)
																	Float tmp34 = (tmp32 * tmp33);		HX_STACK_VAR(tmp34,"tmp34");
																	HX_STACK_LINE(1016)
																	Float tmp35 = l->y;		HX_STACK_VAR(tmp35,"tmp35");
																	HX_STACK_LINE(1016)
										...
										HX_STACK_LINE(1016)
										::zpp_nape::geom::ZPP_Vec2 p0 = tmp18;		HX_STACK_VAR(p0,"p0");
										HX_STACK_LINE(1016)
										{
											HX_STACK_LINE(1016)
											_this->aabb->minx = p0->x;
										...
										HX_STACK_LINE(1016)
										{
											...
											::zpp_nape::geom::ZPP_Vec2 tmp19 = _this->gverts->next;		HX_STACK_VAR(tmp19,"tmp19");
											HX_STACK_LINE(1016)
											::zpp_nape::geom::ZPP_Vec2 cx_ite = tmp19->next;		HX_STACK_VAR(cx_ite,"cx_ite");
											HX_STACK_LINE(1016)
											while((true)){
												HX_STACK_LINE(1016)
												bool tmp20 = (cx_ite != null());		HX_STACK_VAR(tmp20,"tmp20");
												...
												{
													HX_STACK_LINE(1016)
													Float tmp22 = p->x;		HX_STACK_VAR(tmp22,"tmp22");
													HX_STACK_LINE(1016)
													Float tmp23 = _this->aabb->minx;		HX_STACK_VAR(tmp23,"tmp23");
													HX_STACK_LINE(1016)
													...
													HX_STACK_LINE(1016)
													Float tmp26 = _this->aabb->maxx;		HX_STACK_VAR(tmp26,"tmp26");
													HX_STACK_LINE(1016)
													...
													HX_STACK_LINE(1016)
													Float tmp28 = p->y;		HX_STACK_VAR(tmp28,"tmp28");
													HX_STACK_LINE(1016)
													Float tmp29 = _this->aabb->miny;		HX_STACK_VAR(tmp29,"tmp29");
													HX_STACK_LINE(1016)
													...
													HX_STACK_LINE(1016)
													Float tmp32 = _this->aabb->maxy;		HX_STACK_VAR(tmp32,"tmp32");
													HX_STACK_LINE(1016)
						...
						if ((tmp14)){
							...
							HX_STACK_LINE(1018)
							::zpp_nape::space::ZPP_Component tmp16 = shape->body->component;		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(1018)
							bool tmp17 = tmp16->sleeping;		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(1018)
							tmp15 = !(tmp17);
						}
						HX_STACK_LINE(1018)
						bool tmp16 = node->dyn = tmp15;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(1018)
						::zpp_nape::space::ZPP_AABBTree tmp17;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(1018)
						if ((tmp16)){
							HX_STACK_LINE(1018)
							tmp17 = this->dtree;
						...
						HX_STACK_LINE(1018)
						::zpp_nape::space::ZPP_AABBTree tree = tmp17;		HX_STACK_VAR(tree,"tree");
						HX_STACK_LINE(1019)
						{
							HX_STACK_LINE(1019)
							bool tmp18 = (tree->root == null());		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(1019)
							if ((tmp18)){
								HX_STACK_LINE(1019)
								tree->root = node;
								...
								while((true)){
									...
									HX_STACK_LINE(1019)
									{
										...
										::zpp_nape::geom::ZPP_AABB _this = node1->aabb;		HX_STACK_VAR(_this,"_this");
										HX_STACK_LINE(1019)
										Float tmp23 = (_this->maxx - _this->minx);		HX_STACK_VAR(tmp23,"tmp23");
										HX_STACK_LINE(1019)
										Float tmp24 = (_this->maxy - _this->miny);		HX_STACK_VAR(tmp24,"tmp24");
										HX_STACK_LINE(1019)
										Float tmp25 = (tmp23 + tmp24);		HX_STACK_VAR(tmp25,"tmp25");
										HX_STACK_LINE(1019)
										tmp22 = (tmp25 * (int)2);
									...
									HX_STACK_LINE(1019)
									Float area = tmp22;		HX_STACK_VAR(area,"area");
									HX_STACK_LINE(1019)
									{
										HX_STACK_LINE(1019)
										...
										::zpp_nape::geom::ZPP_AABB a = node1->aabb;		HX_STACK_VAR(a,"a");
										HX_STACK_LINE(1019)
										bool tmp24 = (a->minx < leafaabb->minx);		HX_STACK_VAR(tmp24,"tmp24");
										HX_STACK_LINE(1019)
										...
										_this->minx = tmp25;
										HX_STACK_LINE(1019)
										bool tmp26 = (a->miny < leafaabb->miny);		HX_STACK_VAR(tmp26,"tmp26");
										HX_STACK_LINE(1019)
										...
										_this->miny = tmp27;
										HX_STACK_LINE(1019)
										bool tmp28 = (a->maxx > leafaabb->maxx);		HX_STACK_VAR(tmp28,"tmp28");
										HX_STACK_LINE(1019)
										Float tmp29;		HX_STACK_VAR(tmp29,"tmp29");
										HX_STACK_LINE(1019)
										if ((tmp28)){
										...
										_this->maxx = tmp29;
										HX_STACK_LINE(1019)
										bool tmp30 = (a->maxy > leafaabb->maxy);		HX_STACK_VAR(tmp30,"tmp30");
										HX_STACK_LINE(1019)
										Float tmp31;		HX_STACK_VAR(tmp31,"tmp31");
										HX_STACK_LINE(1019)
										if ((tmp30)){
									...
									HX_STACK_LINE(1019)
									Float carea = tmp23;		HX_STACK_VAR(carea,"carea");
									HX_STACK_LINE(1019)
									Float tmp24 = ((int)2 * carea);		HX_STACK_VAR(tmp24,"tmp24");
									HX_STACK_LINE(1019)
									Float cost = tmp24;		HX_STACK_VAR(cost,"cost");
									HX_STACK_LINE(1019)
									Float tmp25 = (carea - area);		HX_STACK_VAR(tmp25,"tmp25");
									HX_STACK_LINE(1019)
									Float tmp26 = ((int)2 * tmp25);		HX_STACK_VAR(tmp26,"tmp26");
									HX_STACK_LINE(1019)
									Float icost = tmp26;		HX_STACK_VAR(icost,"icost");
									HX_STACK_LINE(1019)
									Float tmp27;		HX_STACK_VAR(tmp27,"tmp27");
									HX_STACK_LINE(1019)
									{
										...
										{
											HX_STACK_LINE(1019)
											::zpp_nape::geom::ZPP_AABB tmp28 = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;		HX_STACK_VAR(tmp28,"tmp28");
											HX_STACK_LINE(1019)
											::zpp_nape::geom::ZPP_AABB _this = tmp28;		HX_STACK_VAR(_this,"_this");
											HX_STACK_LINE(1019)
											::zpp_nape::geom::ZPP_AABB b = child1->aabb;		HX_STACK_VAR(b,"b");
											HX_STACK_LINE(1019)
											bool tmp29 = (leafaabb->minx < b->minx);		HX_STACK_VAR(tmp29,"tmp29");
											HX_STACK_LINE(1019)
											Float tmp30;		HX_STACK_VAR(tmp30,"tmp30");
											HX_STACK_LINE(1019)
											if ((tmp29)){
											...
											_this->minx = tmp30;
											HX_STACK_LINE(1019)
											bool tmp31 = (leafaabb->miny < b->miny);		HX_STACK_VAR(tmp31,"tmp31");
											HX_STACK_LINE(1019)
											Float tmp32;		HX_STACK_VAR(tmp32,"tmp32");
											HX_STACK_LINE(1019)
											if ((tmp31)){
											...
											_this->miny = tmp32;
											HX_STACK_LINE(1019)
											bool tmp33 = (leafaabb->maxx > b->maxx);		HX_STACK_VAR(tmp33,"tmp33");
											HX_STACK_LINE(1019)
											Float tmp34;		HX_STACK_VAR(tmp34,"tmp34");
											HX_STACK_LINE(1019)
											if ((tmp33)){
											...
											_this->maxx = tmp34;
											HX_STACK_LINE(1019)
											bool tmp35 = (leafaabb->maxy > b->maxy);		HX_STACK_VAR(tmp35,"tmp35");
											HX_STACK_LINE(1019)
										...
										HX_STACK_LINE(1019)
										bool tmp28 = (child1->child1 == null());		HX_STACK_VAR(tmp28,"tmp28");
										HX_STACK_LINE(1019)
										if ((tmp28)){
											HX_STACK_LINE(1019)
											Float tmp29;		HX_STACK_VAR(tmp29,"tmp29");
											...
											HX_STACK_LINE(1019)
											Float tmp30 = icost;		HX_STACK_VAR(tmp30,"tmp30");
											HX_STACK_LINE(1019)
											tmp27 = (tmp29 + tmp30);
										}
										else{
											...
											HX_STACK_LINE(1019)
											{
												...
												HX_STACK_LINE(1019)
												Float tmp30 = (_this->maxx - _this->minx);		HX_STACK_VAR(tmp30,"tmp30");
												HX_STACK_LINE(1019)
												Float tmp31 = (_this->maxy - _this->miny);		HX_STACK_VAR(tmp31,"tmp31");
												HX_STACK_LINE(1019)
												Float tmp32 = (tmp30 + tmp31);		HX_STACK_VAR(tmp32,"tmp32");
												HX_STACK_LINE(1019)
												tmp29 = (tmp32 * (int)2);
											...
											HX_STACK_LINE(1019)
											Float oarea = tmp29;		HX_STACK_VAR(oarea,"oarea");
											HX_STACK_LINE(1019)
											Float tmp30;		HX_STACK_VAR(tmp30,"tmp30");
											HX_STACK_LINE(1019)
											{
											...
											HX_STACK_LINE(1019)
											Float narea = tmp30;		HX_STACK_VAR(narea,"narea");
											HX_STACK_LINE(1019)
											Float tmp31 = (narea - oarea);		HX_STACK_VAR(tmp31,"tmp31");
											HX_STACK_LINE(1019)
									...
									HX_STACK_LINE(1019)
									Float cost1 = tmp27;		HX_STACK_VAR(cost1,"cost1");
									HX_STACK_LINE(1019)
									Float tmp28;		HX_STACK_VAR(tmp28,"tmp28");
									HX_STACK_LINE(1019)
									{
										...
										HX_STACK_LINE(1019)
										bool tmp29 = (child2->child1 == null());		HX_STACK_VAR(tmp29,"tmp29");
										HX_STACK_LINE(1019)
										if ((tmp29)){
											HX_STACK_LINE(1019)
											Float tmp30;		HX_STACK_VAR(tmp30,"tmp30");
									...
									HX_STACK_LINE(1019)
									Float cost2 = tmp28;		HX_STACK_VAR(cost2,"cost2");
									HX_STACK_LINE(1019)
									bool tmp29 = (cost < cost1);		HX_STACK_VAR(tmp29,"tmp29");
									HX_STACK_LINE(1019)
									...
									if ((tmp30)){
										...
										HX_STACK_LINE(1019)
										bool tmp31 = (cost1 < cost2);		HX_STACK_VAR(tmp31,"tmp31");
										HX_STACK_LINE(1019)
										::zpp_nape::space::ZPP_AABBNode tmp32;		HX_STACK_VAR(tmp32,"tmp32");
										HX_STACK_LINE(1019)
										if ((tmp31)){
											HX_STACK_LINE(1019)
											tmp32 = child1;
								...
								{
									HX_STACK_LINE(1019)
									::zpp_nape::space::ZPP_AABBNode tmp19 = ::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool;		HX_STACK_VAR(tmp19,"tmp19");
									HX_STACK_LINE(1019)
									bool tmp20 = (tmp19 == null());		HX_STACK_VAR(tmp20,"tmp20");
									HX_STACK_LINE(1019)
									if ((tmp20)){
										HX_STACK_LINE(1019)
										::zpp_nape::space::ZPP_AABBNode tmp21 = ::zpp_nape::space::ZPP_AABBNode_obj::__new();		HX_STACK_VAR(tmp21,"tmp21");
										HX_STACK_LINE(1019)
										nparent = tmp21;
									}
									else{
									...
									HX_STACK_LINE(1019)
									{
										...
										{
											HX_STACK_LINE(1019)
											::zpp_nape::geom::ZPP_AABB tmp21 = ::zpp_nape::geom::ZPP_AABB_obj::zpp_pool;		HX_STACK_VAR(tmp21,"tmp21");
											HX_STACK_LINE(1019)
											bool tmp22 = (tmp21 == null());		HX_STACK_VAR(tmp22,"tmp22");
											HX_STACK_LINE(1019)
											if ((tmp22)){
												HX_STACK_LINE(1019)
												::zpp_nape::geom::ZPP_AABB tmp23 = ::zpp_nape::geom::ZPP_AABB_obj::__new();		HX_STACK_VAR(tmp23,"tmp23");
												HX_STACK_LINE(1019)
												nparent->aabb = tmp23;
											}
											else{
												...
												nparent->aabb = tmp23;
												HX_STACK_LINE(1019)
												::zpp_nape::geom::ZPP_AABB tmp24 = nparent->aabb->next;		HX_STACK_VAR(tmp24,"tmp24");
												HX_STACK_LINE(1019)
												::zpp_nape::geom::ZPP_AABB_obj::zpp_pool = tmp24;
												HX_STACK_LINE(1019)
								...
								HX_STACK_LINE(1019)
								{
									...
									HX_STACK_LINE(1019)
									bool tmp19 = (leafaabb->minx < b->minx);		HX_STACK_VAR(tmp19,"tmp19");
									HX_STACK_LINE(1019)
									...
									_this->minx = tmp20;
									HX_STACK_LINE(1019)
									bool tmp21 = (leafaabb->miny < b->miny);		HX_STACK_VAR(tmp21,"tmp21");
									HX_STACK_LINE(1019)
									Float tmp22;		HX_STACK_VAR(tmp22,"tmp22");
									HX_STACK_LINE(1019)
									if ((tmp21)){
									...
									_this->miny = tmp22;
									HX_STACK_LINE(1019)
									bool tmp23 = (leafaabb->maxx > b->maxx);		HX_STACK_VAR(tmp23,"tmp23");
									HX_STACK_LINE(1019)
									Float tmp24;		HX_STACK_VAR(tmp24,"tmp24");
									HX_STACK_LINE(1019)
									if ((tmp23)){
									...
									_this->maxx = tmp24;
									HX_STACK_LINE(1019)
									bool tmp25 = (leafaabb->maxy > b->maxy);		HX_STACK_VAR(tmp25,"tmp25");
									HX_STACK_LINE(1019)
									Float tmp26;		HX_STACK_VAR(tmp26,"tmp26");
									HX_STACK_LINE(1019)
									if ((tmp25)){
								...
								HX_STACK_LINE(1019)
								int tmp19 = (sibling->height + (int)1);		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(1019)
								nparent->height = tmp19;
								HX_STACK_LINE(1019)
								bool tmp20 = (oparent != null());		HX_STACK_VAR(tmp20,"tmp20");
								HX_STACK_LINE(1019)
								if ((tmp20)){
									HX_STACK_LINE(1019)
									bool tmp21 = (oparent->child1 == sibling);		HX_STACK_VAR(tmp21,"tmp21");
									HX_STACK_LINE(1019)
									if ((tmp21)){
										HX_STACK_LINE(1019)
								...
								while((true)){
									HX_STACK_LINE(1019)
									bool tmp21 = (node1 != null());		HX_STACK_VAR(tmp21,"tmp21");
									HX_STACK_LINE(1019)
									bool tmp22 = !(tmp21);		HX_STACK_VAR(tmp22,"tmp22");
									HX_STACK_LINE(1019)
									if ((tmp22)){
									...
									HX_STACK_LINE(1019)
									bool tmp23 = (node1->child1 == null());		HX_STACK_VAR(tmp23,"tmp23");
									HX_STACK_LINE(1019)
									...
									HX_STACK_LINE(1019)
									::zpp_nape::space::ZPP_AABBNode tmp26;		HX_STACK_VAR(tmp26,"tmp26");
									HX_STACK_LINE(1019)
									if ((tmp25)){
										HX_STACK_LINE(1019)
										tmp26 = node1;
										...
										::zpp_nape::space::ZPP_AABBNode c = node1->child2;		HX_STACK_VAR(c,"c");
										HX_STACK_LINE(1019)
										int tmp27 = (c->height - b->height);		HX_STACK_VAR(tmp27,"tmp27");
										HX_STACK_LINE(1019)
										int balance = tmp27;		HX_STACK_VAR(balance,"balance");
										HX_STACK_LINE(1019)
										bool tmp28 = (balance > (int)1);		HX_STACK_VAR(tmp28,"tmp28");
										HX_STACK_LINE(1019)
										if ((tmp28)){
											HX_STACK_LINE(1019)
											::zpp_nape::space::ZPP_AABBNode f = c->child1;		HX_STACK_VAR(f,"f");
											...
											node1->parent = c;
											HX_STACK_LINE(1019)
											bool tmp29 = (c->parent != null());		HX_STACK_VAR(tmp29,"tmp29");
											HX_STACK_LINE(1019)
											if ((tmp29)){
												HX_STACK_LINE(1019)
												::zpp_nape::space::ZPP_AABBNode tmp30 = c->parent->child1;		HX_STACK_VAR(tmp30,"tmp30");
												HX_STACK_LINE(1019)
												::zpp_nape::space::ZPP_AABBNode tmp31 = node1;		HX_STACK_VAR(tmp31,"tmp31");
												HX_STACK_LINE(1019)
											...
											HX_STACK_LINE(1019)
											bool tmp30 = (f->height > g->height);		HX_STACK_VAR(tmp30,"tmp30");
											HX_STACK_LINE(1019)
											if ((tmp30)){
												HX_STACK_LINE(1019)
												c->child2 = f;
												...
												HX_STACK_LINE(1019)
												{
													...
													::zpp_nape::geom::ZPP_AABB b1 = g->aabb;		HX_STACK_VAR(b1,"b1");
													HX_STACK_LINE(1019)
													bool tmp31 = (a->minx < b1->minx);		HX_STACK_VAR(tmp31,"tmp31");
													HX_STACK_LINE(1019)
													Float tmp32;		HX_STACK_VAR(tmp32,"tmp32");
													HX_STACK_LINE(1019)
													if ((tmp31)){
													...
													_this->minx = tmp32;
													HX_STACK_LINE(1019)
													bool tmp33 = (a->miny < b1->miny);		HX_STACK_VAR(tmp33,"tmp33");
													HX_STACK_LINE(1019)
													Float tmp34;		HX_STACK_VAR(tmp34,"tmp34");
													HX_STACK_LINE(1019)
													if ((tmp33)){
													...
													_this->miny = tmp34;
													HX_STACK_LINE(1019)
													bool tmp35 = (a->maxx > b1->maxx);		HX_STACK_VAR(tmp35,"tmp35");
													HX_STACK_LINE(1019)
													Float tmp36;		HX_STACK_VAR(tmp36,"tmp36");
													HX_STACK_LINE(1019)
													if ((tmp35)){
													...
													_this->maxx = tmp36;
													HX_STACK_LINE(1019)
													bool tmp37 = (a->maxy > b1->maxy);		HX_STACK_VAR(tmp37,"tmp37");
													HX_STACK_LINE(1019)
											...
											if ((tmp29)){
												...
												node1->parent = b;
												HX_STACK_LINE(1019)
												bool tmp30 = (b->parent != null());		HX_STACK_VAR(tmp30,"tmp30");
												HX_STACK_LINE(1019)
												if ((tmp30)){
													HX_STACK_LINE(1019)
													::zpp_nape::space::ZPP_AABBNode tmp31 = b->parent->child1;		HX_STACK_VAR(tmp31,"tmp31");
													HX_STACK_LINE(1019)
									...
									HX_STACK_LINE(1019)
									{
										...
										::zpp_nape::geom::ZPP_AABB b = child2->aabb;		HX_STACK_VAR(b,"b");
										HX_STACK_LINE(1019)
										bool tmp29 = (a->minx < b->minx);		HX_STACK_VAR(tmp29,"tmp29");
										HX_STACK_LINE(1019)
										Float tmp30;		HX_STACK_VAR(tmp30,"tmp30");
										HX_STACK_LINE(1019)
										if ((tmp29)){
										...
										_this->minx = tmp30;
										HX_STACK_LINE(1019)
										bool tmp31 = (a->miny < b->miny);		HX_STACK_VAR(tmp31,"tmp31");
										HX_STACK_LINE(1019)
										Float tmp32;		HX_STACK_VAR(tmp32,"tmp32");
										HX_STACK_LINE(1019)
										if ((tmp31)){
										...
										_this->miny = tmp32;
										HX_STACK_LINE(1019)
										bool tmp33 = (a->maxx > b->maxx);		HX_STACK_VAR(tmp33,"tmp33");
										HX_STACK_LINE(1019)
										Float tmp34;		HX_STACK_VAR(tmp34,"tmp34");
										HX_STACK_LINE(1019)
										if ((tmp33)){
										...
										_this->maxx = tmp34;
										HX_STACK_LINE(1019)
										bool tmp35 = (a->maxy > b->maxy);		HX_STACK_VAR(tmp35,"tmp35");
										HX_STACK_LINE(1019)
										Float tmp36;		HX_STACK_VAR(tmp36,"tmp36");
										HX_STACK_LINE(1019)
										if ((tmp35)){
						...
						if ((tmp13)){
							...
							if ((tmp14)){
								...
								if ((tmp15)){
									...
									shape->zip_aabb = false;
									HX_STACK_LINE(1081)
									bool tmp16 = (shape->type == (int)0);		HX_STACK_VAR(tmp16,"tmp16");
									HX_STACK_LINE(1081)
									if ((tmp16)){
										HX_STACK_LINE(1081)
										::zpp_nape::shape::ZPP_Circle _this = shape->circle;		HX_STACK_VAR(_this,"_this");
												...
												if ((tmp18)){
													...
													HX_STACK_LINE(1081)
													{
														...
														if ((tmp19)){
															...
															_this->zip_localCOM = false;
															HX_STACK_LINE(1081)
															bool tmp20 = (_this->type == (int)1);		HX_STACK_VAR(tmp20,"tmp20");
															HX_STACK_LINE(1081)
															if ((tmp20)){
																HX_STACK_LINE(1081)
																::zpp_nape::shape::ZPP_Polygon _this1 = _this->polygon;		HX_STACK_VAR(_this1,"_this1");
										...
										HX_STACK_LINE(1081)
										{
											...
											::zpp_nape::geom::ZPP_Vec2 tmp20 = _this->gverts->next;		HX_STACK_VAR(tmp20,"tmp20");
											HX_STACK_LINE(1081)
											::zpp_nape::geom::ZPP_Vec2 cx_ite = tmp20->next;		HX_STACK_VAR(cx_ite,"cx_ite");
											HX_STACK_LINE(1081)
											while((true)){
												HX_STACK_LINE(1081)
												bool tmp21 = (cx_ite != null());		HX_STACK_VAR(tmp21,"tmp21");
...
Void ZPP_DynAABBPhase_obj::broadphase( ::zpp_nape::space::ZPP_Space space,bool discrete){
{
		...
		while((true)){
			...
			HX_STACK_LINE(1109)
			{
				...
				if ((tmp6)){
					...
					if ((tmp7)){
						...
						if ((tmp8)){
							...
							shape->zip_aabb = false;
							HX_STACK_LINE(1133)
							bool tmp9 = (shape->type == (int)0);		HX_STACK_VAR(tmp9,"tmp9");
							HX_STACK_LINE(1133)
							if ((tmp9)){
								HX_STACK_LINE(1133)
								::zpp_nape::shape::ZPP_Circle _this = shape->circle;		HX_STACK_VAR(_this,"_this");
										...
										if ((tmp11)){
											...
											HX_STACK_LINE(1133)
											{
												...
												if ((tmp12)){
													...
													_this->zip_localCOM = false;
													HX_STACK_LINE(1133)
													bool tmp13 = (_this->type == (int)1);		HX_STACK_VAR(tmp13,"tmp13");
													HX_STACK_LINE(1133)
													if ((tmp13)){
														HX_STACK_LINE(1133)
														::zpp_nape::shape::ZPP_Polygon _this1 = _this->polygon;		HX_STACK_VAR(_this1,"_this1");
				...
				HX_STACK_LINE(1135)
				bool tmp10 = node->dyn = tmp9;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(1135)
				::zpp_nape::space::ZPP_AABBTree tmp11;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(1135)
				if ((tmp10)){
				...
				{
					HX_STACK_LINE(1136)
					bool tmp12 = (tree->root == null());		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(1136)
					if ((tmp12)){
						HX_STACK_LINE(1136)
						tree->root = node;
						...
						while((true)){
							HX_STACK_LINE(1136)
							bool tmp13 = (node1->child1 == null());		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(1136)
							bool tmp14 = !(tmp13);		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(1136)
							bool tmp15 = !(tmp14);		HX_STACK_VAR(tmp15,"tmp15");
							...
							HX_STACK_LINE(1136)
							Float area = tmp16;		HX_STACK_VAR(area,"area");
							HX_STACK_LINE(1136)
							{
								HX_STACK_LINE(1136)
								::zpp_nape::geom::ZPP_AABB tmp17 = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;		HX_STACK_VAR(tmp17,"tmp17");
								HX_STACK_LINE(1136)
								::zpp_nape::geom::ZPP_AABB _this = tmp17;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(1136)
								::zpp_nape::geom::ZPP_AABB a = node1->aabb;		HX_STACK_VAR(a,"a");
								HX_STACK_LINE(1136)
								bool tmp18 = (a->minx < leafaabb->minx);		HX_STACK_VAR(tmp18,"tmp18");
								HX_STACK_LINE(1136)
								Float tmp19;		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(1136)
								if ((tmp18)){
								...
								_this->minx = tmp19;
								HX_STACK_LINE(1136)
								bool tmp20 = (a->miny < leafaabb->miny);		HX_STACK_VAR(tmp20,"tmp20");
								HX_STACK_LINE(1136)
								Float tmp21;		HX_STACK_VAR(tmp21,"tmp21");
								HX_STACK_LINE(1136)
								if ((tmp20)){
								...
								_this->miny = tmp21;
								HX_STACK_LINE(1136)
								bool tmp22 = (a->maxx > leafaabb->maxx);		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(1136)
								Float tmp23;		HX_STACK_VAR(tmp23,"tmp23");
								HX_STACK_LINE(1136)
								if ((tmp22)){
								...
								_this->maxx = tmp23;
								HX_STACK_LINE(1136)
								bool tmp24 = (a->maxy > leafaabb->maxy);		HX_STACK_VAR(tmp24,"tmp24");
								HX_STACK_LINE(1136)
								Float tmp25;		HX_STACK_VAR(tmp25,"tmp25");
								HX_STACK_LINE(1136)
								if ((tmp24)){
							...
							HX_STACK_LINE(1136)
							{
								...
								HX_STACK_LINE(1136)
								Float tmp19 = (_this->maxx - _this->minx);		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(1136)
								Float tmp20 = (_this->maxy - _this->miny);		HX_STACK_VAR(tmp20,"tmp20");
								HX_STACK_LINE(1136)
								Float tmp21 = (tmp19 + tmp20);		HX_STACK_VAR(tmp21,"tmp21");
								HX_STACK_LINE(1136)
								tmp17 = (tmp21 * (int)2);
							...
							HX_STACK_LINE(1136)
							Float carea = tmp17;		HX_STACK_VAR(carea,"carea");
							HX_STACK_LINE(1136)
							Float tmp18 = ((int)2 * carea);		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(1136)
							Float cost = tmp18;		HX_STACK_VAR(cost,"cost");
							HX_STACK_LINE(1136)
							Float tmp19 = (carea - area);		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(1136)
							Float tmp20 = ((int)2 * tmp19);		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(1136)
							Float icost = tmp20;		HX_STACK_VAR(icost,"icost");
							HX_STACK_LINE(1136)
							Float tmp21;		HX_STACK_VAR(tmp21,"tmp21");
							HX_STACK_LINE(1136)
							{
								...
								{
									HX_STACK_LINE(1136)
									::zpp_nape::geom::ZPP_AABB tmp22 = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;		HX_STACK_VAR(tmp22,"tmp22");
									HX_STACK_LINE(1136)
									::zpp_nape::geom::ZPP_AABB _this = tmp22;		HX_STACK_VAR(_this,"_this");
									HX_STACK_LINE(1136)
									::zpp_nape::geom::ZPP_AABB b = child1->aabb;		HX_STACK_VAR(b,"b");
									HX_STACK_LINE(1136)
									bool tmp23 = (leafaabb->minx < b->minx);		HX_STACK_VAR(tmp23,"tmp23");
									HX_STACK_LINE(1136)
									Float tmp24;		HX_STACK_VAR(tmp24,"tmp24");
									HX_STACK_LINE(1136)
									if ((tmp23)){
									...
									_this->minx = tmp24;
									HX_STACK_LINE(1136)
									bool tmp25 = (leafaabb->miny < b->miny);		HX_STACK_VAR(tmp25,"tmp25");
									HX_STACK_LINE(1136)
									Float tmp26;		HX_STACK_VAR(tmp26,"tmp26");
									HX_STACK_LINE(1136)
									if ((tmp25)){
									...
									_this->miny = tmp26;
									HX_STACK_LINE(1136)
									bool tmp27 = (leafaabb->maxx > b->maxx);		HX_STACK_VAR(tmp27,"tmp27");
									HX_STACK_LINE(1136)
									Float tmp28;		HX_STACK_VAR(tmp28,"tmp28");
									HX_STACK_LINE(1136)
									if ((tmp27)){
									...
									_this->maxx = tmp28;
									HX_STACK_LINE(1136)
									bool tmp29 = (leafaabb->maxy > b->maxy);		HX_STACK_VAR(tmp29,"tmp29");
									HX_STACK_LINE(1136)
									Float tmp30;		HX_STACK_VAR(tmp30,"tmp30");
									HX_STACK_LINE(1136)
									if ((tmp29)){
								...
								HX_STACK_LINE(1136)
								bool tmp22 = (child1->child1 == null());		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(1136)
								if ((tmp22)){
									HX_STACK_LINE(1136)
									Float tmp23;		HX_STACK_VAR(tmp23,"tmp23");
									...
									HX_STACK_LINE(1136)
									Float tmp24 = icost;		HX_STACK_VAR(tmp24,"tmp24");
									HX_STACK_LINE(1136)
									tmp21 = (tmp23 + tmp24);
								}
								else{
									...
									HX_STACK_LINE(1136)
									Float oarea = tmp23;		HX_STACK_VAR(oarea,"oarea");
									HX_STACK_LINE(1136)
									Float tmp24;		HX_STACK_VAR(tmp24,"tmp24");
									HX_STACK_LINE(1136)
									{
									...
									HX_STACK_LINE(1136)
									Float narea = tmp24;		HX_STACK_VAR(narea,"narea");
									HX_STACK_LINE(1136)
									Float tmp25 = (narea - oarea);		HX_STACK_VAR(tmp25,"tmp25");
									HX_STACK_LINE(1136)
							...
							HX_STACK_LINE(1136)
							Float cost1 = tmp21;		HX_STACK_VAR(cost1,"cost1");
							HX_STACK_LINE(1136)
							Float tmp22;		HX_STACK_VAR(tmp22,"tmp22");
							HX_STACK_LINE(1136)
							{
								...
								HX_STACK_LINE(1136)
								bool tmp23 = (child2->child1 == null());		HX_STACK_VAR(tmp23,"tmp23");
								HX_STACK_LINE(1136)
								if ((tmp23)){
									HX_STACK_LINE(1136)
									Float tmp24;		HX_STACK_VAR(tmp24,"tmp24");
							...
							HX_STACK_LINE(1136)
							Float cost2 = tmp22;		HX_STACK_VAR(cost2,"cost2");
							HX_STACK_LINE(1136)
							bool tmp23 = (cost < cost1);		HX_STACK_VAR(tmp23,"tmp23");
							HX_STACK_LINE(1136)
							...
							if ((tmp24)){
								...
								HX_STACK_LINE(1136)
								bool tmp25 = (cost1 < cost2);		HX_STACK_VAR(tmp25,"tmp25");
								HX_STACK_LINE(1136)
								::zpp_nape::space::ZPP_AABBNode tmp26;		HX_STACK_VAR(tmp26,"tmp26");
								HX_STACK_LINE(1136)
								if ((tmp25)){
						...
						{
							HX_STACK_LINE(1136)
							::zpp_nape::space::ZPP_AABBNode tmp13 = ::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(1136)
							bool tmp14 = (tmp13 == null());		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(1136)
							if ((tmp14)){
								HX_STACK_LINE(1136)
								::zpp_nape::space::ZPP_AABBNode tmp15 = ::zpp_nape::space::ZPP_AABBNode_obj::__new();		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(1136)
								nparent = tmp15;
							}
							else{
								HX_STACK_LINE(1136)
								::zpp_nape::space::ZPP_AABBNode tmp15 = ::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool;		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(1136)
								nparent = tmp15;
								HX_STACK_LINE(1136)
								::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool = nparent->next;
							...
							HX_STACK_LINE(1136)
							{
								...
								{
									HX_STACK_LINE(1136)
									::zpp_nape::geom::ZPP_AABB tmp15 = ::zpp_nape::geom::ZPP_AABB_obj::zpp_pool;		HX_STACK_VAR(tmp15,"tmp15");
									HX_STACK_LINE(1136)
									bool tmp16 = (tmp15 == null());		HX_STACK_VAR(tmp16,"tmp16");
									HX_STACK_LINE(1136)
									if ((tmp16)){
										HX_STACK_LINE(1136)
										::zpp_nape::geom::ZPP_AABB tmp17 = ::zpp_nape::geom::ZPP_AABB_obj::__new();		HX_STACK_VAR(tmp17,"tmp17");
										HX_STACK_LINE(1136)
										nparent->aabb = tmp17;
									}
									else{
										...
										nparent->aabb = tmp17;
										HX_STACK_LINE(1136)
										::zpp_nape::geom::ZPP_AABB tmp18 = nparent->aabb->next;		HX_STACK_VAR(tmp18,"tmp18");
										HX_STACK_LINE(1136)
										::zpp_nape::geom::ZPP_AABB_obj::zpp_pool = tmp18;
										HX_STACK_LINE(1136)
										nparent->aabb->next = null();
									}
									HX_STACK_LINE(1136)
						...
						HX_STACK_LINE(1136)
						int tmp13 = (sibling->height + (int)1);		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(1136)
						nparent->height = tmp13;
						HX_STACK_LINE(1136)
						bool tmp14 = (oparent != null());		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(1136)
						if ((tmp14)){
							HX_STACK_LINE(1136)
							bool tmp15 = (oparent->child1 == sibling);		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(1136)
							if ((tmp15)){
								HX_STACK_LINE(1136)
								oparent->child1 = nparent;
						...
						while((true)){
							HX_STACK_LINE(1136)
							bool tmp15 = (node1 != null());		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(1136)
							...
							HX_STACK_LINE(1136)
							::zpp_nape::space::ZPP_AABBNode tmp20;		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(1136)
							if ((tmp19)){
								HX_STACK_LINE(1136)
								tmp20 = node1;
								...
								::zpp_nape::space::ZPP_AABBNode c = node1->child2;		HX_STACK_VAR(c,"c");
								HX_STACK_LINE(1136)
								int tmp21 = (c->height - b->height);		HX_STACK_VAR(tmp21,"tmp21");
								HX_STACK_LINE(1136)
								int balance = tmp21;		HX_STACK_VAR(balance,"balance");
								HX_STACK_LINE(1136)
								bool tmp22 = (balance > (int)1);		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(1136)
								if ((tmp22)){
									HX_STACK_LINE(1136)
									::zpp_nape::space::ZPP_AABBNode f = c->child1;		HX_STACK_VAR(f,"f");
									...
									node1->parent = c;
									HX_STACK_LINE(1136)
									bool tmp23 = (c->parent != null());		HX_STACK_VAR(tmp23,"tmp23");
									HX_STACK_LINE(1136)
									if ((tmp23)){
										HX_STACK_LINE(1136)
										::zpp_nape::space::ZPP_AABBNode tmp24 = c->parent->child1;		HX_STACK_VAR(tmp24,"tmp24");
										HX_STACK_LINE(1136)
										::zpp_nape::space::ZPP_AABBNode tmp25 = node1;		HX_STACK_VAR(tmp25,"tmp25");
										HX_STACK_LINE(1136)
									...
									HX_STACK_LINE(1136)
									bool tmp24 = (f->height > g->height);		HX_STACK_VAR(tmp24,"tmp24");
									HX_STACK_LINE(1136)
									if ((tmp24)){
										HX_STACK_LINE(1136)
										c->child2 = f;
										...
										HX_STACK_LINE(1136)
										{
											...
											::zpp_nape::geom::ZPP_AABB b1 = g->aabb;		HX_STACK_VAR(b1,"b1");
											HX_STACK_LINE(1136)
											bool tmp25 = (a->minx < b1->minx);		HX_STACK_VAR(tmp25,"tmp25");
											HX_STACK_LINE(1136)
											Float tmp26;		HX_STACK_VAR(tmp26,"tmp26");
											HX_STACK_LINE(1136)
											if ((tmp25)){
											...
											_this->minx = tmp26;
											HX_STACK_LINE(1136)
											bool tmp27 = (a->miny < b1->miny);		HX_STACK_VAR(tmp27,"tmp27");
											HX_STACK_LINE(1136)
											Float tmp28;		HX_STACK_VAR(tmp28,"tmp28");
											HX_STACK_LINE(1136)
											if ((tmp27)){
											...
											_this->miny = tmp28;
											HX_STACK_LINE(1136)
											bool tmp29 = (a->maxx > b1->maxx);		HX_STACK_VAR(tmp29,"tmp29");
											HX_STACK_LINE(1136)
											Float tmp30;		HX_STACK_VAR(tmp30,"tmp30");
											HX_STACK_LINE(1136)
											if ((tmp29)){
											...
											_this->maxx = tmp30;
											HX_STACK_LINE(1136)
											bool tmp31 = (a->maxy > b1->maxy);		HX_STACK_VAR(tmp31,"tmp31");
											HX_STACK_LINE(1136)
											Float tmp32;		HX_STACK_VAR(tmp32,"tmp32");
											HX_STACK_LINE(1136)
											if ((tmp31)){
									...
									if ((tmp23)){
										...
										node1->parent = b;
										HX_STACK_LINE(1136)
										bool tmp24 = (b->parent != null());		HX_STACK_VAR(tmp24,"tmp24");
										HX_STACK_LINE(1136)
										if ((tmp24)){
											HX_STACK_LINE(1136)
											::zpp_nape::space::ZPP_AABBNode tmp25 = b->parent->child1;		HX_STACK_VAR(tmp25,"tmp25");
											HX_STACK_LINE(1136)
							...
							HX_STACK_LINE(1136)
							{
								...
								int y = child2->height;		HX_STACK_VAR(y,"y");
								HX_STACK_LINE(1136)
								bool tmp22 = (x > y);		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(1136)
								if ((tmp22)){
									HX_STACK_LINE(1136)
									tmp21 = x;
							...
							HX_STACK_LINE(1136)
							int tmp22 = ((int)1 + tmp21);		HX_STACK_VAR(tmp22,"tmp22");
							HX_STACK_LINE(1136)
							node1->height = tmp22;
							HX_STACK_LINE(1136)
							{
				...
				while((true)){
					...
					if ((tmp15)){
						...
						if ((tmp16)){
							...
							if ((tmp23)){
								HX_STACK_LINE(1203)
								int tmp24 = lshape->body->type;		HX_STACK_VAR(tmp24,"tmp24");
								HX_STACK_LINE(1203)
		...
		while((true)){
			...
			if ((tmp12)){
				...
				if ((tmp13)){
					...
					HX_STACK_LINE(1862)
					bool tmp16 = (b1->type == (int)2);		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(1862)
					...
					if ((tmp19)){
						HX_STACK_LINE(1862)
						bool tmp21 = (b2->type == (int)2);		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(1862)
						bool tmp22 = tmp21;		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(1862)
						bool tmp23 = tmp22;		HX_STACK_VAR(tmp23,"tmp23");
					...
					HX_STACK_LINE(1862)
					::zpp_nape::dynamics::ZPP_Arbiter tmp21 = cur->arb;		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(1862)
					::zpp_nape::dynamics::ZPP_Arbiter tmp22 = space->narrowPhase(tmp14,tmp15,tmp20,tmp21,false);		HX_STACK_VAR(tmp22,"tmp22");
					HX_STACK_LINE(1862)
					cur->arb = tmp22;
				}
				else{
					...
					::zpp_nape::dynamics::ZPP_Arbiter tmp21 = cur->arb;		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(1863)
					::zpp_nape::dynamics::ZPP_Arbiter tmp22 = space->continuousEvent(tmp14,tmp15,tmp20,tmp21,false);		HX_STACK_VAR(tmp22,"tmp22");
					HX_STACK_LINE(1863)
					cur->arb = tmp22;
				}
				HX_STACK_LINE(1864)
				...
				if ((tmp18)){
					...
					if ((tmp19)){
						...
						if ((tmp22)){
							...
							if ((tmp24)){
								HX_STACK_LINE(1956)
								::zpp_nape::shape::ZPP_Circle tmp25 = node->shape->circle;		HX_STACK_VAR(tmp25,"tmp25");
								HX_STACK_LINE(1956)
								::zpp_nape::geom::ZPP_Vec2 tmp26 = v;		HX_STACK_VAR(tmp26,"tmp26");
								HX_STACK_LINE(1956)
								bool tmp27 = ::zpp_nape::geom::ZPP_Collide_obj::circleContains(tmp25,tmp26);		HX_STACK_VAR(tmp27,"tmp27");
								HX_STACK_LINE(1956)
								if ((tmp27)){
									HX_STACK_LINE(1956)
									::nape::shape::Shape tmp28 = node->shape->outer;		HX_STACK_VAR(tmp28,"tmp28");
									HX_STACK_LINE(1956)
									ret->push(tmp28);
								}
							}
								...
								HX_STACK_LINE(1959)
								::zpp_nape::shape::ZPP_Polygon tmp25 = node->shape->polygon;		HX_STACK_VAR(tmp25,"tmp25");
								HX_STACK_LINE(1959)
								::zpp_nape::geom::ZPP_Vec2 tmp26 = v;		HX_STACK_VAR(tmp26,"tmp26");
								HX_STACK_LINE(1959)
								bool tmp27 = ::zpp_nape::geom::ZPP_Collide_obj::polyContains(tmp25,tmp26);		HX_STACK_VAR(tmp27,"tmp27");
								HX_STACK_LINE(1959)
								if ((tmp27)){
									HX_STACK_LINE(1959)
									::nape::shape::Shape tmp28 = node->shape->outer;		HX_STACK_VAR(tmp28,"tmp28");
					...
					if ((tmp19)){
						...
						if ((tmp23)){
							...
							if ((tmp26)){
								...
								if ((tmp28)){
									HX_STACK_LINE(2055)
									::zpp_nape::shape::ZPP_Circle tmp29 = node->shape->circle;		HX_STACK_VAR(tmp29,"tmp29");
									HX_STACK_LINE(2055)
									::zpp_nape::geom::ZPP_Vec2 tmp30 = v;		HX_STACK_VAR(tmp30,"tmp30");
									HX_STACK_LINE(2055)
									bool tmp31 = ::zpp_nape::geom::ZPP_Collide_obj::circleContains(tmp29,tmp30);		HX_STACK_VAR(tmp31,"tmp31");
									HX_STACK_LINE(2055)
									if ((tmp31)){
										HX_STACK_LINE(2055)
									...
									HX_STACK_LINE(2058)
									::zpp_nape::shape::ZPP_Polygon tmp29 = node->shape->polygon;		HX_STACK_VAR(tmp29,"tmp29");
									HX_STACK_LINE(2058)
									::zpp_nape::geom::ZPP_Vec2 tmp30 = v;		HX_STACK_VAR(tmp30,"tmp30");
									HX_STACK_LINE(2058)
									bool tmp31 = ::zpp_nape::geom::ZPP_Collide_obj::polyContains(tmp29,tmp30);		HX_STACK_VAR(tmp31,"tmp31");
									HX_STACK_LINE(2058)
									if ((tmp31)){
										HX_STACK_LINE(2058)
										::nape::phys::Body tmp32 = body;		HX_STACK_VAR(tmp32,"tmp32");
...
::nape::geom::RayResult ZPP_DynAABBPhase_obj::rayCast( ::zpp_nape::geom::ZPP_Ray ray,bool inner,::zpp_nape::dynamics::ZPP_InteractionFilter filter){
	...
	while((true)){
		...
		if ((tmp10)){
			...
			if ((tmp13)){
				HX_STACK_LINE(2883)
				bool tmp14 = (shape->type == (int)0);		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(2883)
				::nape::geom::RayResult tmp15;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(2883)
				if ((tmp14)){
					HX_STACK_LINE(2883)
					::zpp_nape::shape::ZPP_Circle tmp16 = shape->circle;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(2883)
					...
					HX_STACK_LINE(2883)
					::zpp_nape::geom::ZPP_AABB tmp16 = shape->aabb;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(2883)
					bool tmp17 = ray->aabbtest(tmp16);		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(2883)
					if ((tmp17)){
						HX_STACK_LINE(2883)
						::zpp_nape::shape::ZPP_Polygon tmp18 = shape->polygon;		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(2883)
						bool tmp19 = inner;		HX_STACK_VAR(tmp19,"tmp19");
						HX_STACK_LINE(2883)
						Float tmp20 = mint;		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(2883)
						tmp15 = ray->polysect(tmp18,tmp19,tmp20);
					}
					else{
						HX_STACK_LINE(2884)
						tmp15 = null();
...
::nape::geom::RayResultList ZPP_DynAABBPhase_obj::rayMultiCast( ::zpp_nape::geom::ZPP_Ray ray,bool inner,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::geom::RayResultList output){
	...
	while((true)){
		...
		if ((tmp14)){
			...
			if ((tmp17)){
				HX_STACK_LINE(2983)
				bool tmp18 = (shape->type == (int)0);		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(2983)
				if ((tmp18)){
					HX_STACK_LINE(2983)
					...
					HX_STACK_LINE(2983)
					::nape::geom::RayResultList tmp21 = ret;		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(2983)
					ray->circlesect2(tmp19,tmp20,tmp21);
				}
				else{
					HX_STACK_LINE(2984)
					::zpp_nape::geom::ZPP_AABB tmp19 = shape->aabb;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(2984)
					bool tmp20 = ray->aabbtest(tmp19);		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(2984)
					if ((tmp20)){
						HX_STACK_LINE(2984)
						::zpp_nape::shape::ZPP_Polygon tmp21 = shape->polygon;		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(2984)
						bool tmp22 = inner;		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(2984)
						::nape::geom::RayResultList tmp23 = ret;		HX_STACK_VAR(tmp23,"tmp23");
						HX_STACK_LINE(2984)
						ray->polysect2(tmp21,tmp22,tmp23);
					}
				}
			}
		}
