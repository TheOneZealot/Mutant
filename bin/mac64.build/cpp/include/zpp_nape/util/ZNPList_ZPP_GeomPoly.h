...
class HXCPP_CLASS_ATTRIBUTES  ZNPList_ZPP_GeomPoly_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPList_ZPP_GeomPoly")
		...
		::String __ToString() const { return HX_HCSTRING("ZNPList_ZPP_GeomPoly","\x92","\xf3","\xdb","\x41"); }
