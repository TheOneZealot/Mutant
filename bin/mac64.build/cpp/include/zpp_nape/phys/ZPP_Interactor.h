...
class HXCPP_CLASS_ATTRIBUTES  ZPP_Interactor_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="zpp_nape.phys.ZPP_Interactor")
		...
		::String __ToString() const { return HX_HCSTRING("ZPP_Interactor","\xfe","\x60","\x93","\x17"); }
