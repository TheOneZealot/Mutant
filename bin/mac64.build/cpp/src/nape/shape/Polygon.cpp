	...
	HX_STACK_ARG(weak,"weak")
{
		...
		HX_STACK_LINE(213)
		return Array_obj< ::Dynamic >::__new().Add(tmp9).Add(tmp10).Add(tmp11).Add(tmp12);
	}
}
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		HX_STACK_LINE(235)
		return ::nape::shape::Polygon_obj::rect(tmp5,tmp8,tmp9,tmp10,tmp11);
	}
}
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		HX_STACK_LINE(262)
		int tmp8 = edgeCount;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(262)
		Float tmp9 = (Float(tmp7) / Float(tmp8));		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(262)
		Float dangle = tmp9;		HX_STACK_VAR(dangle,"dangle");
		HX_STACK_LINE(263)
		{
			HX_STACK_LINE(263)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
			...
			while((true)){
				HX_STACK_LINE(263)
				bool tmp10 = (_g < edgeCount);		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(263)
				bool tmp11 = !(tmp10);		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(263)
				if ((tmp11)){
				...
				HX_STACK_LINE(264)
				Float tmp13 = (i * dangle);		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(264)
				Float tmp14 = angleOffset;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(264)
				Float tmp15 = (tmp13 + tmp14);		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(264)
				Float ang = tmp15;		HX_STACK_VAR(ang,"ang");
				HX_STACK_LINE(265)
				::nape::geom::Vec2 tmp16;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(265)
				{
					HX_STACK_LINE(265)
					Float tmp17 = ang;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(265)
					Float tmp18 = ::Math_obj::cos(tmp17);		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(265)
					Float tmp19 = xRadius;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(265)
					Float tmp20 = (tmp18 * tmp19);		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(265)
					Float x = tmp20;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(265)
					Float tmp21 = ang;		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(265)
					Float tmp22 = ::Math_obj::sin(tmp21);		HX_STACK_VAR(tmp22,"tmp22");
					HX_STACK_LINE(265)
					Float tmp23 = yRadius;		HX_STACK_VAR(tmp23,"tmp23");
					HX_STACK_LINE(265)
					...
					HX_STACK_LINE(265)
					{
						...
						if ((tmp29)){
							...
							ret1->zpp_disp = false;
							HX_STACK_LINE(265)
							::nape::geom::Vec2 tmp31 = ret1;		HX_STACK_VAR(tmp31,"tmp31");
							HX_STACK_LINE(265)
							::nape::geom::Vec2 tmp32 = ::zpp_nape::util::ZPP_PubPool_obj::nextVec2;		HX_STACK_VAR(tmp32,"tmp32");
							HX_STACK_LINE(265)
					...
					HX_STACK_LINE(265)
					bool tmp28 = (ret1->zpp_inner == null());		HX_STACK_VAR(tmp28,"tmp28");
					HX_STACK_LINE(265)
					if ((tmp28)){
						HX_STACK_LINE(265)
						...
						HX_STACK_LINE(265)
						{
							...
							HX_STACK_LINE(265)
							bool tmp29 = _this->_immutable;		HX_STACK_VAR(tmp29,"tmp29");
							HX_STACK_LINE(265)
							if ((tmp29)){
								HX_STACK_LINE(265)
								HX_STACK_DO_THROW(HX_HCSTRING("Error: Vec2 is immutable","\x60","\xee","\x1f","\xbc"));
							...
							HX_STACK_LINE(265)
							bool tmp30 = (_this->_isimmutable != null());		HX_STACK_VAR(tmp30,"tmp30");
							HX_STACK_LINE(265)
							if ((tmp30)){
								HX_STACK_LINE(265)
								_this->_isimmutable();
						...
						HX_STACK_LINE(265)
						bool tmp29 = (x != x);		HX_STACK_VAR(tmp29,"tmp29");
						HX_STACK_LINE(265)
						bool tmp30 = !(tmp29);		HX_STACK_VAR(tmp30,"tmp30");
						HX_STACK_LINE(265)
						...
						if ((tmp34)){
							...
							HX_STACK_LINE(265)
							{
								...
								HX_STACK_LINE(265)
								Float tmp37 = ret1->zpp_inner->y;		HX_STACK_VAR(tmp37,"tmp37");
								HX_STACK_LINE(265)
								tmp36 = tmp37;
							}
							HX_STACK_LINE(265)
						...
						if ((tmp36)){
							...
							HX_STACK_LINE(265)
							{
								...
								if ((tmp37)){
									HX_STACK_LINE(265)
									::zpp_nape::geom::ZPP_Vec2 tmp38 = _this;		HX_STACK_VAR(tmp38,"tmp38");
									HX_STACK_LINE(265)
									_this->_invalidate(tmp38);
								}
							}
						}
						HX_STACK_LINE(265)
				...
				HX_STACK_LINE(265)
				::nape::geom::Vec2 x = tmp16;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(266)
				::nape::geom::Vec2 tmp17 = x;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(266)
				ret->push(tmp17);
			}
		}
