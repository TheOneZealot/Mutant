...
::String InteractionCallback_obj::toString( ){
	...
	HX_STACK_LINE(225)
	::String tmp2 = Array_obj< ::String >::__new().Add(HX_HCSTRING("BEGIN","\x09","\x22","\x44","\x2e")).Add(HX_HCSTRING("END","\xbb","\x9f","\x34","\x00")).Add(HX_HCSTRING("","\x00","\x00","\x00","\x00")).Add(HX_HCSTRING("","\x00","\x00","\x00","\x00")).Add(HX_HCSTRING("","\x00","\x00","\x00","\x00")).Add(HX_HCSTRING("","\x00","\x00","\x00","\x00")).Add(HX_HCSTRING("ONGOING","\x1b","\x7e","\xd8","\x1a"))->__get(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(225)
	hx::AddEq(ret,tmp2);
	HX_STACK_LINE(226)
	::zpp_nape::callbacks::ZPP_Callback tmp3 = this->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(226)
	::nape::phys::Interactor tmp4 = tmp3->int1->outer_i;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(226)
	::String tmp5 = tmp4->toString();		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(226)
	::String tmp6 = (HX_HCSTRING(":","\x3a","\x00","\x00","\x00") + tmp5);		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(226)
	...
	HX_STACK_LINE(226)
	::nape::phys::Interactor tmp9 = tmp8->int2->outer_i;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(226)
	...
	hx::AddEq(ret,tmp11);
	HX_STACK_LINE(227)
	::zpp_nape::callbacks::ZPP_Callback tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(227)
	::String tmp13 = tmp12->wrap_arbiters->toString();		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(227)
	::String tmp14 = (HX_HCSTRING(" : ","\xc6","\x7a","\x18","\x00") + tmp13);		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(227)
	hx::AddEq(ret,tmp14);
	HX_STACK_LINE(228)
	::zpp_nape::callbacks::ZPP_Callback tmp15 = this->zpp_inner;		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(228)
	::nape::callbacks::Listener tmp16 = tmp15->listener->outer;		HX_STACK_VAR(tmp16,"tmp16");
	HX_STACK_LINE(228)
	::String tmp17 = ::Std_obj::string(tmp16);		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(228)
	::String tmp18 = (HX_HCSTRING(" : listener: ","\x60","\x26","\x46","\xe2") + tmp17);		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(228)
	hx::AddEq(ret,tmp18);
	HX_STACK_LINE(229)
	::String tmp19 = ret;		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(229)
	return tmp19;
}
