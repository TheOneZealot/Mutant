...
class HXCPP_CLASS_ATTRIBUTES  ZPP_Flags_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="zpp_nape.util.ZPP_Flags")
		...
		::String __ToString() const { return HX_HCSTRING("ZPP_Flags","\xc2","\x92","\xf8","\x98"); }
