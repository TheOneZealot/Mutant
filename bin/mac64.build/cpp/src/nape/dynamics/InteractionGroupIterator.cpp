...
::nape::dynamics::InteractionGroupIterator InteractionGroupIterator_obj::get( ::nape::dynamics::InteractionGroupList list){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(220)
		::nape::dynamics::InteractionGroupIterator tmp3 = ::nape::dynamics::InteractionGroupIterator_obj::__new();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(220)
		::nape::dynamics::InteractionGroupIterator ret = tmp3;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(221)
