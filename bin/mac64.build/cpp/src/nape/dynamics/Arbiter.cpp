...
::nape::dynamics::ArbiterType Arbiter_obj::get_type( ){
	...
	HX_STACK_LINE(204)
	::nape::dynamics::ArbiterType tmp2 = ::zpp_nape::dynamics::ZPP_Arbiter_obj::types->__get(tmp1).StaticCast< ::nape::dynamics::ArbiterType >();		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(204)
	return tmp2;
}
...
::nape::callbacks::PreFlag Arbiter_obj::get_state( ){
	...
	HX_STACK_LINE(327)
	{
		...
		HX_STACK_LINE(327)
		{
			...
			if ((tmp7)){
				HX_STACK_LINE(328)
				::nape::callbacks::PreFlag tmp8 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(328)
				...
				if ((tmp9)){
					...
					HX_STACK_LINE(328)
					::nape::callbacks::PreFlag tmp10 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(328)
					::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT = tmp10;
					HX_STACK_LINE(328)
				...
				switch( (int)(tmp8)){
					case (int)1: {
						HX_STACK_LINE(329)
						::nape::callbacks::PreFlag tmp9 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT_ONCE;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(329)
						...
						if ((tmp10)){
							...
							::zpp_nape::util::ZPP_Flags_obj::internal = true;
							HX_STACK_LINE(329)
							::nape::callbacks::PreFlag tmp11 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(329)
							::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT_ONCE = tmp11;
							HX_STACK_LINE(329)
							::zpp_nape::util::ZPP_Flags_obj::internal = false;
						}
						HX_STACK_LINE(329)
					...
					default: {
						HX_STACK_LINE(330)
						int tmp9 = x1;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(330)
						...
						if ((tmp11)){
							HX_STACK_LINE(330)
							::nape::callbacks::PreFlag tmp12 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE;		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(330)
							...
							if ((tmp13)){
								...
								::zpp_nape::util::ZPP_Flags_obj::internal = true;
								HX_STACK_LINE(330)
								::nape::callbacks::PreFlag tmp14 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp14,"tmp14");
								HX_STACK_LINE(330)
								::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE = tmp14;
								HX_STACK_LINE(330)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(330)
							...
							HX_STACK_LINE(331)
							::nape::callbacks::PreFlag tmp12 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE_ONCE;		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(331)
							bool tmp13 = (tmp12 == null());		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(331)
							if ((tmp13)){
								...
								::nape::callbacks::PreFlag tmp14 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp14,"tmp14");
								HX_STACK_LINE(331)
								::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE_ONCE = tmp14;
								HX_STACK_LINE(331)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(331)
...
::String Arbiter_obj::toString( ){
	...
	if ((tmp6)){
		...
		if ((tmp19)){
			...
			::zpp_nape::dynamics::ZPP_Arbiter tmp21 = this->zpp_inner;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(379)
			bool tmp22 = tmp21->colarb->stat;		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(379)
			...
			HX_STACK_LINE(379)
			::String tmp24 = Array_obj< ::String >::__new().Add(HX_HCSTRING("SD","\x91","\x48","\x00","\x00")).Add(HX_HCSTRING("DD","\x80","\x3b","\x00","\x00"))->__get(tmp23);		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(379)
			::String tmp25 = (HX_HCSTRING("[","\x5b","\x00","\x00","\x00") + tmp24);		HX_STACK_VAR(tmp25,"tmp25");
			HX_STACK_LINE(379)
			tmp20 = (tmp25 + HX_HCSTRING("]","\x5d","\x00","\x00","\x00"));
		}
		else{
			HX_STACK_LINE(379)
		...
		HX_STACK_LINE(379)
		{
			...
			HX_STACK_LINE(379)
			{
				...
				HX_STACK_LINE(379)
				{
					...
					HX_STACK_LINE(379)
					int tmp29 = (int)5;		HX_STACK_VAR(tmp29,"tmp29");
					HX_STACK_LINE(379)
					bool tmp30 = (tmp28 == tmp29);		HX_STACK_VAR(tmp30,"tmp30");
					HX_STACK_LINE(379)
					if ((tmp30)){
						HX_STACK_LINE(379)
						::nape::callbacks::PreFlag tmp31 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT;		HX_STACK_VAR(tmp31,"tmp31");
						HX_STACK_LINE(379)
						...
						if ((tmp32)){
							...
							::zpp_nape::util::ZPP_Flags_obj::internal = true;
							HX_STACK_LINE(379)
							::nape::callbacks::PreFlag tmp33 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp33,"tmp33");
							HX_STACK_LINE(379)
							::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT = tmp33;
							HX_STACK_LINE(379)
							::zpp_nape::util::ZPP_Flags_obj::internal = false;
						}
						HX_STACK_LINE(379)
						...
						switch( (int)(tmp31)){
							case (int)1: {
								HX_STACK_LINE(379)
								::nape::callbacks::PreFlag tmp32 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT_ONCE;		HX_STACK_VAR(tmp32,"tmp32");
								HX_STACK_LINE(379)
								...
								if ((tmp33)){
									...
									::zpp_nape::util::ZPP_Flags_obj::internal = true;
									HX_STACK_LINE(379)
									::nape::callbacks::PreFlag tmp34 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp34,"tmp34");
									HX_STACK_LINE(379)
									::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT_ONCE = tmp34;
									HX_STACK_LINE(379)
									::zpp_nape::util::ZPP_Flags_obj::internal = false;
								}
								HX_STACK_LINE(379)
							...
							default: {
								...
								HX_STACK_LINE(379)
								int tmp33 = (int)6;		HX_STACK_VAR(tmp33,"tmp33");
								HX_STACK_LINE(379)
								bool tmp34 = (tmp32 == tmp33);		HX_STACK_VAR(tmp34,"tmp34");
								HX_STACK_LINE(379)
								if ((tmp34)){
									HX_STACK_LINE(379)
									::nape::callbacks::PreFlag tmp35 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE;		HX_STACK_VAR(tmp35,"tmp35");
									HX_STACK_LINE(379)
									...
									if ((tmp36)){
										...
										::zpp_nape::util::ZPP_Flags_obj::internal = true;
										HX_STACK_LINE(379)
										::nape::callbacks::PreFlag tmp37 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp37,"tmp37");
										HX_STACK_LINE(379)
										::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE = tmp37;
										HX_STACK_LINE(379)
										::zpp_nape::util::ZPP_Flags_obj::internal = false;
									}
									HX_STACK_LINE(379)
									...
									HX_STACK_LINE(379)
									::nape::callbacks::PreFlag tmp35 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE_ONCE;		HX_STACK_VAR(tmp35,"tmp35");
									HX_STACK_LINE(379)
									bool tmp36 = (tmp35 == null());		HX_STACK_VAR(tmp36,"tmp36");
									HX_STACK_LINE(379)
									if ((tmp36)){
										...
										::nape::callbacks::PreFlag tmp37 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp37,"tmp37");
										HX_STACK_LINE(379)
										::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE_ONCE = tmp37;
										HX_STACK_LINE(379)
										::zpp_nape::util::ZPP_Flags_obj::internal = false;
									}
									HX_STACK_LINE(379)
