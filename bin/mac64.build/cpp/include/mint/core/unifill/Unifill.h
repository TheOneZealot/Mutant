...
#define INCLUDED_mint_core_unifill_Unifill
...
HX_DECLARE_CLASS3(mint,core,unifill,Unifill)
namespace mint{
namespace core{
namespace unifill{
...
class HXCPP_CLASS_ATTRIBUTES  Unifill_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="mint.core.unifill.Unifill")
		...
		static ::mint::core::unifill::CodePointIter uIterator( ::String s);
...
#endif /* INCLUDED_mint_core_unifill_Unifill */ 
