...
::luxe::importers::tiled::TiledObjectType_obj::__register();
...
::luxe::physics::nape::DebugDraw_obj::__register();
::luxe::macros::BuildVersion_obj::__register();
::luxe::importers::tiled::TiledLayer_obj::__register();
...
::snow::types::_Types::ApplyType_obj::__register();
...
::phoenix::_Shader::Uniform_snow_api_buffers_Float32Array_obj::__register();
::phoenix::_Shader::Uniform_phoenix_Vector_obj::__register();
::phoenix::_Shader::Uniform_phoenix_Texture_obj::__register();
::phoenix::_Shader::Uniform_phoenix_Matrix_obj::__register();
::phoenix::_Shader::Uniform_phoenix_Color_obj::__register();
::phoenix::_Shader::Uniform_Int_obj::__register();
::phoenix::_Shader::Uniform_Float_obj::__register();
::phoenix::_Vector::Vec_Impl__obj::__register();
::phoenix::Spatial_obj::__register();
::phoenix::Transform_obj::__register();
::phoenix::_Shader::Uniform_obj::__register();
::phoenix::Shader_obj::__register();
::phoenix::Uniforms_obj::__register();
...
::luxe::utils::Random_obj::__register();
::luxe::tween::easing::QuadEaseInOut_obj::__register();
::luxe::tween::easing::QuadEaseIn_obj::__register();
::luxe::tween::easing::LinearEaseNone_obj::__register();
::luxe::tween::easing::Linear_obj::__register();
...
::luxe::tilemaps::Tileset_obj::__register();
::luxe::tilemaps::TileLayer_obj::__register();
::luxe::tilemaps::Tile_obj::__register();
::luxe::tilemaps::OrthoVisual_obj::__register();
::luxe::tilemaps::Ortho_obj::__register();
::luxe::tilemaps::IsometricVisual_obj::__register();
::luxe::tilemaps::TilemapVisual_obj::__register();
::luxe::tilemaps::Isometric_obj::__register();
::luxe::structural::OrderedMap_String_luxe_Component_obj::__register();
::luxe::structural::OrderedMapIterator_String_luxe_Component_obj::__register();
::luxe::structural::OrderedMap_obj::__register();
::luxe::structural::OrderedMapIterator_obj::__register();
...
::luxe::structural::BalancedBSTIterator_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry_obj::__register();
::luxe::structural::BalancedBSTNode_obj::__register();
::luxe::structural::BalancedBSTIterator_obj::__register();
::luxe::structural::BalancedBST_obj::__register();
::luxe::resource::AudioResource_obj::__register();
...
::luxe::importers::tiled::TiledTile_obj::__register();
::luxe::importers::tiled::TiledObjectGroup_obj::__register();
::luxe::importers::tiled::TiledObject_obj::__register();
::luxe::importers::tiled::TiledPolyObject_obj::__register();
::luxe::importers::tiled::TiledPropertyTile_obj::__register();
::luxe::importers::tiled::TiledMapData_obj::__register();
::luxe::importers::tiled::TiledMap_obj::__register();
::luxe::tilemaps::Tilemap_obj::__register();
::luxe::importers::tiled::TiledImage_obj::__register();
::luxe::importers::tiled::TiledImageLayer_obj::__register();
::luxe::importers::bitmapfont::BitmapFontParser_obj::__register();
::luxe::debug::TraceDebugView_obj::__register();
::luxe::debug::StatsDebugView_obj::__register();
::luxe::debug::SceneDebugView_obj::__register();
...
::luxe::components::physics::nape::BoxCollider_obj::__register();
::luxe::components::physics::nape::NapeBody_obj::__register();
...
::luxe::InputEvent_obj::__register();
::luxe::MouseEvent_obj::__register();
::luxe::GamepadEvent_obj::__register();
::luxe::TextEvent_obj::__register();
::luxe::TouchEvent_obj::__register();
::luxe::KeyEvent_obj::__register();
::luxe::Input_obj::__register();
::luxe::IO_obj::__register();
::luxe::_Events::EventObject_obj::__register();
::luxe::_Events::EventConnection_obj::__register();
::luxe::Events_obj::__register();
::luxe::Engine_obj::__register();
...
::luxe::importers::tiled::TiledObjectType_obj::__boot();
...
::luxe::importers::tiled::TiledLayer_obj::__boot();
::luxe::macros::BuildVersion_obj::__boot();
::luxe::physics::nape::DebugDraw_obj::__boot();
