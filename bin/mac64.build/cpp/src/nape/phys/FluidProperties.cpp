...
::nape::phys::FluidProperties FluidProperties_obj::copy( ){
	...
	HX_STACK_LINE(255)
	::nape::phys::FluidProperties tmp10 = ::nape::phys::FluidProperties_obj::__new(tmp4,tmp9);		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(255)
	::nape::phys::FluidProperties ret = tmp10;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(256)
	::zpp_nape::phys::ZPP_FluidProperties tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(256)
	Dynamic tmp12 = tmp11->userData;		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(256)
	...
	if ((tmp13)){
		...
		HX_STACK_LINE(256)
		Dynamic tmp15 = tmp14->userData;		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(256)
		Dynamic tmp16 = ::Reflect_obj::copy(tmp15);		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(256)
		ret->zpp_inner->userData = tmp16;
	}
	HX_STACK_LINE(257)
	{
		HX_STACK_LINE(257)
		::zpp_nape::phys::ZPP_FluidProperties tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(257)
		::nape::geom::Vec2 gravity = tmp14->wrap_gravity;		HX_STACK_VAR(gravity,"gravity");
		HX_STACK_LINE(257)
		{
			HX_STACK_LINE(257)
			...
			if ((tmp15)){
				HX_STACK_LINE(257)
				::nape::geom::Vec2 tmp16 = ret->zpp_inner->wrap_gravity;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(257)
				...
				if ((tmp17)){
					...
					HX_STACK_LINE(257)
					tmp18->zpp_inner->_inuse = false;
					HX_STACK_LINE(257)
					{
						HX_STACK_LINE(257)
						::nape::geom::Vec2 tmp19 = ret->zpp_inner->wrap_gravity;		HX_STACK_VAR(tmp19,"tmp19");
						HX_STACK_LINE(257)
						::nape::geom::Vec2 _this = tmp19;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(257)
						{
							HX_STACK_LINE(257)
				...
				{
					HX_STACK_LINE(257)
					bool tmp16 = (gravity != null());		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(257)
					bool tmp17;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(257)
					if ((tmp16)){
						HX_STACK_LINE(257)
						tmp17 = gravity->zpp_disp;
					}
					else{
						HX_STACK_LINE(257)
						tmp17 = false;
				...
				HX_STACK_LINE(257)
				{
					...
					{
						HX_STACK_LINE(257)
						bool tmp19 = (gravity != null());		HX_STACK_VAR(tmp19,"tmp19");
						HX_STACK_LINE(257)
						bool tmp20;		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(257)
						if ((tmp19)){
							HX_STACK_LINE(257)
							tmp20 = gravity->zpp_disp;
						}
						else{
							HX_STACK_LINE(257)
							tmp20 = false;
					...
					HX_STACK_LINE(257)
					{
						...
						{
							HX_STACK_LINE(257)
							bool tmp23 = (gravity != null());		HX_STACK_VAR(tmp23,"tmp23");
							HX_STACK_LINE(257)
							bool tmp24;		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(257)
							if ((tmp23)){
								HX_STACK_LINE(257)
								tmp24 = gravity->zpp_disp;
							}
							else{
								HX_STACK_LINE(257)
								tmp24 = false;
						...
						HX_STACK_LINE(257)
						{
							...
							::zpp_nape::geom::ZPP_Vec2 _this1 = _this->zpp_inner;		HX_STACK_VAR(_this1,"_this1");
							HX_STACK_LINE(257)
							bool tmp23 = _this1->_immutable;		HX_STACK_VAR(tmp23,"tmp23");
							HX_STACK_LINE(257)
							if ((tmp23)){
								HX_STACK_LINE(257)
								HX_STACK_DO_THROW(HX_HCSTRING("Error: Vec2 is immutable","\x60","\xee","\x1f","\xbc"));
							...
							HX_STACK_LINE(257)
							bool tmp24 = (_this1->_isimmutable != null());		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(257)
							if ((tmp24)){
								HX_STACK_LINE(257)
								_this1->_isimmutable();
						...
						HX_STACK_LINE(257)
						bool tmp23 = (x != x);		HX_STACK_VAR(tmp23,"tmp23");
						HX_STACK_LINE(257)
						...
						HX_STACK_LINE(257)
						{
							...
							{
								HX_STACK_LINE(257)
								bool tmp27 = (_this != null());		HX_STACK_VAR(tmp27,"tmp27");
								HX_STACK_LINE(257)
								bool tmp28;		HX_STACK_VAR(tmp28,"tmp28");
								HX_STACK_LINE(257)
								if ((tmp27)){
									HX_STACK_LINE(257)
									tmp28 = _this->zpp_disp;
								}
								else{
									HX_STACK_LINE(257)
									tmp28 = false;
						...
						if ((tmp28)){
							...
							HX_STACK_LINE(257)
							{
								...
								HX_STACK_LINE(257)
								Float tmp31 = _this->zpp_inner->y;		HX_STACK_VAR(tmp31,"tmp31");
								HX_STACK_LINE(257)
								tmp30 = tmp31;
							}
							HX_STACK_LINE(257)
					...
					HX_STACK_LINE(257)
					::nape::geom::Vec2 ret1 = tmp20;		HX_STACK_VAR(ret1,"ret1");
					HX_STACK_LINE(257)
					{
						HX_STACK_LINE(257)
						bool tmp21;		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(257)
						tmp21 = gravity->zpp_inner->weak;
						HX_STACK_LINE(257)
						if ((tmp21)){
							HX_STACK_LINE(257)
							{
								...
								HX_STACK_LINE(257)
								bool tmp22 = gravity->zpp_inner->_inuse;		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(257)
								if ((tmp22)){
									HX_STACK_LINE(257)
									HX_STACK_DO_THROW(HX_HCSTRING("Error: This Vec2 is not disposable","\xb5","\xd1","\xd1","\xd8"));
	...
	HX_STACK_LINE(258)
	::nape::phys::FluidProperties tmp14 = ret;		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(258)
	return tmp14;
}
