...
Void ZPP_Shape_obj::clear( ){
{
		...
		if ((tmp1)){
			HX_STACK_LINE(227)
			::zpp_nape::shape::ZPP_Circle tmp2 = this->circle;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(227)
			tmp2->__clear();
		}
		else{
...
Void ZPP_Shape_obj::validate_aabb( ){
{
		...
		if ((tmp)){
			...
			if ((tmp2)){
				...
				if ((tmp4)){
					HX_STACK_LINE(238)
					::zpp_nape::shape::ZPP_Circle tmp5 = this->circle;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(238)
					::zpp_nape::shape::ZPP_Circle _this = tmp5;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(238)
					{
						HX_STACK_LINE(238)
					...
					{
						HX_STACK_LINE(238)
						Float tmp6 = (_this->worldCOMx - rx);		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(238)
						_this->aabb->minx = tmp6;
						HX_STACK_LINE(238)
						Float tmp7 = (_this->worldCOMy - ry);		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(238)
						_this->aabb->miny = tmp7;
					}
					HX_STACK_LINE(238)
					{
						HX_STACK_LINE(238)
					...
					HX_STACK_LINE(239)
					{
						...
						while((true)){
							...
							HX_STACK_LINE(239)
							{
								...
								HX_STACK_LINE(239)
								Float tmp13 = _this->aabb->minx;		HX_STACK_VAR(tmp13,"tmp13");
								HX_STACK_LINE(239)
								...
								HX_STACK_LINE(239)
								Float tmp16 = _this->aabb->maxx;		HX_STACK_VAR(tmp16,"tmp16");
								HX_STACK_LINE(239)
								...
								HX_STACK_LINE(239)
								Float tmp19 = _this->aabb->miny;		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(239)
								...
								HX_STACK_LINE(239)
								Float tmp22 = _this->aabb->maxy;		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(239)
...
Void ZPP_Shape_obj::force_validate_aabb( ){
{
		...
		if ((tmp1)){
			...
			::zpp_nape::shape::ZPP_Circle tmp2 = this->circle;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(246)
			::zpp_nape::shape::ZPP_Circle _this = tmp2;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(246)
			{
				HX_STACK_LINE(246)
				Float tmp3 = _this->body->posx;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(246)
				Float tmp4 = _this->body->axisy;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(246)
				Float tmp5 = _this->localCOMx;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(246)
				Float tmp6 = (tmp4 * tmp5);		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(246)
				Float tmp7 = _this->body->axisx;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(246)
				Float tmp8 = _this->localCOMy;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(246)
				...
				Float tmp20 = (tmp12 + tmp19);		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(246)
				_this->worldCOMy = tmp20;
			}
			HX_STACK_LINE(246)
			Float tmp3 = (_this->worldCOMx - _this->radius);		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(246)
			_this->aabb->minx = tmp3;
			HX_STACK_LINE(246)
			Float tmp4 = (_this->worldCOMy - _this->radius);		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(246)
			_this->aabb->miny = tmp4;
			HX_STACK_LINE(246)
			Float tmp5 = (_this->worldCOMx + _this->radius);		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(246)
			_this->aabb->maxx = tmp5;
			HX_STACK_LINE(246)
			Float tmp6 = (_this->worldCOMy + _this->radius);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(246)
			_this->aabb->maxy = tmp6;
		}
		else{
			HX_STACK_LINE(247)
			::zpp_nape::shape::ZPP_Polygon tmp2 = this->polygon;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(247)
			::zpp_nape::shape::ZPP_Polygon _this = tmp2;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(247)
			::zpp_nape::geom::ZPP_Vec2 tmp3 = _this->lverts->next;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(247)
			::zpp_nape::geom::ZPP_Vec2 li = tmp3;		HX_STACK_VAR(li,"li");
			HX_STACK_LINE(247)
			::zpp_nape::geom::ZPP_Vec2 tmp4 = _this->gverts->next;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(247)
			::zpp_nape::geom::ZPP_Vec2 p0 = tmp4;		HX_STACK_VAR(p0,"p0");
			HX_STACK_LINE(247)
			::zpp_nape::geom::ZPP_Vec2 l = li;		HX_STACK_VAR(l,"l");
			HX_STACK_LINE(247)
			li = li->next;
			...
			HX_STACK_LINE(247)
			{
				...
				HX_STACK_LINE(247)
				::zpp_nape::geom::ZPP_Vec2 cx_ite = tmp5->next;		HX_STACK_VAR(cx_ite,"cx_ite");
				HX_STACK_LINE(247)
				while((true)){
					HX_STACK_LINE(247)
					...
					HX_STACK_LINE(247)
					{
						...
						HX_STACK_LINE(247)
						{
							...
							Float tmp12 = _this->body->axisx;		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(247)
							Float tmp13 = l1->y;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(247)
							Float tmp14 = (tmp12 * tmp13);		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(247)
							Float tmp15 = (tmp11 - tmp14);		HX_STACK_VAR(tmp15,"tmp15");
							...
							Float tmp17 = _this->body->posy;		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(247)
							Float tmp18 = l1->x;		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(247)
							Float tmp19 = _this->body->axisx;		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(247)
							Float tmp20 = (tmp18 * tmp19);		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(247)
							Float tmp21 = l1->y;		HX_STACK_VAR(tmp21,"tmp21");
							HX_STACK_LINE(247)
							Float tmp22 = _this->body->axisy;		HX_STACK_VAR(tmp22,"tmp22");
							HX_STACK_LINE(247)
							Float tmp23 = (tmp21 * tmp22);		HX_STACK_VAR(tmp23,"tmp23");
						...
						HX_STACK_LINE(247)
						Float tmp9 = _this->aabb->minx;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(247)
						...
						HX_STACK_LINE(247)
						Float tmp12 = _this->aabb->maxx;		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(247)
						...
						HX_STACK_LINE(247)
						Float tmp15 = _this->aabb->miny;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(247)
						...
						HX_STACK_LINE(247)
						Float tmp18 = _this->aabb->maxy;		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(247)
...
Void ZPP_Shape_obj::validate_angDrag( ){
{
		...
		if ((tmp2)){
			...
			if ((tmp6)){
				HX_STACK_LINE(266)
				::zpp_nape::shape::ZPP_Circle tmp7 = this->circle;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(266)
				tmp7->__validate_angDrag();
			}
			else{
				HX_STACK_LINE(267)
...
Void ZPP_Shape_obj::validate_localCOM( ){
{
		...
		if ((tmp)){
			...
			if ((tmp4)){
				HX_STACK_LINE(277)
				Float tmp5 = this->localCOMx;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(277)
				::nape::geom::Vec2 tmp6 = this->wrap_localCOM;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(277)
				tmp6->zpp_inner->x = tmp5;
				HX_STACK_LINE(278)
				Float tmp7 = this->localCOMy;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(278)
				::nape::geom::Vec2 tmp8 = this->wrap_localCOM;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(278)
				...
				HX_STACK_LINE(304)
				{
					...
					if ((tmp3)){
						...
						if ((tmp5)){
							...
							::zpp_nape::geom::ZPP_Vec2 tmp9 = _this->lverts->next;		HX_STACK_VAR(tmp9,"tmp9");
							HX_STACK_LINE(304)
							::zpp_nape::geom::ZPP_Vec2 tmp10 = tmp9->next;		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(304)
							bool tmp11 = (tmp10 == null());		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(304)
							if ((tmp11)){
								...
								::zpp_nape::geom::ZPP_Vec2 tmp12 = _this->lverts->next;		HX_STACK_VAR(tmp12,"tmp12");
								HX_STACK_LINE(304)
								::zpp_nape::geom::ZPP_Vec2 tmp13 = tmp12->next->next;		HX_STACK_VAR(tmp13,"tmp13");
								HX_STACK_LINE(304)
								bool tmp14 = (tmp13 == null());		HX_STACK_VAR(tmp14,"tmp14");
								HX_STACK_LINE(304)
								if ((tmp14)){
									...
									HX_STACK_LINE(304)
									{
										...
										::zpp_nape::geom::ZPP_Vec2 tmp15 = _this->lverts->next;		HX_STACK_VAR(tmp15,"tmp15");
										HX_STACK_LINE(304)
										Float tmp16 = tmp15->next->x;		HX_STACK_VAR(tmp16,"tmp16");
										HX_STACK_LINE(304)
										Float tmp17 = t;		HX_STACK_VAR(tmp17,"tmp17");
										HX_STACK_LINE(304)
										Float tmp18 = (tmp16 * tmp17);		HX_STACK_VAR(tmp18,"tmp18");
										HX_STACK_LINE(304)
										hx::AddEq(_this->localCOMx,tmp18);
										HX_STACK_LINE(304)
										::zpp_nape::geom::ZPP_Vec2 tmp19 = _this->lverts->next;		HX_STACK_VAR(tmp19,"tmp19");
										HX_STACK_LINE(304)
										Float tmp20 = tmp19->next->y;		HX_STACK_VAR(tmp20,"tmp20");
										HX_STACK_LINE(304)
										Float tmp21 = t;		HX_STACK_VAR(tmp21,"tmp21");
										HX_STACK_LINE(304)
										Float tmp22 = (tmp20 * tmp21);		HX_STACK_VAR(tmp22,"tmp22");
										HX_STACK_LINE(304)
										hx::AddEq(_this->localCOMy,tmp22);
									}
									HX_STACK_LINE(304)
									{
										HX_STACK_LINE(304)
									...
									HX_STACK_LINE(304)
									{
										...
										HX_STACK_LINE(304)
										{
											...
											Float tmp17 = v->x;		HX_STACK_VAR(tmp17,"tmp17");
											HX_STACK_LINE(304)
											Float tmp18 = (w1->y - u->y);		HX_STACK_VAR(tmp18,"tmp18");
											HX_STACK_LINE(304)
											Float tmp19 = (tmp17 * tmp18);		HX_STACK_VAR(tmp19,"tmp19");
											HX_STACK_LINE(304)
											hx::AddEq(area,tmp19);
											HX_STACK_LINE(304)
											Float tmp20 = (w1->y * v->x);		HX_STACK_VAR(tmp20,"tmp20");
											HX_STACK_LINE(304)
											Float tmp21 = (w1->x * v->y);		HX_STACK_VAR(tmp21,"tmp21");
											HX_STACK_LINE(304)
											Float tmp22 = (tmp20 - tmp21);		HX_STACK_VAR(tmp22,"tmp22");
											HX_STACK_LINE(304)
											Float cf = tmp22;		HX_STACK_VAR(cf,"cf");
											HX_STACK_LINE(304)
											Float tmp23 = (v->x + w1->x);		HX_STACK_VAR(tmp23,"tmp23");
											HX_STACK_LINE(304)
											Float tmp24 = cf;		HX_STACK_VAR(tmp24,"tmp24");
											HX_STACK_LINE(304)
											Float tmp25 = (tmp23 * tmp24);		HX_STACK_VAR(tmp25,"tmp25");
											...
											hx::AddEq(_this->localCOMx,tmp25);
											HX_STACK_LINE(304)
											Float tmp26 = (v->y + w1->y);		HX_STACK_VAR(tmp26,"tmp26");
											HX_STACK_LINE(304)
											Float tmp27 = cf;		HX_STACK_VAR(tmp27,"tmp27");
											HX_STACK_LINE(304)
											Float tmp28 = (tmp26 * tmp27);		HX_STACK_VAR(tmp28,"tmp28");
									...
									HX_STACK_LINE(304)
									Float tmp15 = ((int)3 * area);		HX_STACK_VAR(tmp15,"tmp15");
									HX_STACK_LINE(304)
						...
						if ((tmp7)){
							...
							HX_STACK_LINE(304)
							::nape::geom::Vec2 tmp11 = this->wrap_localCOM;		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(304)
							tmp11->zpp_inner->y = tmp10;
							HX_STACK_LINE(304)
							{
							}
						}
				...
				if ((tmp4)){
					...
					HX_STACK_LINE(317)
					{
						...
						if ((tmp5)){
							...
							if ((tmp9)){
								HX_STACK_LINE(317)
								Float tmp10 = this->localCOMx;		HX_STACK_VAR(tmp10,"tmp10");
								HX_STACK_LINE(317)
								::nape::geom::Vec2 tmp11 = this->wrap_localCOM;		HX_STACK_VAR(tmp11,"tmp11");
								HX_STACK_LINE(317)
								tmp11->zpp_inner->x = tmp10;
								HX_STACK_LINE(317)
								Float tmp12 = this->localCOMy;		HX_STACK_VAR(tmp12,"tmp12");
								HX_STACK_LINE(317)
								::nape::geom::Vec2 tmp13 = this->wrap_localCOM;		HX_STACK_VAR(tmp13,"tmp13");
								HX_STACK_LINE(317)
...
Void ZPP_Shape_obj::invalidate_localCOM( ){
{
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(356)
			::zpp_nape::phys::ZPP_Body _this = tmp4;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(356)
			_this->zip_localCOM = true;
			HX_STACK_LINE(356)
			_this->zip_worldCOM = true;
			...
			if ((tmp2)){
				...
				if ((tmp4)){
					...
					if ((tmp6)){
						...
						::zpp_nape::shape::ZPP_Circle tmp7 = this->circle;		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(389)
						::zpp_nape::shape::ZPP_Circle _this = tmp7;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(389)
						{
							HX_STACK_LINE(389)
...
::nape::shape::Shape ZPP_Shape_obj::copy( ){
	...
	if ((tmp1)){
		...
		::zpp_nape::shape::ZPP_Circle tmp2 = this->circle;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(503)
		::zpp_nape::shape::ZPP_Circle tmp3 = tmp2->__copy();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(503)
		ret = tmp3;
	}
	else{
		...
		::zpp_nape::shape::ZPP_Polygon tmp2 = this->polygon;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(504)
		::zpp_nape::shape::ZPP_Polygon tmp3 = tmp2->__copy();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(504)
		ret = tmp3;
	}
	HX_STACK_LINE(505)
	bool tmp2 = this->zip_area_inertia;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(505)
	...
	HX_STACK_LINE(510)
	bool tmp4 = this->zip_sweepRadius;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(510)
	bool tmp5 = !(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(510)
	if ((tmp5)){
		HX_STACK_LINE(511)
		Float tmp6 = this->sweepRadius;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(511)
		ret->sweepRadius = tmp6;
		HX_STACK_LINE(512)
		Float tmp7 = this->sweepCoef;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(512)
		ret->sweepCoef = tmp7;
	}
	else{
	...
	HX_STACK_LINE(515)
	bool tmp6 = this->zip_angDrag;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(515)
	bool tmp7 = !(tmp6);		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(515)
	if ((tmp7)){
		HX_STACK_LINE(515)
		Float tmp8 = this->angDrag;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(515)
		ret->angDrag = tmp8;
	}
	else{
	...
	HX_STACK_LINE(517)
	bool tmp8 = this->zip_aabb;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(517)
	...
	if ((tmp9)){
		...
		HX_STACK_LINE(538)
		{
			...
			::zpp_nape::geom::ZPP_AABB tmp10 = this->aabb;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(539)
			ret->aabb->maxx = tmp10->maxx;
			HX_STACK_LINE(540)
			::zpp_nape::geom::ZPP_AABB tmp11 = this->aabb;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(540)
			ret->aabb->maxy = tmp11->maxy;
			HX_STACK_LINE(549)
			{
			}
		}
		...
		ret->zip_aabb = true;
		HX_STACK_LINE(559)
		bool tmp10 = (ret->body != null());		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(559)
		if ((tmp10)){
			HX_STACK_LINE(559)
	...
	ret->material = tmp10;
	HX_STACK_LINE(595)
	::zpp_nape::dynamics::ZPP_InteractionFilter tmp11 = this->filter;		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(595)
	ret->filter = tmp11;
	HX_STACK_LINE(596)
	::zpp_nape::phys::ZPP_FluidProperties tmp12 = this->fluidProperties;		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(596)
	bool tmp13 = (tmp12 != null());		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(596)
	if ((tmp13)){
		HX_STACK_LINE(596)
		::zpp_nape::phys::ZPP_FluidProperties tmp14 = this->fluidProperties;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(596)
		ret->fluidProperties = tmp14;
	}
	HX_STACK_LINE(597)
	bool tmp14 = this->fluidEnabled;		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(597)
	ret->fluidEnabled = tmp14;
	HX_STACK_LINE(598)
	bool tmp15 = this->sensorEnabled;		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(598)
	ret->sensorEnabled = tmp15;
	HX_STACK_LINE(599)
	Dynamic tmp16 = this->userData;		HX_STACK_VAR(tmp16,"tmp16");
	HX_STACK_LINE(599)
	bool tmp17 = (tmp16 != null());		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(599)
	if ((tmp17)){
		HX_STACK_LINE(599)
		Dynamic tmp18 = this->userData;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(599)
		Dynamic tmp19 = ::Reflect_obj::copy(tmp18);		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(599)
		ret->userData = tmp19;
	}
	HX_STACK_LINE(600)
	::nape::shape::Shape tmp18 = ret->outer;		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(600)
	this->copyto(tmp18);
	HX_STACK_LINE(601)
