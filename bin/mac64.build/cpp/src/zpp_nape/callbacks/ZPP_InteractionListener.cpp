...
Void ZPP_InteractionListener_obj::addedToSpace( ){
{
		...
		HX_STACK_LINE(643)
		bool pre = tmp1;		HX_STACK_VAR(pre,"pre");
		HX_STACK_LINE(644)
		{
			HX_STACK_LINE(644)
			::zpp_nape::callbacks::ZPP_OptionType tmp2 = this->options1;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(644)
			::zpp_nape::util::ZNPNode_ZPP_CbType tmp3 = tmp2->includes->head;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(644)
			::zpp_nape::util::ZNPNode_ZPP_CbType ite1 = tmp3;		HX_STACK_VAR(ite1,"ite1");
			HX_STACK_LINE(644)
			::zpp_nape::callbacks::ZPP_OptionType tmp4 = this->options2;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(644)
			::zpp_nape::util::ZNPNode_ZPP_CbType tmp5 = tmp4->includes->head;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(644)
			::zpp_nape::util::ZNPNode_ZPP_CbType ite2 = tmp5;		HX_STACK_VAR(ite2,"ite2");
			HX_STACK_LINE(644)
			while((true)){
				HX_STACK_LINE(644)
				bool tmp6 = (ite1 != null());		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(644)
				...
				::zpp_nape::callbacks::ZPP_CbType cb2 = ite2->elt;		HX_STACK_VAR(cb2,"cb2");
				HX_STACK_LINE(644)
				bool tmp9 = (cb1 == cb2);		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(644)
				if ((tmp9)){
					HX_STACK_LINE(644)
					::zpp_nape::callbacks::ZPP_CbType tmp10 = cb1;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(644)
					{
						HX_STACK_LINE(645)
						{
							HX_STACK_LINE(645)
							{
								...
								{
									HX_STACK_LINE(645)
									::zpp_nape::util::ZNPNode_ZPP_InteractionListener tmp11 = tmp10->listeners->head;		HX_STACK_VAR(tmp11,"tmp11");
									HX_STACK_LINE(645)
									::zpp_nape::util::ZNPNode_ZPP_InteractionListener cx_ite = tmp11;		HX_STACK_VAR(cx_ite,"cx_ite");
									HX_STACK_LINE(645)
									while((true)){
										HX_STACK_LINE(645)
										...
										{
											HX_STACK_LINE(645)
											bool tmp14 = (_g->precedence > j->precedence);		HX_STACK_VAR(tmp14,"tmp14");
											HX_STACK_LINE(645)
								...
								{
									HX_STACK_LINE(645)
									::zpp_nape::util::ZNPList_ZPP_InteractionListener _this = tmp10->listeners;		HX_STACK_VAR(_this,"_this");
									HX_STACK_LINE(645)
									::zpp_nape::util::ZNPNode_ZPP_InteractionListener tmp11;		HX_STACK_VAR(tmp11,"tmp11");
									HX_STACK_LINE(645)
									{
										HX_STACK_LINE(645)
										...
										{
											HX_STACK_LINE(645)
											::zpp_nape::util::ZNPNode_ZPP_InteractionListener tmp12 = ::zpp_nape::util::ZNPNode_ZPP_InteractionListener_obj::zpp_pool;		HX_STACK_VAR(tmp12,"tmp12");
											HX_STACK_LINE(645)
											bool tmp13 = (tmp12 == null());		HX_STACK_VAR(tmp13,"tmp13");
											HX_STACK_LINE(645)
											if ((tmp13)){
												HX_STACK_LINE(645)
												::zpp_nape::util::ZNPNode_ZPP_InteractionListener tmp14 = ::zpp_nape::util::ZNPNode_ZPP_InteractionListener_obj::__new();		HX_STACK_VAR(tmp14,"tmp14");
												HX_STACK_LINE(645)
												ret = tmp14;
											}
											else{
									...
									HX_STACK_LINE(645)
									::zpp_nape::util::ZNPNode_ZPP_InteractionListener temp = tmp11;		HX_STACK_VAR(temp,"temp");
									HX_STACK_LINE(645)
									bool tmp12 = (pre1 == null());		HX_STACK_VAR(tmp12,"tmp12");
									HX_STACK_LINE(645)
									if ((tmp12)){
										HX_STACK_LINE(645)
									...
									HX_STACK_LINE(645)
									bool tmp13 = _this->modified = true;		HX_STACK_VAR(tmp13,"tmp13");
									HX_STACK_LINE(645)
									_this->pushmod = tmp13;
									HX_STACK_LINE(645)
									(_this->length)++;
							...
							{
								HX_STACK_LINE(645)
								::zpp_nape::util::ZNPNode_ZPP_CbSet tmp11 = tmp10->cbsets->head;		HX_STACK_VAR(tmp11,"tmp11");
								HX_STACK_LINE(645)
						...
						HX_STACK_LINE(646)
						bool tmp11 = pre;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(646)
						if ((tmp11)){
							HX_STACK_LINE(648)
							::zpp_nape::util::ZNPNode_ZPP_Interactor tmp12 = tmp10->interactors->head;		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(648)
							::zpp_nape::util::ZNPNode_ZPP_Interactor cx_ite = tmp12;		HX_STACK_VAR(cx_ite,"cx_ite");
							HX_STACK_LINE(649)
							while((true)){
								HX_STACK_LINE(649)
								bool tmp13 = (cx_ite != null());		HX_STACK_VAR(tmp13,"tmp13");
					...
					HX_STACK_LINE(644)
					bool tmp10 = (cb1->id < cb2->id);		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(644)
					if ((tmp10)){
						HX_STACK_LINE(644)
						...
						HX_STACK_LINE(644)
						::zpp_nape::callbacks::ZPP_CbType tmp11 = cb2;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(644)
						{
							HX_STACK_LINE(645)
							{
			...
			while((true)){
				...
				HX_STACK_LINE(644)
				::zpp_nape::callbacks::ZPP_CbType tmp8 = ite1->elt;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(644)
				{
					HX_STACK_LINE(645)
					{
						HX_STACK_LINE(645)
						{
							...
							{
								HX_STACK_LINE(645)
								::zpp_nape::util::ZNPNode_ZPP_InteractionListener tmp9 = tmp8->listeners->head;		HX_STACK_VAR(tmp9,"tmp9");
								HX_STACK_LINE(645)
								::zpp_nape::util::ZNPNode_ZPP_InteractionListener cx_ite = tmp9;		HX_STACK_VAR(cx_ite,"cx_ite");
								HX_STACK_LINE(645)
								while((true)){
									HX_STACK_LINE(645)
									bool tmp10 = (cx_ite != null());		HX_STACK_VAR(tmp10,"tmp10");
									...
									{
										HX_STACK_LINE(645)
										bool tmp12 = (_g->precedence > j->precedence);		HX_STACK_VAR(tmp12,"tmp12");
										HX_STACK_LINE(645)
										bool tmp13 = !(tmp12);		HX_STACK_VAR(tmp13,"tmp13");
										HX_STACK_LINE(645)
							...
							{
								HX_STACK_LINE(645)
								::zpp_nape::util::ZNPList_ZPP_InteractionListener _this = tmp8->listeners;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(645)
								::zpp_nape::util::ZNPNode_ZPP_InteractionListener tmp9;		HX_STACK_VAR(tmp9,"tmp9");
								HX_STACK_LINE(645)
								{
									HX_STACK_LINE(645)
									::zpp_nape::util::ZNPNode_ZPP_InteractionListener ret;		HX_STACK_VAR(ret,"ret");
									...
									{
										HX_STACK_LINE(645)
										::zpp_nape::util::ZNPNode_ZPP_InteractionListener tmp10 = ::zpp_nape::util::ZNPNode_ZPP_InteractionListener_obj::zpp_pool;		HX_STACK_VAR(tmp10,"tmp10");
										HX_STACK_LINE(645)
										bool tmp11 = (tmp10 == null());		HX_STACK_VAR(tmp11,"tmp11");
										HX_STACK_LINE(645)
										if ((tmp11)){
											HX_STACK_LINE(645)
											::zpp_nape::util::ZNPNode_ZPP_InteractionListener tmp12 = ::zpp_nape::util::ZNPNode_ZPP_InteractionListener_obj::__new();		HX_STACK_VAR(tmp12,"tmp12");
											HX_STACK_LINE(645)
											ret = tmp12;
										}
										else{
								...
								HX_STACK_LINE(645)
								::zpp_nape::util::ZNPNode_ZPP_InteractionListener temp = tmp9;		HX_STACK_VAR(temp,"temp");
								HX_STACK_LINE(645)
								bool tmp10 = (pre1 == null());		HX_STACK_VAR(tmp10,"tmp10");
								HX_STACK_LINE(645)
								if ((tmp10)){
									HX_STACK_LINE(645)
									temp->next = _this->head;
						...
						{
							HX_STACK_LINE(645)
							::zpp_nape::util::ZNPNode_ZPP_CbSet tmp9 = tmp8->cbsets->head;		HX_STACK_VAR(tmp9,"tmp9");
							HX_STACK_LINE(645)
							::zpp_nape::util::ZNPNode_ZPP_CbSet cx_ite = tmp9;		HX_STACK_VAR(cx_ite,"cx_ite");
							HX_STACK_LINE(645)
							while((true)){
								HX_STACK_LINE(645)
								bool tmp10 = (cx_ite != null());		HX_STACK_VAR(tmp10,"tmp10");
					...
					HX_STACK_LINE(646)
					bool tmp9 = pre;		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(646)
					if ((tmp9)){
						HX_STACK_LINE(648)
						::zpp_nape::util::ZNPNode_ZPP_Interactor tmp10 = tmp8->interactors->head;		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(648)
						::zpp_nape::util::ZNPNode_ZPP_Interactor cx_ite = tmp10;		HX_STACK_VAR(cx_ite,"cx_ite");
						HX_STACK_LINE(649)
						while((true)){
			...
			while((true)){
				...
				HX_STACK_LINE(644)
				::zpp_nape::callbacks::ZPP_CbType tmp8 = ite2->elt;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(644)
				{
					HX_STACK_LINE(645)
					{
		...
		HX_STACK_LINE(657)
		Dynamic tmp2 = this->cbtype_change1_dyn();		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(657)
		::zpp_nape::callbacks::ZPP_OptionType tmp3 = this->options1;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(657)
		tmp3->handler = tmp2;
		HX_STACK_LINE(658)
		Dynamic tmp4 = this->cbtype_change2_dyn();		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(658)
...
Void ZPP_InteractionListener_obj::removedFromSpace( ){
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				if ((tmp9)){
					...
					HX_STACK_LINE(664)
					{
						...
						{
							HX_STACK_LINE(665)
							::zpp_nape::callbacks::ZPP_InteractionListener tmp11 = _g;		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(665)
							tmp10->listeners->remove(tmp11);
							HX_STACK_LINE(665)
							{
								HX_STACK_LINE(665)
								::zpp_nape::util::ZNPNode_ZPP_CbSet tmp12 = tmp10->cbsets->head;		HX_STACK_VAR(tmp12,"tmp12");
								HX_STACK_LINE(665)
								::zpp_nape::util::ZNPNode_ZPP_CbSet cx_ite = tmp12;		HX_STACK_VAR(cx_ite,"cx_ite");
								HX_STACK_LINE(665)
								while((true)){
			...
			while((true)){
				...
				HX_STACK_LINE(664)
				{
					...
					{
						HX_STACK_LINE(665)
						::zpp_nape::callbacks::ZPP_InteractionListener tmp9 = _g;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(665)
						tmp8->listeners->remove(tmp9);
						HX_STACK_LINE(665)
						{
							HX_STACK_LINE(665)
							::zpp_nape::util::ZNPNode_ZPP_CbSet tmp10 = tmp8->cbsets->head;		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(665)
		...
		tmp2->handler = null();
		HX_STACK_LINE(678)
		::zpp_nape::callbacks::ZPP_OptionType tmp3 = this->options2;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(678)
		tmp3->handler = null();
	}
return null();
...
Void ZPP_InteractionListener_obj::invalidate_precedence( ){
{
		...
		if ((tmp1)){
			...
			HX_STACK_LINE(682)
			bool pre = tmp3;		HX_STACK_VAR(pre,"pre");
			HX_STACK_LINE(683)
			{
				HX_STACK_LINE(683)
				...
				::zpp_nape::util::ZNPNode_ZPP_CbType tmp5 = tmp4->includes->head;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(683)
				::zpp_nape::util::ZNPNode_ZPP_CbType ite1 = tmp5;		HX_STACK_VAR(ite1,"ite1");
				HX_STACK_LINE(683)
				::zpp_nape::callbacks::ZPP_OptionType tmp6 = this->options2;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(683)
				::zpp_nape::util::ZNPNode_ZPP_CbType tmp7 = tmp6->includes->head;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(683)
				::zpp_nape::util::ZNPNode_ZPP_CbType ite2 = tmp7;		HX_STACK_VAR(ite2,"ite2");
				HX_STACK_LINE(683)
				while((true)){
					HX_STACK_LINE(683)
					bool tmp8 = (ite1 != null());		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(683)
					...
					::zpp_nape::callbacks::ZPP_CbType cb2 = ite2->elt;		HX_STACK_VAR(cb2,"cb2");
					HX_STACK_LINE(683)
					bool tmp11 = (cb1 == cb2);		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(683)
					if ((tmp11)){
						HX_STACK_LINE(683)
						...
						HX_STACK_LINE(683)
						bool tmp12 = (cb1->id < cb2->id);		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(683)
						if ((tmp12)){
							HX_STACK_LINE(683)
							...
							HX_STACK_LINE(683)
							::zpp_nape::callbacks::ZPP_CbType tmp13 = cb2;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(683)
							{
								HX_STACK_LINE(684)
								{
				...
				while((true)){
					...
					HX_STACK_LINE(683)
					::zpp_nape::callbacks::ZPP_CbType tmp10 = ite1->elt;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(683)
					{
						HX_STACK_LINE(684)
						{
				...
				while((true)){
					...
					HX_STACK_LINE(683)
					::zpp_nape::callbacks::ZPP_CbType tmp10 = ite2->elt;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(683)
					{
						HX_STACK_LINE(684)
						{
...
Void ZPP_InteractionListener_obj::swapEvent( int newev){
{
		...
		if ((tmp1)){
			...
			HX_STACK_LINE(717)
			bool tmp2 = (newev != (int)0);		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(717)
			bool tmp3 = tmp2;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(717)
			bool tmp4;		HX_STACK_VAR(tmp4,"tmp4");
