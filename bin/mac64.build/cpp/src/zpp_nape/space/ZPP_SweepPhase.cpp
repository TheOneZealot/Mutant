		...
		if ((tmp2)){
			...
			if ((tmp3)){
				...
				if ((tmp4)){
					...
					HX_STACK_LINE(305)
					bool tmp5 = (shape->type == (int)0);		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(305)
					if ((tmp5)){
						HX_STACK_LINE(305)
		...
		if ((tmp1)){
			...
			while((true)){
				...
				while((true)){
					...
					HX_STACK_LINE(362)
					bool tmp12 = (b1->type == (int)1);		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(362)
					...
					HX_STACK_LINE(366)
					bool tmp14 = b1->component->sleeping;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(366)
					bool tmp15;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(366)
					if ((tmp14)){
						HX_STACK_LINE(366)
						tmp15 = b2->component->sleeping;
					}
					else{
						HX_STACK_LINE(366)
						tmp15 = false;
					...
					HX_STACK_LINE(370)
					{
						...
						HX_STACK_LINE(370)
						bool tmp17 = (x->miny > _this->maxy);		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(370)
					...
					if ((tmp16)){
						HX_STACK_LINE(371)
						bool tmp17 = discrete;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(371)
						if ((tmp17)){
							HX_STACK_LINE(372)
							::zpp_nape::shape::ZPP_Shape tmp18 = s1;		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(372)
							::zpp_nape::shape::ZPP_Shape tmp19 = s2;		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(372)
							bool tmp20 = (b1->type == (int)2);		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(372)
							...
							if ((tmp23)){
								HX_STACK_LINE(372)
								bool tmp25 = (b2->type == (int)2);		HX_STACK_VAR(tmp25,"tmp25");
								HX_STACK_LINE(372)
							...
							HX_STACK_LINE(372)
							space->narrowPhase(tmp18,tmp19,tmp24,null(),false);
						}
						else{
							HX_STACK_LINE(375)
							::zpp_nape::shape::ZPP_Shape tmp18 = s1;		HX_STACK_VAR(tmp18,"tmp18");
							...
							HX_STACK_LINE(375)
							space->continuousEvent(tmp18,tmp19,tmp24,null(),false);
						}
					}
					HX_STACK_LINE(378)
					d2 = d2->next;
	...
	while((true)){
		...
		if ((tmp12)){
			...
			if ((tmp15)){
				...
				if ((tmp16)){
					HX_STACK_LINE(401)
					::zpp_nape::shape::ZPP_Circle tmp17 = shape->circle;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(401)
					::zpp_nape::geom::ZPP_Vec2 tmp18 = v;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(401)
					bool tmp19 = ::zpp_nape::geom::ZPP_Collide_obj::circleContains(tmp17,tmp18);		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(401)
					if ((tmp19)){
						HX_STACK_LINE(401)
					...
					HX_STACK_LINE(404)
					::zpp_nape::shape::ZPP_Polygon tmp17 = shape->polygon;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(404)
					::zpp_nape::geom::ZPP_Vec2 tmp18 = v;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(404)
					bool tmp19 = ::zpp_nape::geom::ZPP_Collide_obj::polyContains(tmp17,tmp18);		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(404)
					if ((tmp19)){
						HX_STACK_LINE(404)
						::nape::shape::Shape tmp20 = shape->outer;		HX_STACK_VAR(tmp20,"tmp20");
	...
	while((true)){
		...
		if ((tmp12)){
			...
			if ((tmp16)){
				...
				if ((tmp19)){
					HX_STACK_LINE(441)
					bool tmp20 = (shape->type == (int)0);		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(441)
					if ((tmp20)){
						HX_STACK_LINE(442)
						::zpp_nape::shape::ZPP_Circle tmp21 = shape->circle;		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(442)
						::zpp_nape::geom::ZPP_Vec2 tmp22 = v;		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(442)
						bool tmp23 = ::zpp_nape::geom::ZPP_Collide_obj::circleContains(tmp21,tmp22);		HX_STACK_VAR(tmp23,"tmp23");
						HX_STACK_LINE(442)
						if ((tmp23)){
							HX_STACK_LINE(442)
						...
						::zpp_nape::geom::ZPP_Vec2 tmp22 = v;		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(445)
						bool tmp23 = ::zpp_nape::geom::ZPP_Collide_obj::polyContains(tmp21,tmp22);		HX_STACK_VAR(tmp23,"tmp23");
						HX_STACK_LINE(445)
						if ((tmp23)){
							HX_STACK_LINE(445)
							::nape::phys::Body tmp24 = body;		HX_STACK_VAR(tmp24,"tmp24");
		...
		while((true)){
			...
			if ((tmp7)){
				...
				if ((tmp11)){
					...
					bool tmp13 = (tmp12 == (int)0);		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(669)
					::nape::geom::RayResult tmp14;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(669)
					if ((tmp13)){
						HX_STACK_LINE(669)
						::zpp_nape::shape::ZPP_Circle tmp15 = a->shape->circle;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(669)
						bool tmp16 = inner;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(669)
						Float tmp17 = mint;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(669)
						tmp14 = ray->circlesect(tmp15,tmp16,tmp17);
					}
					else{
						HX_STACK_LINE(669)
						::zpp_nape::shape::ZPP_Polygon tmp15 = a->shape->polygon;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(669)
						bool tmp16 = inner;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(669)
						Float tmp17 = mint;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(669)
						tmp14 = ray->polysect(tmp15,tmp16,tmp17);
					}
					HX_STACK_LINE(669)
					::nape::geom::RayResult result = tmp14;		HX_STACK_VAR(result,"result");
					HX_STACK_LINE(670)
					...
					if ((tmp15)){
						...
						HX_STACK_LINE(671)
						{
							...
							{
								HX_STACK_LINE(671)
								::zpp_nape::geom::ZPP_ConvexRayResult tmp17 = result->zpp_inner->next;		HX_STACK_VAR(tmp17,"tmp17");
								HX_STACK_LINE(671)
							...
							HX_STACK_LINE(671)
							tmp16 = result->zpp_inner->toiDistance;
						}
						HX_STACK_LINE(671)
						mint = tmp16;
						HX_STACK_LINE(672)
						bool tmp17 = (minres != null());		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(672)
						if ((tmp17)){
							HX_STACK_LINE(673)
							{
								HX_STACK_LINE(673)
								::zpp_nape::geom::ZPP_ConvexRayResult tmp18 = minres->zpp_inner->next;		HX_STACK_VAR(tmp18,"tmp18");
								HX_STACK_LINE(673)
			...
			while((true)){
				...
				if ((tmp10)){
					...
					if ((tmp14)){
						...
						if ((tmp16)){
							HX_STACK_LINE(713)
							::zpp_nape::shape::ZPP_Circle tmp18 = a->shape->circle;		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(713)
							...
							HX_STACK_LINE(713)
							::zpp_nape::shape::ZPP_Polygon tmp18 = a->shape->polygon;		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(713)
							bool tmp19 = inner;		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(713)
							Float tmp20 = mint;		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(713)
							tmp17 = ray->polysect(tmp18,tmp19,tmp20);
						}
						HX_STACK_LINE(713)
			...
			if ((tmp9)){
				...
				if ((tmp12)){
					...
					if ((tmp14)){
						...
						bool tmp16 = inner;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(756)
						::nape::geom::RayResultList tmp17 = ret;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(756)
						ray->circlesect2(tmp15,tmp16,tmp17);
					}
					else{
						HX_STACK_LINE(757)
						::zpp_nape::shape::ZPP_Polygon tmp15 = a->shape->polygon;		HX_STACK_VAR(tmp15,"tmp15");
						...
						::nape::geom::RayResultList tmp17 = ret;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(757)
						ray->polysect2(tmp15,tmp16,tmp17);
					}
				}
			}
			HX_STACK_LINE(760)
