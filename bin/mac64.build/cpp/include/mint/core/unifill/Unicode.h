...
#define INCLUDED_mint_core_unifill_Unicode

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(mint,core,unifill,Unicode)
namespace mint{
namespace core{
namespace unifill{
...
class HXCPP_CLASS_ATTRIBUTES  Unicode_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="mint.core.unifill.Unicode")
...
#endif /* INCLUDED_mint_core_unifill_Unicode */ 
