...
Float MatMN_obj::x( int row,int col){
	...
	HX_STACK_LINE(215)
	::zpp_nape::geom::ZPP_MatMN tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(215)
	int tmp12 = tmp11->n;		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(215)
	int tmp13 = (tmp10 * tmp12);		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(215)
	int tmp14 = col;		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(215)
	int tmp15 = (tmp13 + tmp14);		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(215)
	Float tmp16 = tmp9->x->__get(tmp15);		HX_STACK_VAR(tmp16,"tmp16");
	HX_STACK_LINE(215)
	return tmp16;
}
...
Float MatMN_obj::setx( int row,int col,Float x){
	...
	HX_STACK_LINE(234)
	Float tmp17 = tmp9->x[tmp15] = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(234)
	return tmp17;
}
				...
				while((true)){
					...
					HX_STACK_LINE(277)
					{
						...
						if ((tmp19)){
							...
							HX_STACK_LINE(277)
							int tmp25 = tmp24->m;		HX_STACK_VAR(tmp25,"tmp25");
							HX_STACK_LINE(277)
							tmp20 = (tmp21 >= tmp25);
						}
						else{
						...
						if ((tmp21)){
							...
							HX_STACK_LINE(277)
							::zpp_nape::geom::ZPP_MatMN tmp24 = this->zpp_inner;		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(277)
							::zpp_nape::geom::ZPP_MatMN tmp25 = tmp24;		HX_STACK_VAR(tmp25,"tmp25");
							HX_STACK_LINE(277)
						...
						HX_STACK_LINE(277)
						tmp13 = tmp23->x->__get(tmp29);
					}
					HX_STACK_LINE(277)
					Float x = tmp13;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(277)
					bool tmp14 = (j < (int)0);		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(277)
					bool tmp15 = !(tmp14);		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(277)
					bool tmp16 = tmp15;		HX_STACK_VAR(tmp16,"tmp16");
					...
					if ((tmp19)){
						...
						HX_STACK_LINE(277)
						int tmp22 = ret->zpp_inner->m;		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(277)
...
::nape::geom::MatMN MatMN_obj::mul( ::nape::geom::MatMN matrix){
	...
	HX_STACK_LINE(301)
	::nape::geom::MatMN tmp7 = ::nape::geom::MatMN_obj::__new(tmp5,tmp6);		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(301)
	::nape::geom::MatMN ret = tmp7;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(302)
	{
		HX_STACK_LINE(302)
		int _g1 = (int)0;		HX_STACK_VAR(_g1,"_g1");
		...
		::zpp_nape::geom::ZPP_MatMN tmp8 = this->zpp_inner;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(302)
		int _g = tmp8->m;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(302)
		while((true)){
			HX_STACK_LINE(302)
			...
			HX_STACK_LINE(303)
			{
				...
				int _g3 = (int)0;		HX_STACK_VAR(_g3,"_g3");
				HX_STACK_LINE(303)
				int tmp12 = y->zpp_inner->n;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(303)
				...
				while((true)){
					...
					HX_STACK_LINE(305)
					{
						...
						HX_STACK_LINE(305)
						int _g4 = tmp16->n;		HX_STACK_VAR(_g4,"_g4");
						HX_STACK_LINE(305)
						while((true)){
							HX_STACK_LINE(305)
							bool tmp17 = (_g5 < _g4);		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(305)
							bool tmp18 = !(tmp17);		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(305)
							if ((tmp18)){
							...
							HX_STACK_LINE(305)
							int tmp19 = (_g5)++;		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(305)
							...
							HX_STACK_LINE(305)
							{
								...
								if ((tmp26)){
									...
									HX_STACK_LINE(305)
									int tmp32 = tmp31->m;		HX_STACK_VAR(tmp32,"tmp32");
									HX_STACK_LINE(305)
									tmp27 = (tmp28 >= tmp32);
								}
								else{
								...
								if ((tmp28)){
									...
									HX_STACK_LINE(305)
									::zpp_nape::geom::ZPP_MatMN tmp31 = this->zpp_inner;		HX_STACK_VAR(tmp31,"tmp31");
									HX_STACK_LINE(305)
									::zpp_nape::geom::ZPP_MatMN tmp32 = tmp31;		HX_STACK_VAR(tmp32,"tmp32");
									HX_STACK_LINE(305)
							...
							{
								HX_STACK_LINE(305)
								bool tmp22 = (k < (int)0);		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(305)
								bool tmp23 = !(tmp22);		HX_STACK_VAR(tmp23,"tmp23");
								HX_STACK_LINE(305)
								...
								if ((tmp27)){
									...
									HX_STACK_LINE(305)
									int tmp30 = y->zpp_inner->m;		HX_STACK_VAR(tmp30,"tmp30");
									HX_STACK_LINE(305)
								...
								HX_STACK_LINE(305)
								tmp21 = y->zpp_inner->x->__get(tmp35);
							}
							HX_STACK_LINE(305)
					...
					HX_STACK_LINE(306)
					{
						...
						if ((tmp21)){
							...
							int tmp23 = i;		HX_STACK_VAR(tmp23,"tmp23");
							HX_STACK_LINE(306)
							int tmp24 = ret->zpp_inner->m;		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(306)
							int tmp25 = tmp24;		HX_STACK_VAR(tmp25,"tmp25");
							HX_STACK_LINE(306)
	...
	HX_STACK_LINE(309)
	::nape::geom::MatMN tmp8 = ret;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(309)
	return tmp8;
}
