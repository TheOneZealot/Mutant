...
::zpp_nape::phys::ZPP_Material ZPP_Material_obj::copy( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	::zpp_nape::phys::ZPP_Material tmp = ::zpp_nape::phys::ZPP_Material_obj::__new();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(265)
	::zpp_nape::phys::ZPP_Material ret = tmp;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(266)
	Float tmp1 = this->dynamicFriction;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(266)
	ret->dynamicFriction = tmp1;
	HX_STACK_LINE(267)
	Float tmp2 = this->staticFriction;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(267)
	ret->staticFriction = tmp2;
	HX_STACK_LINE(268)
	Float tmp3 = this->density;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(268)
	ret->density = tmp3;
	HX_STACK_LINE(269)
	Float tmp4 = this->elasticity;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(269)
	ret->elasticity = tmp4;
	HX_STACK_LINE(270)
	Float tmp5 = this->rollingFriction;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(270)
	ret->rollingFriction = tmp5;
	HX_STACK_LINE(271)
	::zpp_nape::phys::ZPP_Material tmp6 = ret;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(271)
	return tmp6;
}
