...
::nape::geom::MatMN LineJoint_obj::impulse( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(456)
	::nape::geom::MatMN tmp = ::nape::geom::MatMN_obj::__new((int)2,(int)1);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(456)
	...
	HX_STACK_LINE(457)
	{
		...
		if ((tmp6)){
			HX_STACK_LINE(457)
			int tmp8 = ret->zpp_inner->m;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(457)
	...
	HX_STACK_LINE(459)
	::nape::geom::MatMN tmp1 = ret;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(459)
	return tmp1;
}
