...
::zpp_nape::util::ZNPList_ZPP_GeomVert ZPP_Simple_obj::decompose( ::zpp_nape::geom::ZPP_GeomVert poly,::zpp_nape::util::ZNPList_ZPP_GeomVert rets){
	...
	HX_STACK_LINE(1759)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(1760)
			::zpp_nape::util::Hashable2_Boolfalse tmp14 = tmp13->table->__get(i).StaticCast< ::zpp_nape::util::Hashable2_Boolfalse >();		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(1760)
			::zpp_nape::util::Hashable2_Boolfalse n = tmp14;		HX_STACK_VAR(n,"n");
			HX_STACK_LINE(1761)
			bool tmp15 = (n == null());		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(1761)
			if ((tmp15)){
				HX_STACK_LINE(1761)
				continue;
			...
			while((true)){
				HX_STACK_LINE(1762)
				bool tmp16 = (n != null());		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(1762)
				...
				HX_STACK_LINE(1765)
				{
					...
					HX_STACK_LINE(1776)
					::zpp_nape::util::Hashable2_Boolfalse tmp18 = ::zpp_nape::util::Hashable2_Boolfalse_obj::zpp_pool;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(1776)
					o->next = tmp18;
					HX_STACK_LINE(1777)
			...
			HX_STACK_LINE(1784)
			::zpp_nape::util::FastHash2_Hashable2_Boolfalse tmp16 = ::zpp_nape::geom::ZPP_Simple_obj::inthash;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(1784)
			tmp16->table[i] = null();
		}
	}
