...
::String Utf8_Impl__obj::fromCodePoint( int codePoint){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","fromCodePoint",0x15141498,"mint.core.unifill._Utf8.Utf8_Impl_.fromCodePoint","mint/core/unifill/Utf8.hx",11,0xef70830e)
	...
	HX_STACK_LINE(13)
	::mint::core::unifill::_Utf8::Utf8Impl_obj::encode_code_point(tmp1,tmp2);
	HX_STACK_LINE(14)
...
::String Utf8_Impl__obj::fromCodePoints( Dynamic codePoints){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","fromCodePoints",0x5c7df0db,"mint.core.unifill._Utf8.Utf8_Impl_.fromCodePoints","mint/core/unifill/Utf8.hx",20,0xef70830e)
	...
	for(::cpp::FastIterator_obj< int > *__it = ::cpp::CreateFastIterator< int >(tmp1);  __it->hasNext(); ){
		int c = __it->next();
		{
			...
			HX_STACK_LINE(23)
			::mint::core::unifill::_Utf8::Utf8Impl_obj::encode_code_point(tmp2,tmp3);
		}
;
	}
	HX_STACK_LINE(25)
...
::String Utf8_Impl__obj::fromString( ::String s){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","fromString",0x05d750fc,"mint.core.unifill._Utf8.Utf8_Impl_.fromString","mint/core/unifill/Utf8.hx",28,0xef70830e)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(29)
...
::String Utf8_Impl__obj::fromBytes( ::haxe::io::Bytes b){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","fromBytes",0xc46e4ea0,"mint.core.unifill._Utf8.Utf8_Impl_.fromBytes","mint/core/unifill/Utf8.hx",32,0xef70830e)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(33)
...
int Utf8_Impl__obj::codeUnitAt( ::String this1,int index){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","codeUnitAt",0xdcb194c5,"mint.core.unifill._Utf8.Utf8_Impl_.codeUnitAt","mint/core/unifill/Utf8.hx",41,0xef70830e)
...
int Utf8_Impl__obj::codePointAt( ::String this1,int index){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","codePointAt",0xd14fe175,"mint.core.unifill._Utf8.Utf8_Impl_.codePointAt","mint/core/unifill/Utf8.hx",49,0xef70830e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(50)
	...
	int run(int i){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","mint/core/unifill/Utf8.hx",50,0xef70830e)
		HX_STACK_ARG(i,"i")
		{
			HX_STACK_LINE(50)
	...
	HX_STACK_LINE(50)
	int tmp2 = ::mint::core::unifill::_Utf8::Utf8Impl_obj::decode_code_point(tmp, Dynamic(new _Function_1_1(this1)),tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(50)
	return tmp2;
}
...
::String Utf8_Impl__obj::charAt( ::String this1,int index){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","charAt",0x9f1e380a,"mint.core.unifill._Utf8.Utf8_Impl_.charAt","mint/core/unifill/Utf8.hx",57,0xef70830e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(58)
	::String tmp;		HX_STACK_VAR(tmp,"tmp");
...
int Utf8_Impl__obj::codePointCount( ::String this1,int beginIndex,int endIndex){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","codePointCount",0xd440f58d,"mint.core.unifill._Utf8.Utf8_Impl_.codePointCount","mint/core/unifill/Utf8.hx",65,0xef70830e)
	HX_STACK_ARG(this1,"this1")
...
int Utf8_Impl__obj::codePointWidthAt( ::String this1,int index){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","codePointWidthAt",0x323ad8d7,"mint.core.unifill._Utf8.Utf8_Impl_.codePointWidthAt","mint/core/unifill/Utf8.hx",79,0xef70830e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(80)
	int tmp = index;		HX_STACK_VAR(tmp,"tmp");
...
int Utf8_Impl__obj::codePointWidthBefore( ::String this1,int index){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","codePointWidthBefore",0x36c69a63,"mint.core.unifill._Utf8.Utf8_Impl_.codePointWidthBefore","mint/core/unifill/Utf8.hx",88,0xef70830e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(89)
...
int Utf8_Impl__obj::offsetByCodePoints( ::String this1,int index,int codePointOffset){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","offsetByCodePoints",0xeb3ea43b,"mint.core.unifill._Utf8.Utf8_Impl_.offsetByCodePoints","mint/core/unifill/Utf8.hx",96,0xef70830e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
...
::String Utf8_Impl__obj::substr( ::String this1,int index,Dynamic len){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","substr",0x81b3add2,"mint.core.unifill._Utf8.Utf8_Impl_.substr","mint/core/unifill/Utf8.hx",107,0xef70830e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
...
{
		HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","validate",0xb7323977,"mint.core.unifill._Utf8.Utf8_Impl_.validate","mint/core/unifill/Utf8.hx",117,0xef70830e)
		HX_STACK_ARG(this1,"this1")
		HX_STACK_LINE(118)
		int tmp = this1.length;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(118)
		...
		int __ArgCount() const { return 1; }
		int run(int i){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","mint/core/unifill/Utf8.hx",119,0xef70830e)
			HX_STACK_ARG(i,"i")
			{
				HX_STACK_LINE(119)
		...
		while((true)){
			...
			HX_STACK_LINE(122)
			::mint::core::unifill::_Utf8::Utf8Impl_obj::decode_code_point(tmp3,tmp4,tmp5);
			HX_STACK_LINE(123)
			int tmp6;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(123)
			{
...
::String Utf8_Impl__obj::toString( ::String this1){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","toString",0xeabd398d,"mint.core.unifill._Utf8.Utf8_Impl_.toString","mint/core/unifill/Utf8.hx",127,0xef70830e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(128)
...
::haxe::io::Bytes Utf8_Impl__obj::toBytes( ::String this1){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","toBytes",0x561a632f,"mint.core.unifill._Utf8.Utf8_Impl_.toBytes","mint/core/unifill/Utf8.hx",131,0xef70830e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(132)
	::String tmp = this1;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(132)
...
::String Utf8_Impl__obj::_new( ::String s){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","_new",0x4bad39c2,"mint.core.unifill._Utf8.Utf8_Impl_._new","mint/core/unifill/Utf8.hx",136,0xef70830e)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(136)
	::String tmp = s;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(136)
...
int Utf8_Impl__obj::get_length( ::String this1){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","get_length",0x40f227d0,"mint.core.unifill._Utf8.Utf8_Impl_.get_length","mint/core/unifill/Utf8.hx",139,0xef70830e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(140)
	int tmp = this1.length;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(140)
...
int Utf8_Impl__obj::forward_offset_by_code_points( ::String this1,int index,int codePointOffset){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","forward_offset_by_code_points",0x8645673e,"mint.core.unifill._Utf8.Utf8_Impl_.forward_offset_by_code_points","mint/core/unifill/Utf8.hx",143,0xef70830e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
	HX_STACK_ARG(codePointOffset,"codePointOffset")
	HX_STACK_LINE(144)
...
int Utf8_Impl__obj::backward_offset_by_code_points( ::String this1,int index,int codePointOffset){
	HX_STACK_FRAME("mint.core.unifill._Utf8.Utf8_Impl_","backward_offset_by_code_points",0xa4594bfe,"mint.core.unifill._Utf8.Utf8_Impl_.backward_offset_by_code_points","mint/core/unifill/Utf8.hx",153,0xef70830e)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
	HX_STACK_ARG(codePointOffset,"codePointOffset")
	HX_STACK_LINE(154)
...
void Utf8_Impl__obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("mint.core.unifill._Utf8.Utf8_Impl_","\xad","\x97","\xda","\x28");
