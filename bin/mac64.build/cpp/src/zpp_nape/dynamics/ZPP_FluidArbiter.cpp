...
Void ZPP_FluidArbiter_obj::preStep( ::zpp_nape::space::ZPP_Space s,Float dt){
{
		...
		if ((tmp16)){
			HX_STACK_LINE(966)
			{
				...
				HX_STACK_LINE(967)
				Float t = tmp17->imass;		HX_STACK_VAR(t,"t");
				HX_STACK_LINE(976)
				Float tmp18 = (buoyx * t);		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(976)
				::zpp_nape::phys::ZPP_Body tmp19 = this->b1;		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(976)
				hx::SubEq(tmp19->velx,tmp18);
				HX_STACK_LINE(977)
				Float tmp20 = (buoyy * t);		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(977)
				::zpp_nape::phys::ZPP_Body tmp21 = this->b1;		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(977)
				hx::SubEq(tmp21->vely,tmp20);
			}
			HX_STACK_LINE(979)
			Float tmp17 = buoyy;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(979)
			Float tmp18 = this->r1x;		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(979)
			Float tmp19 = (tmp17 * tmp18);		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(979)
			Float tmp20 = buoyx;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(979)
			Float tmp21 = this->r1y;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(979)
		...
		HX_STACK_LINE(981)
		bool tmp19 = (tmp18 == (int)2);		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(981)
		if ((tmp19)){
			HX_STACK_LINE(982)
			{
				...
				HX_STACK_LINE(983)
				Float t = tmp20->imass;		HX_STACK_VAR(t,"t");
				HX_STACK_LINE(992)
				Float tmp21 = (buoyx * t);		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(992)
				::zpp_nape::phys::ZPP_Body tmp22 = this->b2;		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(992)
				hx::AddEq(tmp22->velx,tmp21);
				HX_STACK_LINE(993)
				Float tmp23 = (buoyy * t);		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(993)
				::zpp_nape::phys::ZPP_Body tmp24 = this->b2;		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(993)
				hx::AddEq(tmp24->vely,tmp23);
			}
			HX_STACK_LINE(995)
			Float tmp20 = buoyy;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(995)
			Float tmp21 = this->r2x;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(995)
			Float tmp22 = (tmp20 * tmp21);		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(995)
			Float tmp23 = buoyx;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(995)
			Float tmp24 = this->r2y;		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(995)
		...
		HX_STACK_LINE(997)
		::zpp_nape::shape::ZPP_Shape tmp20 = this->ws1;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(997)
		bool tmp21 = tmp20->fluidEnabled;		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(997)
		...
		if ((tmp25)){
			HX_STACK_LINE(997)
			::zpp_nape::shape::ZPP_Shape tmp27 = this->ws1;		HX_STACK_VAR(tmp27,"tmp27");
			HX_STACK_LINE(997)
			::zpp_nape::shape::ZPP_Shape tmp28 = tmp27;		HX_STACK_VAR(tmp28,"tmp28");
			HX_STACK_LINE(997)
			::zpp_nape::shape::ZPP_Shape tmp29 = tmp28;		HX_STACK_VAR(tmp29,"tmp29");
			HX_STACK_LINE(997)
			Float tmp30 = tmp29->fluidProperties->viscosity;		HX_STACK_VAR(tmp30,"tmp30");
			HX_STACK_LINE(997)
		...
		if ((tmp26)){
			HX_STACK_LINE(997)
			::zpp_nape::shape::ZPP_Shape tmp28 = this->ws2;		HX_STACK_VAR(tmp28,"tmp28");
			HX_STACK_LINE(997)
			::zpp_nape::shape::ZPP_Shape tmp29 = tmp28;		HX_STACK_VAR(tmp29,"tmp29");
			HX_STACK_LINE(997)
			bool tmp30 = tmp29->fluidEnabled;		HX_STACK_VAR(tmp30,"tmp30");
			HX_STACK_LINE(997)
			...
			if ((tmp38)){
				HX_STACK_LINE(997)
				::zpp_nape::shape::ZPP_Shape tmp39 = this->ws2;		HX_STACK_VAR(tmp39,"tmp39");
				HX_STACK_LINE(997)
				::zpp_nape::shape::ZPP_Shape tmp40 = tmp39;		HX_STACK_VAR(tmp40,"tmp40");
				HX_STACK_LINE(997)
				::zpp_nape::shape::ZPP_Shape tmp41 = tmp40;		HX_STACK_VAR(tmp41,"tmp41");
				HX_STACK_LINE(997)
				Float tmp42 = tmp41->fluidProperties->viscosity;		HX_STACK_VAR(tmp42,"tmp42");
				HX_STACK_LINE(997)
		...
		if ((tmp27)){
			...
			::zpp_nape::shape::ZPP_Shape tmp28 = this->ws1;		HX_STACK_VAR(tmp28,"tmp28");
			HX_STACK_LINE(1024)
			bool tmp29 = tmp28->fluidEnabled;		HX_STACK_VAR(tmp29,"tmp29");
			HX_STACK_LINE(1024)
			if ((tmp29)){
				HX_STACK_LINE(1025)
				::zpp_nape::shape::ZPP_Shape tmp30 = this->ws2;		HX_STACK_VAR(tmp30,"tmp30");
				HX_STACK_LINE(1025)
				tmp30->validate_angDrag();
				HX_STACK_LINE(1026)
				::zpp_nape::shape::ZPP_Shape tmp31 = this->ws1;		HX_STACK_VAR(tmp31,"tmp31");
				HX_STACK_LINE(1026)
				Float tmp32 = tmp31->fluidProperties->viscosity;		HX_STACK_VAR(tmp32,"tmp32");
				HX_STACK_LINE(1026)
				::zpp_nape::shape::ZPP_Shape tmp33 = this->ws2;		HX_STACK_VAR(tmp33,"tmp33");
				HX_STACK_LINE(1026)
				Float tmp34 = tmp33->angDrag;		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(1026)
				Float tmp35 = (tmp32 * tmp34);		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(1026)
				Float tmp36 = this->overlap;		HX_STACK_VAR(tmp36,"tmp36");
				HX_STACK_LINE(1026)
				Float tmp37 = (tmp35 * tmp36);		HX_STACK_VAR(tmp37,"tmp37");
				HX_STACK_LINE(1026)
				::zpp_nape::shape::ZPP_Shape tmp38 = this->ws2;		HX_STACK_VAR(tmp38,"tmp38");
				HX_STACK_LINE(1026)
				Float tmp39 = tmp38->area;		HX_STACK_VAR(tmp39,"tmp39");
				HX_STACK_LINE(1026)
				Float tmp40 = (Float(tmp37) / Float(tmp39));		HX_STACK_VAR(tmp40,"tmp40");
				HX_STACK_LINE(1026)
				hx::AddEq(tViscosity,tmp40);
			}
			HX_STACK_LINE(1028)
			::zpp_nape::shape::ZPP_Shape tmp30 = this->ws2;		HX_STACK_VAR(tmp30,"tmp30");
			HX_STACK_LINE(1028)
			...
			if ((tmp31)){
				HX_STACK_LINE(1029)
				::zpp_nape::shape::ZPP_Shape tmp32 = this->ws1;		HX_STACK_VAR(tmp32,"tmp32");
				HX_STACK_LINE(1029)
				...
				HX_STACK_LINE(1030)
				::zpp_nape::shape::ZPP_Shape tmp35 = this->ws1;		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(1030)
				...
				HX_STACK_LINE(1030)
				::zpp_nape::shape::ZPP_Shape tmp40 = this->ws1;		HX_STACK_VAR(tmp40,"tmp40");
				HX_STACK_LINE(1030)
			...
			HX_STACK_LINE(1032)
			bool tmp32 = (tViscosity != (int)0);		HX_STACK_VAR(tmp32,"tmp32");
			HX_STACK_LINE(1032)
			if ((tmp32)){
				HX_STACK_LINE(1033)
				::zpp_nape::phys::ZPP_Body tmp33 = this->b1;		HX_STACK_VAR(tmp33,"tmp33");
				HX_STACK_LINE(1033)
				Float tmp34 = tmp33->sinertia;		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(1033)
				...
				Float tmp37 = (tmp34 + tmp36);		HX_STACK_VAR(tmp37,"tmp37");
				HX_STACK_LINE(1033)
				Float iSum = tmp37;		HX_STACK_VAR(iSum,"iSum");
				HX_STACK_LINE(1034)
				bool tmp38 = (iSum != (int)0);		HX_STACK_VAR(tmp38,"tmp38");
				HX_STACK_LINE(1034)
				if ((tmp38)){
					HX_STACK_LINE(1034)
					Float tmp39 = (Float((int)1) / Float(iSum));		HX_STACK_VAR(tmp39,"tmp39");
					HX_STACK_LINE(1034)
					this->wMass = tmp39;
				}
				else{
				...
				HX_STACK_LINE(1038)
				{
					...
					HX_STACK_LINE(1039)
					Float tmp42 = tViscosity;		HX_STACK_VAR(tmp42,"tmp42");
					HX_STACK_LINE(1039)
					Float tmp43 = (tmp41 * tmp42);		HX_STACK_VAR(tmp43,"tmp43");
					HX_STACK_LINE(1039)
					Float omega = tmp43;		HX_STACK_VAR(omega,"omega");
					HX_STACK_LINE(1040)
					Float tmp44 = (dt * omega);		HX_STACK_VAR(tmp44,"tmp44");
					HX_STACK_LINE(1040)
					int tmp45 = (int)2;		HX_STACK_VAR(tmp45,"tmp45");
					HX_STACK_LINE(1040)
					Float tmp46 = (omega * dt);		HX_STACK_VAR(tmp46,"tmp46");
					HX_STACK_LINE(1040)
					...
					this->agamma = tmp49;
					HX_STACK_LINE(1041)
					Float tmp50 = this->agamma;		HX_STACK_VAR(tmp50,"tmp50");
					HX_STACK_LINE(1041)
					Float tmp51 = ((int)1 + tmp50);		HX_STACK_VAR(tmp51,"tmp51");
					HX_STACK_LINE(1041)
					Float tmp52 = (Float((int)1) / Float(tmp51));		HX_STACK_VAR(tmp52,"tmp52");
					HX_STACK_LINE(1041)
					Float ig = tmp52;		HX_STACK_VAR(ig,"ig");
					HX_STACK_LINE(1042)
					Float tmp53 = (dt * omega);		HX_STACK_VAR(tmp53,"tmp53");
					HX_STACK_LINE(1042)
					Float tmp54 = omega;		HX_STACK_VAR(tmp54,"tmp54");
					HX_STACK_LINE(1042)
					Float tmp55 = (tmp53 * tmp54);		HX_STACK_VAR(tmp55,"tmp55");
					HX_STACK_LINE(1042)
					Float tmp56 = this->agamma;		HX_STACK_VAR(tmp56,"tmp56");
					HX_STACK_LINE(1042)
			...
			HX_STACK_LINE(1051)
			Float tmp34 = tmp33->velx;		HX_STACK_VAR(tmp34,"tmp34");
			HX_STACK_LINE(1051)
			::zpp_nape::phys::ZPP_Body tmp35 = this->b2;		HX_STACK_VAR(tmp35,"tmp35");
			HX_STACK_LINE(1051)
			Float tmp36 = tmp35->kinvelx;		HX_STACK_VAR(tmp36,"tmp36");
			HX_STACK_LINE(1051)
			Float tmp37 = (tmp34 + tmp36);		HX_STACK_VAR(tmp37,"tmp37");
			HX_STACK_LINE(1051)
			Float tmp38 = this->r2y;		HX_STACK_VAR(tmp38,"tmp38");
			HX_STACK_LINE(1051)
			::zpp_nape::phys::ZPP_Body tmp39 = this->b2;		HX_STACK_VAR(tmp39,"tmp39");
			HX_STACK_LINE(1051)
			Float tmp40 = tmp39->angvel;		HX_STACK_VAR(tmp40,"tmp40");
			HX_STACK_LINE(1051)
			::zpp_nape::phys::ZPP_Body tmp41 = this->b2;		HX_STACK_VAR(tmp41,"tmp41");
			HX_STACK_LINE(1051)
			Float tmp42 = tmp41->kinangvel;		HX_STACK_VAR(tmp42,"tmp42");
			HX_STACK_LINE(1051)
			...
			HX_STACK_LINE(1051)
			Float tmp47 = tmp46->velx;		HX_STACK_VAR(tmp47,"tmp47");
			HX_STACK_LINE(1051)
			::zpp_nape::phys::ZPP_Body tmp48 = this->b1;		HX_STACK_VAR(tmp48,"tmp48");
			HX_STACK_LINE(1051)
			Float tmp49 = tmp48->kinvelx;		HX_STACK_VAR(tmp49,"tmp49");
			HX_STACK_LINE(1051)
			Float tmp50 = (tmp47 + tmp49);		HX_STACK_VAR(tmp50,"tmp50");
			HX_STACK_LINE(1051)
			Float tmp51 = this->r1y;		HX_STACK_VAR(tmp51,"tmp51");
			HX_STACK_LINE(1051)
			::zpp_nape::phys::ZPP_Body tmp52 = this->b2;		HX_STACK_VAR(tmp52,"tmp52");
			HX_STACK_LINE(1051)
			Float tmp53 = tmp52->angvel;		HX_STACK_VAR(tmp53,"tmp53");
			HX_STACK_LINE(1051)
			::zpp_nape::phys::ZPP_Body tmp54 = this->b2;		HX_STACK_VAR(tmp54,"tmp54");
			HX_STACK_LINE(1051)
			Float tmp55 = tmp54->kinangvel;		HX_STACK_VAR(tmp55,"tmp55");
			HX_STACK_LINE(1051)
			...
			HX_STACK_LINE(1051)
			Float tmp59 = (tmp45 - tmp58);		HX_STACK_VAR(tmp59,"tmp59");
			HX_STACK_LINE(1051)
			Float vrnx = tmp59;		HX_STACK_VAR(vrnx,"vrnx");
			HX_STACK_LINE(1052)
			::zpp_nape::phys::ZPP_Body tmp60 = this->b2;		HX_STACK_VAR(tmp60,"tmp60");
			HX_STACK_LINE(1052)
			Float tmp61 = tmp60->vely;		HX_STACK_VAR(tmp61,"tmp61");
			HX_STACK_LINE(1052)
			::zpp_nape::phys::ZPP_Body tmp62 = this->b2;		HX_STACK_VAR(tmp62,"tmp62");
			HX_STACK_LINE(1052)
			Float tmp63 = tmp62->kinvely;		HX_STACK_VAR(tmp63,"tmp63");
			HX_STACK_LINE(1052)
			Float tmp64 = (tmp61 + tmp63);		HX_STACK_VAR(tmp64,"tmp64");
			HX_STACK_LINE(1052)
			Float tmp65 = this->r2x;		HX_STACK_VAR(tmp65,"tmp65");
			HX_STACK_LINE(1052)
			...
			HX_STACK_LINE(1052)
			Float tmp74 = tmp73->vely;		HX_STACK_VAR(tmp74,"tmp74");
			HX_STACK_LINE(1052)
			::zpp_nape::phys::ZPP_Body tmp75 = this->b1;		HX_STACK_VAR(tmp75,"tmp75");
			HX_STACK_LINE(1052)
			Float tmp76 = tmp75->kinvely;		HX_STACK_VAR(tmp76,"tmp76");
			HX_STACK_LINE(1052)
			Float tmp77 = (tmp74 + tmp76);		HX_STACK_VAR(tmp77,"tmp77");
			HX_STACK_LINE(1052)
			Float tmp78 = this->r1x;		HX_STACK_VAR(tmp78,"tmp78");
			HX_STACK_LINE(1052)
			::zpp_nape::phys::ZPP_Body tmp79 = this->b1;		HX_STACK_VAR(tmp79,"tmp79");
			HX_STACK_LINE(1052)
			Float tmp80 = tmp79->angvel;		HX_STACK_VAR(tmp80,"tmp80");
			HX_STACK_LINE(1052)
			...
			HX_STACK_LINE(1052)
			Float tmp85 = (tmp77 + tmp84);		HX_STACK_VAR(tmp85,"tmp85");
			HX_STACK_LINE(1052)
			Float tmp86 = (tmp72 - tmp85);		HX_STACK_VAR(tmp86,"tmp86");
			HX_STACK_LINE(1052)
			Float vrny = tmp86;		HX_STACK_VAR(vrny,"vrny");
			HX_STACK_LINE(1069)
			Float tmp87 = (vrnx * vrnx);		HX_STACK_VAR(tmp87,"tmp87");
			HX_STACK_LINE(1069)
			Float tmp88 = (vrny * vrny);		HX_STACK_VAR(tmp88,"tmp88");
			HX_STACK_LINE(1069)
			Float tmp89 = (tmp87 + tmp88);		HX_STACK_VAR(tmp89,"tmp89");
			HX_STACK_LINE(1069)
			Float tmp90 = ::nape::Config_obj::epsilon;		HX_STACK_VAR(tmp90,"tmp90");
			HX_STACK_LINE(1069)
			Float tmp91 = ::nape::Config_obj::epsilon;		HX_STACK_VAR(tmp91,"tmp91");
			HX_STACK_LINE(1069)
			Float tmp92 = (tmp90 * tmp91);		HX_STACK_VAR(tmp92,"tmp92");
			HX_STACK_LINE(1069)
			bool tmp93 = (tmp89 < tmp92);		HX_STACK_VAR(tmp93,"tmp93");
			HX_STACK_LINE(1069)
			if ((tmp93)){
			}
			else{
				...
				{
					HX_STACK_LINE(1072)
					Float tmp94 = (vrnx * vrnx);		HX_STACK_VAR(tmp94,"tmp94");
					HX_STACK_LINE(1072)
					Float tmp95 = (vrny * vrny);		HX_STACK_VAR(tmp95,"tmp95");
					HX_STACK_LINE(1072)
					...
					HX_STACK_LINE(1081)
					{
						...
						{
							HX_STACK_LINE(1081)
							Float tmp99 = d;		HX_STACK_VAR(tmp99,"tmp99");
							HX_STACK_LINE(1081)
							tmp98 = ::Math_obj::sqrt(tmp99);
						}
						HX_STACK_LINE(1081)
						tmp97 = (Float(((Float)1.0)) / Float(tmp98));
					}
					HX_STACK_LINE(1081)
					Float imag = tmp97;		HX_STACK_VAR(imag,"imag");
					HX_STACK_LINE(1082)
					{
						HX_STACK_LINE(1083)
			...
			HX_STACK_LINE(1118)
			::zpp_nape::shape::ZPP_Shape tmp94 = this->ws1;		HX_STACK_VAR(tmp94,"tmp94");
			HX_STACK_LINE(1118)
			bool tmp95 = tmp94->fluidEnabled;		HX_STACK_VAR(tmp95,"tmp95");
			HX_STACK_LINE(1118)
			if ((tmp95)){
				HX_STACK_LINE(1119)
				::zpp_nape::shape::ZPP_Shape tmp96 = this->ws1;		HX_STACK_VAR(tmp96,"tmp96");
				HX_STACK_LINE(1119)
				Float tmp97 = tmp96->fluidProperties->viscosity;		HX_STACK_VAR(tmp97,"tmp97");
				HX_STACK_LINE(1119)
				Float tmp98 = -(tmp97);		HX_STACK_VAR(tmp98,"tmp98");
				HX_STACK_LINE(1119)
				Float tmp99 = this->overlap;		HX_STACK_VAR(tmp99,"tmp99");
				HX_STACK_LINE(1119)
				Float tmp100 = (tmp98 * tmp99);		HX_STACK_VAR(tmp100,"tmp100");
				HX_STACK_LINE(1119)
				::zpp_nape::shape::ZPP_Shape tmp101 = this->ws2;		HX_STACK_VAR(tmp101,"tmp101");
				HX_STACK_LINE(1119)
				Float tmp102 = tmp101->area;		HX_STACK_VAR(tmp102,"tmp102");
				HX_STACK_LINE(1119)
				Float tmp103 = (Float(tmp100) / Float(tmp102));		HX_STACK_VAR(tmp103,"tmp103");
				HX_STACK_LINE(1119)
				Float f = tmp103;		HX_STACK_VAR(f,"f");
				HX_STACK_LINE(1120)
				::zpp_nape::shape::ZPP_Shape tmp104 = this->ws2;		HX_STACK_VAR(tmp104,"tmp104");
				HX_STACK_LINE(1120)
				int tmp105 = tmp104->type;		HX_STACK_VAR(tmp105,"tmp105");
				HX_STACK_LINE(1120)
				...
				if ((tmp106)){
					...
					HX_STACK_LINE(1120)
					::zpp_nape::shape::ZPP_Shape tmp108 = this->ws2;		HX_STACK_VAR(tmp108,"tmp108");
					HX_STACK_LINE(1120)
					Float tmp109 = tmp108->circle->radius;		HX_STACK_VAR(tmp109,"tmp109");
					HX_STACK_LINE(1120)
					...
					HX_STACK_LINE(1120)
					::zpp_nape::shape::ZPP_Shape tmp113 = this->ws2;		HX_STACK_VAR(tmp113,"tmp113");
					HX_STACK_LINE(1120)
					...
					HX_STACK_LINE(1122)
					::zpp_nape::shape::ZPP_Shape tmp107 = this->ws2;		HX_STACK_VAR(tmp107,"tmp107");
					HX_STACK_LINE(1122)
					::zpp_nape::shape::ZPP_Polygon poly = tmp107->polygon;		HX_STACK_VAR(poly,"poly");
					HX_STACK_LINE(1123)
					...
					HX_STACK_LINE(1125)
					{
						...
						while((true)){
							...
							HX_STACK_LINE(1129)
							{
								...
								HX_STACK_LINE(1131)
								Float tmp112 = ex->gnormx;		HX_STACK_VAR(tmp112,"tmp112");
								HX_STACK_LINE(1131)
								Float tmp113 = this->nx;		HX_STACK_VAR(tmp113,"tmp113");
								HX_STACK_LINE(1131)
								Float tmp114 = (tmp112 * tmp113);		HX_STACK_VAR(tmp114,"tmp114");
								HX_STACK_LINE(1131)
								Float tmp115 = ex->gnormy;		HX_STACK_VAR(tmp115,"tmp115");
								HX_STACK_LINE(1131)
								Float tmp116 = this->ny;		HX_STACK_VAR(tmp116,"tmp116");
								HX_STACK_LINE(1131)
								Float tmp117 = (tmp115 * tmp116);		HX_STACK_VAR(tmp117,"tmp117");
								HX_STACK_LINE(1131)
								Float tmp118 = (tmp114 + tmp117);		HX_STACK_VAR(tmp118,"tmp118");
								HX_STACK_LINE(1131)
								Float tmp119 = (tmp111 * tmp118);		HX_STACK_VAR(tmp119,"tmp119");
								HX_STACK_LINE(1131)
								Float fact = tmp119;		HX_STACK_VAR(fact,"fact");
								HX_STACK_LINE(1132)
								bool tmp120 = (fact > (int)0);		HX_STACK_VAR(tmp120,"tmp120");
								HX_STACK_LINE(1132)
								if ((tmp120)){
									HX_STACK_LINE(1132)
									Float tmp121 = ::nape::Config_obj::fluidVacuumDrag;		HX_STACK_VAR(tmp121,"tmp121");
									HX_STACK_LINE(1132)
									Float tmp122 = -(tmp121);		HX_STACK_VAR(tmp122,"tmp122");
									HX_STACK_LINE(1132)
									Float tmp123 = hx::MultEq(fact,tmp122);		HX_STACK_VAR(tmp123,"tmp123");
									HX_STACK_LINE(1132)
									fact = tmp123;
								}
								HX_STACK_LINE(1133)
								Float tmp121 = (fact * ((Float)0.5));		HX_STACK_VAR(tmp121,"tmp121");
								HX_STACK_LINE(1133)
								Float tmp122 = ::nape::Config_obj::fluidLinearDrag;		HX_STACK_VAR(tmp122,"tmp122");
								HX_STACK_LINE(1133)
			...
			HX_STACK_LINE(1141)
			::zpp_nape::shape::ZPP_Shape tmp96 = this->ws2;		HX_STACK_VAR(tmp96,"tmp96");
			HX_STACK_LINE(1141)
			...
			if ((tmp97)){
				...
				HX_STACK_LINE(1142)
				::zpp_nape::shape::ZPP_Shape tmp103 = this->ws1;		HX_STACK_VAR(tmp103,"tmp103");
				HX_STACK_LINE(1142)
				...
				HX_STACK_LINE(1143)
				::zpp_nape::shape::ZPP_Shape tmp106 = this->ws1;		HX_STACK_VAR(tmp106,"tmp106");
				HX_STACK_LINE(1143)
				...
				if ((tmp108)){
					HX_STACK_LINE(1143)
					Float tmp109 = f;		HX_STACK_VAR(tmp109,"tmp109");
					HX_STACK_LINE(1143)
					::zpp_nape::shape::ZPP_Shape tmp110 = this->ws1;		HX_STACK_VAR(tmp110,"tmp110");
					HX_STACK_LINE(1143)
					Float tmp111 = tmp110->circle->radius;		HX_STACK_VAR(tmp111,"tmp111");
					HX_STACK_LINE(1143)
					Float tmp112 = (tmp109 * tmp111);		HX_STACK_VAR(tmp112,"tmp112");
					HX_STACK_LINE(1143)
					Float tmp113 = ::nape::Config_obj::fluidLinearDrag;		HX_STACK_VAR(tmp113,"tmp113");
					HX_STACK_LINE(1143)
					Float tmp114 = (tmp112 * tmp113);		HX_STACK_VAR(tmp114,"tmp114");
					HX_STACK_LINE(1143)
					::zpp_nape::shape::ZPP_Shape tmp115 = this->ws1;		HX_STACK_VAR(tmp115,"tmp115");
					HX_STACK_LINE(1143)
					Float tmp116 = tmp115->circle->radius;		HX_STACK_VAR(tmp116,"tmp116");
					HX_STACK_LINE(1143)
					Float tmp117 = ((int)2 * tmp116);		HX_STACK_VAR(tmp117,"tmp117");
					HX_STACK_LINE(1143)
					Float tmp118 = ::Math_obj::PI;		HX_STACK_VAR(tmp118,"tmp118");
					HX_STACK_LINE(1143)
					Float tmp119 = (tmp117 * tmp118);		HX_STACK_VAR(tmp119,"tmp119");
					HX_STACK_LINE(1143)
					Float tmp120 = (Float(tmp114) / Float(tmp119));		HX_STACK_VAR(tmp120,"tmp120");
					HX_STACK_LINE(1143)
					hx::SubEq(tViscosity1,tmp120);
				}
				else{
					HX_STACK_LINE(1145)
					::zpp_nape::shape::ZPP_Shape tmp109 = this->ws1;		HX_STACK_VAR(tmp109,"tmp109");
					HX_STACK_LINE(1145)
					::zpp_nape::shape::ZPP_Polygon poly = tmp109->polygon;		HX_STACK_VAR(poly,"poly");
					HX_STACK_LINE(1146)
					Float bord = ((Float)0.0);		HX_STACK_VAR(bord,"bord");
					HX_STACK_LINE(1147)
					Float acc = ((Float)0.0);		HX_STACK_VAR(acc,"acc");
					...
					{
						HX_STACK_LINE(1149)
						::zpp_nape::util::ZNPNode_ZPP_Edge tmp110 = poly->edges->head;		HX_STACK_VAR(tmp110,"tmp110");
						HX_STACK_LINE(1149)
						::zpp_nape::util::ZNPNode_ZPP_Edge cx_ite = tmp110;		HX_STACK_VAR(cx_ite,"cx_ite");
						HX_STACK_LINE(1150)
						while((true)){
							HX_STACK_LINE(1150)
							bool tmp111 = (cx_ite != null());		HX_STACK_VAR(tmp111,"tmp111");
							HX_STACK_LINE(1150)
							...
							HX_STACK_LINE(1152)
							{
								...
								hx::AddEq(bord,ex->length);
								HX_STACK_LINE(1154)
								Float tmp113 = (f * ex->length);		HX_STACK_VAR(tmp113,"tmp113");
								HX_STACK_LINE(1154)
								Float tmp114 = ex->gnormx;		HX_STACK_VAR(tmp114,"tmp114");
								HX_STACK_LINE(1154)
								Float tmp115 = this->nx;		HX_STACK_VAR(tmp115,"tmp115");
								HX_STACK_LINE(1154)
								Float tmp116 = (tmp114 * tmp115);		HX_STACK_VAR(tmp116,"tmp116");
								HX_STACK_LINE(1154)
								Float tmp117 = ex->gnormy;		HX_STACK_VAR(tmp117,"tmp117");
								HX_STACK_LINE(1154)
								Float tmp118 = this->ny;		HX_STACK_VAR(tmp118,"tmp118");
								HX_STACK_LINE(1154)
								Float tmp119 = (tmp117 * tmp118);		HX_STACK_VAR(tmp119,"tmp119");
								HX_STACK_LINE(1154)
								Float tmp120 = (tmp116 + tmp119);		HX_STACK_VAR(tmp120,"tmp120");
								HX_STACK_LINE(1154)
								Float tmp121 = (tmp113 * tmp120);		HX_STACK_VAR(tmp121,"tmp121");
								HX_STACK_LINE(1154)
								Float fact = tmp121;		HX_STACK_VAR(fact,"fact");
								HX_STACK_LINE(1155)
								bool tmp122 = (fact > (int)0);		HX_STACK_VAR(tmp122,"tmp122");
								HX_STACK_LINE(1155)
								if ((tmp122)){
									HX_STACK_LINE(1155)
									Float tmp123 = ::nape::Config_obj::fluidVacuumDrag;		HX_STACK_VAR(tmp123,"tmp123");
									HX_STACK_LINE(1155)
									Float tmp124 = -(tmp123);		HX_STACK_VAR(tmp124,"tmp124");
									HX_STACK_LINE(1155)
									Float tmp125 = hx::MultEq(fact,tmp124);		HX_STACK_VAR(tmp125,"tmp125");
									HX_STACK_LINE(1155)
									fact = tmp125;
								}
								HX_STACK_LINE(1156)
								Float tmp123 = (fact * ((Float)0.5));		HX_STACK_VAR(tmp123,"tmp123");
								HX_STACK_LINE(1156)
								Float tmp124 = ::nape::Config_obj::fluidLinearDrag;		HX_STACK_VAR(tmp124,"tmp124");
								HX_STACK_LINE(1156)
					...
					HX_STACK_LINE(1161)
					Float tmp110 = (Float(acc) / Float(bord));		HX_STACK_VAR(tmp110,"tmp110");
					HX_STACK_LINE(1161)
					hx::AddEq(tViscosity1,tmp110);
				}
			}
			HX_STACK_LINE(1164)
			bool tmp98 = (tViscosity1 != (int)0);		HX_STACK_VAR(tmp98,"tmp98");
			HX_STACK_LINE(1164)
			if ((tmp98)){
				HX_STACK_LINE(1165)
				::zpp_nape::phys::ZPP_Body tmp99 = this->b1;		HX_STACK_VAR(tmp99,"tmp99");
				HX_STACK_LINE(1165)
				Float tmp100 = tmp99->smass;		HX_STACK_VAR(tmp100,"tmp100");
				HX_STACK_LINE(1165)
				::zpp_nape::phys::ZPP_Body tmp101 = this->b2;		HX_STACK_VAR(tmp101,"tmp101");
				HX_STACK_LINE(1165)
				Float tmp102 = tmp101->smass;		HX_STACK_VAR(tmp102,"tmp102");
				HX_STACK_LINE(1165)
				Float tmp103 = (tmp100 + tmp102);		HX_STACK_VAR(tmp103,"tmp103");
				HX_STACK_LINE(1165)
				Float m = tmp103;		HX_STACK_VAR(m,"m");
				HX_STACK_LINE(1166)
				...
				HX_STACK_LINE(1174)
				::zpp_nape::phys::ZPP_Body tmp104 = this->b1;		HX_STACK_VAR(tmp104,"tmp104");
				HX_STACK_LINE(1174)
				Float tmp105 = tmp104->sinertia;		HX_STACK_VAR(tmp105,"tmp105");
				HX_STACK_LINE(1174)
				bool tmp106 = (tmp105 != (int)0);		HX_STACK_VAR(tmp106,"tmp106");
				HX_STACK_LINE(1174)
				if ((tmp106)){
					HX_STACK_LINE(1175)
					Float tmp107 = this->r1x;		HX_STACK_VAR(tmp107,"tmp107");
					HX_STACK_LINE(1175)
					::zpp_nape::phys::ZPP_Body tmp108 = this->b1;		HX_STACK_VAR(tmp108,"tmp108");
					HX_STACK_LINE(1175)
					Float tmp109 = tmp108->sinertia;		HX_STACK_VAR(tmp109,"tmp109");
					HX_STACK_LINE(1175)
					Float tmp110 = (tmp107 * tmp109);		HX_STACK_VAR(tmp110,"tmp110");
					HX_STACK_LINE(1175)
					Float X = tmp110;		HX_STACK_VAR(X,"X");
					HX_STACK_LINE(1176)
					Float tmp111 = this->r1y;		HX_STACK_VAR(tmp111,"tmp111");
					HX_STACK_LINE(1176)
					::zpp_nape::phys::ZPP_Body tmp112 = this->b1;		HX_STACK_VAR(tmp112,"tmp112");
					HX_STACK_LINE(1176)
					Float tmp113 = tmp112->sinertia;		HX_STACK_VAR(tmp113,"tmp113");
					HX_STACK_LINE(1176)
					Float tmp114 = (tmp111 * tmp113);		HX_STACK_VAR(tmp114,"tmp114");
					HX_STACK_LINE(1176)
					Float Y = tmp114;		HX_STACK_VAR(Y,"Y");
					HX_STACK_LINE(1177)
					{
						HX_STACK_LINE(1178)
						Float tmp115 = Y;		HX_STACK_VAR(tmp115,"tmp115");
						HX_STACK_LINE(1178)
						Float tmp116 = this->r1y;		HX_STACK_VAR(tmp116,"tmp116");
						HX_STACK_LINE(1178)
						Float tmp117 = (tmp115 * tmp116);		HX_STACK_VAR(tmp117,"tmp117");
						HX_STACK_LINE(1178)
						hx::AddEq(Ka,tmp117);
						HX_STACK_LINE(1179)
						Float tmp118 = Y;		HX_STACK_VAR(tmp118,"tmp118");
						HX_STACK_LINE(1179)
						Float tmp119 = -(tmp118);		HX_STACK_VAR(tmp119,"tmp119");
						HX_STACK_LINE(1179)
						Float tmp120 = this->r1x;		HX_STACK_VAR(tmp120,"tmp120");
						HX_STACK_LINE(1179)
						...
						HX_STACK_LINE(1180)
						Float tmp123 = this->r1x;		HX_STACK_VAR(tmp123,"tmp123");
						HX_STACK_LINE(1180)
				...
				HX_STACK_LINE(1183)
				::zpp_nape::phys::ZPP_Body tmp107 = this->b2;		HX_STACK_VAR(tmp107,"tmp107");
				HX_STACK_LINE(1183)
				Float tmp108 = tmp107->sinertia;		HX_STACK_VAR(tmp108,"tmp108");
				HX_STACK_LINE(1183)
				bool tmp109 = (tmp108 != (int)0);		HX_STACK_VAR(tmp109,"tmp109");
				HX_STACK_LINE(1183)
				if ((tmp109)){
					HX_STACK_LINE(1184)
					Float tmp110 = this->r2x;		HX_STACK_VAR(tmp110,"tmp110");
					HX_STACK_LINE(1184)
					::zpp_nape::phys::ZPP_Body tmp111 = this->b2;		HX_STACK_VAR(tmp111,"tmp111");
					HX_STACK_LINE(1184)
					Float tmp112 = tmp111->sinertia;		HX_STACK_VAR(tmp112,"tmp112");
					HX_STACK_LINE(1184)
					Float tmp113 = (tmp110 * tmp112);		HX_STACK_VAR(tmp113,"tmp113");
					HX_STACK_LINE(1184)
					Float X = tmp113;		HX_STACK_VAR(X,"X");
					HX_STACK_LINE(1185)
					Float tmp114 = this->r2y;		HX_STACK_VAR(tmp114,"tmp114");
					HX_STACK_LINE(1185)
					::zpp_nape::phys::ZPP_Body tmp115 = this->b2;		HX_STACK_VAR(tmp115,"tmp115");
					HX_STACK_LINE(1185)
					Float tmp116 = tmp115->sinertia;		HX_STACK_VAR(tmp116,"tmp116");
					HX_STACK_LINE(1185)
					Float tmp117 = (tmp114 * tmp116);		HX_STACK_VAR(tmp117,"tmp117");
					HX_STACK_LINE(1185)
					Float Y = tmp117;		HX_STACK_VAR(Y,"Y");
					HX_STACK_LINE(1186)
					{
						HX_STACK_LINE(1187)
						Float tmp118 = Y;		HX_STACK_VAR(tmp118,"tmp118");
						HX_STACK_LINE(1187)
						Float tmp119 = this->r2y;		HX_STACK_VAR(tmp119,"tmp119");
						HX_STACK_LINE(1187)
						Float tmp120 = (tmp118 * tmp119);		HX_STACK_VAR(tmp120,"tmp120");
						HX_STACK_LINE(1187)
						hx::AddEq(Ka,tmp120);
						HX_STACK_LINE(1188)
						Float tmp121 = Y;		HX_STACK_VAR(tmp121,"tmp121");
						HX_STACK_LINE(1188)
						Float tmp122 = -(tmp121);		HX_STACK_VAR(tmp122,"tmp122");
						HX_STACK_LINE(1188)
						Float tmp123 = this->r2x;		HX_STACK_VAR(tmp123,"tmp123");
						HX_STACK_LINE(1188)
						Float tmp124 = (tmp122 * tmp123);		HX_STACK_VAR(tmp124,"tmp124");
						HX_STACK_LINE(1188)
						hx::AddEq(Kb,tmp124);
						HX_STACK_LINE(1189)
						Float tmp125 = X;		HX_STACK_VAR(tmp125,"tmp125");
						HX_STACK_LINE(1189)
						Float tmp126 = this->r2x;		HX_STACK_VAR(tmp126,"tmp126");
						HX_STACK_LINE(1189)
				...
				{
					HX_STACK_LINE(1193)
					Float tmp110 = (Ka * Kc);		HX_STACK_VAR(tmp110,"tmp110");
					HX_STACK_LINE(1193)
					Float tmp111 = (Kb * Kb);		HX_STACK_VAR(tmp111,"tmp111");
					HX_STACK_LINE(1193)
					Float tmp112 = (tmp110 - tmp111);		HX_STACK_VAR(tmp112,"tmp112");
					HX_STACK_LINE(1193)
					...
					if ((tmp113)){
						HX_STACK_LINE(1195)
						Float tmp114 = Kc = (int)0;		HX_STACK_VAR(tmp114,"tmp114");
						HX_STACK_LINE(1195)
						Float tmp115 = Kb = tmp114;		HX_STACK_VAR(tmp115,"tmp115");
						HX_STACK_LINE(1195)
						Ka = tmp115;
						HX_STACK_LINE(1196)
						(int)3;
						...
						if ((tmp114)){
							...
							HX_STACK_LINE(1200)
							bool tmp115 = (Ka != (int)0);		HX_STACK_VAR(tmp115,"tmp115");
							HX_STACK_LINE(1200)
							if ((tmp115)){
								HX_STACK_LINE(1200)
								Float tmp116 = (Float((int)1) / Float(Ka));		HX_STACK_VAR(tmp116,"tmp116");
								HX_STACK_LINE(1200)
								Ka = tmp116;
							}
							else{
							...
							HX_STACK_LINE(1205)
							bool tmp116 = (Kc != (int)0);		HX_STACK_VAR(tmp116,"tmp116");
							HX_STACK_LINE(1205)
							if ((tmp116)){
								HX_STACK_LINE(1205)
								Float tmp117 = (Float((int)1) / Float(Kc));		HX_STACK_VAR(tmp117,"tmp117");
								HX_STACK_LINE(1205)
								Kc = tmp117;
							}
							else{
							...
							det = tmp115;
							HX_STACK_LINE(1215)
							Float tmp116 = (Kc * det);		HX_STACK_VAR(tmp116,"tmp116");
							HX_STACK_LINE(1215)
							Float t = tmp116;		HX_STACK_VAR(t,"t");
							HX_STACK_LINE(1216)
							Float tmp117 = (Ka * det);		HX_STACK_VAR(tmp117,"tmp117");
							HX_STACK_LINE(1216)
							Kc = tmp117;
							HX_STACK_LINE(1217)
							Ka = t;
				...
				{
					HX_STACK_LINE(1229)
					Float tmp110;		HX_STACK_VAR(tmp110,"tmp110");
					HX_STACK_LINE(1229)
					{
						HX_STACK_LINE(1230)
						Float tmp111 = ::Math_obj::PI;		HX_STACK_VAR(tmp111,"tmp111");
						HX_STACK_LINE(1230)
						Float tmp112 = ((int)2 * tmp111);		HX_STACK_VAR(tmp112,"tmp112");
						HX_STACK_LINE(1230)
						Float tmp113 = tViscosity1;		HX_STACK_VAR(tmp113,"tmp113");
						HX_STACK_LINE(1230)
						Float tmp114 = (tmp112 * tmp113);		HX_STACK_VAR(tmp114,"tmp114");
						HX_STACK_LINE(1230)
						Float omega = tmp114;		HX_STACK_VAR(omega,"omega");
						HX_STACK_LINE(1231)
						Float tmp115 = (dt * omega);		HX_STACK_VAR(tmp115,"tmp115");
						HX_STACK_LINE(1231)
						int tmp116 = (int)2;		HX_STACK_VAR(tmp116,"tmp116");
						HX_STACK_LINE(1231)
						Float tmp117 = (omega * dt);		HX_STACK_VAR(tmp117,"tmp117");
						HX_STACK_LINE(1231)
						Float tmp118 = (tmp116 + tmp117);		HX_STACK_VAR(tmp118,"tmp118");
						HX_STACK_LINE(1231)
						Float tmp119 = (tmp115 * tmp118);		HX_STACK_VAR(tmp119,"tmp119");
						HX_STACK_LINE(1231)
						Float tmp120 = (Float((int)1) / Float(tmp119));		HX_STACK_VAR(tmp120,"tmp120");
						HX_STACK_LINE(1231)
						this->lgamma = tmp120;
						HX_STACK_LINE(1232)
						Float tmp121 = this->lgamma;		HX_STACK_VAR(tmp121,"tmp121");
						HX_STACK_LINE(1232)
						Float tmp122 = ((int)1 + tmp121);		HX_STACK_VAR(tmp122,"tmp122");
						HX_STACK_LINE(1232)
						Float tmp123 = (Float((int)1) / Float(tmp122));		HX_STACK_VAR(tmp123,"tmp123");
						HX_STACK_LINE(1232)
						Float ig = tmp123;		HX_STACK_VAR(ig,"ig");
						HX_STACK_LINE(1233)
						Float tmp124 = (dt * omega);		HX_STACK_VAR(tmp124,"tmp124");
						HX_STACK_LINE(1233)
						Float tmp125 = omega;		HX_STACK_VAR(tmp125,"tmp125");
						HX_STACK_LINE(1233)
						Float tmp126 = (tmp124 * tmp125);		HX_STACK_VAR(tmp126,"tmp126");
						HX_STACK_LINE(1233)
						Float tmp127 = this->lgamma;		HX_STACK_VAR(tmp127,"tmp127");
						HX_STACK_LINE(1233)
