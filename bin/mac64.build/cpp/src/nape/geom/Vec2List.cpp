		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				if ((tmp5)){
					...
					{
						HX_STACK_LINE(664)
						bool tmp7 = (i != null());		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(664)
					...
					HX_STACK_LINE(664)
					{
						...
						{
							HX_STACK_LINE(664)
							bool tmp9 = i->zpp_disp;		HX_STACK_VAR(tmp9,"tmp9");
							HX_STACK_LINE(664)
							if ((tmp9)){
								HX_STACK_LINE(664)
						...
						HX_STACK_LINE(664)
						{
							...
							if ((tmp13)){
								...
								ret1->zpp_disp = false;
								HX_STACK_LINE(664)
								::nape::geom::Vec2 tmp15 = ret1;		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(664)
						...
						HX_STACK_LINE(664)
						bool tmp12 = (ret1->zpp_inner == null());		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(664)
						if ((tmp12)){
							HX_STACK_LINE(664)
							...
							{
								HX_STACK_LINE(664)
								bool tmp13 = (ret1 != null());		HX_STACK_VAR(tmp13,"tmp13");
								HX_STACK_LINE(664)
							...
							if ((tmp18)){
								...
								HX_STACK_LINE(664)
								{
									...
									HX_STACK_LINE(664)
									Float tmp21 = ret1->zpp_inner->y;		HX_STACK_VAR(tmp21,"tmp21");
									HX_STACK_LINE(664)
									tmp20 = tmp21;
								}
								HX_STACK_LINE(664)
...
::nape::geom::Vec2List Vec2List_obj::fromArray( Array< ::Dynamic > array){
	...
	HX_STACK_LINE(310)
	::nape::geom::Vec2List tmp1 = ::nape::geom::Vec2List_obj::__new();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(310)
	::nape::geom::Vec2List ret = tmp1;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(311)
	{
		HX_STACK_LINE(311)
		...
		while((true)){
			...
			HX_STACK_LINE(311)
			::nape::geom::Vec2 tmp4 = array->__get(_g).StaticCast< ::nape::geom::Vec2 >();		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(311)
			::nape::geom::Vec2 i = tmp4;		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			::nape::geom::Vec2 tmp5 = i;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(316)
			ret->push(tmp5);
		}
	}
	HX_STACK_LINE(318)
	::nape::geom::Vec2List tmp2 = ret;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(318)
	return tmp2;
}
