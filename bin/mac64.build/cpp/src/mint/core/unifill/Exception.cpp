...
::mint::core::unifill::Exception  Exception_obj::InvalidCodePoint(int code)
	{ return hx::CreateEnum< Exception_obj >(HX_HCSTRING("InvalidCodePoint","\x0c","\x5a","\xfa","\xab"),0,hx::DynamicArray(0,1).Add(code)); }

::mint::core::unifill::Exception  Exception_obj::InvalidCodeUnitSequence(int index)
...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("mint.core.unifill.Exception","\xf1","\x9b","\x58","\xfb"), hx::TCanCast< Exception_obj >,sStaticFields,sMemberFields,
