...
::nape::constraint::Constraint ZPP_WeldJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	...
	HX_STACK_LINE(332)
	::nape::constraint::WeldJoint tmp2 = ::nape::constraint::WeldJoint_obj::__new(null(),null(),tmp,tmp1,null());		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(332)
	::nape::constraint::WeldJoint ret = tmp2;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(333)
	::nape::constraint::WeldJoint tmp3 = ret;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(333)
	this->copyto(tmp3);
	HX_STACK_LINE(334)
	{
		...
		if ((tmp5)){
			...
			if ((tmp6)){
				...
				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_4_1,::nape::constraint::WeldJoint,ret)
	...
	HX_STACK_LINE(376)
	::nape::constraint::WeldJoint tmp4 = ret;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(376)
	return tmp4;
}
...
Void ZPP_WeldJoint_obj::validate( ){
{
		...
		if ((tmp17)){
			...
			HX_STACK_LINE(495)
			int tmp21 = tmp20->type;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(495)
			bool tmp22 = (tmp21 == (int)2);		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(495)
