...
::zpp_nape::constraint::ZPP_CopyHelper ZPP_CopyHelper_obj::dict( int id,::nape::phys::Body bc){
	...
	HX_STACK_ARG(bc,"bc")
	HX_STACK_LINE(561)
	::zpp_nape::constraint::ZPP_CopyHelper tmp = ::zpp_nape::constraint::ZPP_CopyHelper_obj::__new();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(561)
	::zpp_nape::constraint::ZPP_CopyHelper ret = tmp;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(562)
	ret->id = id;
	HX_STACK_LINE(563)
	ret->bc = bc;
	HX_STACK_LINE(564)
	::zpp_nape::constraint::ZPP_CopyHelper tmp1 = ret;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(564)
	return tmp1;
}
