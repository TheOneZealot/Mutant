	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				if ((tmp5)){
					HX_STACK_LINE(666)
					::String tmp7 = HX_HCSTRING("Error: Contact","\xf2","\xbf","\x0d","\x29");		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(666)
...
::nape::dynamics::ContactList ContactList_obj::fromArray( Array< ::Dynamic > array){
	...
	HX_STACK_LINE(310)
	::nape::dynamics::ContactList tmp1 = ::nape::dynamics::ContactList_obj::__new();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(310)
	::nape::dynamics::ContactList ret = tmp1;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(311)
	{
		HX_STACK_LINE(311)
		...
		while((true)){
			...
			HX_STACK_LINE(311)
			::nape::dynamics::Contact tmp4 = array->__get(_g).StaticCast< ::nape::dynamics::Contact >();		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(311)
			::nape::dynamics::Contact i = tmp4;		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			::nape::dynamics::Contact tmp5 = i;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(316)
			ret->push(tmp5);
		}
	}
	HX_STACK_LINE(318)
	::nape::dynamics::ContactList tmp2 = ret;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(318)
	return tmp2;
}
