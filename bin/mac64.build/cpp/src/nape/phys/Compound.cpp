			...
			HX_STACK_ARG(b,"b")
			{
				...
				if ((tmp2)){
					...
					HX_STACK_LINE(405)
					{
						...
						if ((tmp7)){
							HX_STACK_LINE(405)
							::zpp_nape::util::ZNPList_ZPP_Shape tmp9 = b->zpp_inner->shapes;		HX_STACK_VAR(tmp9,"tmp9");
							HX_STACK_LINE(405)
					...
					HX_STACK_LINE(406)
					{
						...
						if ((tmp9)){
							HX_STACK_LINE(406)
							::zpp_nape::util::ZNPList_ZPP_Shape tmp11 = b->zpp_inner->shapes;		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(406)
