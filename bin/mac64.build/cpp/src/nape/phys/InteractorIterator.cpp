...
::nape::phys::InteractorIterator InteractorIterator_obj::get( ::nape::phys::InteractorList list){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(220)
		::nape::phys::InteractorIterator tmp3 = ::nape::phys::InteractorIterator_obj::__new();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(220)
		::nape::phys::InteractorIterator ret = tmp3;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(221)
