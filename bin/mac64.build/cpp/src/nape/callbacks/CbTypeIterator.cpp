...
::nape::callbacks::CbTypeIterator CbTypeIterator_obj::get( ::nape::callbacks::CbTypeList list){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(220)
		::nape::callbacks::CbTypeIterator tmp3 = ::nape::callbacks::CbTypeIterator_obj::__new();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(220)
		::nape::callbacks::CbTypeIterator ret = tmp3;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(221)
