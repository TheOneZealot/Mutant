...
Void ZNPArray2_ZPP_GeomVert_obj::resize( int width,int height,::zpp_nape::geom::ZPP_GeomVert def){
{
		...
		HX_STACK_LINE(263)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(264)
				::zpp_nape::geom::ZPP_GeomVert tmp4 = def;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(264)
				this->list[i] = tmp4;
			}
		}
...
::zpp_nape::geom::ZPP_GeomVert ZNPArray2_ZPP_GeomVert_obj::get( int x,int y){
	...
	HX_STACK_LINE(278)
	::zpp_nape::geom::ZPP_GeomVert tmp5 = this->list->__get(tmp4).StaticCast< ::zpp_nape::geom::ZPP_GeomVert >();		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(278)
	return tmp5;
}
...
::zpp_nape::geom::ZPP_GeomVert ZNPArray2_ZPP_GeomVert_obj::set( int x,int y,::zpp_nape::geom::ZPP_GeomVert obj){
	...
	int tmp4 = (tmp2 + tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(291)
	::zpp_nape::geom::ZPP_GeomVert tmp5 = obj;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(291)
	::zpp_nape::geom::ZPP_GeomVert tmp6 = this->list[tmp4] = tmp5;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(291)
	return tmp6;
}
