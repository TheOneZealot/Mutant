...
::mint::core::DebugError  DebugError_obj::assertion(::String expr)
	{ return hx::CreateEnum< DebugError_obj >(HX_HCSTRING("assertion","\xc2","\xc6","\xfc","\x9f"),0,hx::DynamicArray(0,1).Add(expr)); }

::mint::core::DebugError  DebugError_obj::null_assertion(::String expr)
...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("mint.core.DebugError","\x78","\x8d","\xb4","\x4a"), hx::TCanCast< DebugError_obj >,sStaticFields,sMemberFields,
