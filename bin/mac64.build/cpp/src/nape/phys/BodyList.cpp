	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				if ((tmp5)){
					HX_STACK_LINE(666)
					::String tmp7 = HX_HCSTRING("Error: Body","\x10","\x8e","\x85","\x67");		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(666)
...
::nape::phys::BodyList BodyList_obj::fromArray( Array< ::Dynamic > array){
	...
	HX_STACK_LINE(310)
	::nape::phys::BodyList tmp1 = ::nape::phys::BodyList_obj::__new();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(310)
	...
	HX_STACK_LINE(311)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(311)
			::nape::phys::Body tmp4 = array->__get(_g).StaticCast< ::nape::phys::Body >();		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(311)
			::nape::phys::Body i = tmp4;		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			::nape::phys::Body tmp5 = i;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(316)
			ret->push(tmp5);
		}
	}
