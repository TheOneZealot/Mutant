...
::nape::shape::Shape ShapeList_obj::at( int index){
	...
	if ((tmp2)){
		...
		HX_STACK_LINE(368)
		{
			...
			::zpp_nape::util::ZPP_ShapeList tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(368)
			::zpp_nape::util::ZPP_ShapeList tmp7 = tmp6;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(368)
			tmp7->valmod();
			HX_STACK_LINE(368)
			...
			if ((tmp11)){
				...
				HX_STACK_LINE(368)
				::zpp_nape::util::ZPP_ShapeList tmp13 = tmp12;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(368)
				...
				HX_STACK_LINE(368)
				{
					...
					HX_STACK_LINE(368)
					::zpp_nape::util::ZPP_ShapeList tmp15 = tmp14;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(368)
					...
					HX_STACK_LINE(368)
					::zpp_nape::util::ZPP_ShapeList tmp19 = tmp18;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(368)
	...
	if ((tmp6)){
		...
		if ((tmp11)){
			...
			::zpp_nape::util::ZPP_ShapeList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZPP_ShapeList tmp14 = tmp13;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp15 = tmp14->at_ite;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(372)
			tmp12 = (tmp15 == null());
		}
		else{
		...
		if ((tmp12)){
			...
			HX_STACK_LINE(374)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp16 = tmp14->inner->iterator_at(tmp15);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(374)
			...
			while((true)){
				...
				HX_STACK_LINE(379)
				::zpp_nape::util::ZNPNode_ZPP_Shape tmp20 = tmp19->at_ite->next;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(379)
		...
		if ((tmp12)){
			...
			::zpp_nape::util::ZPP_ShapeList tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(386)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp15 = tmp14->inner->head;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(386)
			...
			while((true)){
				...
				::zpp_nape::util::ZPP_ShapeList tmp17 = this->zpp_inner;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(388)
				::zpp_nape::shape::ZPP_Shape tmp18 = tmp17->at_ite->elt;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(388)
				::zpp_nape::shape::ZPP_Shape x = tmp18;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(389)
				break;
				HX_STACK_LINE(390)
				::zpp_nape::util::ZPP_ShapeList tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
		...
		while((true)){
			...
			while((true)){
				...
				HX_STACK_LINE(397)
				::zpp_nape::shape::ZPP_Shape tmp23 = tmp22->at_ite->elt;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(397)
				::zpp_nape::shape::ZPP_Shape x = tmp23;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(398)
				break;
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_ShapeList tmp24 = this->zpp_inner;		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZNPNode_ZPP_Shape tmp25 = tmp24->at_ite->next;		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_ShapeList tmp26 = this->zpp_inner;		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(399)
				tmp26->at_ite = tmp25;
			}
		}
	...
	::zpp_nape::util::ZPP_ShapeList tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(403)
	::zpp_nape::shape::ZPP_Shape tmp8 = tmp7->at_ite->elt;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(403)
	::nape::shape::Shape tmp9 = tmp8->outer;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(403)
	return tmp9;
}
...
bool ShapeList_obj::push( ::nape::shape::Shape obj){
	...
	if ((tmp1)){
		HX_STACK_LINE(418)
		::String tmp2 = HX_HCSTRING("Error: Shape","\xf3","\xcf","\x83","\xf2");		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(418)
	...
	if ((tmp6)){
		...
		::zpp_nape::util::ZPP_ShapeList tmp8 = this->zpp_inner;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(424)
		::nape::shape::Shape tmp9 = obj;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(424)
	...
	if ((tmp8)){
		...
		if ((tmp10)){
			...
			::zpp_nape::util::ZPP_ShapeList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(426)
			::zpp_nape::shape::ZPP_Shape tmp12 = obj->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(426)
			...
			::zpp_nape::util::ZPP_ShapeList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(428)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp12 = tmp11->push_ite;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(428)
			...
			if ((tmp13)){
				...
				HX_STACK_LINE(428)
				{
					...
					HX_STACK_LINE(428)
					::zpp_nape::util::ZNPNode_ZPP_Shape tmp16 = tmp15->inner->head;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(428)
					tmp14 = (tmp16 == null());
				}
				HX_STACK_LINE(428)
				::zpp_nape::util::ZNPNode_ZPP_Shape tmp15;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(428)
				if ((tmp14)){
					HX_STACK_LINE(428)
					tmp15 = null();
			...
			::zpp_nape::util::ZPP_ShapeList tmp15 = this->zpp_inner;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp16 = tmp15->push_ite;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(429)
			::zpp_nape::shape::ZPP_Shape tmp17 = obj->zpp_inner;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp18 = tmp14->inner->insert(tmp16,tmp17);		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZPP_ShapeList tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(429)
...
::nape::shape::Shape ShapeList_obj::pop( ){
	...
	if ((tmp6)){
		...
		::zpp_nape::util::ZPP_ShapeList tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(491)
		::zpp_nape::util::ZNPNode_ZPP_Shape tmp8 = tmp7->inner->head;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(491)
		ret = tmp8->elt;
		HX_STACK_LINE(492)
		...
		if ((tmp11)){
			...
			::zpp_nape::util::ZPP_ShapeList tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(493)
			::nape::shape::Shape tmp13 = retx;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(493)
			tmp12->subber(tmp13);
		}
		HX_STACK_LINE(494)
		...
		::zpp_nape::util::ZPP_ShapeList tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(497)
		::zpp_nape::util::ZNPNode_ZPP_Shape tmp8 = tmp7->at_ite;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(497)
		...
		if ((tmp9)){
			...
			::zpp_nape::util::ZPP_ShapeList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZPP_ShapeList tmp12 = tmp11;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp13 = tmp12->at_ite->next;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp14 = tmp13;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(497)
			tmp10 = (tmp14 == null());
		}
		else{
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_Shape ite = tmp13;		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(499)
		bool tmp14 = (ite == null());		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(499)
		::zpp_nape::shape::ZPP_Shape tmp15;		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(499)
		if ((tmp14)){
			HX_STACK_LINE(499)
			::zpp_nape::util::ZPP_ShapeList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(499)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp17 = tmp16->inner->head;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(499)
			tmp15 = tmp17->elt;
		}
		else{
		...
		if ((tmp18)){
			...
			::zpp_nape::util::ZPP_ShapeList tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(501)
			::nape::shape::Shape tmp20 = retx;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(501)
			tmp19->subber(tmp20);
		}
		HX_STACK_LINE(502)
		...
		if ((tmp21)){
			...
			::zpp_nape::util::ZPP_ShapeList tmp22 = this->zpp_inner;		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(502)
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp23 = ite;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(502)
	...
	::nape::shape::Shape retx = ret->outer;		HX_STACK_VAR(retx,"retx");
	HX_STACK_LINE(506)
	::nape::shape::Shape tmp8 = retx;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(506)
	return tmp8;
}
...
bool ShapeList_obj::remove( ::nape::shape::Shape obj){
	...
	HX_STACK_LINE(585)
	{
		...
		HX_STACK_LINE(587)
		{
			...
			::zpp_nape::util::ZNPNode_ZPP_Shape tmp5 = tmp4->inner->head;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_ZPP_Shape cx_ite = tmp5;		HX_STACK_VAR(cx_ite,"cx_ite");
			HX_STACK_LINE(589)
			while((true)){
				HX_STACK_LINE(589)
		...
		if ((tmp3)){
			...
			while((true)){
				...
				HX_STACK_LINE(619)
				{
					...
					::zpp_nape::util::ZPP_ShapeList tmp5 = this->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(619)
					::zpp_nape::util::ZNPNode_ZPP_Shape tmp6 = tmp5->inner->head;		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(619)
					tmp4 = (tmp6 == null());
				}
				HX_STACK_LINE(619)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				if ((tmp5)){
					HX_STACK_LINE(666)
					::String tmp7 = HX_HCSTRING("Error: Shape","\xf3","\xcf","\x83","\xf2");		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(666)
...
{
		HX_STACK_FRAME("nape.shape.ShapeList","merge",0x06d88db6,"nape.shape.ShapeList.merge","nape/shape/ShapeList.hx",684,0xf97a5714)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		...
		HX_STACK_LINE(688)
		{
			...
			HX_STACK_LINE(688)
			{
				...
				xs->zpp_inner->valmod();
				HX_STACK_LINE(688)
				::nape::shape::ShapeList tmp2 = xs;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(688)
				tmp1 = ::nape::shape::ShapeIterator_obj::get(tmp2);
			}
			HX_STACK_LINE(688)
			::nape::shape::ShapeIterator _g = tmp1;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(688)
			while((true)){
				...
				HX_STACK_LINE(688)
				::nape::shape::Shape x = tmp4;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(689)
				::nape::shape::Shape tmp5 = x;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(689)
				...
				if ((tmp7)){
					...
					if ((tmp9)){
						HX_STACK_LINE(689)
						::nape::shape::Shape tmp10 = x;		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(689)
						this->push(tmp10);
					}
					else{
...
::nape::shape::ShapeList ShapeList_obj::foreach( Dynamic lambda){
	...
	HX_STACK_LINE(736)
	::nape::shape::ShapeIterator it = tmp1;		HX_STACK_VAR(it,"it");
	HX_STACK_LINE(737)
	while((true)){
		HX_STACK_LINE(737)
		bool tmp2;		HX_STACK_VAR(tmp2,"tmp2");
		...
		{
			HX_STACK_LINE(737)
			::zpp_nape::util::ZPP_ShapeList tmp3 = it->zpp_inner->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(737)
			tmp3->valmod();
			HX_STACK_LINE(737)
			int tmp4;		HX_STACK_VAR(tmp4,"tmp4");
...
::nape::shape::ShapeList ShapeList_obj::filter( Dynamic lambda){
	...
	while((true)){
		...
		HX_STACK_LINE(785)
		::nape::shape::Shape tmp6 = this->at(tmp5);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(785)
		::nape::shape::Shape x = tmp6;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(786)
		try
		{
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			HX_STACK_LINE(787)
			::nape::shape::Shape tmp7 = x;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(787)
...
::nape::shape::ShapeList ShapeList_obj::fromArray( Array< ::Dynamic > array){
	...
	HX_STACK_LINE(310)
	::nape::shape::ShapeList tmp1 = ::nape::shape::ShapeList_obj::__new();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(310)
	...
	HX_STACK_LINE(311)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(311)
			::nape::shape::Shape tmp4 = array->__get(_g).StaticCast< ::nape::shape::Shape >();		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(311)
			::nape::shape::Shape i = tmp4;		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			::nape::shape::Shape tmp5 = i;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(316)
			ret->push(tmp5);
		}
	}
