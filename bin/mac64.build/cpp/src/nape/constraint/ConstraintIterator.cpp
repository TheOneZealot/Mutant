...
::nape::constraint::ConstraintIterator ConstraintIterator_obj::get( ::nape::constraint::ConstraintList list){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(220)
		::nape::constraint::ConstraintIterator tmp3 = ::nape::constraint::ConstraintIterator_obj::__new();		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(220)
		::nape::constraint::ConstraintIterator ret = tmp3;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(221)
