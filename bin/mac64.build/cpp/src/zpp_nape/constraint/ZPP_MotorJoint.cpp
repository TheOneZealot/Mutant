...
::nape::constraint::Constraint ZPP_MotorJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	...
	HX_STACK_LINE(208)
	::nape::constraint::MotorJoint tmp2 = ::nape::constraint::MotorJoint_obj::__new(null(),null(),tmp,tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(208)
	::nape::constraint::MotorJoint ret = tmp2;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(209)
	...
	HX_STACK_LINE(252)
	::nape::constraint::MotorJoint tmp4 = ret;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(252)
	return tmp4;
}
