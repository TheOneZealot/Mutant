...
int precedence = __o_precedence.Default(0);
{
	...
	HX_STACK_LINE(369)
	{
		HX_STACK_LINE(369)
		{
			...
			{
				HX_STACK_LINE(369)
				::zpp_nape::callbacks::ZPP_InteractionListener tmp18 = this->zpp_inner_zn;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(369)
				int ret = tmp18->itype;		HX_STACK_VAR(ret,"ret");
				HX_STACK_LINE(369)
				bool tmp19 = (ret == (int)1);		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(369)
				if ((tmp19)){
					HX_STACK_LINE(369)
					...
					HX_STACK_LINE(369)
					bool tmp20 = (ret == (int)2);		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(369)
					if ((tmp20)){
						HX_STACK_LINE(369)
						...
						HX_STACK_LINE(369)
						tmp17 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;
					}
					else{
						HX_STACK_LINE(369)
						bool tmp21 = (ret == (int)4);		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(369)
						if ((tmp21)){
							HX_STACK_LINE(369)
							::nape::callbacks::InteractionType tmp22 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;		HX_STACK_VAR(tmp22,"tmp22");
							HX_STACK_LINE(369)
							...
							if ((tmp23)){
								...
								HX_STACK_LINE(369)
								::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID = tmp24;
								HX_STACK_LINE(369)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(369)
							tmp17 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;
						}
						else{
							HX_STACK_LINE(369)
							bool tmp22 = (ret == (int)7);		HX_STACK_VAR(tmp22,"tmp22");
							HX_STACK_LINE(369)
							if ((tmp22)){
								HX_STACK_LINE(369)
								::nape::callbacks::InteractionType tmp23 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY;		HX_STACK_VAR(tmp23,"tmp23");
								HX_STACK_LINE(369)
								...
								if ((tmp24)){
									...
									HX_STACK_LINE(369)
									::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY = tmp25;
									HX_STACK_LINE(369)
									::zpp_nape::util::ZPP_Flags_obj::internal = false;
								}
								HX_STACK_LINE(369)
								tmp17 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY;
							}
							else{
								HX_STACK_LINE(369)
								tmp17 = null();
			...
			if ((tmp19)){
				...
				{
					HX_STACK_LINE(369)
					::nape::callbacks::InteractionType tmp22 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION;		HX_STACK_VAR(tmp22,"tmp22");
					HX_STACK_LINE(369)
					bool tmp23 = (tmp22 == null());		HX_STACK_VAR(tmp23,"tmp23");
					HX_STACK_LINE(369)
					if ((tmp23)){
						...
						::nape::callbacks::InteractionType tmp24 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(tmp24,"tmp24");
						HX_STACK_LINE(369)
						::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION = tmp24;
						HX_STACK_LINE(369)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(369)
					tmp21 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION;
				}
				HX_STACK_LINE(369)
				...
				if ((tmp22)){
					...
					HX_STACK_LINE(369)
					::nape::callbacks::InteractionType tmp24 = interactionType;		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(369)
					::nape::callbacks::InteractionType tmp25;		HX_STACK_VAR(tmp25,"tmp25");
					HX_STACK_LINE(369)
					{
						HX_STACK_LINE(369)
						...
						HX_STACK_LINE(369)
						tmp25 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;
					}
					HX_STACK_LINE(369)
					...
					if ((tmp26)){
						...
						HX_STACK_LINE(369)
						::nape::callbacks::InteractionType tmp27 = interactionType;		HX_STACK_VAR(tmp27,"tmp27");
						HX_STACK_LINE(369)
						::nape::callbacks::InteractionType tmp28;		HX_STACK_VAR(tmp28,"tmp28");
						HX_STACK_LINE(369)
						{
							HX_STACK_LINE(369)
							...
							HX_STACK_LINE(369)
							tmp28 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;
						}
						HX_STACK_LINE(369)
				...
				HX_STACK_LINE(369)
				int xtype = tmp23;		HX_STACK_VAR(xtype,"xtype");
				HX_STACK_LINE(369)
				{
					HX_STACK_LINE(369)
					::zpp_nape::callbacks::ZPP_InteractionListener tmp24 = this->zpp_inner_zn;		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(369)
					tmp24->itype = xtype;
				}
			}
		...
		HX_STACK_LINE(369)
		{
			...
			HX_STACK_LINE(369)
			bool tmp17 = (ret == (int)1);		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(369)
			if ((tmp17)){
				HX_STACK_LINE(369)
				...
				HX_STACK_LINE(369)
				bool tmp18 = (ret == (int)2);		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(369)
				if ((tmp18)){
					HX_STACK_LINE(369)
					::nape::callbacks::InteractionType tmp19 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(369)
					...
					if ((tmp20)){
						...
						HX_STACK_LINE(369)
						::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR = tmp21;
						HX_STACK_LINE(369)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(369)
					...
					HX_STACK_LINE(369)
					bool tmp19 = (ret == (int)4);		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(369)
					if ((tmp19)){
						HX_STACK_LINE(369)
						::nape::callbacks::InteractionType tmp20 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(369)
						bool tmp21 = (tmp20 == null());		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(369)
						if ((tmp21)){
							...
							::nape::callbacks::InteractionType tmp22 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(tmp22,"tmp22");
							HX_STACK_LINE(369)
							::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID = tmp22;
							HX_STACK_LINE(369)
							::zpp_nape::util::ZPP_Flags_obj::internal = false;
						}
						HX_STACK_LINE(369)
						...
						HX_STACK_LINE(369)
						bool tmp20 = (ret == (int)7);		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(369)
						if ((tmp20)){
							HX_STACK_LINE(369)
							::nape::callbacks::InteractionType tmp21 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY;		HX_STACK_VAR(tmp21,"tmp21");
							HX_STACK_LINE(369)
							bool tmp22 = (tmp21 == null());		HX_STACK_VAR(tmp22,"tmp22");
							HX_STACK_LINE(369)
							if ((tmp22)){
								...
								::nape::callbacks::InteractionType tmp23 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(tmp23,"tmp23");
								HX_STACK_LINE(369)
								::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY = tmp23;
								HX_STACK_LINE(369)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(369)
