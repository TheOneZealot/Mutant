...
#define INCLUDED_mint_core_unifill__Utf8_StringU8_Impl_
...
HX_DECLARE_CLASS4(mint,core,unifill,_Utf8,StringU8_Impl_)
namespace mint{
namespace core{
namespace unifill{
namespace _Utf8{
...
class HXCPP_CLASS_ATTRIBUTES  StringU8_Impl__obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="mint.core.unifill._Utf8.StringU8_Impl_")
...
#endif /* INCLUDED_mint_core_unifill__Utf8_StringU8_Impl_ */ 
