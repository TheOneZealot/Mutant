...
HX_STACK_THIS(this)
{
	...
	this->inertiaMode = (int)0;
	HX_STACK_LINE(1621)
	::zpp_nape::util::ZNPList_ZPP_Arbiter tmp8 = ::zpp_nape::util::ZNPList_ZPP_Arbiter_obj::__new();		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(1621)
	this->arbiters = tmp8;
	HX_STACK_LINE(1622)
	...
	HX_STACK_LINE(1623)
	::zpp_nape::util::ZNPList_ZPP_Shape tmp10 = ::zpp_nape::util::ZNPList_ZPP_Shape_obj::__new();		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(1623)
	this->shapes = tmp10;
	HX_STACK_LINE(1624)
	::zpp_nape::util::ZNPList_ZPP_Shape tmp11 = this->shapes;		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(1624)
	::nape::shape::ShapeList tmp12 = ::zpp_nape::util::ZPP_ShapeList_obj::get(tmp11,null());		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(1624)
	this->wrap_shapes = tmp12;
	HX_STACK_LINE(1625)
	Dynamic tmp13 = this->shapes_adder_dyn();		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(1625)
	::nape::shape::ShapeList tmp14 = this->wrap_shapes;		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(1625)
	tmp14->zpp_inner->adder = tmp13;
	HX_STACK_LINE(1626)
	Dynamic tmp15 = this->shapes_subber_dyn();		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(1626)
	::nape::shape::ShapeList tmp16 = this->wrap_shapes;		HX_STACK_VAR(tmp16,"tmp16");
	HX_STACK_LINE(1626)
	tmp16->zpp_inner->subber = tmp15;
	HX_STACK_LINE(1627)
	Dynamic tmp17 = this->shapes_invalidate_dyn();		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(1627)
	::nape::shape::ShapeList tmp18 = this->wrap_shapes;		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(1627)
	tmp18->zpp_inner->_invalidate = tmp17;
	HX_STACK_LINE(1629)
	Dynamic tmp19 = this->shapes_modifiable_dyn();		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(1629)
	::nape::shape::ShapeList tmp20 = this->wrap_shapes;		HX_STACK_VAR(tmp20,"tmp20");
	HX_STACK_LINE(1629)
	tmp20->zpp_inner->_modifiable = tmp19;
	HX_STACK_LINE(1631)
...
bool ZPP_Body_obj::atRest( Float dt){
	...
	if ((tmp2)){
		...
		HX_STACK_LINE(308)
		Float tmp3 = ::nape::Config_obj::linearSleepThreshold;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(308)
		Float linSq = tmp3;		HX_STACK_VAR(linSq,"linSq");
		HX_STACK_LINE(309)
		...
		HX_STACK_LINE(310)
		Float tmp11 = linSq;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(310)
		...
		if ((tmp12)){
			...
			HX_STACK_LINE(311)
			{
				...
				{
					HX_STACK_LINE(311)
					Float tmp15 = this->posx;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(311)
					Float tmp16 = this->pre_posx;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(311)
					Float tmp17 = (tmp15 - tmp16);		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(311)
					dx = tmp17;
					HX_STACK_LINE(311)
					Float tmp18 = this->posy;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(311)
					Float tmp19 = this->pre_posy;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(311)
			...
			HX_STACK_LINE(311)
			Float tmp15 = (((Float)0.25) * linSq);		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(311)
			...
			if ((tmp20)){
				...
				HX_STACK_LINE(314)
				{
					...
					HX_STACK_LINE(315)
					Float tmp22 = tmp21->maxx;		HX_STACK_VAR(tmp22,"tmp22");
					HX_STACK_LINE(315)
					::zpp_nape::geom::ZPP_AABB tmp23 = this->aabb;		HX_STACK_VAR(tmp23,"tmp23");
					HX_STACK_LINE(315)
					Float tmp24 = tmp23->minx;		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(315)
					Float tmp25 = (tmp22 - tmp24);		HX_STACK_VAR(tmp25,"tmp25");
					HX_STACK_LINE(315)
					dx = tmp25;
					HX_STACK_LINE(316)
					::zpp_nape::geom::ZPP_AABB tmp26 = this->aabb;		HX_STACK_VAR(tmp26,"tmp26");
					HX_STACK_LINE(316)
					Float tmp27 = tmp26->maxy;		HX_STACK_VAR(tmp27,"tmp27");
					HX_STACK_LINE(316)
					::zpp_nape::geom::ZPP_AABB tmp28 = this->aabb;		HX_STACK_VAR(tmp28,"tmp28");
					HX_STACK_LINE(316)
					Float tmp29 = tmp28->miny;		HX_STACK_VAR(tmp29,"tmp29");
					HX_STACK_LINE(316)
				...
				HX_STACK_LINE(318)
				Float idl = tmp23;		HX_STACK_VAR(idl,"idl");
				HX_STACK_LINE(319)
				Float tmp24 = ::nape::Config_obj::angularSleepThreshold;		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(319)
				Float angSq = tmp24;		HX_STACK_VAR(angSq,"angSq");
				HX_STACK_LINE(320)
				hx::MultEq(angSq,angSq);
				HX_STACK_LINE(321)
				Float tmp25 = this->angvel;		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(321)
				Float tmp26 = ((int)4 * tmp25);		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(321)
				Float tmp27 = this->angvel;		HX_STACK_VAR(tmp27,"tmp27");
				HX_STACK_LINE(321)
				Float tmp28 = (tmp26 * tmp27);		HX_STACK_VAR(tmp28,"tmp28");
				HX_STACK_LINE(321)
				Float tmp29 = idl;		HX_STACK_VAR(tmp29,"tmp29");
				HX_STACK_LINE(321)
				Float tmp30 = (tmp28 * tmp29);		HX_STACK_VAR(tmp30,"tmp30");
				HX_STACK_LINE(321)
				Float tmp31 = angSq;		HX_STACK_VAR(tmp31,"tmp31");
				HX_STACK_LINE(321)
				...
				if ((tmp32)){
					...
					HX_STACK_LINE(322)
					Float tmp33 = this->rot;		HX_STACK_VAR(tmp33,"tmp33");
					HX_STACK_LINE(322)
					Float tmp34 = this->pre_rot;		HX_STACK_VAR(tmp34,"tmp34");
					HX_STACK_LINE(322)
					Float tmp35 = (tmp33 - tmp34);		HX_STACK_VAR(tmp35,"tmp35");
					HX_STACK_LINE(322)
					Float dr = tmp35;		HX_STACK_VAR(dr,"dr");
					HX_STACK_LINE(323)
					Float tmp36 = (dr * dr);		HX_STACK_VAR(tmp36,"tmp36");
					HX_STACK_LINE(323)
					Float tmp37 = idl;		HX_STACK_VAR(tmp37,"tmp37");
					HX_STACK_LINE(323)
					Float tmp38 = (tmp36 * tmp37);		HX_STACK_VAR(tmp38,"tmp38");
					HX_STACK_LINE(323)
					Float tmp39 = (angSq * dt);		HX_STACK_VAR(tmp39,"tmp39");
					HX_STACK_LINE(323)
					Float tmp40 = dt;		HX_STACK_VAR(tmp40,"tmp40");
					HX_STACK_LINE(323)
		...
		HX_STACK_LINE(310)
		bool cansleep = tmp13;		HX_STACK_VAR(cansleep,"cansleep");
		HX_STACK_LINE(326)
		bool tmp14 = cansleep;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(326)
		...
		if ((tmp15)){
			...
			HX_STACK_LINE(326)
			tmp17->waket = tmp16->stamp;
		}
		HX_STACK_LINE(327)
		::zpp_nape::space::ZPP_Component tmp16 = this->component;		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(327)
		int tmp17 = tmp16->waket;		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(327)
		int tmp18 = ::nape::Config_obj::sleepDelay;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(327)
		int tmp19 = (tmp17 + tmp18);		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(327)
		::zpp_nape::space::ZPP_Space tmp20 = this->space;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(327)
		int tmp21 = tmp20->stamp;		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(327)
...
Void ZPP_Body_obj::sweepValidate( ::zpp_nape::shape::ZPP_Shape s){
{
		...
		if ((tmp)){
			...
			HX_STACK_LINE(390)
			Float tmp3 = s->localCOMx;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(390)
			Float tmp4 = (tmp2 * tmp3);		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(390)
			Float tmp5 = this->axisx;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(390)
			Float tmp6 = s->localCOMy;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(390)
			...
			HX_STACK_LINE(391)
			Float tmp11 = s->localCOMx;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(391)
			Float tmp12 = this->axisx;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(391)
			Float tmp13 = (tmp11 * tmp12);		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(391)
			Float tmp14 = s->localCOMy;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(391)
			...
			HX_STACK_LINE(396)
			::zpp_nape::geom::ZPP_Vec2 tmp1 = p->lverts->next;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(396)
			::zpp_nape::geom::ZPP_Vec2 li = tmp1;		HX_STACK_VAR(li,"li");
			HX_STACK_LINE(397)
			{
				HX_STACK_LINE(398)
				::zpp_nape::geom::ZPP_Vec2 tmp2 = p->gverts->next;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(398)
				::zpp_nape::geom::ZPP_Vec2 cx_ite = tmp2;		HX_STACK_VAR(cx_ite,"cx_ite");
				HX_STACK_LINE(399)
				while((true)){
					HX_STACK_LINE(399)
					...
					HX_STACK_LINE(401)
					{
						...
						{
							HX_STACK_LINE(405)
							Float tmp5 = this->posx;		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(405)
							Float tmp6 = this->axisy;		HX_STACK_VAR(tmp6,"tmp6");
							HX_STACK_LINE(405)
							Float tmp7 = l->x;		HX_STACK_VAR(tmp7,"tmp7");
							HX_STACK_LINE(405)
							Float tmp8 = (tmp6 * tmp7);		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(405)
							...
							g->x = tmp13;
							HX_STACK_LINE(406)
							Float tmp14 = this->posy;		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(406)
			...
			HX_STACK_LINE(412)
			::zpp_nape::util::ZNPNode_ZPP_Edge tmp2 = p->edges->head;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(412)
			::zpp_nape::util::ZNPNode_ZPP_Edge ite = tmp2;		HX_STACK_VAR(ite,"ite");
			HX_STACK_LINE(413)
			{
				HX_STACK_LINE(414)
				...
				while((true)){
					...
					HX_STACK_LINE(419)
					{
						...
						HX_STACK_LINE(426)
						Float tmp6 = this->posx;		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(426)
						Float tmp7 = e->gnormx;		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(426)
						Float tmp8 = (tmp6 * tmp7);		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(426)
						Float tmp9 = this->posy;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(426)
				...
				HX_STACK_LINE(433)
				::zpp_nape::geom::ZPP_Vec2 v = tmp4;		HX_STACK_VAR(v,"v");
				HX_STACK_LINE(434)
				{
					HX_STACK_LINE(435)
					::zpp_nape::shape::ZPP_Edge e = ite->elt;		HX_STACK_VAR(e,"e");
					...
					{
						HX_STACK_LINE(438)
						Float tmp5 = this->axisy;		HX_STACK_VAR(tmp5,"tmp5");
						HX_STACK_LINE(438)
						Float tmp6 = e->lnormx;		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(438)
						Float tmp7 = (tmp5 * tmp6);		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(438)
						Float tmp8 = this->axisx;		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(438)
						Float tmp9 = e->lnormy;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(438)
						...
						HX_STACK_LINE(439)
						Float tmp13 = this->axisx;		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(439)
						Float tmp14 = (tmp12 * tmp13);		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(439)
						Float tmp15 = e->lnormy;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(439)
						Float tmp16 = this->axisy;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(439)
						Float tmp17 = (tmp15 * tmp16);		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(439)
					...
					Float tmp5 = this->posx;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(441)
					Float tmp6 = e->gnormx;		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(441)
					Float tmp7 = (tmp5 * tmp6);		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(441)
					Float tmp8 = this->posy;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(441)
					Float tmp9 = e->gnormy;		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(441)
					Float tmp10 = (tmp8 * tmp9);		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(441)
					Float tmp11 = (tmp7 + tmp10);		HX_STACK_VAR(tmp11,"tmp11");
...
Void ZPP_Body_obj::invalidate_pos( ){
{
		...
		HX_STACK_LINE(468)
		{
			...
			while((true)){
				...
				{
					HX_STACK_LINE(473)
					bool tmp3 = (s->type == (int)1);		HX_STACK_VAR(tmp3,"tmp3");
					HX_STACK_LINE(473)
					if ((tmp3)){
						HX_STACK_LINE(474)
...
Void ZPP_Body_obj::pos_invalidate( ::zpp_nape::geom::ZPP_Vec2 pos){
{
		...
		HX_STACK_LINE(489)
		Float tmp4 = pos->x;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(489)
		...
		if ((tmp5)){
			HX_STACK_LINE(489)
			Float tmp7 = this->posy;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(489)
			Float tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(489)
			Float tmp9 = pos->y;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(489)
			tmp6 = (tmp8 == tmp9);
		}
		else{
		...
		if ((tmp7)){
			...
			HX_STACK_LINE(510)
			{
				...
				{
					HX_STACK_LINE(510)
					::zpp_nape::util::ZNPList_ZPP_Shape tmp8 = this->shapes;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(510)
					::zpp_nape::util::ZNPNode_ZPP_Shape cx_ite = tmp8->head;		HX_STACK_VAR(cx_ite,"cx_ite");
					HX_STACK_LINE(510)
					while((true)){
						HX_STACK_LINE(510)
						...
						{
							HX_STACK_LINE(510)
							bool tmp11 = (s->type == (int)1);		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(510)
							if ((tmp11)){
								HX_STACK_LINE(510)
								s->polygon->invalidate_gverts();
...
Void ZPP_Body_obj::validate_mass( ){
{
		...
		if ((tmp2)){
			...
			if ((tmp4)){
				...
				{
					HX_STACK_LINE(869)
					::zpp_nape::util::ZNPList_ZPP_Shape tmp5 = this->shapes;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(869)
					...
					while((true)){
						...
						{
							HX_STACK_LINE(873)
							Float tmp8 = s->material->density;		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(873)
							s->refmaterial->density = tmp8;
							HX_STACK_LINE(874)
							s->validate_area_inertia();
							HX_STACK_LINE(875)
							Float tmp9 = s->area;		HX_STACK_VAR(tmp9,"tmp9");
							HX_STACK_LINE(875)
							Float tmp10 = s->material->density;		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(875)
							Float tmp11 = (tmp9 * tmp10);		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(875)
							hx::AddEq(this->cmass,tmp11);
						}
						HX_STACK_LINE(877)
						cx_ite = cx_ite->next;
					}
			...
			if ((tmp6)){
				HX_STACK_LINE(881)
				bool tmp8 = this->nomove;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(881)
			...
			if ((tmp7)){
				...
				this->mass = tmp8;
				HX_STACK_LINE(883)
				Float tmp9 = this->mass;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(883)
				Float tmp10 = (Float(((Float)1.0)) / Float(tmp9));		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(883)
				Float tmp11 = this->smass = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(883)
				this->imass = tmp11;
			}
			else{
				...
				this->mass = tmp8;
				HX_STACK_LINE(887)
				Float tmp9 = this->smass = ((Float)0.0);		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(887)
				this->imass = tmp9;
			}
			HX_STACK_LINE(889)
			bool tmp8 = exist;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(889)
			if ((tmp8)){
				HX_STACK_LINE(889)
				this->invalidate_inertia();
...
Void ZPP_Body_obj::invalidate_gravMass( ){
{
		...
		HX_STACK_LINE(899)
		int tmp2 = this->gravMassMode;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(899)
...
Void ZPP_Body_obj::validate_gravMass( ){
{
		...
		if ((tmp)){
			...
			if ((tmp2)){
				...
				this->validate_mass();
				HX_STACK_LINE(908)
				Float tmp3 = this->cmass;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(908)
				this->gravMass = tmp3;
			}
			else{
				...
				if ((tmp4)){
					...
					this->validate_mass();
					HX_STACK_LINE(912)
					Float tmp5 = this->cmass;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(912)
					Float tmp6 = this->gravMassScale;		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(912)
					Float tmp7 = (tmp5 * tmp6);		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(912)
					this->gravMass = tmp7;
		...
		if ((tmp)){
			...
			if ((tmp2)){
				...
				if ((tmp4)){
					...
					this->validate_mass();
					HX_STACK_LINE(926)
					Float tmp5 = this->gravMass;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(926)
					Float tmp6 = this->cmass;		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(926)
					Float tmp7 = (Float(tmp5) / Float(tmp6));		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(926)
					this->gravMassScale = tmp7;
				}
			}
		}
	}
...
Void ZPP_Body_obj::validate_inertia( ){
{
		...
		if ((tmp2)){
				...
				HX_STACK_LINE(947)
				{
					...
					while((true)){
						...
						HX_STACK_LINE(951)
						{
							...
							s->validate_area_inertia();
							HX_STACK_LINE(954)
							Float tmp9 = (s->inertia * s->area);		HX_STACK_VAR(tmp9,"tmp9");
							HX_STACK_LINE(954)
							Float tmp10 = s->material->density;		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(954)
							Float tmp11 = (tmp9 * tmp10);		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(954)
							hx::AddEq(this->cinertia,tmp11);
						}
						HX_STACK_LINE(956)
						cx_ite = cx_ite->next;
					}
			...
			if ((tmp6)){
				HX_STACK_LINE(960)
				bool tmp8 = this->norotate;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(960)
				bool tmp9 = tmp8;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(960)
				bool tmp10 = tmp9;		HX_STACK_VAR(tmp10,"tmp10");
			...
			if ((tmp7)){
				HX_STACK_LINE(961)
				Float tmp8 = this->cinertia;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(961)
				this->inertia = tmp8;
				HX_STACK_LINE(962)
				Float tmp9 = this->inertia;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(962)
				Float tmp10 = (Float(((Float)1.0)) / Float(tmp9));		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(962)
				Float tmp11 = this->iinertia = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(962)
				this->sinertia = tmp11;
			}
			else{
				...
				this->inertia = tmp8;
				HX_STACK_LINE(966)
				Float tmp9 = this->iinertia = (int)0;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(966)
				this->sinertia = tmp9;
			}
			HX_STACK_LINE(968)
						...
						HX_STACK_LINE(1030)
						{
							...
							if ((tmp7)){
								...
								if ((tmp8)){
									...
									s->zip_aabb = false;
									HX_STACK_LINE(1030)
									bool tmp9 = (s->type == (int)0);		HX_STACK_VAR(tmp9,"tmp9");
									HX_STACK_LINE(1030)
									if ((tmp9)){
										HX_STACK_LINE(1030)
					...
					HX_STACK_LINE(1088)
					{
						HX_STACK_LINE(1089)
						{
							...
							if ((tmp4)){
								...
								HX_STACK_LINE(1089)
								bool tmp5 = (s->type == (int)1);		HX_STACK_VAR(tmp5,"tmp5");
								HX_STACK_LINE(1089)
								if ((tmp5)){
									HX_STACK_LINE(1089)
									::zpp_nape::shape::ZPP_Polygon _this = s->polygon;		HX_STACK_VAR(_this,"_this");
								...
								HX_STACK_LINE(1089)
								bool tmp6 = (s->wrap_localCOM != null());		HX_STACK_VAR(tmp6,"tmp6");
								HX_STACK_LINE(1089)
								if ((tmp6)){
									HX_STACK_LINE(1089)
									...
									tmp7->x = s->localCOMx;
									HX_STACK_LINE(1089)
									::zpp_nape::geom::ZPP_Vec2 tmp8 = s->wrap_localCOM->zpp_inner;		HX_STACK_VAR(tmp8,"tmp8");
									HX_STACK_LINE(1089)
									tmp8->y = s->localCOMy;
									HX_STACK_LINE(1089)
									{
		...
		HX_STACK_LINE(1346)
		{
			HX_STACK_LINE(1346)
			{
				...
				while((true)){
					...
					{
						HX_STACK_LINE(1346)
						bool tmp13 = (s->type == (int)1);		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(1346)
						if ((tmp13)){
							HX_STACK_LINE(1346)
							s->polygon->invalidate_gverts();
							...
							HX_STACK_LINE(1390)
							{
								...
								if ((tmp10)){
									...
									if ((tmp11)){
										...
										s->zip_aabb = false;
										HX_STACK_LINE(1390)
										bool tmp12 = (s->type == (int)0);		HX_STACK_VAR(tmp12,"tmp12");
										HX_STACK_LINE(1390)
										if ((tmp12)){
											HX_STACK_LINE(1390)
											::zpp_nape::shape::ZPP_Circle _this = s->circle;		HX_STACK_VAR(_this,"_this");
											...
											{
												HX_STACK_LINE(1390)
												bool tmp13 = _this->zip_worldCOM;		HX_STACK_VAR(tmp13,"tmp13");
												HX_STACK_LINE(1390)
												if ((tmp13)){
													HX_STACK_LINE(1390)
													...
													if ((tmp14)){
														...
														{
															HX_STACK_LINE(1390)
															bool tmp15 = _this->zip_localCOM;		HX_STACK_VAR(tmp15,"tmp15");
															HX_STACK_LINE(1390)
															if ((tmp15)){
																HX_STACK_LINE(1390)
																_this->zip_localCOM = false;
																HX_STACK_LINE(1390)
																bool tmp16 = (_this->type == (int)1);		HX_STACK_VAR(tmp16,"tmp16");
																HX_STACK_LINE(1390)
																if ((tmp16)){
																	HX_STACK_LINE(1390)
																	::zpp_nape::shape::ZPP_Polygon _this1 = _this->polygon;		HX_STACK_VAR(_this1,"_this1");
														...
														HX_STACK_LINE(1390)
														{
															...
															HX_STACK_LINE(1390)
															Float tmp17 = _this->localCOMx;		HX_STACK_VAR(tmp17,"tmp17");
															HX_STACK_LINE(1390)
															Float tmp18 = (tmp16 * tmp17);		HX_STACK_VAR(tmp18,"tmp18");
															HX_STACK_LINE(1390)
															Float tmp19 = _this->body->axisx;		HX_STACK_VAR(tmp19,"tmp19");
															HX_STACK_LINE(1390)
															Float tmp20 = _this->localCOMy;		HX_STACK_VAR(tmp20,"tmp20");
															HX_STACK_LINE(1390)
															Float tmp21 = (tmp19 * tmp20);		HX_STACK_VAR(tmp21,"tmp21");
															HX_STACK_LINE(1390)
															...
															HX_STACK_LINE(1390)
															_this->worldCOMx = tmp23;
															HX_STACK_LINE(1390)
															Float tmp24 = _this->body->posy;		HX_STACK_VAR(tmp24,"tmp24");
															HX_STACK_LINE(1390)
															Float tmp25 = _this->localCOMx;		HX_STACK_VAR(tmp25,"tmp25");
															HX_STACK_LINE(1390)
															Float tmp26 = _this->body->axisx;		HX_STACK_VAR(tmp26,"tmp26");
															HX_STACK_LINE(1390)
															Float tmp27 = (tmp25 * tmp26);		HX_STACK_VAR(tmp27,"tmp27");
															HX_STACK_LINE(1390)
															Float tmp28 = _this->localCOMy;		HX_STACK_VAR(tmp28,"tmp28");
															HX_STACK_LINE(1390)
											...
											{
												HX_STACK_LINE(1390)
												Float tmp13 = (_this->worldCOMx - rx);		HX_STACK_VAR(tmp13,"tmp13");
												HX_STACK_LINE(1390)
												_this->aabb->minx = tmp13;
												HX_STACK_LINE(1390)
												Float tmp14 = (_this->worldCOMy - ry);		HX_STACK_VAR(tmp14,"tmp14");
												HX_STACK_LINE(1390)
												_this->aabb->miny = tmp14;
											}
											HX_STACK_LINE(1390)
											{
												HX_STACK_LINE(1390)
												Float tmp13 = (_this->worldCOMx + rx);		HX_STACK_VAR(tmp13,"tmp13");
												HX_STACK_LINE(1390)
												_this->aabb->maxx = tmp13;
												HX_STACK_LINE(1390)
												Float tmp14 = (_this->worldCOMy + ry);		HX_STACK_VAR(tmp14,"tmp14");
												HX_STACK_LINE(1390)
												_this->aabb->maxy = tmp14;
											}
										}
										else{
											HX_STACK_LINE(1390)
											...
											{
												HX_STACK_LINE(1390)
												bool tmp13 = _this->zip_gverts;		HX_STACK_VAR(tmp13,"tmp13");
												HX_STACK_LINE(1390)
												if ((tmp13)){
													HX_STACK_LINE(1390)
													bool tmp14 = (_this->body != null());		HX_STACK_VAR(tmp14,"tmp14");
													...
													if ((tmp14)){
														...
														::zpp_nape::geom::ZPP_Vec2 tmp15 = _this->lverts->next;		HX_STACK_VAR(tmp15,"tmp15");
														HX_STACK_LINE(1390)
														::zpp_nape::geom::ZPP_Vec2 li = tmp15;		HX_STACK_VAR(li,"li");
														HX_STACK_LINE(1390)
														{
															HX_STACK_LINE(1390)
											...
											HX_STACK_LINE(1390)
											::zpp_nape::geom::ZPP_Vec2 p0 = tmp15;		HX_STACK_VAR(p0,"p0");
											HX_STACK_LINE(1390)
											{
												HX_STACK_LINE(1390)
												_this->aabb->minx = p0->x;
											...
											HX_STACK_LINE(1390)
											{
												...
												::zpp_nape::geom::ZPP_Vec2 tmp16 = _this->gverts->next;		HX_STACK_VAR(tmp16,"tmp16");
												HX_STACK_LINE(1390)
												::zpp_nape::geom::ZPP_Vec2 cx_ite1 = tmp16->next;		HX_STACK_VAR(cx_ite1,"cx_ite1");
												HX_STACK_LINE(1390)
												while((true)){
													HX_STACK_LINE(1390)
													bool tmp17 = (cx_ite1 != null());		HX_STACK_VAR(tmp17,"tmp17");
													...
													HX_STACK_LINE(1390)
													{
														...
														Float tmp19 = p->x;		HX_STACK_VAR(tmp19,"tmp19");
														HX_STACK_LINE(1390)
														Float tmp20 = _this->aabb->minx;		HX_STACK_VAR(tmp20,"tmp20");
														HX_STACK_LINE(1390)
														bool tmp21 = (tmp19 < tmp20);		HX_STACK_VAR(tmp21,"tmp21");
														HX_STACK_LINE(1390)
														if ((tmp21)){
														...
														HX_STACK_LINE(1390)
														Float tmp23 = _this->aabb->maxx;		HX_STACK_VAR(tmp23,"tmp23");
														HX_STACK_LINE(1390)
														bool tmp24 = (tmp22 > tmp23);		HX_STACK_VAR(tmp24,"tmp24");
														HX_STACK_LINE(1390)
														if ((tmp24)){
														...
														Float tmp25 = p->y;		HX_STACK_VAR(tmp25,"tmp25");
														HX_STACK_LINE(1390)
														Float tmp26 = _this->aabb->miny;		HX_STACK_VAR(tmp26,"tmp26");
														HX_STACK_LINE(1390)
														bool tmp27 = (tmp25 < tmp26);		HX_STACK_VAR(tmp27,"tmp27");
														HX_STACK_LINE(1390)
														if ((tmp27)){
														...
														HX_STACK_LINE(1390)
														Float tmp29 = _this->aabb->maxy;		HX_STACK_VAR(tmp29,"tmp29");
														HX_STACK_LINE(1390)
...
bool ZPP_Body_obj::shapes_adder( ::nape::shape::Shape s){
	...
	if ((tmp1)){
		...
		if ((tmp5)){
			...
			if ((tmp8)){
				...
				if ((tmp10)){
					...
					HX_STACK_LINE(1397)
					bool tmp15 = (o->type == (int)3);		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(1397)
					if ((tmp15)){
						HX_STACK_LINE(1397)
					...
					HX_STACK_LINE(1397)
					bool tmp16 = o->component->sleeping;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(1397)
					if ((tmp16)){
						HX_STACK_LINE(1397)
						::zpp_nape::phys::ZPP_Body tmp17 = o;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(1397)
						_this->really_wake(tmp17,false);
					}
				}
			}
			HX_STACK_LINE(1397)
		...
		if ((tmp7)){
			HX_STACK_LINE(1399)
			::zpp_nape::shape::ZPP_Polygon tmp8 = s->zpp_inner->polygon;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(1399)
			tmp8->invalidate_gaxi();
			HX_STACK_LINE(1400)
			::zpp_nape::shape::ZPP_Polygon tmp9 = s->zpp_inner->polygon;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(1400)
			tmp9->invalidate_gverts();
		}
		HX_STACK_LINE(1402)
		return true;
	}
