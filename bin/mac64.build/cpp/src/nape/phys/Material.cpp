...
::nape::phys::Material Material_obj::copy( ){
	...
	HX_STACK_LINE(265)
	::nape::phys::Material tmp25 = ::nape::phys::Material_obj::__new(tmp4,tmp9,tmp14,tmp19,tmp24);		HX_STACK_VAR(tmp25,"tmp25");
	HX_STACK_LINE(265)
	::nape::phys::Material ret = tmp25;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(266)
	::zpp_nape::phys::ZPP_Material tmp26 = this->zpp_inner;		HX_STACK_VAR(tmp26,"tmp26");
	HX_STACK_LINE(266)
	Dynamic tmp27 = tmp26->userData;		HX_STACK_VAR(tmp27,"tmp27");
	HX_STACK_LINE(266)
	bool tmp28 = (tmp27 != null());		HX_STACK_VAR(tmp28,"tmp28");
	HX_STACK_LINE(266)
	if ((tmp28)){
		HX_STACK_LINE(266)
		::zpp_nape::phys::ZPP_Material tmp29 = this->zpp_inner;		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(266)
		Dynamic tmp30 = tmp29->userData;		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(266)
		Dynamic tmp31 = ::Reflect_obj::copy(tmp30);		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(266)
		ret->zpp_inner->userData = tmp31;
	}
	HX_STACK_LINE(267)
	::nape::phys::Material tmp29 = ret;		HX_STACK_VAR(tmp29,"tmp29");
	HX_STACK_LINE(267)
	return tmp29;
}
