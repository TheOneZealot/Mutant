...
HX_STACK_THIS(this)
{
	...
	this->zpp_inner = null();
	HX_STACK_LINE(696)
	::zpp_nape::util::ZPP_InteractionGroupList tmp = ::zpp_nape::util::ZPP_InteractionGroupList_obj::__new();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(696)
	this->zpp_inner = tmp;
	HX_STACK_LINE(697)
	::zpp_nape::util::ZPP_InteractionGroupList tmp1 = this->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(697)
...
{  hx::ObjectPtr< InteractionGroupList_obj > _result_ = new InteractionGroupList_obj();
...
int InteractionGroupList_obj::get_length( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	::zpp_nape::util::ZPP_InteractionGroupList tmp = this->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(245)
	tmp->valmod();
	HX_STACK_LINE(246)
	::zpp_nape::util::ZPP_InteractionGroupList tmp1 = this->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
	...
	if ((tmp2)){
		HX_STACK_LINE(247)
		::zpp_nape::util::ZPP_InteractionGroupList tmp3 = this->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(247)
		tmp3->zip_length = false;
		HX_STACK_LINE(259)
		{
			HX_STACK_LINE(259)
			::zpp_nape::util::ZPP_InteractionGroupList tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(259)
			int tmp5 = tmp4->inner->length;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(259)
			::zpp_nape::util::ZPP_InteractionGroupList tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(259)
...
bool InteractionGroupList_obj::has( ::nape::dynamics::InteractionGroup obj){
	...
	::zpp_nape::util::ZPP_InteractionGroupList tmp1 = this->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(350)
	::zpp_nape::dynamics::ZPP_InteractionGroup tmp2 = obj->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(350)
...
::nape::dynamics::InteractionGroup InteractionGroupList_obj::at( int index){
	...
	if ((tmp2)){
		...
		HX_STACK_LINE(368)
		{
			...
			::zpp_nape::util::ZPP_InteractionGroupList tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(368)
			::zpp_nape::util::ZPP_InteractionGroupList tmp7 = tmp6;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(368)
			tmp7->valmod();
			HX_STACK_LINE(368)
			::zpp_nape::util::ZPP_InteractionGroupList tmp8 = this->zpp_inner;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(368)
			::zpp_nape::util::ZPP_InteractionGroupList tmp9 = tmp8;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(368)
			...
			if ((tmp11)){
				HX_STACK_LINE(368)
				::zpp_nape::util::ZPP_InteractionGroupList tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(368)
				::zpp_nape::util::ZPP_InteractionGroupList tmp13 = tmp12;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(368)
				tmp13->zip_length = false;
				HX_STACK_LINE(368)
				{
					HX_STACK_LINE(368)
					::zpp_nape::util::ZPP_InteractionGroupList tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(368)
					::zpp_nape::util::ZPP_InteractionGroupList tmp15 = tmp14;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(368)
					int tmp16 = tmp15->inner->length;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(368)
					int tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(368)
					::zpp_nape::util::ZPP_InteractionGroupList tmp18 = this->zpp_inner;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(368)
					::zpp_nape::util::ZPP_InteractionGroupList tmp19 = tmp18;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(368)
	...
	if ((tmp5)){
		...
		{
			HX_STACK_LINE(370)
			::zpp_nape::util::ZPP_InteractionGroupList tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(370)
			tmp7->valmod();
			HX_STACK_LINE(370)
			::zpp_nape::util::ZPP_InteractionGroupList tmp8 = this->zpp_inner;		HX_STACK_VAR(tmp8,"tmp8");
			...
			if ((tmp9)){
				HX_STACK_LINE(370)
				::zpp_nape::util::ZPP_InteractionGroupList tmp10 = this->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(370)
				tmp10->zip_length = false;
				HX_STACK_LINE(370)
				{
					HX_STACK_LINE(370)
					::zpp_nape::util::ZPP_InteractionGroupList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(370)
					int tmp12 = tmp11->inner->length;		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(370)
					::zpp_nape::util::ZPP_InteractionGroupList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(370)
	...
	if ((tmp6)){
		...
		if ((tmp11)){
			...
			::zpp_nape::util::ZPP_InteractionGroupList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZPP_InteractionGroupList tmp14 = tmp13;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp15 = tmp14->at_ite;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(372)
			tmp12 = (tmp15 == null());
		}
		else{
		...
		if ((tmp12)){
			...
			HX_STACK_LINE(374)
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp16 = tmp14->inner->iterator_at(tmp15);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(374)
			::zpp_nape::util::ZPP_InteractionGroupList tmp17 = this->zpp_inner;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(374)
			tmp17->at_ite = tmp16;
		}
		else{
			...
			while((true)){
				...
				(tmp18->at_index)++;
				HX_STACK_LINE(379)
				::zpp_nape::util::ZPP_InteractionGroupList tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(379)
				::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp20 = tmp19->at_ite->next;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(379)
				::zpp_nape::util::ZPP_InteractionGroupList tmp21 = this->zpp_inner;		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(379)
				tmp21->at_ite = tmp20;
			}
		}
		...
		if ((tmp12)){
			...
			::zpp_nape::util::ZPP_InteractionGroupList tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(386)
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp15 = tmp14->inner->head;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(386)
			::zpp_nape::util::ZPP_InteractionGroupList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(386)
			tmp16->at_ite = tmp15;
			HX_STACK_LINE(387)
			while((true)){
				...
				::zpp_nape::util::ZPP_InteractionGroupList tmp17 = this->zpp_inner;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(388)
				::zpp_nape::dynamics::ZPP_InteractionGroup tmp18 = tmp17->at_ite->elt;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(388)
				::zpp_nape::dynamics::ZPP_InteractionGroup x = tmp18;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(389)
				break;
				HX_STACK_LINE(390)
				::zpp_nape::util::ZPP_InteractionGroupList tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
		...
		while((true)){
			...
			while((true)){
				HX_STACK_LINE(397)
				::zpp_nape::util::ZPP_InteractionGroupList tmp22 = this->zpp_inner;		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(397)
				::zpp_nape::dynamics::ZPP_InteractionGroup tmp23 = tmp22->at_ite->elt;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(397)
				::zpp_nape::dynamics::ZPP_InteractionGroup x = tmp23;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(398)
				break;
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_InteractionGroupList tmp24 = this->zpp_inner;		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp25 = tmp24->at_ite->next;		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_InteractionGroupList tmp26 = this->zpp_inner;		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(399)
				tmp26->at_ite = tmp25;
			}
		}
	...
	::zpp_nape::util::ZPP_InteractionGroupList tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(403)
	::zpp_nape::dynamics::ZPP_InteractionGroup tmp8 = tmp7->at_ite->elt;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(403)
	::nape::dynamics::InteractionGroup tmp9 = tmp8->outer;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(403)
	return tmp9;
}
...
bool InteractionGroupList_obj::push( ::nape::dynamics::InteractionGroup obj){
	...
	if ((tmp1)){
		HX_STACK_LINE(418)
		::String tmp2 = HX_HCSTRING("Error: InteractionGroup","\x7b","\xd2","\x63","\x85");		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(418)
	...
	HX_STACK_LINE(420)
	::zpp_nape::util::ZPP_InteractionGroupList tmp2 = this->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(420)
	tmp2->modify_test();
	HX_STACK_LINE(421)
	::zpp_nape::util::ZPP_InteractionGroupList tmp3 = this->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
	...
	if ((tmp6)){
		...
		::zpp_nape::util::ZPP_InteractionGroupList tmp8 = this->zpp_inner;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(424)
		::nape::dynamics::InteractionGroup tmp9 = obj;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(424)
	...
	if ((tmp8)){
		HX_STACK_LINE(426)
		::zpp_nape::util::ZPP_InteractionGroupList tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(426)
		...
		if ((tmp10)){
			...
			::zpp_nape::util::ZPP_InteractionGroupList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(426)
			::zpp_nape::dynamics::ZPP_InteractionGroup tmp12 = obj->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(426)
			...
			::zpp_nape::util::ZPP_InteractionGroupList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(428)
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp12 = tmp11->push_ite;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(428)
			...
			if ((tmp13)){
				...
				{
					HX_STACK_LINE(428)
					::zpp_nape::util::ZPP_InteractionGroupList tmp15 = this->zpp_inner;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(428)
					::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp16 = tmp15->inner->head;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(428)
					tmp14 = (tmp16 == null());
				}
				HX_STACK_LINE(428)
				::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp15;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(428)
				if ((tmp14)){
					HX_STACK_LINE(428)
					tmp15 = null();
			...
			::zpp_nape::util::ZPP_InteractionGroupList tmp15 = this->zpp_inner;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp16 = tmp15->push_ite;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(429)
			::zpp_nape::dynamics::ZPP_InteractionGroup tmp17 = obj->zpp_inner;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp18 = tmp14->inner->insert(tmp16,tmp17);		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZPP_InteractionGroupList tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(429)
		...
		if ((tmp14)){
			...
			::zpp_nape::util::ZPP_InteractionGroupList tmp15 = this->zpp_inner;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(432)
			::nape::dynamics::InteractionGroup tmp16 = obj;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(432)
...
::nape::dynamics::InteractionGroup InteractionGroupList_obj::pop( ){
	...
	HX_STACK_LINE(484)
	{
		...
		::zpp_nape::util::ZPP_InteractionGroupList tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(484)
		::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp5 = tmp4->inner->head;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(484)
		tmp3 = (tmp5 == null());
	}
	HX_STACK_LINE(484)
	...
	HX_STACK_LINE(490)
	::zpp_nape::util::ZPP_InteractionGroupList tmp5 = this->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(490)
	...
	if ((tmp6)){
		...
		::zpp_nape::util::ZPP_InteractionGroupList tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(491)
		::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp8 = tmp7->inner->head;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(491)
		ret = tmp8->elt;
		HX_STACK_LINE(492)
		...
		if ((tmp11)){
			...
			::zpp_nape::util::ZPP_InteractionGroupList tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(493)
			::nape::dynamics::InteractionGroup tmp13 = retx;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(493)
			tmp12->subber(tmp13);
		}
		HX_STACK_LINE(494)
		...
		::zpp_nape::util::ZPP_InteractionGroupList tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(497)
		::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp8 = tmp7->at_ite;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(497)
		...
		if ((tmp9)){
			...
			::zpp_nape::util::ZPP_InteractionGroupList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZPP_InteractionGroupList tmp12 = tmp11;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp13 = tmp12->at_ite->next;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp14 = tmp13;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(497)
			tmp10 = (tmp14 == null());
		}
		else{
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp13;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(498)
		if ((tmp12)){
			HX_STACK_LINE(498)
			tmp13 = null();
			...
			HX_STACK_LINE(498)
			{
				...
				if ((tmp18)){
					...
					{
						HX_STACK_LINE(498)
						::zpp_nape::util::ZPP_InteractionGroupList tmp20 = this->zpp_inner;		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(498)
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_InteractionGroup ite = tmp13;		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(499)
		bool tmp14 = (ite == null());		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(499)
		::zpp_nape::dynamics::ZPP_InteractionGroup tmp15;		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(499)
		if ((tmp14)){
			HX_STACK_LINE(499)
			::zpp_nape::util::ZPP_InteractionGroupList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(499)
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp17 = tmp16->inner->head;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(499)
			tmp15 = tmp17->elt;
		}
		else{
		...
		if ((tmp18)){
			...
			::zpp_nape::util::ZPP_InteractionGroupList tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(501)
			::nape::dynamics::InteractionGroup tmp20 = retx;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(501)
			tmp19->subber(tmp20);
		}
		HX_STACK_LINE(502)
		...
		if ((tmp21)){
			...
			::zpp_nape::util::ZPP_InteractionGroupList tmp22 = this->zpp_inner;		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(502)
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp23 = ite;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(502)
	...
	::nape::dynamics::InteractionGroup retx = ret->outer;		HX_STACK_VAR(retx,"retx");
	HX_STACK_LINE(506)
	::nape::dynamics::InteractionGroup tmp8 = retx;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(506)
	return tmp8;
}
...
bool InteractionGroupList_obj::add( ::nape::dynamics::InteractionGroup obj){
	HX_STACK_FRAME("nape.dynamics.InteractionGroupList","add",0xa27633f2,"nape.dynamics.InteractionGroupList.add","nape/dynamics/InteractionGroupList.hx",563,0x068b827f)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	::zpp_nape::util::ZPP_InteractionGroupList tmp = this->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
	...
	if ((tmp1)){
		HX_STACK_LINE(564)
		::nape::dynamics::InteractionGroup tmp3 = obj;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(564)
		tmp2 = this->push(tmp3);
	}
	else{
...
bool InteractionGroupList_obj::remove( ::nape::dynamics::InteractionGroup obj){
	...
	HX_STACK_LINE(585)
	{
		...
		HX_STACK_LINE(587)
		{
			...
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp5 = tmp4->inner->head;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_ZPP_InteractionGroup cx_ite = tmp5;		HX_STACK_VAR(cx_ite,"cx_ite");
			HX_STACK_LINE(589)
			while((true)){
				HX_STACK_LINE(589)
...
{
		HX_STACK_FRAME("nape.dynamics.InteractionGroupList","clear",0xff78899e,"nape.dynamics.InteractionGroupList.clear","nape/dynamics/InteractionGroupList.hx",614,0x068b827f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		::zpp_nape::util::ZPP_InteractionGroupList tmp = this->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(616)
		...
		if ((tmp3)){
			...
			while((true)){
				...
				HX_STACK_LINE(619)
				{
					...
					::zpp_nape::util::ZPP_InteractionGroupList tmp5 = this->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(619)
					::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp6 = tmp5->inner->head;		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(619)
					tmp4 = (tmp6 == null());
				}
				HX_STACK_LINE(619)
...
bool InteractionGroupList_obj::empty( ){
	...
	::zpp_nape::util::ZPP_InteractionGroupList tmp = this->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(633)
	::zpp_nape::util::ZNPNode_ZPP_InteractionGroup tmp1 = tmp->inner->head;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(633)
...
::nape::dynamics::InteractionGroupIterator InteractionGroupList_obj::iterator( ){
	...
	tmp->valmod();
	HX_STACK_LINE(651)
	::nape::dynamics::InteractionGroupIterator tmp1 = ::nape::dynamics::InteractionGroupIterator_obj::get(hx::ObjectPtr<OBJ_>(this));		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(651)
	return tmp1;
}
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		{
			HX_STACK_LINE(664)
			::nape::dynamics::InteractionGroupIterator tmp1;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(664)
			{
				HX_STACK_LINE(664)
				::zpp_nape::util::ZPP_InteractionGroupList tmp2 = this->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
				...
				tmp2->valmod();
				HX_STACK_LINE(664)
				tmp1 = ::nape::dynamics::InteractionGroupIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
			}
			HX_STACK_LINE(664)
			::nape::dynamics::InteractionGroupIterator _g = tmp1;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(664)
			while((true)){
				HX_STACK_LINE(664)
				bool tmp2;		HX_STACK_VAR(tmp2,"tmp2");
				...
				{
					HX_STACK_LINE(664)
					::zpp_nape::util::ZPP_InteractionGroupList tmp3 = _g->zpp_inner->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
					HX_STACK_LINE(664)
					tmp3->valmod();
					HX_STACK_LINE(664)
					...
					HX_STACK_LINE(664)
					{
						...
						if ((tmp5)){
							...
							{
								HX_STACK_LINE(664)
								::zpp_nape::util::ZNPList_ZPP_InteractionGroup tmp6 = _this->zpp_inner->inner;		HX_STACK_VAR(tmp6,"tmp6");
								HX_STACK_LINE(664)
					...
					if ((tmp5)){
						...
						{
							HX_STACK_LINE(664)
							::nape::dynamics::InteractionGroupIterator tmp6 = ::nape::dynamics::InteractionGroupIterator_obj::zpp_pool;		HX_STACK_VAR(tmp6,"tmp6");
							HX_STACK_LINE(664)
							_g->zpp_next = tmp6;
							HX_STACK_LINE(664)
				...
				HX_STACK_LINE(664)
				::nape::dynamics::InteractionGroup tmp4;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(664)
				{
					HX_STACK_LINE(664)
				...
				HX_STACK_LINE(664)
				::nape::dynamics::InteractionGroup i = tmp4;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(664)
				bool tmp5 = deep;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(664)
				::nape::dynamics::InteractionGroup tmp6;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(664)
				if ((tmp5)){
					HX_STACK_LINE(666)
					::String tmp7 = HX_HCSTRING("Error: InteractionGroup","\x7b","\xd2","\x63","\x85");		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(666)
		...
		HX_STACK_LINE(671)
		::nape::dynamics::InteractionGroupList tmp1 = ret;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(671)
		return tmp1;
	}
}
...
{
		HX_STACK_FRAME("nape.dynamics.InteractionGroupList","merge",0xbce3bac9,"nape.dynamics.InteractionGroupList.merge","nape/dynamics/InteractionGroupList.hx",684,0x068b827f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		...
		HX_STACK_LINE(688)
		{
			...
			HX_STACK_LINE(688)
			{
				...
				xs->zpp_inner->valmod();
				HX_STACK_LINE(688)
				::nape::dynamics::InteractionGroupList tmp2 = xs;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(688)
				tmp1 = ::nape::dynamics::InteractionGroupIterator_obj::get(tmp2);
			}
			HX_STACK_LINE(688)
			::nape::dynamics::InteractionGroupIterator _g = tmp1;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(688)
			while((true)){
				...
				HX_STACK_LINE(688)
				::nape::dynamics::InteractionGroup x = tmp4;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(689)
				::nape::dynamics::InteractionGroup tmp5 = x;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(689)
				...
				if ((tmp7)){
					...
					if ((tmp9)){
						HX_STACK_LINE(689)
						::nape::dynamics::InteractionGroup tmp10 = x;		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(689)
						this->push(tmp10);
					}
					else{
...
::String InteractionGroupList_obj::toString( ){
	...
	{
		HX_STACK_LINE(705)
		::nape::dynamics::InteractionGroupIterator tmp;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(705)
		{
			HX_STACK_LINE(705)
			::zpp_nape::util::ZPP_InteractionGroupList tmp1 = this->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
			...
			tmp1->valmod();
			HX_STACK_LINE(705)
			tmp = ::nape::dynamics::InteractionGroupIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
		}
		HX_STACK_LINE(705)
		::nape::dynamics::InteractionGroupIterator _g = tmp;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(705)
		while((true)){
			HX_STACK_LINE(705)
			...
			{
				HX_STACK_LINE(705)
				::zpp_nape::util::ZPP_InteractionGroupList tmp2 = _g->zpp_inner->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(705)
				tmp2->valmod();
				HX_STACK_LINE(705)
				...
				HX_STACK_LINE(705)
				{
					...
					if ((tmp4)){
						...
						{
							HX_STACK_LINE(705)
							::zpp_nape::util::ZNPList_ZPP_InteractionGroup tmp5 = _this->zpp_inner->inner;		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(705)
			...
			HX_STACK_LINE(705)
			::nape::dynamics::InteractionGroup i = tmp3;		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(706)
...
::nape::dynamics::InteractionGroupList InteractionGroupList_obj::foreach( Dynamic lambda){
	...
	HX_STACK_LINE(736)
	::nape::dynamics::InteractionGroupIterator it = tmp1;		HX_STACK_VAR(it,"it");
	HX_STACK_LINE(737)
	while((true)){
		HX_STACK_LINE(737)
		bool tmp2;		HX_STACK_VAR(tmp2,"tmp2");
		...
		{
			HX_STACK_LINE(737)
			::zpp_nape::util::ZPP_InteractionGroupList tmp3 = it->zpp_inner->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(737)
			tmp3->valmod();
			HX_STACK_LINE(737)
			int tmp4;		HX_STACK_VAR(tmp4,"tmp4");
...
::nape::dynamics::InteractionGroupList InteractionGroupList_obj::filter( Dynamic lambda){
	...
	while((true)){
		...
		HX_STACK_LINE(785)
		::nape::dynamics::InteractionGroup tmp6 = this->at(tmp5);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(785)
		::nape::dynamics::InteractionGroup x = tmp6;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(786)
		try
		{
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			HX_STACK_LINE(787)
			::nape::dynamics::InteractionGroup tmp7 = x;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(787)
			...
			if ((tmp8)){
				...
				HX_STACK_LINE(788)
				::nape::dynamics::InteractionGroup tmp9 = x;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(788)
				this->remove(tmp9);
			}
		}
...
::nape::dynamics::InteractionGroupList InteractionGroupList_obj::fromArray( Array< ::Dynamic > array){
	...
	HX_STACK_LINE(310)
	::nape::dynamics::InteractionGroupList tmp1 = ::nape::dynamics::InteractionGroupList_obj::__new();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(310)
	::nape::dynamics::InteractionGroupList ret = tmp1;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(311)
	{
		HX_STACK_LINE(311)
		...
		while((true)){
			...
			HX_STACK_LINE(311)
			::nape::dynamics::InteractionGroup tmp4 = array->__get(_g).StaticCast< ::nape::dynamics::InteractionGroup >();		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(311)
			::nape::dynamics::InteractionGroup i = tmp4;		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			::nape::dynamics::InteractionGroup tmp5 = i;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(316)
			ret->push(tmp5);
		}
	}
...
Dynamic InteractionGroupList_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic InteractionGroupList_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 9:
